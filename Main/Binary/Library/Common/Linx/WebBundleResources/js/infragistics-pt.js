...
if (!$.ig.Grid) {
    ...
    $.extend($.ig.Grid, {
        ...
        locale: {
            ...
            collapseTooltip: "Contraer linha",
    ...
    $.extend($.ig.GridGroupBy, {
        locale: {
            emptyGroupByAreaContent: "Arraste uma columa aqui {0} para Agrupar por",
            emptyGroupByAreaContentSelectColumns: "selecione columas",
            emptyGroupByAreaContentSelectColumnsCaption: "selecione columas",
            expandTooltip: "Expandir linha agrupada",
            collapseTooltip: "Contraer linha agrupada",
            removeButtonTooltip: "Quitar columa agrupada",
    ...
    $.extend($.ig.GridUpdating, {
        locale: {
            ...
            addRowLabel: 'Adicionar Novo registro',
            addRowTooltip: 'Clique para adicionar um novo registro',
            deleteRowLabel: '',
...
if (!$.ig.PivotShared) {
    ...
    $.extend($.ig.PivotShared, {
        locale: {
            invalidDataSource: "Fonte de dados invalidas.",
            measureList: "Medidas",
            ok: "OK",
            cancel: "Cancelar",
            addToMeasures: "Adicionar nas medidas",
            addToFilters: "Adicionar nos filtros",
            addToColumns: "Adicionar nas colunas",
            addToRows: "Adicionar nas Linhas"
        }
    });
}
/*!@license
...
if (!$.ig.PivotDataSelector) {
    ...
    $.extend($.ig.PivotDataSelector, {
        locale: {
            invalidBaseElement: " não se permite como elemento base. Use DIV em seu lugar.",
            catalog: "Catálogo",
            cube: "Cubo",
...
if (!$.ig.PivotGrid) {
    ...
    $.extend($.ig.PivotGrid, {
        locale: {
            filtersHeader: "Soltar campos de filtro aqui",
            measuresHeader: "Soltar elementos de medidas aqui",
            rowsHeader: "Soltar campos de linha aqui",
            columnsHeader: "Soltar campos de coluna aqui",
            ...
            noSuchAxis: "Não existe tal eixo"
        }
    });
}
/*!@license
