define(['durandal/app', 'pkg_linxtraining001-bv-spa/services/TiposCamposSingleContext', 'plugins/router', 'plugins/widget', 'managers/__auth', 'viewmodels/shared/modal', 'viewmodels/shared/modal2', 'managers/brand', 'managers/predefinedFilters', 'services/logger', 'viewmodels/shared/modalMultimidia', 'common', 'pkg_linxtraining001-bv-spa/viewmodels/TiposCamposSingleComplement', 'viewmodels/shared/modalCustomSearch'],
...
var vmConstructor = function () {
      ...
      if ((typeof settings === 'object') && (settings != null) && settings.objectQuery) {
          ...
          if ((typeof settings === 'object') && (settings != null) && settings.uiSettings) {
              ...
              if (uiSettings.executeQuery === true) {
                  ...
                  filteredEntities = [];
                  if (settings.parentVM) { settings.parentVM.internalUIs = [ 'TiposCamposSingle' ]; settings.parentVM.TiposCamposSingle = getVM; }
                  clear();
                  ...
                  if ((typeof settings.parentVM === 'object') && settings.parentVM != null) {
                      ...
                      parentVM.TiposCamposSingle = getVM;
                      if (isLookup()) { 
                      ...
                      if ($.inArray('TiposCamposSingle', parentVM.internalUIs) === -1) parentVM.internalUIs.push('TiposCamposSingle');
                  }
              }
          }
          else {
    ...
    var adjustModuleSecurity = function () {
        ...
        if (managerAuth.shellMode == 'PROD') {
           managerAuth.getFormAccess('linxtraining001-bv-spa-TiposCamposSingle', function (data) {
    ...
    var canActivate = function() {
        ...
        if (data.lxShellCompiledVersion != managerAuth.shellVersion) {
            app.showMessage('Versão de formulário incompatível com a versão de ambiente [' + managerAuth.shellVersion + '].', 'Formulário: TiposCamposSingle', ['Ok']);
            return false;
        }
        return true;
    };
    ...
    var compositionComplete = function() {
        complement.renderscyTiposCamposSingle_dGrid(vm);
    ...
    var removeFormViewControl = function () {
        var front = $('#TiposCamposSingle_formViewer_front')[0];
        if (front) front.removeClassName('front');
        var back = $('#TiposCamposSingle_formViewer_back')[0];
    ...
    var changeFormView = function () {
        ...
        var panel = $('#TiposCamposSingle_formViewer')[0];
           ...
           if (vm.status() !== 'C') {
               ...
               colunas.forEach(function (entry, index) {
                   if (entry.hidden && entry.key !== 'RowDataId') {
                       var control = $('#TiposCamposSingle_div' + (!dataView ? '' : '' + dataView + '_') + entry.key + 'Template');
    ...
    var vm = {
            ...
            rootNamespace: 'LinxTraining001.BV.TiposCamposSingle',
            ...
            __moduleId__: 'pkg_linxtraining001-bv-spa/viewmodels/TiposCamposSingle'
        };
