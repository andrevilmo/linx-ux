...
var vmConstructor = function () {
    ...
    var activate = function (settings, querystring) {
      ...
      vm.TelaPreenchimentoPIVOT = getVM;
      ...
      if ((typeof settings === 'object') && (settings != null) && settings.objectQuery) {
          ...
          if ((typeof settings === 'object') && (settings != null) && settings.uiSettings) {
              ...
              if (uiSettings.executeQuery === true) {
                  ...
                  filteredEntities = [];
                  if (settings.parentVM) { settings.parentVM.internalUIs = [ 'TelaPreenchimentoPIVOT' ]; settings.parentVM.TelaPreenchimentoPIVOT = getVM; }
                  clear();
                  ...
                  if ((typeof settings.parentVM === 'object') && settings.parentVM != null) {
                      ...
                      parentVM.TelaPreenchimentoPIVOT = getVM;
                      if (isLookup()) { 
                      ...
                      if ($.inArray('TelaPreenchimentoPIVOT', parentVM.internalUIs) === -1) parentVM.internalUIs.push('TelaPreenchimentoPIVOT');
                  }
              }
          }
          else {
    ...
    var adjustModuleSecurity = function () {
        ...
        if (managerAuth.shellMode == 'PROD') {
           managerAuth.getFormAccess('linxtraining001-bv-spa-TelaPreenchimentoPIVOT', function (data) {
    ...
    var canActivate = function() {
        ...
        if (data.lxShellCompiledVersion != managerAuth.shellVersion) {
            app.showMessage('Versão de formulário incompatível com a versão de ambiente [' + managerAuth.shellVersion + '].', 'Formulário: TelaPreenchimentoPIVOT', ['Ok']);
            return false;
        }
        return true;
    };
    ...
    var compositionComplete = function() {
        complement.renderscyTelaPreenchimentoPIVOT_dGrid(vm);
    ...
    var visibleColumns = 'Bolean,Data,Decimal,Inteiro,String';
    ...
    var removeFormViewControl = function () {
        var front = $('#TelaPreenchimentoPIVOT_formViewer_front')[0];
        if (front) front.removeClassName('front');
        var back = $('#TelaPreenchimentoPIVOT_formViewer_back')[0];
    ...
    var changeFormView = function () {
        ...
        var panel = $('#TelaPreenchimentoPIVOT_formViewer')[0];
           ...
           if (vm.status() !== 'C') {
               ...
               colunas.forEach(function (entry, index) {
                   if (entry.hidden && entry.key !== 'RowDataId') {
                       var control = $('#TelaPreenchimentoPIVOT_div' + (!dataView ? '' : '' + dataView + '_') + entry.key + 'Template');
    ...
    var vm = {
            dataView: dataView,
            viewName: 'TelaPreenchimentoPIVOT',
            ...
            __moduleId__: 'pkg_linxtraining001-bv-spa/viewmodels/TelaPreenchimentoPIVOT'
        };
