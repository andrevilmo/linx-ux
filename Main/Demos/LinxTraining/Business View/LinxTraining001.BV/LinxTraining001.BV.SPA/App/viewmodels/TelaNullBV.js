define(['durandal/app', 'pkg_linxtraining001-bv-spa/services/NotNullContext', 'plugins/router', 'plugins/widget', 'managers/__auth', 'viewmodels/shared/modal', 'viewmodels/shared/modal2', 'managers/brand', 'managers/predefinedFilters', 'services/logger', 'viewmodels/shared/modalMultimidia', 'common', 'pkg_linxtraining001-bv-spa/viewmodels/TelaNullBVComplement', 'viewmodels/shared/modalCustomSearch'],
...
var vmConstructor = function () {
      ...
      if ((typeof settings === 'object') && (settings != null) && settings.objectQuery) {
          ...
          if ((typeof settings === 'object') && (settings != null) && settings.uiSettings) {
              ...
              if (uiSettings.executeQuery === true) {
                  ...
                  filteredEntities = [];
                  if (settings.parentVM) { settings.parentVM.internalUIs = [ 'TelaNullBV' ]; settings.parentVM.TelaNullBV = getVM; }
                  clear();
                  ...
                  if ((typeof settings.parentVM === 'object') && settings.parentVM != null) {
                      ...
                      if ($.inArray('TelaNullBV', parentVM.internalUIs) === -1) parentVM.internalUIs.push('TelaNullBV');
                  }
              }
          }
          else {
    ...
    var adjustModuleSecurity = function () {
        ...
        if (managerAuth.shellMode == 'PROD') {
           managerAuth.getFormAccess('linxtraining001-bv-spa-TelaNullBV', function (data) {
    ...
    var canActivate = function() {
        ...
        if (data.lxShellCompiledVersion != managerAuth.shellVersion) {
            app.showMessage('Versão de formulário incompatível com a versão de ambiente [' + managerAuth.shellVersion + '].', 'Formulário: TelaNullBV', ['Ok']);
            return false;
        }
        return true;
    };
    ...
    var compositionComplete = function() {
        $('#TelaNullBV_tcTiposCamposViewTabControl').on('shown.bs.tab', function (e) { vm.notifyInnerElements($(e.target.hash)); });
    initializeTabControl('#TelaNullBV_tcTiposCamposViewTabControl');

    complement.renderTelaNullBV_dGridTiposCamposFilhaView(vm);

    complement.renderscyTelaNullBV_dGrid(vm);
    ...
    var visibleColumns = 'Boolean,Byte,ByteArray,DateTime,DateTimeOffset,Decimal,IDTiposCampos,Int,Long,Short,String,StringChar,StringText,Timestamp';
    ...
    var removeFormViewControl = function () {
        var front = $('#TelaNullBV_formViewer_front')[0];
        if (front) front.removeClassName('front');
        var back = $('#TelaNullBV_formViewer_back')[0];
    ...
    var changeFormView = function () {
        ...
        var panel = $('#TelaNullBV_formViewer')[0];
    ...
    var entitySearchRange = {
        ...
        TiposCamposFilhaViewByte_begin: ko.observable(null), TiposCamposFilhaViewByte_end: ko.observable(null),
        ...
        TiposCamposFilhaViewIDTiposCampos: ko.observable(null)
    };
    entitySearchRange.clear = function(){
        ...
        entitySearchRange.TiposCamposFilhaViewByte_begin(null); entitySearchRange.TiposCamposFilhaViewByte_end(null);
        ...
        entitySearchRange.TiposCamposFilhaViewIDTiposCampos(null);
    };
    ...
    entitySearchRange.has_TiposCamposFilhaViewByte = ko.computed(function(){ return (entitySearchRange.TiposCamposFilhaViewByte_begin() != null || entitySearchRange.TiposCamposFilhaViewByte_end() != null); });
           ...
           if (vm.status() !== 'C') {
               ...
               colunas.forEach(function (entry, index) {
                   if (entry.hidden && entry.key !== 'RowDataId') {
                       var control = $('#TelaNullBV_div' + (!dataView ? '' : '' + dataView + '_') + entry.key + 'Template');
    ...
    var vm = {
            ...
            rootNamespace: 'LinxTraining001.BV.NotNull',
            ...
            __moduleId__: 'pkg_linxtraining001-bv-spa/viewmodels/TelaNullBV'
        };
