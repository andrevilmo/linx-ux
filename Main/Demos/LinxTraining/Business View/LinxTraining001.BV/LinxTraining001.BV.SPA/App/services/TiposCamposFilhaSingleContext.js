...
var result = function () {
    ...
    var getDataFeedUrl = function() {
       return getServiceAddress('LinxTraining001TiposCamposFilhaSingleOData');
    };
    ...
    var controllerName = 'LinxTraining001TiposCamposFilhaSingle';
    ...
    metadataInfo['TiposCamposFilhaView'] = [
        ...
        { key: 'IDTiposCampos', isDomain: false, domainName: '', lookupPropertyName: 'IDTiposCampos', lookupVisibleColumns: '', maxLength: 12, isPartOfKey: false, headerText: 'ID TiposCampos', width: '218px', dataType: 'number', format: 'int', hidden: false, unbound: false, group: null },
    ...
    dataExportInfo['TiposCamposFilhaView'] = [ 
        { name: 'TiposCamposFilhaView', canExportMedia: true , canExportReport: true, actionExport: 'LinxTraining001TiposCamposFilhaSingle/GetTiposCamposFilhaViewToExcel', actionReport: 'LinxTraining001TiposCamposFilhaSingle/GetTiposCamposFilhaViewToReportXml', actionFeed: 'LinxTraining001TiposCamposFilhaSingleOData/TiposCamposFilhaView', actionName: 'LinxTraining001TiposCamposFilhaSingle/GetTiposCamposFilhaViewByEntitySearchNoAssociations', display: 'TiposCamposFilhaView',  metaData: function() { return metadataInfo['TiposCamposFilhaView']; } }
    ];
    entitylookUps.push('TiposCamposFilhaView');
    entitylookUps['TiposCamposFilhaView'] = [];
    entitylookUps['TiposCamposFilhaView'].push('LookUpTiposCampos');
    lookUpNames.push('LookUpTiposCampos');
    metadataInfo['LookUpTiposCampos'] = [
        { key: 'IDTiposCampos', relatedKey: 'IDTiposCampos', maxLength: 12, isPartOfKey: true, headerText: 'ID TiposCampos', width: '218px', dataType: 'number', format: 'int', hidden: false, unbound: false, group: null }
    ];
    ...
    lookUpProperties['TiposCamposFilhaView'] = {IDTiposCampos: 'LookUpTiposCampos'};
    var TiposCamposFilhaViewInitializer = function (ownerReference, isPOCO) {
       ...
       if (isPOCO !== true) {
           ...
           ownerReference.getLookupDisplay = function (lookupName) {
               var displayName = '';
               if (lookupName === 'LookUpTiposCampos') {
                   displayName = ' de TiposCampos';
               }
           ...
           ownerReference.getSubQueryFilterFromLookUpTiposCampos = function (propertyName) {
               var filter = '';
               return filter;
           }
       ...
       ownerReference.namespace = 'LinxTraining001.BV.TiposCamposFilhaSingle';
       ownerReference.myProperties = [ 'Boolean','Byte','DateTime','Decimal','Guid','IDTiposCampos','IDTiposCamposFilha','Int','Long','Short','String','StringChar','StringText' ];
    ...
    var getLookUpTiposCamposByEntitySearch = function (jEntitySearch, order, skip, take, direction) {
        var query = EntityQuery.from('GetLookUpTiposCamposByEntitySearch').noTracking(true);
    ...
    // Define that the event name is 'TiposCamposFilhaSingleContext_DataUpdate'.
    var contextUpdtEvt = 'TiposCamposFilhaSingleContext_DataUpdate_' + getNewGuid();
    dataUpdateEvent.initEvent(contextUpdtEvt, true, true);
    
    //#region LookUps Finalizers
     var finalizeAllLookUpTiposCampos = function (replaceTo, selectedElements, propertyName, lookupInfo) {
        ...
        for (var i = 0; i < selectedElements.length; i++)
        {
            ...
            if (propertyName === '' || propertyName === 'IDTiposCampos') {
               if (selectedElement.hasOwnProperty('IDTiposCampos') && replaceTo.hasOwnProperty('IDTiposCampos'))
               {
                   setAbsoluteValue(replaceTo, 'IDTiposCampos', getAbsoluteValue(selectedElement['IDTiposCampos']));
               }
               else if (replaceTo.hasOwnProperty('IDTiposCampos')) {
                   setAbsoluteValue(replaceTo, 'IDTiposCampos', 0);
               }
            }
            if (replaceTo.validatedlookupsArray && !replaceTo.validatedlookupsArray.contains('LookUpTiposCampos'))
                replaceTo.validatedlookupsArray.push('LookUpTiposCampos');
        }
    ...
    function clearLookUpTiposCampos(replaceTo) {
        if (!replaceTo)
            return;
    ...
    var saveChanges = function(saveSucceeded, saveFailed, fin, saveNoTRack) {
        if (saveNoTRack === true) {
            ...
            return $.ajax({
               type: 'POST',
               crossDomain: true,
               url: getServiceAddress('LinxTraining001TiposCamposFilhaSingle/Save' + vm.rootDataTypeName),
               globalError: true,
    ...
    var createTiposCamposFilhaView = function() {
        ...
        var entity = createEntity('TiposCamposFilhaView', { Boolean: false });
        entity.setDefaults();
        return entity;
    };
    ...
    var exportReportDataSource = function(complete) {
        $.ajax({
           ...
           crossDomain: true,
           headers: managerAuth.getHeaders(),
           url: getServiceAddress("LinxTraining001TiposCamposFilhaSingle/GetReportDataSource"),
           success: function (response) {
    ...
    var exportTemplateReport = function(reportPath, complete) {
        $.ajax({
           ...
           crossDomain: true,
           headers: managerAuth.getHeaders(),
           url: getServiceAddress("LinxTraining001TiposCamposFilhaSingle/GetTemplateReport"),
    ...
    //#endregion getWithBinding
        ...
        var dataContext = {
            ...
            setCurrentViewModel: function(vModel) { vm = vModel; },
                getLookUpTiposCamposByEntitySearch: getLookUpTiposCamposByEntitySearch,
            ...
            getTiposCamposFilhaViewByEntitySearchNoAssociations: getTiposCamposFilhaViewByEntitySearchNoAssociations,
                finalizeAllLookUpTiposCampos: finalizeAllLookUpTiposCampos,
            clearLookUpTiposCampos: clearLookUpTiposCampos
        };
    loadParameters();
    return dataContext;
