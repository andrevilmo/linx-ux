...
var result = function () {
    ...
    var getDataFeedUrl = function() {
       return getServiceAddress('LinxTraining001TiposCamposUIExternaOData');
    };
    ...
    var controllerName = 'LinxTraining001TiposCamposUIExterna';
    ...
    metadataInfo['TiposCamposView'] = [
        ...
        { key: 'Guid', isDomain: false, domainName: '', lookupPropertyName: '', lookupVisibleColumns: '', isRequired: true, maxLength: 36, isPartOfKey: false, headerText: 'Guid', width: '250px', dataType: 'string', format: '', hidden: false, unbound: false, group: null },
    ...
    dataExportInfo['TiposCamposView'] = [ 
        { name: 'TiposCamposView', canExportMedia: true , canExportReport: true, actionExport: 'LinxTraining001TiposCamposUIExterna/GetTiposCamposViewToExcel', actionReport: 'LinxTraining001TiposCamposUIExterna/GetTiposCamposViewToReportXml', actionFeed: 'LinxTraining001TiposCamposUIExternaOData/TiposCamposView', actionName: 'LinxTraining001TiposCamposUIExterna/GetTiposCamposViewByEntitySearchNoAssociations', display: 'TiposCamposView',  metaData: function() { return metadataInfo['TiposCamposView']; } }
    ];
    ...
    var TiposCamposViewInitializer = function (ownerReference, isPOCO) {
       ownerReference.RowDataId = (isPOCO === true ? getNextSequence('TiposCamposView') : ko.observable(getNextSequence('TiposCamposView')));
        ...
        var _boolean = ownerReference.Boolean;
        Object.defineProperty(ownerReference, 'Boolean', {
          get: function() { return _boolean; },
          set: function(newValue) { var oldValue = _boolean; _boolean = newValue; if (!entityPropChanged(ownerReference, 'Boolean', oldValue, newValue)) { _boolean = oldValue; } }
        });
        var _byte = ownerReference.Byte;
        Object.defineProperty(ownerReference, 'Byte', {
          get: function() { return _byte; },
          set: function(newValue) { var oldValue = _byte; _byte = newValue; if (!entityPropChanged(ownerReference, 'Byte', oldValue, newValue)) { _byte = oldValue; } }
        });
        var _dateTime = ownerReference.DateTime;
        Object.defineProperty(ownerReference, 'DateTime', {
          get: function() { return _dateTime; },
          set: function(newValue) { var oldValue = _dateTime; _dateTime = newValue; if (!entityPropChanged(ownerReference, 'DateTime', oldValue, newValue)) { _dateTime = oldValue; } }
        });
        var _decimal = ownerReference.Decimal;
        Object.defineProperty(ownerReference, 'Decimal', {
          get: function() { return _decimal; },
          set: function(newValue) { var oldValue = _decimal; _decimal = newValue; if (!entityPropChanged(ownerReference, 'Decimal', oldValue, newValue)) { _decimal = oldValue; } }
        });
        var _guid = ownerReference.Guid;
        Object.defineProperty(ownerReference, 'Guid', {
          get: function() { return _guid; },
          set: function(newValue) { var oldValue = _guid; _guid = newValue; if (!entityPropChanged(ownerReference, 'Guid', oldValue, newValue)) { _guid = oldValue; } }
        });
        var _iDTiposCampos = ownerReference.IDTiposCampos;
        Object.defineProperty(ownerReference, 'IDTiposCampos', {
          get: function() { return _iDTiposCampos; },
          set: function(newValue) { var oldValue = _iDTiposCampos; _iDTiposCampos = newValue; if (!entityPropChanged(ownerReference, 'IDTiposCampos', oldValue, newValue)) { _iDTiposCampos = oldValue; } }
        });
        var _int = ownerReference.Int;
        Object.defineProperty(ownerReference, 'Int', {
          get: function() { return _int; },
          set: function(newValue) { var oldValue = _int; _int = newValue; if (!entityPropChanged(ownerReference, 'Int', oldValue, newValue)) { _int = oldValue; } }
        });
        var _long = ownerReference.Long;
        Object.defineProperty(ownerReference, 'Long', {
          get: function() { return _long; },
          set: function(newValue) { var oldValue = _long; _long = newValue; if (!entityPropChanged(ownerReference, 'Long', oldValue, newValue)) { _long = oldValue; } }
        });
        var _short = ownerReference.Short;
        Object.defineProperty(ownerReference, 'Short', {
          get: function() { return _short; },
          set: function(newValue) { var oldValue = _short; _short = newValue; if (!entityPropChanged(ownerReference, 'Short', oldValue, newValue)) { _short = oldValue; } }
        });
        var _string = ownerReference.String;
        Object.defineProperty(ownerReference, 'String', {
          get: function() { return _string; },
          set: function(newValue) { var oldValue = _string; _string = newValue; if (!entityPropChanged(ownerReference, 'String', oldValue, newValue)) { _string = oldValue; } }
        });
        var _stringChar = ownerReference.StringChar;
        Object.defineProperty(ownerReference, 'StringChar', {
          get: function() { return _stringChar; },
          set: function(newValue) { var oldValue = _stringChar; _stringChar = newValue; if (!entityPropChanged(ownerReference, 'StringChar', oldValue, newValue)) { _stringChar = oldValue; } }
        });
        var _stringText = ownerReference.StringText;
        Object.defineProperty(ownerReference, 'StringText', {
          get: function() { return _stringText; },
          set: function(newValue) { var oldValue = _stringText; _stringText = newValue; if (!entityPropChanged(ownerReference, 'StringText', oldValue, newValue)) { _stringText = oldValue; } }
        });
       ...
       ownerReference.delete = function() {
           ...
           if (ownerReference.ChangeState == 'I') {
               if (parent && (typeof parent.TiposCamposViewList === 'function')) { parent.TiposCamposViewList.remove(ownerReference); }
           }
           else {
       ...
       ownerReference.namespace = 'LinxTraining001.BV.TiposCamposUIExterna';
       ownerReference.myProperties = [ 'Boolean','Byte','DateTime','Decimal','Guid','IDTiposCampos','Int','Long','Short','String','StringChar','StringText' ];
    ...
    // Define that the event name is 'TiposCamposUIExternaContext_DataUpdate'.
    var contextUpdtEvt = 'TiposCamposUIExternaContext_DataUpdate_' + getNewGuid();
    ...
    var saveChangesFake = function (transactionID, saveSucceeded) {
        ...
        return $.ajax({
            type: 'POST',
            crossDomain: true,
            url: getServiceAddress('LinxTraining001TiposCamposUIExterna/Save' + vm.rootDataTypeName + 'InCache'),
            globalError: true,
    ...
    var submitAllChanges = function (transactionId, saveSucceeded, failed, completed) {
        return $.ajax({
            type: 'GET',
            crossDomain: true,
            url: getServiceAddress('LinxTraining001TiposCamposUIExterna/submitAllChanges?transactionID=' + transactionId),
            globalError: false,
            contentType: 'application/json',
            async: true,
            cache: false,
    ...
    var cancelAllChanges = function (transactionId, saveSucceeded, failed) {
        return $.ajax({
            type: 'GET',
            crossDomain: true,
            url: getServiceAddress('LinxTraining001TiposCamposUIExterna/CancelAllChanges?transactionID=' + transactionId),
            globalError: false,
            contentType: 'application/json',
            async: true,
            cache: false,
    ...
    var saveChanges = function(saveSucceeded, saveFailed, fin, saveNoTRack) {
        if (saveNoTRack === true) {
            ...
            return $.ajax({
               type: 'POST',
               crossDomain: true,
               url: getServiceAddress('LinxTraining001TiposCamposUIExterna/Save' + vm.rootDataTypeName),
               globalError: true,
               contentType: 'application/json',
               async: true,
               cache: false,
    ...
    var createTiposCamposView = function() {
        ...
        var defaultVals = { IDTiposCampos: (-1 * getSequence('TiposCamposView')), Boolean: false };
        var entityType = manager.metadataStore.getEntityType('TiposCamposView');
        var entity = {};
        ...
        dataContext.initializePOCO(entity, 'TiposCamposView');
        entity.setDefaults();
    ...
    var exportReportDataSource = function(complete) {
        $.ajax({
           ...
           crossDomain: true,
           headers: managerAuth.getHeaders(),
           url: getServiceAddress("LinxTraining001TiposCamposUIExterna/GetReportDataSource"),
           success: function (response) {
    ...
    var exportTemplateReport = function(reportPath, complete) {
        $.ajax({
           ...
           crossDomain: true,
           headers: managerAuth.getHeaders(),
           url: getServiceAddress("LinxTraining001TiposCamposUIExterna/GetTemplateReport"),
