...
var result = function () {
    ...
    var getDataFeedUrl = function() {
       return getServiceAddress('LinxTraining001TiposCamposSingleOData');
    };
    ...
    var controllerName = 'LinxTraining001TiposCamposSingle';
    ...
    dataExportInfo['TiposCamposView'] = [ 
        { name: 'TiposCamposView', canExportMedia: true , canExportReport: true, actionExport: 'LinxTraining001TiposCamposSingle/GetTiposCamposViewToExcel', actionReport: 'LinxTraining001TiposCamposSingle/GetTiposCamposViewToReportXml', actionFeed: 'LinxTraining001TiposCamposSingleOData/TiposCamposView', actionName: 'LinxTraining001TiposCamposSingle/GetTiposCamposViewByEntitySearchNoAssociations', display: 'TiposCamposView',  metaData: function() { return metadataInfo['TiposCamposView']; } }
    ];
    ...
    var TiposCamposViewInitializer = function (ownerReference, isPOCO) {
       ...
       ownerReference.namespace = 'LinxTraining001.BV.TiposCamposSingle';
    ...
    // Define that the event name is 'TiposCamposSingleContext_DataUpdate'.
    var contextUpdtEvt = 'TiposCamposSingleContext_DataUpdate_' + getNewGuid();
    ...
    var saveChanges = function(saveSucceeded, saveFailed, fin, saveNoTRack) {
        if (saveNoTRack === true) {
            ...
            return $.ajax({
               type: 'POST',
               crossDomain: true,
               url: getServiceAddress('LinxTraining001TiposCamposSingle/Save' + vm.rootDataTypeName),
               globalError: true,
    ...
    var exportReportDataSource = function(complete) {
        $.ajax({
           ...
           crossDomain: true,
           headers: managerAuth.getHeaders(),
           url: getServiceAddress("LinxTraining001TiposCamposSingle/GetReportDataSource"),
           success: function (response) {
    ...
    var exportTemplateReport = function(reportPath, complete) {
        $.ajax({
           ...
           crossDomain: true,
           headers: managerAuth.getHeaders(),
           url: getServiceAddress("LinxTraining001TiposCamposSingle/GetTemplateReport"),
