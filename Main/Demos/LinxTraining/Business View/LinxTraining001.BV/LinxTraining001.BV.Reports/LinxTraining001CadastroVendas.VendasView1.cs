namespace LinxTraining001.BV.Reports {
    ...
    [Description("testeCrostab42")]
    public partial class LinxTraining001CadastroVendasVendasView1 : Telerik.Reporting.Report {
        
        public LinxTraining001CadastroVendasVendasView1() {
            InitializeComponent();
            this.ReportDS.DataMember = "GetVendasView";
            this.ReportDS.DataSource = new CadastroVendasDataSource();
            this.DataSource = null;
            this.crosstabVendasView.DataSource = this.ReportDS;
            this.ItemDataBinding += new System.EventHandler(this.LinxTraining001CadastroVendasVendasView1_ItemDataBinding);
        }
        
        private void LinxTraining001CadastroVendasVendasView1_ItemDataBinding(object sender, EventArgs e) {
