namespace LinxTraining001.BV.Reports {
    ...
    [Description("tstnocross42")]
    public partial class LinxTraining001CadastroVendasVendasView2 : Telerik.Reporting.Report {
        
        public LinxTraining001CadastroVendasVendasView2() {
            InitializeComponent();
            this.ReportDS.DataMember = "GetVendasView";
            this.ReportDS.DataSource = new CadastroVendasDataSource();
            this.DataSource = this.ReportDS;
            this.ItemDataBinding += new System.EventHandler(this.LinxTraining001CadastroVendasVendasView2_ItemDataBinding);
        }
        
        private void LinxTraining001CadastroVendasVendasView2_ItemDataBinding(object sender, EventArgs e) {
