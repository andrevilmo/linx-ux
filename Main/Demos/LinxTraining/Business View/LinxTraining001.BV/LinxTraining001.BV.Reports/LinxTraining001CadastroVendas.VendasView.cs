namespace LinxTraining001.BV.Reports {
    ...
    [Description("tst cross 42")]
    public partial class LinxTraining001CadastroVendasVendasView : Telerik.Reporting.Report {
        
        public LinxTraining001CadastroVendasVendasView() {
            InitializeComponent();
            ...
            this.ItemDataBinding += new System.EventHandler(this.LinxTraining001CadastroVendasVendasView_ItemDataBinding);
        }
        
        private void LinxTraining001CadastroVendasVendasView_ItemDataBinding(object sender, EventArgs e) {
