namespace LinxTraining001.BV.Reports {
    ...
    using LinxTraining001.BV.TiposCamposSingle;
    using System.Net.Http;
    using System.Net.Http.Headers;
    
    
    public partial class TiposCamposSingleDataSource {
        
        private string url = "LinxTraining001TiposCamposSingle/";
        
        public LinxTraining001.BV.TiposCamposSingle.TiposCamposSingleDomainService _tiposCamposSingleContext;
        ...
        private IEnumerable<TiposCamposView> GetLocalTiposCamposView(Telerik.Reporting.Processing.Report report) {
            ...
            if (_tiposCamposSingleContext == null) _tiposCamposSingleContext = new LinxTraining001.BV.TiposCamposSingle.TiposCamposSingleDomainService(headers) { IsSecure = true };
            ...
            if (!entitySearchExpression.IsNullOrEmpty() || !jEntitySearch.IsNullOrEmpty())
              result = this._tiposCamposSingleContext.GetTiposCamposViewByEntitySearchNoAssociations(entitySearchExpression, jEntitySearch).ToList();
            else
              result = this._tiposCamposSingleContext.GetTiposCamposViewByEntitySearchNoAssociations(null).ToList();
            return result;
        }
