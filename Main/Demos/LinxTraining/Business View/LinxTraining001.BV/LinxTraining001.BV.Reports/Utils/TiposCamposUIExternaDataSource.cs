namespace LinxTraining001.BV.Reports {
    ...
    using LinxTraining001.BV.TiposCamposUIExterna;
    using System.Net.Http;
    using System.Net.Http.Headers;
    
    
    public partial class TiposCamposUIExternaDataSource {
        
        private string url = "LinxTraining001TiposCamposUIExterna/";
        
        public LinxTraining001.BV.TiposCamposUIExterna.TiposCamposUIExternaDomainService _tiposCamposUIExternaContext;
        ...
        private IEnumerable<TiposCamposView> GetLocalTiposCamposView(Telerik.Reporting.Processing.Report report) {
            ...
            if (_tiposCamposUIExternaContext == null) _tiposCamposUIExternaContext = new LinxTraining001.BV.TiposCamposUIExterna.TiposCamposUIExternaDomainService(headers) { IsSecure = true };
            ...
            if (!entitySearchExpression.IsNullOrEmpty() || !jEntitySearch.IsNullOrEmpty())
              result = this._tiposCamposUIExternaContext.GetTiposCamposViewByEntitySearchNoAssociations(entitySearchExpression, jEntitySearch).ToList();
            else
              result = this._tiposCamposUIExternaContext.GetTiposCamposViewByEntitySearchNoAssociations(null).ToList();
            return result;
        }
