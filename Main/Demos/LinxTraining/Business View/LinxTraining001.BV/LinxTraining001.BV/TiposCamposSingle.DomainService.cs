...
{  
	...
	[ExportMetadata("ImplementationName", "LinxTraining001.BV.TiposCamposSingle.TiposCamposView")]
	...
	///////////////////////////////////////////////////////////////////////
	[EnableClientAccess()]	
	[DomainIdentifier("ProcessorOverviewTiposCamposSingleDomainService", CodeProcessor = typeof(MethodPatchingCodeProcessor))]
	public partial class TiposCamposSingleDomainService : DomainService, IDataServiceContext 
	{
	    ...
	    public TiposCamposSingleDomainService() : this("", null, null){ }
	    public TiposCamposSingleDomainService(string connectionString) : this(connectionString, null, null) { }
	    public TiposCamposSingleDomainService(Dictionary<string, string> headers) : this("", null, headers) { }
	    public TiposCamposSingleDomainService(LinxTraining002.BM.ModeloVendaCliente dataContext, Dictionary<string, string> headers) : this("", dataContext, headers) { }
	    public TiposCamposSingleDomainService(string connectionString, LinxTraining002.BM.ModeloVendaCliente dataContext, Dictionary<string, string> headers) : base() 
	    { 
	    ...
	    public List<LinxEntityReferenceInfo> GetMetaDataObject(string entityName, bool forceAll = false, bool removeParentComposition = false)
        {
	        ...
	        if (entityName.InList("LinxTraining001.BV.TiposCamposSingle.TiposCamposView"))
	        {
	        		result.Add(new LinxEntityReferenceInfo()
	        		{
	        			...
	        			EdmEntityName = ObjectExtension.GetFunctionalPointOfType(Type.GetType("LinxTraining001.BV.TiposCamposSingle.TiposCamposView"), "EdmEntityName"),
	        			Properties = ObjectExtension.GetFunctionalPoints(Type.GetType("LinxTraining001.BV.TiposCamposSingle.TiposCamposView"), forceAll: forceAll)
	        		});
	        }
        ...
        {	
             ...
             return new string[] { "LinxTraining001_tiposCamposSingleService", Linx.Tools.AssemblyHelper.ReadResourceContent("LinxTraining001.BV.ClientResources.tiposCamposSingleService.res", System.Reflection.Assembly.GetExecutingAssembly()) };	
