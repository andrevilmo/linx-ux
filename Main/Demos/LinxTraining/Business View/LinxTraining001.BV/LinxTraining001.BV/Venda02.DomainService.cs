...
{  
	...
	[LinxPublicationView(PrimaryKeys="ClientesView.EntityUniqueKey", IsUpdatable=false, EdmName="LinxTraining002.BM.ModeloVendaCliente")]
	
	[FunctionalPoint("ClassDescription[ ];DisplayName[];SizeGridConfigurations[];ReplicationKey[];CompositionHierarchy[ClientesView,ClientesView.VendasView];IsOlap[false];OlapCatalogName[];CubeName[];IsAggregationView[false];ForceAggregationPaging[false];HasLocalResultEntityAdapters[false];TemporaryKeyName[];ReadOnly[false];Entities[Clientes:IDClientes];SubQueryInfo[];EdmEntityName[Clientes];EntityRelations[];EdmParentEntityName[];IsIQueryable[true]")]
		
	[DataContract(IsReference = false, Name = "ClientesView")]
	[Serializable()]
	[Export(typeof(object))]
	[ExportMetadata("ImplementationName", "LinxTraining001.BV.Venda02.ClientesView")]
	public partial class ClientesView : Linx.Data.Entity
	{

	

	    public ClientesView() : this(true) { }

	    public ClientesView(bool setDefaults) 
	    {
	    ...
	    public virtual void FillDetails(Venda02DomainService context, string serializedEntitySearch = null, string jEntitySearch = null, string[] viewNames = null, int take = 0)
	    {
	    ...
	    [SoapIgnore()]
	    [Association("FK_ClientesView_VendasView", "EntityUniqueKey", "EntityParentUniqueKey", IsForeignKey=false)]
	...
	[LinxPublicationView(PrimaryKeys="VendasView.EntityUniqueKey", IsUpdatable=false, EdmName="LinxTraining002.BM.ModeloVendaCliente")]
	
	[FunctionalPoint("ClassDescription[ ];DisplayName[VendasView];SizeGridConfigurations[];ReplicationKey[];CompositionHierarchy[];IsOlap[false];OlapCatalogName[];CubeName[];IsAggregationView[false];ForceAggregationPaging[false];HasLocalResultEntityAdapters[false];TemporaryKeyName[];ReadOnly[false];Entities[Vendas:IDVendas];SubQueryInfo[Select 1 From #ParentAlias#.Vendas_LISTA as #Alias#];EdmEntityName[Vendas];EntityRelations[Clientes(Clientes)];EdmParentEntityName[Clientes];IsIQueryable[true]")]
	...
	public partial class VendasView : Linx.Data.Entity
	{
	    ...
	    public VendasView() : this(true) { }

	    public VendasView(bool setDefaults) 
	    {
	    ...
	    public void LoadParent(Venda02DomainService context)
	    {
	    ...
	    [XmlIgnore()]	
	    [SoapIgnore()]
	    [Association("FK_ClientesView_VendasView", "EntityParentUniqueKey", "EntityUniqueKey", IsForeignKey=true)]
	    ...
	    {	
	        ...
	        metaData.PropertiesMap.Add(new EdmEntityPropertydMap() { EdmKey ="Vendas.Clientes.ID_Clientes", Source = "IDClientes", Target = "ID_Clientes", TargetKeyName = "", NoUpdatable = false, IsKey = true, IsFK = false, QualifiedEntitySetName = "ModeloVendaCliente.Clientes", RelationPropertyName = "Clientes" });
	...
	///////////////////////////////////////////////////////////////////////
	[EnableClientAccess()]	
	[DomainIdentifier("ProcessorOverviewVenda02DomainService", CodeProcessor = typeof(MethodPatchingCodeProcessor))]
	public partial class Venda02DomainService : DomainService, IDataServiceContext 
	{
	    ...
	    public Venda02DomainService() : this("", null, null){ }
	    public Venda02DomainService(string connectionString) : this(connectionString, null, null) { }
	    public Venda02DomainService(Dictionary<string, string> headers) : this("", null, headers) { }
	    public Venda02DomainService(LinxTraining002.BM.ModeloVendaCliente dataContext, Dictionary<string, string> headers) : this("", dataContext, headers) { }
	    public Venda02DomainService(string connectionString, LinxTraining002.BM.ModeloVendaCliente dataContext, Dictionary<string, string> headers) : base() 
	    { 
	    ...
	    public List<LinxEntityReferenceInfo> GetMetaDataObject(string entityName, bool forceAll = false, bool removeParentComposition = false)
        {
	        ...
	        if (entityName.InList("LinxTraining001.BV.Venda02.ClientesView"))
	        {
	        		result.Add(new LinxEntityReferenceInfo()
	        		{
	        			...
	        			EdmEntityName = ObjectExtension.GetFunctionalPointOfType(Type.GetType("LinxTraining001.BV.Venda02.ClientesView"), "EdmEntityName"),
	        			Properties = ObjectExtension.GetFunctionalPoints(Type.GetType("LinxTraining001.BV.Venda02.ClientesView"), forceAll: forceAll)
	        		});
	        }
		

	        if (entityName.InList("LinxTraining001.BV.Venda02.ClientesView", "LinxTraining001.BV.Venda02.VendasView"))
	        {
	        		result.Add(new LinxEntityReferenceInfo()
	        		{
	        			...
	        			EdmEntityName = ObjectExtension.GetFunctionalPointOfType(Type.GetType("LinxTraining001.BV.Venda02.VendasView"), "EdmEntityName"),
	        			Properties = ObjectExtension.GetFunctionalPoints(Type.GetType("LinxTraining001.BV.Venda02.VendasView" + (removeParentComposition ? "" : "ParentComposition")), forceAll: forceAll)
	        		});
	        }
        ...
        {	
             ...
             return new string[] { "LinxTraining001_venda02Service", Linx.Tools.AssemblyHelper.ReadResourceContent("LinxTraining001.BV.ClientResources.venda02Service.res", System.Reflection.Assembly.GetExecutingAssembly()) };	
        ...
        {	
             ...
             if (entityName == "ClientesView") return new string[] { "LinxTraining001_clientLocalService1Factory", Linx.Tools.AssemblyHelper.ReadResourceContent("LinxTraining001.BV.ClientResources.clientLocalService1Factory.res", System.Reflection.Assembly.GetExecutingAssembly()) };
        ...
        {	
             ...
             if (entityName == "ClientesView") return new string[] { "LinxTraining001_clientLocalService1ExtendedFactory", Linx.Tools.AssemblyHelper.ReadResourceContent("LinxTraining001.BV.ClientResources.clientLocalService1ExtendedFactory.res", System.Reflection.Assembly.GetExecutingAssembly()) };
             else return new string[] { };	
	    ...
	    public IEnumerable<ClientesView> ClearClientesView()
	    {
	        ...
	        result.Add(new ClientesView(false));	
			
	        result[0].VendasViewList = new List<VendasView>();
	        ((List<VendasView>)result[0].VendasViewList).Add(new VendasView(false));
	    ...
	    public IEnumerable<VendasView> ClearVendasView()
	    {
	        ...
	        result.Add(new VendasView(false));	
	    ...
	    public IQueryable<VendasView> GetPagedVendasView(string serializedEntitySearch, int skip, int take, string jEntitySearch = "")
	    {
	        ...
	        IQueryable<VendasView> result = 
	            (from entity0 in this.DbContext.Vendas.Where(dynQuery, parameters.ToArray())
                  let entity0Al1 = entity0.Clientes
                orderby entity0.Data ascending
