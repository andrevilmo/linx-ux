...
{  
	...
	[ExportMetadata("ImplementationName", "LinxTraining001.BV.TiposCampos.TiposCamposView")]
	public partial class TiposCamposView : Linx.Data.Entity
	{
	    ...
	    public virtual void FillDetails(TiposCamposDomainService context, string serializedEntitySearch = null, string jEntitySearch = null, string[] viewNames = null, int take = 0)
	    {
	    ...
	    [RoundtripOriginal()]
	    [FunctionalPoint("Precision[10:2];IsEditable[true];CustomMediaTable[];IsAutomaticSequency[false];IsNull[true];DomainName[];KpiName[KpiTeste];KpiRelatedAttribute[];DefaultValue[];DataFormatString[P2];OrderByOrientation[Ascending];OrderBySequence[-1];AggregationFunction[None];ObjectClass[NumericTextBox];ConnectedField[];Mask[];MaskType[];ExcludedAsFilter[false];FilterDataKey[TiposCampos.Decimal];IsMeasure[false]")]
	    ...
	    [XmlAttribute()]
	    [Editable(true)]
	    [Display(Name = "Guid", Description="", Order = 8, AutoGenerateField = false, GroupName="", ResourceType= null)]
	    [RoundtripOriginal()]
	    ...
	    //Extensibility Partial Method Definitions For DecimalKpiInfo
	    partial void OnDecimalKpiInfoChanging(System.String value);
	    partial void OnDecimalKpiInfoChanged();

	    private System.String _DecimalKpiInfo;

	    [DataMember(IsRequired = true, Name = "DecimalKpiInfo", EmitDefaultValue = true)]
	    [XmlAttribute()]
	    [Editable(true)]
	    [Display(Name = "Decimal (KPI)", Description="", Order = 0, AutoGenerateField = true, GroupName="", ResourceType= null)]
	    [RoundtripOriginal()]
	    [LinxStringLength(20)]
	    [FunctionalPoint("Precision[20:2];IsEditable[false];CustomMediaTable[];IsAutomaticSequency[false];IsNull[false];DomainName[];KpiName[];KpiRelatedAttribute[Decimal];DefaultValue[];DataFormatString[];OrderByOrientation[Ascending];OrderBySequence[-1];AggregationFunction[None];ObjectClass[KpiBox];ConnectedField[];Mask[];MaskType[];ExcludedAsFilter[true];FilterDataKey[];IsMeasure[true]")]
	    [LinxPublicationField(IsSuggestion=false, LookUpInfo="", EdmKey="")]
	    public System.String DecimalKpiInfo
	    {
	    	    get
	    	    {
	    	          return _DecimalKpiInfo;
	    	    }
	    	    set
	    	    {
	    	          if (this._DecimalKpiInfo != value)
	    	          {
	    	              this.ValidateProperty("DecimalKpiInfo", value);
	    	              this.OnDecimalKpiInfoChanging(value);
	    	              this.RaiseDataMemberChanging("DecimalKpiInfo");
	    	              this._DecimalKpiInfo = value;
	    	              this.RaiseDataMemberChanged("DecimalKpiInfo");
	    	              this.OnDecimalKpiInfoChanged();
	    	          }
	    	    }
	    }
	    ...
	    private static KpiInfo _DecimalKPI;
	    public static KpiInfo GetDecimalKPI()
	    {
	    	    if (_DecimalKPI == null)
	    	        _DecimalKPI = new LinxTraining001.BV.KPIs.KpiTeste();
	    	    return _DecimalKPI;
	    }
	...
	public partial class TiposCamposFilhaView : Linx.Data.Entity
	{
	    ...
	    public void LoadParent(TiposCamposDomainService context)
	    {
	    ...
	    [RoundtripOriginal()]
	    [LinxStringLength(10)]
	    [FunctionalPoint("Precision[10:0];IsEditable[true];CustomMediaTable[];IsAutomaticSequency[false];IsNull[true];DomainName[DomainString];KpiName[];KpiRelatedAttribute[];DefaultValue[];DataFormatString[];OrderByOrientation[Ascending];OrderBySequence[-1];AggregationFunction[None];ObjectClass[ComboBox];ConnectedField[];Mask[];MaskType[];ExcludedAsFilter[false];FilterDataKey[TiposCamposFilha.String];IsMeasure[false]")]
	    ...
	    public Dictionary<string, string> GetStringValues()
	    {
	    	    return LinxTraining001.BV.Domains.DomainString.GetValues();
	    }
	    private string _stringName;
	    [DataMember(IsRequired = false, Name = "StringName", EmitDefaultValue = true)]
	    [XmlAttribute()]
	...
	public partial class TiposCamposFilhaViewParentComposition : Linx.Data.Entity
	{
	    ...
	    [Display(Name = "Byte", Description="", Order = 2, AutoGenerateField = true, GroupName="", ResourceType= null)]
	    [RoundtripOriginal()]
	    [FunctionalPoint("Precision[3:0];IsEditable[true];CustomMediaTable[];IsAutomaticSequency[false];IsNull[true];DomainName[];KpiName[];KpiRelatedAttribute[];DefaultValue[];DataFormatString[];OrderByOrientation[Ascending];OrderBySequence[-1];AggregationFunction[None];ObjectClass[NumericTextBox];ConnectedField[];Mask[];MaskType[];ExcludedAsFilter[true];FilterDataKey[TiposCamposFilha.TiposCampos.Byte];IsMeasure[false]")]
	    [LinxPublicationField(IsSuggestion=false, LookUpInfo="", EdmKey="TiposCampos.Byte")]
	    public System.Nullable<System.Byte> Byte
	    {
	    	    get
	...
	///////////////////////////////////////////////////////////////////////
	[EnableClientAccess()]	
	[DomainIdentifier("ProcessorOverviewTiposCamposDomainService", CodeProcessor = typeof(MethodPatchingCodeProcessor))]
	public partial class TiposCamposDomainService : DomainService, IDataServiceContext 
	{
	    ...
	    public TiposCamposDomainService() : this("", null, null){ }
	    public TiposCamposDomainService(string connectionString) : this(connectionString, null, null) { }
	    public TiposCamposDomainService(Dictionary<string, string> headers) : this("", null, headers) { }
	    public TiposCamposDomainService(LinxTraining002.BM.ModeloVendaCliente dataContext, Dictionary<string, string> headers) : this("", dataContext, headers) { }
	    public TiposCamposDomainService(string connectionString, LinxTraining002.BM.ModeloVendaCliente dataContext, Dictionary<string, string> headers) : base() 
	    { 
	    ...
	    public string GetDecimalKpiInfo()
	    {
	       Linx.Business.Tools.KpiManager.UpdateKpiInfo(TiposCamposView.GetDecimalKPI());
	       KpiInfo info = new KpiInfo();
	       info.CopyInstanceFrom(TiposCamposView.GetDecimalKPI());
	       foreach (var element in TiposCamposView.GetDecimalKPI().Ranges)
	       {
	    ...
	    public List<LinxEntityReferenceInfo> GetMetaDataObject(string entityName, bool forceAll = false, bool removeParentComposition = false)
        {
	        ...
	        if (entityName.InList("LinxTraining001.BV.TiposCampos.TiposCamposView"))
	        {
	        		result.Add(new LinxEntityReferenceInfo()
	        		{
	        			...
	        			EdmEntityName = ObjectExtension.GetFunctionalPointOfType(Type.GetType("LinxTraining001.BV.TiposCampos.TiposCamposView"), "EdmEntityName"),
	        			Properties = ObjectExtension.GetFunctionalPoints(Type.GetType("LinxTraining001.BV.TiposCampos.TiposCamposView"), forceAll: forceAll)
	        		});
	        }
		

	        if (entityName.InList("LinxTraining001.BV.TiposCampos.TiposCamposView", "LinxTraining001.BV.TiposCampos.TiposCamposFilhaView"))
	        {
	        		result.Add(new LinxEntityReferenceInfo()
	        		{
	        			...
	        			EdmEntityName = ObjectExtension.GetFunctionalPointOfType(Type.GetType("LinxTraining001.BV.TiposCampos.TiposCamposFilhaView"), "EdmEntityName"),
	        			Properties = ObjectExtension.GetFunctionalPoints(Type.GetType("LinxTraining001.BV.TiposCampos.TiposCamposFilhaView" + (removeParentComposition ? "" : "ParentComposition")), forceAll: forceAll)
	        		});
	        }
        ...
        {	
             ...
             return new string[] { "LinxTraining001_tiposCamposService", Linx.Tools.AssemblyHelper.ReadResourceContent("LinxTraining001.BV.ClientResources.tiposCamposService.res", System.Reflection.Assembly.GetExecutingAssembly()) };	
	    ...
	    public IEnumerable<TiposCamposView> ClearTiposCamposView()
	    {
	        ...
	        ((List<TiposCamposFilhaView>)result[0].TiposCamposFilhaViewList).Add(new TiposCamposFilhaView(false));
	        ...
	        IQueryable<TiposCamposView> result = 
                ...
                ,TiposCamposFilhaViewList = 
	                        ...
	                        select new TiposCamposFilhaView()
	                        {
                                ...
                                , StringName = ((entity1.String) == "05" ? "String 05" : ((entity1.String) == "06" ? "String 06" : ((entity1.String) == "B" ? "String B" : ((entity1.String) == "01B" ? "String 01B" : ((entity1.String) == "ststt" ? "Teste String" : "")))))
	    ...
	    public IQueryable<TiposCamposFilhaView> GetTiposCamposFilhaView()
	    {
	        ...
	        IQueryable<TiposCamposFilhaView> result = 
                ...
                , Short = entity0.Short
                , String = entity0.String
                , StringName = ((entity0.String) == "05" ? "String 05" : ((entity0.String) == "06" ? "String 06" : ((entity0.String) == "B" ? "String B" : ((entity0.String) == "01B" ? "String 01B" : ((entity0.String) == "ststt" ? "Teste String" : "")))))
                , StringChar = entity0.StringChar
                , StringText = entity0.StringText
