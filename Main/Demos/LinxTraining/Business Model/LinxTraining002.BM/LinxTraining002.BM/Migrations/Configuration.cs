...
namespace LinxTraining002.BM.Migrations
{
    using System;
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ModeloVendaCliente>
    {
	...
	internal sealed class SqlMigrator : SqlServerMigrationSqlGenerator
    {
            ...
            : base()
        {
            ...
            //Add Indexes
            createIndexOperation = new CreateIndexOperation() { Table = "dbo.FilhaNotNull", IsUnique = false, Name = "IX_ID_PaiNotNull" };
            createIndexOperation.Columns.Add("ID_PaiNotNull");
            _tableMigrator.Indexes.Add(createIndexOperation);
            //Add Primary Keys
            _tableMigrator.PrimaryKeys["dbo.Clientes"] = "PK_dbo.Clientes";
            _tableMigrator.PrimaryKeys["dbo.Vendas"] = "PK_dbo.Vendas";
            _tableMigrator.PrimaryKeys["dbo.PaiNotNull"] = "PK_dbo.PaiNotNull";
            _tableMigrator.PrimaryKeys["dbo.FilhaNotNull"] = "PK_dbo.FilhaNotNull";
            _tableMigrator.PrimaryKeys["dbo.TestePIVOT"] = "PK_dbo.TestePIVOT";
            //Add Defaults
            _tableMigrator.Defauls.Add("dbo.Clientes.ID_Clientes", "(newsequentialid())");
            _tableMigrator.Defauls.Add("dbo.Vendas.ID_Clientes", "(newsequentialid())");
            _tableMigrator.Defauls.Add("dbo.TiposCamposFilha.Guid", "(newsequentialid())");
            _tableMigrator.Defauls.Add("dbo.TiposCampos.Guid", "(newsequentialid())");
            //Add Foreign Keys
            _tableMigrator.Fks.Add("dbo.Clientes.ID_Clientes.dbo.Vendas.ID_Clientes", "FK_Vendas_ebdb6b,false");
            _tableMigrator.Fks.Add("dbo.Vendas.ID_Vendas.dbo.VendaDetalhe.ID_Vendas", "FK_VendaDetalhe_6F9D3782,true");
            _tableMigrator.Fks.Add("dbo.TiposCampos.ID_TiposCampos.dbo.TiposCamposFilha.ID_TiposCampos", "FK_TiposCamposFilha_D8A6CBFD,false");
            _tableMigrator.Fks.Add("dbo.PaiNotNull.ID_PaiNotNull.dbo.FilhaNotNull.ID_PaiNotNull", "FK_FilhaNotNull_d60af0,false");
            _tableMigrator.Fks.Add("dbo.Estado.ID_Estado.dbo.Loja.ID_Estado", "FK_Loja_C59C1266,false");
            _tableMigrator.Fks.Add("dbo.Cidade.ID_Cidade.dbo.Loja.ID_Cidade", "FK_Loja_6223DD1C,false");
            _tableMigrator.Fks.Add("dbo.Estado.ID_Estado.dbo.Cidade.ID_Estado", "FK_Cidade_DEA1E40D,false");
