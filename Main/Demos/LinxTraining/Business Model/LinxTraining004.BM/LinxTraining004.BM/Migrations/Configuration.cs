...
namespace LinxTraining004.BM.Migrations
{
    using System;
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ValidaCampos>
    {
	...
	internal sealed class SqlMigrator : SqlServerMigrationSqlGenerator
    {
            ...
            : base()
        {
            ...
            //Add Foreign Keys
            _tableMigrator.Fks.Add("dbo.ValidaCamposMaster.ID_ValidaCamposMaster.dbo.ValidaCamposDetail.ID_ValidaCamposMaster", "FK_ValidaCamposDetail_4a41cb,false");
