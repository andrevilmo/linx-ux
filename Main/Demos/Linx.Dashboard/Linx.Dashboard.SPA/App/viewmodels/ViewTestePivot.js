...
var vmConstructor = function () {
      ...
      if ((typeof settings === 'object') && (settings != null) && settings.objectQuery) {
          ...
          if ((typeof settings === 'object') && (settings != null) && settings.uiSettings) {
              ...
              if (uiSettings.executeQuery === true) {
                  ...
                  filteredEntities = [];
                  if (settings.parentVM) { settings.parentVM.internalUIs = [ 'ViewTestePivot' ]; settings.parentVM.ViewTestePivot = getVM; }
                  clear();
                  ...
                  if ((typeof settings.parentVM === 'object') && settings.parentVM != null) {
                      ...
                      if ($.inArray('ViewTestePivot', parentVM.internalUIs) === -1) parentVM.internalUIs.push('ViewTestePivot');
                  }
              }
          }
          else {
    ...
    var adjustModuleSecurity = function () {
        ...
        managerAuth.getFormAccess('linx-dashboard-spa-ViewTestePivot', function (data) {
    ...
    var canActivate = function() {
        ...
        if (data.lxShellCompiledVersion != managerAuth.shellVersion) {
            app.showMessage('Versão de formulário incompatível com a versão de ambiente [' + managerAuth.shellVersion + '].', 'Formulário: ViewTestePivot', ['Ok']);
            return false;
        }
        return true;
    };
    ...
    var compositionComplete = function() {
        complement.renderpivotc838a61b68234f13922bce5061094d01ViewTestePivot_pivotLjvAtendimento(vm);
    ...
    var visibleColumns = 'CodBandeiraRede,CodigoFilial,CodLoja,DataAtendimento,DescBandeiraRede,DescLoja,IdBandeiraRede,IdFilialPfj,IdGpecon,IdLoja,ValorCupomFiscal,ValorDescontoSubtotal,QtdeAtendimento,TicketMedio,ValorTotal';
    ...
    var removeFormViewControl = function () {
        var front = $('#ViewTestePivot_formViewer_front')[0];
        if (front) front.removeClassName('front');
        var back = $('#ViewTestePivot_formViewer_back')[0];
    ...
    var changeFormView = function () {
        ...
        var panel = $('#ViewTestePivot_formViewer')[0];
    ...
    var entitySearchRange = {
        ...
        LjvAtendimentoIdBandeiraRede: ko.observable(null),
        LjvAtendimentoIdFilialPfj: ko.observable(null),
        LjvAtendimentoIdGpecon: ko.observable(null),
        LjvAtendimentoIdLoja: ko.observable(null)
    };
    entitySearchRange.clear = function(){
        ...
        entitySearchRange.LjvAtendimentoIdBandeiraRede(null);
        entitySearchRange.LjvAtendimentoIdFilialPfj(null);
        entitySearchRange.LjvAtendimentoIdGpecon(null);
        entitySearchRange.LjvAtendimentoIdLoja(null);
    };
           ...
           if (vm.status() !== 'C') {
               ...
               colunas.forEach(function (entry, index) {
                   if (entry.hidden && entry.key !== 'RowDataId') {
                       var control = $('#ViewTestePivot_div' + (!dataView ? '' : '' + dataView + '_') + entry.key + 'Template');
    ...
    var vm = {
            ...
            __moduleId__: 'pkg_linx-dashboard-spa/viewmodels/ViewTestePivot'
        };
