...
namespace TesteBM.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<TesteBM>
    {
	...
	internal sealed class SqlMigrator : SqlServerMigrationSqlGenerator
    {
            ...
            : base()
        {
            ...
            _tableMigrator.Fks.Add("dbo.VENDA.ID_VENDA.dbo.VENDA_ITEM.ID_VENDA", "FK_VENDA_ITEM_ce4bb6,true");
