...
var vmConstructor = function () {
    ...
    var changeLanguage = function() {
        ...
        require([fName],
            function(result) {
            vm.flattenLayout(ko.observable(flattenObjectByProperty(result.objectLanguage_UIPaiFilhaNeta(), 'Name'))());
        }, function (err) {
    ...
    var compositionComplete = function() {
        //changeLanguage();
        $('#UIPaiFilhaNeta_gbLoja').one('shown.bs.collapse', function (e) { vm.notifyInnerElements($(e.currentTarget), true); });

    $('#UIPaiFilhaNeta_tcLojaTabControl').on('shown.bs.tab', function (e) { vm.notifyInnerElements($(e.target.hash)); });
    initializeTabControl('#UIPaiFilhaNeta_tcLojaTabControl');

    complement.renderUIPaiFilhaNeta_dGridExpander_6af03c3127324c9b892b5bb7581ee2fd(vm);

    complement.renderpivoteddf683f6acd456db79626c004f9b13bUIPaiFilhaNeta_pivotVendaItem(vm);
    ...
    complement.renderscyUIPaiFilhaNeta_dGrid(vm);
        ...
        vm.currentBrands.subscribe(function(newValue) {
            ...
            var reset = (!newValue || searchedBrands.cod === ''), decimals = searchedBrands.decimals;
                           complement.ChangedBrandUIPaiFilhaNeta_dGridExpander_6af03c3127324c9b892b5bb7581ee2fd(vm, decimals, reset);
    ...
    var getMaxLength = function(entityName, propertyName){
        if (isNullOrEmpty(entityName)) entityName = 'Loja';
    ...
    var visibleColumns = 'IdLoja,IntLoja,BigIntLoja,BitLoja,IdCidade,IdEstado,IdPais,NomeCidade,StringPais,StringLoja,ComboboxLoja,DatetimeLoja,DecimalLoja,SmallIntLoja,StringEstado';
    ...
    var exportData = function (forceAdd, isExcelDataSource) {
        if (forceAdd)
            require(['viewmodels/shared/addCustomExport'],
                function(addCustomExport){ addCustomExport.showModal(vm, null, 'Loja', getVisiblePropertiesForExcel('dataView'), null, true, isExcelDataSource); } );
        else
            require(['viewmodels/shared/customExport'],
                function(modalExport){ modalExport.showModal(vm, 'Loja', getVisiblePropertiesForExcel('dataView'), null, { canAdd: true, canEdit: true, canDel: true }, isExcelDataSource); } );
    };
    ...
    var getAddedEntities = function () {
        return dataContext.getEntities('Loja', [dataContext.breeze.EntityState.Added]);
    }
    var getRelatedElementsInCache = function () {
        if (parentEntityRelated != null && preserveDataCurrentState()) {
           var cacheElements = dataContext.getEntities('Loja');
           var result = [];
           var relationExpr = '';
    ...
    var query = function (lookupInitializing, parentEntity, quickSearchJExpression, externalQueryCallBack, noMessages, noDetails) {
        ...
        if (freeEntityForQuerying == null && isChildVM()) freeEntityForQuerying = dataContext.createFreeEntity('Loja');
        ...
        return dataContext.getLojaByEntitySearchNoAssociations(lastJEntitySearch, 0, pageSize(), (pageSize() > 0), preserveDataCurrentState(), status() !== 'E', sortInfo).then(querySucceeded).fin(complete);
        ...
        function querySucceeded(data) {
            if (vm.status() !== 'E') { for (var idx = 0; idx < data.results.length; idx++) { dataContext.initializePOCO(data.results[idx], 'Loja'); } }
            hasError = false;
    ...
    var refresh = function (curPage, goLast) {
        ...
        return dataContext.getLojaByEntitySearchNoAssociations(lastJEntitySearch, curPage * pageSize(), pageSize(), false, false, status() !== 'E', sortInfo).then(querySucceeded).fin(complete);
    ...
    var entitySearchRange = {
        predefinedFilters: ko.observableArray(managerPredefined.predefinedFilters),
            LojaDatetimeLoja_typeRange: ko.observable('R'), LojaDatetimeLoja_begin: ko.observable(null), LojaDatetimeLoja_end: ko.observable(null), LojaDatetimeLoja_predefFilter: ko.observableArray([]), LojaDatetimeLoja_predefValue: ko.observable(null),
        ...
        LojaBigIntLoja_begin: ko.observable(null), LojaBigIntLoja_end: ko.observable(null),
        LojaDecimalLoja_begin: ko.observable(null), LojaDecimalLoja_end: ko.observable(null),
        LojaIdLoja_begin: ko.observable(null), LojaIdLoja_end: ko.observable(null),
        LojaIntLoja_begin: ko.observable(null), LojaIntLoja_end: ko.observable(null),
        LojaSmallIntLoja_begin: ko.observable(null), LojaSmallIntLoja_end: ko.observable(null),
        ...
        LojaIdCidade: ko.observable(null),
        LojaIdEstado: ko.observable(null),
        LojaIdPais: ko.observable(null),
        LojaNomeCidade: ko.observable(null),
        LojaStringEstado: ko.observable(null),
        LojaStringPais: ko.observable(null),
        VendaIdVendedor: ko.observable(null)
    };
    entitySearchRange.clear = function(){
            entitySearchRange.LojaDatetimeLoja_typeRange('R'); entitySearchRange.LojaDatetimeLoja_begin(null); entitySearchRange.LojaDatetimeLoja_end(null); entitySearchRange.LojaDatetimeLoja_predefFilter([]); entitySearchRange.LojaDatetimeLoja_predefValue(null);
        ...
        entitySearchRange.LojaIdCidade(null);
        entitySearchRange.LojaIdEstado(null);
        entitySearchRange.LojaIdPais(null);
        entitySearchRange.LojaNomeCidade(null);
        entitySearchRange.LojaStringEstado(null);
        entitySearchRange.LojaStringPais(null);
        entitySearchRange.VendaIdVendedor(null);
    };
    entitySearchRange.has_LojaBigIntLoja = ko.computed(function(){ return (entitySearchRange.LojaBigIntLoja_begin() != null || entitySearchRange.LojaBigIntLoja_end() != null); });
    entitySearchRange.has_LojaDecimalLoja = ko.computed(function(){ return (entitySearchRange.LojaDecimalLoja_begin() != null || entitySearchRange.LojaDecimalLoja_end() != null); });
    entitySearchRange.has_LojaIdLoja = ko.computed(function(){ return (entitySearchRange.LojaIdLoja_begin() != null || entitySearchRange.LojaIdLoja_end() != null); });
    entitySearchRange.has_LojaIntLoja = ko.computed(function(){ return (entitySearchRange.LojaIntLoja_begin() != null || entitySearchRange.LojaIntLoja_end() != null); });
    entitySearchRange.has_LojaSmallIntLoja = ko.computed(function(){ return (entitySearchRange.LojaSmallIntLoja_begin() != null || entitySearchRange.LojaSmallIntLoja_end() != null); });
    ...
    entitySearchRange.has_LojaDatetimeLoja = ko.computed(function(){ return (entitySearchRange.LojaDatetimeLoja_typeRange() == 'R' && (entitySearchRange.LojaDatetimeLoja_begin() != null || entitySearchRange.LojaDatetimeLoja_end() != null) || (entitySearchRange.LojaDatetimeLoja_typeRange() == 'P' && entitySearchRange.LojaDatetimeLoja_predefFilter().length > 0)); });
    ...
    var getSPAVersion = function(){
       ...
       var packageName = 'pkg_linx-demo-bv-spa';
    ...
    var getLayoutsFiles = function () {
        ...
        {
            rootNamespace: 'Linx.Demo.BV.SPA',
            viewName: 'UIPaiFilhaNeta',
            pivotName: 'VendaItem',
    ...
    var vm = {
            ...
            deleteLayoutPivot: deleteLayoutPivot,
