...
function (app, logger) {
    ...
    var arrumaMascaraCnpj = function (vm) {
        $lx(vm, '#mskCpfCnpj').igMaskEditor("option", "inputMask", vm.currentDataItem().IndicaCpf() == 1 ? "###.###.###-##" : "##.###.###/####-##");
    ...
    var afterSelecting = function (e) { /* e = { selectedItem: entity, viewModel: viewModel } */
        ...
        e.selectedItem.IndicaCpf.subscribe(function (value) {
        arrumaMascaraCnpj(e.viewModel);
        });
