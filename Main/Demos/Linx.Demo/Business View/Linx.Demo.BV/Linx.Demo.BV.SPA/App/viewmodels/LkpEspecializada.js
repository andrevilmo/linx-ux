define(['durandal/app', 'pkg_linx-demo-bv-spa/services/ExAutocompleteContext', 'plugins/router', 'plugins/widget', 'managers/__auth', 'viewmodels/shared/modal', 'viewmodels/shared/modal2', 'managers/brand', 'managers/predefinedFilters', 'services/logger', 'viewmodels/shared/modalMultimidia', 'common', 'pkg_linx-demo-bv-spa/viewmodels/LkpEspecializadaComplement', 'viewmodels/shared/modalCustomSearch', 'managers/user'],
...
var vmConstructor = function () {
    ...
    var objectLayout = function () {
       return {Name: 'LkpEspecializada', Items: [
    ...
    var changeLanguage = function() {
        ...
        require([fName],
            function(result) {
            vm.flattenLayout(ko.observable(flattenObjectByProperty(result.objectLanguage_LkpEspecializada(), 'Name'))());
        }, function (err) {
      ...
      if ((typeof settings === 'object') && (settings != null) && settings.objectQuery) {
          ...
          if ((typeof settings === 'object') && (settings != null) && settings.uiSettings) {
              ...
              if (uiSettings.executeQuery === true) {
                  ...
                  filteredEntities = [];
                  if (settings.parentVM) { settings.parentVM.internalUIs = [ 'LkpEspecializada' ]; settings.parentVM.LkpEspecializada = getVM; }
                  clear();
                  ...
                  if ((typeof settings.parentVM === 'object') && settings.parentVM != null) {
                      ...
                      parentVM.LkpEspecializada = getVM;
                      if (isLookup()) { 
                      ...
                      if ($.inArray('LkpEspecializada', parentVM.internalUIs) === -1) parentVM.internalUIs.push('LkpEspecializada');
                  }
              }
          }
          else {
    ...
    var adjustModuleSecurity = function () {
        ...
        managerAuth.getFormAccess('linx-demo-bv-spa-LkpEspecializada', function (data) {
    ...
    var canActivate = function() {
        ...
        if (data.lxShellCompiledVersion != managerAuth.shellVersion) {
            app.showMessage('Versão de formulário incompatível com a versão de ambiente [' + managerAuth.shellVersion + '].', 'Formulário: LkpEspecializada', ['Ok']);
            return false;
        }
        return true;
    };
    ...
    var compositionComplete = function() {
        //changeLanguage();
        $('#LkpEspecializada_gbCliente').one('shown.bs.collapse', function (e) { vm.notifyInnerElements($(e.currentTarget), true); });

    complement.renderscyLkpEspecializada_dGrid(vm);
    ...
    var visibleColumns = 'ComboboxCliente,DatetimeCliente,DecimalCliente,IdCliente,IdEstado,IntCliente,SmallIntCliente,IdNmCompleto,StringCliente,StringEstado';
    ...
    var removeFormViewControl = function () {
        var front = $('#LkpEspecializada_formViewer_front')[0];
        if (front) front.removeClassName('front');
        var back = $('#LkpEspecializada_formViewer_back')[0];
    ...
    var changeFormView = function () {
        ...
        var panel = $('#LkpEspecializada_formViewer')[0];
    ...
    var entitySearchRange = {
        ...
        ClienteComboboxCliente_begin: ko.observable(null), ClienteComboboxCliente_end: ko.observable(null),
        ...
        ClienteStringCliente: ko.observable(null)
    };
    entitySearchRange.clear = function(){
        ...
        entitySearchRange.ClienteComboboxCliente_begin(null); entitySearchRange.ClienteComboboxCliente_end(null);
        ...
        entitySearchRange.ClienteStringCliente(null);
    };
    entitySearchRange.has_ClienteComboboxCliente = ko.computed(function(){ return (entitySearchRange.ClienteComboboxCliente_begin() != null || entitySearchRange.ClienteComboboxCliente_end() != null); });
           ...
           if (vm.status() !== 'C') {
               ...
               colunas.forEach(function (entry, index) {
                   if (entry.hidden && entry.key !== 'RowDataId') {
                       var control = $('#LkpEspecializada_div' + (!dataView ? '' : '' + dataView + '_') + entry.key + 'Template');
    ...
    var vm = {
            ...
            rootNamespace: 'Linx.Demo.BV.ExAutocomplete',
            ...
            __moduleId__: 'pkg_linx-demo-bv-spa/viewmodels/LkpEspecializada'
        };
