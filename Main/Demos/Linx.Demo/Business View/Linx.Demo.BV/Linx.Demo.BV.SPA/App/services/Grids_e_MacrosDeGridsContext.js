...
var result = function () {
    ...
    var getDataFeedUrl = function() {
       return getServiceAddress('LinxDemoGrids_e_MacrosDeGridsOData');
    };
    ...
    var controllerName = 'LinxDemoGrids_e_MacrosDeGrids';
    ...
    metadataInfo['Venda'] = [
        { key: 'BigIntVenda', isQbeZero: false, isDomain: false, domainName: '', lookupPropertyName: '', lookupVisibleColumns: '', maxLength: 19, isPartOfKey: false, headerText: 'Big Int Venda', width: '250px', dataType: 'number', format: 'int', hidden: false, unbound: false, group: null },
        { key: 'BitVenda', isQbeZero: false, isDomain: false, domainName: '', lookupPropertyName: '', lookupVisibleColumns: '', maxLength: 0, isPartOfKey: false, headerText: 'Bit Venda', width: '250px', dataType: 'bool', format: 'checkbox', hidden: false, unbound: false, group: null },
        ...
        { key: 'GuidVenda', isQbeZero: false, isDomain: false, domainName: '', lookupPropertyName: '', lookupVisibleColumns: '', maxLength: 36, isPartOfKey: false, headerText: 'Guid Venda', width: '250px', dataType: 'string', format: '', hidden: false, unbound: false, group: null },
        { key: 'IdCidade', isQbeZero: false, isDomain: false, domainName: '', lookupPropertyName: 'IdCidade', lookupVisibleColumns: 'IdCidade,NomeCidade', maxLength: 10, isPartOfKey: false, headerText: 'Id Cidade', width: '271px', dataType: 'number', format: 'int', hidden: false, unbound: false, group: null },
        { key: 'IdCliente', isQbeZero: false, isDomain: false, domainName: '', lookupPropertyName: '', lookupVisibleColumns: '', maxLength: 10, isPartOfKey: false, headerText: 'Id Cliente', width: '250px', dataType: 'number', format: 'int', hidden: false, unbound: false, group: null },
        { key: 'IdLoja', isQbeZero: false, isDomain: false, domainName: '', lookupPropertyName: 'IdLoja', lookupVisibleColumns: '', maxLength: 10, isPartOfKey: false, headerText: 'Id Loja', width: '271px', dataType: 'number', format: 'int', hidden: false, unbound: false, group: null },
        ...
        { key: 'NomeCidade', isQbeZero: false, isDomain: false, domainName: '', lookupPropertyName: 'NomeCidade', lookupVisibleColumns: 'IdCidade,NomeCidade', maxLength: 50, validateMaxLength: true, isPartOfKey: false, headerText: 'Nome Cidade', width: '421px', dataType: 'string', format: '', hidden: false, unbound: false, group: null },
        ...
        { key: 'StringVendedor', isQbeZero: false, isDomain: false, domainName: '', lookupPropertyName: 'StringVendedor', lookupVisibleColumns: '', maxLength: 50, validateMaxLength: true, isPartOfKey: false, headerText: 'String Vendedor', width: '421px', dataType: 'string', format: '', hidden: false, unbound: false, group: null }
    ];
    dataExportInfo['Venda'] = [ 
        { name: 'Venda', canExportMedia: true , canExportReport: true, actionExport: 'LinxDemoGrids_e_MacrosDeGrids/GetVendaToExcel', actionReport: 'LinxDemoGrids_e_MacrosDeGrids/GetVendaToReportXml', actionFeed: 'LinxDemoGrids_e_MacrosDeGridsOData/Venda', actionName: 'LinxDemoGrids_e_MacrosDeGrids/GetVendaByEntitySearchNoAssociations', display: 'Venda',  metaData: function() { return metadataInfo['Venda']; } }
        , { name: 'VendaItem', canExportMedia: true , canExportReport: true, actionExport: 'LinxDemoGrids_e_MacrosDeGrids/GetVendaItemParentCompositionToExcel', actionReport: 'LinxDemoGrids_e_MacrosDeGrids/GetVendaItemParentCompositionToReportXml', actionFeed: 'LinxDemoGrids_e_MacrosDeGridsOData/VendaItemParentComposition', actionName: 'LinxDemoGrids_e_MacrosDeGrids/GetVendaItemParentCompositionByEntitySearchNoAssociations', display: 'Itens de Venda',  metaData: function() { return metadataInfo['VendaItemParentComposition']; } }
    ];
    ...
    metadataInfo['LookUpLoja'] = [
        ...
        { key: 'NomeCidade', relatedKey: 'NomeCidade', maxLength: 50, isPartOfKey: false, headerText: 'Nome Cidade', width: '400px', dataType: 'string', format: '', hidden: false, unbound: false, group: null }
    ];
    ...
    metadataInfo['VendaItem'] = [
        { key: 'BigIntVendaItem', isQbeZero: false, isDomain: false, domainName: '', lookupPropertyName: '', lookupVisibleColumns: '', maxLength: 19, isPartOfKey: false, headerText: 'Big Int Venda Item', width: '270px', dataType: 'number', format: 'int', hidden: false, unbound: false, group: null },
        { key: 'BitVendaItem', isQbeZero: false, isDomain: false, domainName: '', lookupPropertyName: '', lookupVisibleColumns: '', maxLength: 0, isPartOfKey: false, headerText: 'Bit Venda Item', width: '250px', dataType: 'bool', format: 'checkbox', hidden: false, unbound: false, group: null },
        ...
        { key: 'GuidVendaItem', isQbeZero: false, isDomain: false, domainName: '', lookupPropertyName: '', lookupVisibleColumns: '', maxLength: 36, isPartOfKey: false, headerText: 'Guid Venda Item', width: '250px', dataType: 'string', format: '', hidden: false, unbound: false, group: null },
        ...
        { key: 'IntVendaItem', isQbeZero: false, isDomain: false, domainName: '', lookupPropertyName: '', lookupVisibleColumns: '', maxLength: 10, isPartOfKey: false, headerText: 'Int Venda Item', width: '250px', dataType: 'number', format: 'int', hidden: false, unbound: false, group: null },
        { key: 'SmallIntVendaItem', isQbeZero: false, isDomain: false, domainName: '', lookupPropertyName: '', lookupVisibleColumns: '', maxLength: 5, isPartOfKey: false, headerText: 'Small Int Venda Item', width: '296px', dataType: 'number', format: 'int', hidden: false, unbound: false, group: null },
    ...
    metadataInfo['VendaItemParentComposition'] = [
        ...
        { key: 'StringVenda', isQbeZero: false, isDomain: false, domainName: '', lookupPropertyName: '', lookupVisibleColumns: '', maxLength: 50, validateMaxLength: true, isPartOfKey: false, headerText: 'String Venda', width: '400px', dataType: 'string', format: '', hidden: false, unbound: false, group: null },
        { key: 'StringVendedor', isQbeZero: false, isDomain: false, domainName: '', lookupPropertyName: '', lookupVisibleColumns: '', maxLength: 50, validateMaxLength: true, isPartOfKey: false, headerText: 'String Vendedor', width: '421px', dataType: 'string', format: '', hidden: false, unbound: false, group: null }
    ];
    dataExportInfo['VendaItem'] = [ 
        { name: 'VendaItem', canExportMedia: true , canExportReport: true, actionExport: 'LinxDemoGrids_e_MacrosDeGrids/GetVendaItemToExcel', actionReport: 'LinxDemoGrids_e_MacrosDeGrids/GetVendaItemToReportXml', actionFeed: 'LinxDemoGrids_e_MacrosDeGridsOData/VendaItem', actionName: 'LinxDemoGrids_e_MacrosDeGrids/GetVendaItemByEntitySearchNoAssociations', display: 'Itens de Venda',  metaData: function() { return metadataInfo['VendaItem']; } }
    ];
    ...
    VendaItemList: { entityTypeName: "VendaItem:#Linx.Demo.BV.Grids_e_MacrosDeGrids", isScalar: false, invForeignKeyNames: ["IdVenda"], associationName: "FK_Venda_VendaItem" }
                          }
    });
    lookUpProperties['Venda'] = {IdCidade: 'LookUpLoja', IdLoja: 'LookUpLoja', IdVendedor: 'LookUpVendedor', NomeCidade: 'LookUpLoja', StringLoja: 'LookUpLoja', StringVendedor: 'LookUpVendedor'};
    var VendaInitializer = function (ownerReference, isPOCO) {
       ...
       if (isPOCO !== true) {
           ...
           ownerReference.getSubQueryFilterFromLookUpLoja = function (propertyName) {
               var filter = '';
               if (propertyName === 'IdLoja') {
                   var _IdCidade = getAbsoluteValue(this.IdCidade);
                   if (!isNullOrEmpty(_IdCidade)) { filter += (filter === '' ? '' : ';') + 'IdCidade' + (_IdCidade.toString().indexOf('[') > -1 ? '#In#S' : '#==#I') + _IdCidade.toString().replaceAll('[', '').replaceAll(']', ''); }
                   var _NomeCidade = getAbsoluteValue(this.NomeCidade);
                   if (!isNullOrEmpty(_NomeCidade)) { filter += (filter === '' ? '' : ';') + 'NomeCidade' + (_NomeCidade.toString().indexOf('[') > -1 ? '#In#S' : '#==#S') + (_NomeCidade.toString().indexOf('[') > -1 ? 'S,' : '') + _NomeCidade.toString().replaceAll('[', '').replaceAll(']', ''); }
               }
               if (propertyName === 'StringLoja') {
                   var _IdCidade = getAbsoluteValue(this.IdCidade);
                   if (!isNullOrEmpty(_IdCidade)) { filter += (filter === '' ? '' : ';') + 'IdCidade' + (_IdCidade.toString().indexOf('[') > -1 ? '#In#S' : '#==#I') + _IdCidade.toString().replaceAll('[', '').replaceAll(']', ''); }
                   var _NomeCidade = getAbsoluteValue(this.NomeCidade);
                   if (!isNullOrEmpty(_NomeCidade)) { filter += (filter === '' ? '' : ';') + 'NomeCidade' + (_NomeCidade.toString().indexOf('[') > -1 ? '#In#S' : '#==#S') + (_NomeCidade.toString().indexOf('[') > -1 ? 'S,' : '') + _NomeCidade.toString().replaceAll('[', '').replaceAll(']', ''); }
       ...
       ownerReference.namespace = 'Linx.Demo.BV.Grids_e_MacrosDeGrids';
       ownerReference.myProperties = [ 'BigIntVenda','BitVenda','ComboboxVenda','DatetimeVenda','DecimalVenda','GuidVenda','IdCidade','IdCliente','IdLoja','IdVenda','IdVendedor','IntVenda','NomeCidade','SmallIntVenda','StringLoja','StringVenda','StringVendedor' ];
    ...
    Venda: { entityTypeName: "Venda:#Linx.Demo.BV.Grids_e_MacrosDeGrids", isScalar: true, foreignKeyNames: ["IdVenda"], associationName: "FK_Venda_VendaItem" }
    // Returns collections of details and associates with Parent
                          }
    });
    ...
    // Define that the event name is 'Grids_e_MacrosDeGridsContext_DataUpdate'.
    var contextUpdtEvt = 'Grids_e_MacrosDeGridsContext_DataUpdate_' + getNewGuid();
    ...
    var saveChanges = function(saveSucceeded, saveFailed, fin, saveNoTRack) {
        if (saveNoTRack === true) {
            ...
            return $.ajax({
               type: 'POST',
               crossDomain: true,
               url: getServiceAddress('LinxDemoGrids_e_MacrosDeGrids/Save' + vm.rootDataTypeName),
               globalError: false,
    ...
    var exportReportDataSource = function(complete) {
        $.ajax({
           ...
           crossDomain: true,
           headers: managerAuth.getHeaders(),
           url: getServiceAddress("LinxDemoGrids_e_MacrosDeGrids/GetReportDataSource"),
           success: function (response) {
    ...
    var exportTemplateReport = function(reportPath, complete) {
        $.ajax({
           ...
           crossDomain: true,
           headers: managerAuth.getHeaders(),
           url: getServiceAddress("LinxDemoGrids_e_MacrosDeGrids/GetTemplateReport"),
