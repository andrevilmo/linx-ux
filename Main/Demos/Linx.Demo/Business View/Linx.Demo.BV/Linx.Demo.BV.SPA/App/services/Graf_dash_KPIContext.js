...
var result = function () {
    ...
    var getDataFeedUrl = function() {
       return getServiceAddress('LinxDemoGraf_dash_KPIOData');
    };
    ...
    metadataInfo['Produto'] = [
        ...
        { key: 'DescEstoque', isQbeZero: false, isDomain: false, domainName: '', lookupPropertyName: '', lookupVisibleColumns: '', maxLength: 0, isPartOfKey: false, headerText: 'Descrição Estoque', width: '257px', dataType: 'string', format: '', hidden: false, unbound: false, group: null },
        { key: 'QtdeEstoque', isQbeZero: false, isDomain: false, domainName: '', lookupPropertyName: '', lookupVisibleColumns: '', maxLength: 0, isPartOfKey: false, headerText: 'QTDE', width: '250px', dataType: 'number', format: 'int', hidden: false, unbound: false, group: null },
        { key: 'DtEntrada', isQbeZero: false, isDomain: false, domainName: '', lookupPropertyName: '', lookupVisibleColumns: '', maxLength: 0, isPartOfKey: false, headerText: 'Dt Entrada', width: '166px', dataType: 'date', format: 'dd/MM/yyyy', hidden: false, unbound: false, group: null }
    ];
    dataExportInfo['Produto'] = [ 
        { name: 'Produto', canExportMedia: true , canExportReport: true, actionExport: 'LinxDemoGraf_dash_KPI/GetProdutoToExcel', actionReport: 'LinxDemoGraf_dash_KPI/GetProdutoToReportXml', actionFeed: 'LinxDemoGraf_dash_KPIOData/Produto', actionName: 'LinxDemoGraf_dash_KPI/GetProdutoByEntitySearchNoAssociations', display: 'Produto',  metaData: function() { return metadataInfo['Produto']; } }
    ];
    ...
    ,DescEstoque: { dataType: DataType.String, isNullable: true, isPartOfKey: false, validators: [ ]  }
    ,QtdeEstoque: { dataType: DataType.Int32, isNullable: true, isPartOfKey: false, validators: [ ]  }
    ,DtEntrada: { dataType: DataType.DateTime, isNullable: true, isPartOfKey: false, validators: [ ]  }
                    },
    ...
    var ProdutoInitializer = function (ownerReference, isPOCO) {
       ...
       ownerReference.serverDataType['DescEstoque'] = 'S';
       ownerReference.serverDataType['QtdeEstoque'] = 'I';
       ownerReference.serverDataType['DtEntrada'] = 'T';
       ...
       ownerReference.namespace = 'Linx.Demo.BV.Graf_dash_KPI';
       ownerReference.myProperties = [ 'DataCadastro','DescProduto','IdProduto','NmProduto','TipoUnidade','DescEstoque','QtdeEstoque','DtEntrada' ];
    ...
    //#region Client Events
       ownerReference.BuscaEstoquePorIdProduto = function (idproduto) {
    //var produto = getAbsoluteValue(currentDataItem().IdProduto) 
      ...
      urlDef += "BuscaEstoquePorProduto2?idproduto="+idproduto;
    ...
    // Define that the event name is 'Graf_dash_KPIContext_DataUpdate'.
    var contextUpdtEvt = 'Graf_dash_KPIContext_DataUpdate_' + getNewGuid();
    ...
    var saveChanges = function(saveSucceeded, saveFailed, fin, saveNoTRack) {
        if (saveNoTRack === true) {
            ...
            return $.ajax({
               type: 'POST',
               crossDomain: true,
               url: getServiceAddress('LinxDemoGraf_dash_KPI/Save' + vm.rootDataTypeName),
               globalError: false,
    ...
    var exportReportDataSource = function(complete) {
        $.ajax({
           ...
           crossDomain: true,
           headers: managerAuth.getHeaders(),
           url: getServiceAddress("LinxDemoGraf_dash_KPI/GetReportDataSource"),
           success: function (response) {
    ...
    var exportTemplateReport = function(reportPath, complete) {
        $.ajax({
           ...
           crossDomain: true,
           headers: managerAuth.getHeaders(),
           url: getServiceAddress("LinxDemoGraf_dash_KPI/GetTemplateReport"),
