...
{  
	...
	[ExportMetadata("ImplementationName", "Linx.Demo.BV.Graf_dash_KPI.Produto")]
	public partial class Produto : Linx.Data.Entity
	{
	    ...
	    [XmlAttribute()]
	    [Editable(true)]
	    [Display(Name = "Id Produto", Description="", Order = 4, AutoGenerateField = true, GroupName="", ResourceType= null)]
	    [Key()]
	    ...
	    //Extensibility Partial Method Definitions For DescEstoque
	    partial void OnDescEstoqueChanging(String value);
	    partial void OnDescEstoqueChanged();

	    private String _DescEstoque;

	    [DataMember(Name = "DescEstoque", EmitDefaultValue = true)]
	    [XmlAttribute()]
	    [Editable(true)]
	    [Display(Name = "Descrição Estoque", Description="", Order = 0, AutoGenerateField = true, GroupName="", ResourceType= null)]
	    ...
	    public String DescEstoque
	    {
	    	    ...
	    	    set
	    	    {
	    	          if (this._DescEstoque != value)
	    	          {
	    	              this.ValidateProperty("DescEstoque", value);
	    	              this.OnDescEstoqueChanging(value);
	    	              this.RaiseDataMemberChanging("DescEstoque");
	    	              this._DescEstoque = value;
	    	              this.RaiseDataMemberChanged("DescEstoque");
	    	              this.OnDescEstoqueChanged();
	    	          }
	    	    }
	    }
	    //Extensibility Partial Method Definitions For QtdeEstoque
	    partial void OnQtdeEstoqueChanging(System.Nullable<int> value);
	    partial void OnQtdeEstoqueChanged();

	    private System.Nullable<int> _QtdeEstoque;

	    [DataMember(Name = "QtdeEstoque", EmitDefaultValue = true)]
	    [XmlAttribute()]
	    [Editable(true)]
	    [Display(Name = "QTDE", Description="", Order = 0, AutoGenerateField = true, GroupName="", ResourceType= null)]
	    [FunctionalPoint("Precision[0];IsEditable[false];CustomMediaTable[];IsAutomaticSequency[false];IsNull[true];DomainName[];KpiName[];KpiRelatedAttribute[];DefaultValue[];DataFormatString[];OrderByOrientation[Ascending];OrderBySequence[-1];AggregationFunction[None];ObjectClass[TextBox];ConnectedField[];Mask[];MaskType[];ExcludedAsFilter[true];FilterDataKey[0];IsMeasure[false]")]
	    [LinxPublicationField(IsSuggestion=false, LookUpInfo="", EdmKey="0")]
	    public System.Nullable<int> QtdeEstoque
	    {
	    	    get
	    	    {
	    	          return _QtdeEstoque;
	    	    ...
	    	    set
	    	    {
	    	          if (this._QtdeEstoque != value)
	    	          {
	    	              this.ValidateProperty("QtdeEstoque", value);
	    	              this.OnQtdeEstoqueChanging(value);
	    	              this.RaiseDataMemberChanging("QtdeEstoque");
	    	              this._QtdeEstoque = value;
	    	              this.RaiseDataMemberChanged("QtdeEstoque");
	    	              this.OnQtdeEstoqueChanged();
	    	          }
	    	    }
	    }
	    //Extensibility Partial Method Definitions For DtEntrada
	    partial void OnDtEntradaChanging(System.Nullable<DateTime> value);
	    partial void OnDtEntradaChanged();

	    private System.Nullable<DateTime> _DtEntrada;

	    [DataMember(Name = "DtEntrada", EmitDefaultValue = true)]
	    [XmlAttribute()]
	    [Editable(true)]
	    [Display(Name = "Dt Entrada", Description="", Order = 0, AutoGenerateField = true, GroupName="", ResourceType= null)]
	    [FunctionalPoint("Precision[0];IsEditable[false];CustomMediaTable[];IsAutomaticSequency[false];IsNull[true];DomainName[];KpiName[];KpiRelatedAttribute[];DefaultValue[];DataFormatString[];OrderByOrientation[Ascending];OrderBySequence[-1];AggregationFunction[None];ObjectClass[TextBox];ConnectedField[];Mask[];MaskType[];ExcludedAsFilter[true];FilterDataKey[null];IsMeasure[false]")]
	    [LinxPublicationField(IsSuggestion=false, LookUpInfo="", EdmKey="null")]
	    public System.Nullable<DateTime> DtEntrada
	    {
	    	    get
	    	    {
	    	          return _DtEntrada;
	    	    ...
	    	    set
	    	    {
	    	          ...
	    	          {
	    	              this.ValidateProperty("DtEntrada", value);
	    	              this.OnDtEntradaChanging(value);
	    	              this.RaiseDataMemberChanging("DtEntrada");
	    	              this._DtEntrada = value;
	    	              this.RaiseDataMemberChanged("DtEntrada");
	...
	///////////////////////////////////////////////////////////////////////
	[EnableClientAccess()]	
	[DomainIdentifier("ProcessorOverviewGraf_dash_KPIDomainService", CodeProcessor = typeof(MethodPatchingCodeProcessor))]
	public partial class Graf_dash_KPIDomainService : DomainService, IDataServiceContext 
	{
	    ...
	    public Graf_dash_KPIDomainService() : this("", null, null) { }
	    public Graf_dash_KPIDomainService(string connectionString) : this(connectionString, null, null) { }
	    public Graf_dash_KPIDomainService(Dictionary<string, string> headers) : this("", null, headers) { }
	    public Graf_dash_KPIDomainService(Linx.Demo.BM.BMDTesteFrame dataContext, Dictionary<string, string> headers) : this("", dataContext, headers) { }
	    public Graf_dash_KPIDomainService(string connectionString, Linx.Demo.BM.BMDTesteFrame dataContext, Dictionary<string, string> headers) : base() 
	    { 
	    ...
	    public List<LinxEntityReferenceInfo> GetMetaDataObject(string entityName, bool forceAll = false, bool removeParentComposition = false)
        {
	        ...
	        if (entityName.InList("Linx.Demo.BV.Graf_dash_KPI.Produto"))
	        {
	        		result.Add(new LinxEntityReferenceInfo()
	        		{
	        			...
	        			EdmEntityName = ObjectExtension.GetFunctionalPointOfType(Type.GetType("Linx.Demo.BV.Graf_dash_KPI.Produto"), "EdmEntityName"),
	        			Properties = ObjectExtension.GetFunctionalPoints(Type.GetType("Linx.Demo.BV.Graf_dash_KPI.Produto"), forceAll: forceAll)
	        		});
	        }
        ...
        {	
	    		...
	    		if (erp)
	    		{
         		    ...
         		    return new string[] { "Demo_Graf_dash_KPIClientErpService", Linx.Tools.AssemblyHelper.ReadResourceContent("Linx.Demo.BV.ClientResources.Graf_dash_KPIClientErpService.res", System.Reflection.Assembly.GetExecutingAssembly()) };		
	    		}
	    		else 
	    		{

         		    return new string[] { "Demo_graf_dash_KPIService", Linx.Tools.AssemblyHelper.ReadResourceContent("Linx.Demo.BV.ClientResources.graf_dash_KPIService.res", System.Reflection.Assembly.GetExecutingAssembly()) };	
	    		}
	    ...
	    private List<string> GetExcludedFilters()
	    {
	    	...
	    	result.Add("Produto|DescEstoque");
	    	result.Add("Produto|''");
	    	result.Add("Produto|QtdeEstoque");
	    	result.Add("Produto|0");
	    	result.Add("Produto|DtEntrada");
	    	result.Add("Produto|null");
	    ...
	    public IQueryable<Produto> GetProdutoByEntitySearch(string serializedEntitySearch, string jEntitySearch = "")
	    {
	        ...
	        SetProdutoBusinessFilter(ref result, entitySearchList);
	    ...
	    [Ignore()]
	    private void SetProdutoBusinessFilter(ref IQueryable<Produto> query, List<EntitySearch> entitySearchList)
	    {
	    		int idxElement;
	    		...
	    		{
	    			foreach (EntitySearch search in entitySearchList.Where(e => e.EntityName == "Produto"))
	    			{

	
	    				foreach (var exp in search.Expressions.Where(e => e.Name == "Field" && (e.Value.ToString() == "DescEstoque" || e.Value.ToString() == "''")))
	    				{
	    					...
	    					if ((idxElement + 2) < search.Expressions.Count)
	    					{
	    						if (search.Expressions[idxElement + 1].Name == "Operator" && search.Expressions[idxElement + 2].Name == "Value")
	    						{
	    								...
	    								{
	    									case "==":
	    										String tmpDescEstoque1 = (String)value;
	    										query = from r in query where r.DescEstoque == tmpDescEstoque1 select r;
	    										break;
	    									case "!=":
	    										String tmpDescEstoque2 = (String)value;
	    										query = from r in query where r.DescEstoque != tmpDescEstoque2 select r;
	    										break;

	
	    									case "Contains":
	    										String tmpDescEstoque7 = (String)value;
	    									    query = from r in query where r.DescEstoque.Contains(tmpDescEstoque7) select r;
	    									    break;
	    									case "StartsWith":
	    										String tmpDescEstoque8 = (String)value;
	    									    query = from r in query where r.DescEstoque.StartsWith(tmpDescEstoque8) select r;
	    									    break;
	    									case "EndsWith":
	    										String tmpDescEstoque9 = (String)value;
	    									    query = from r in query where r.DescEstoque.EndsWith(tmpDescEstoque9) select r;
	    									    break;
	    				...
	    				foreach (var exp in search.Expressions.Where(e => e.Name == "Field" && (e.Value.ToString() == "QtdeEstoque" || e.Value.ToString() == "0")))
	    				{
	    					idxElement = search.Expressions.IndexOf(exp);
	    					if ((idxElement + 2) < search.Expressions.Count)
	    					{
	    						if (search.Expressions[idxElement + 1].Name == "Operator" && search.Expressions[idxElement + 2].Name == "Value")
	    						{
	    								...
	    								{
	    									case "==":
	    										System.Nullable<int> tmpQtdeEstoque1 = (System.Nullable<int>)value;
	    										query = from r in query where r.QtdeEstoque == tmpQtdeEstoque1 select r;
	    										break;
	    									case "!=":
	    										System.Nullable<int> tmpQtdeEstoque2 = (System.Nullable<int>)value;
	    										query = from r in query where r.QtdeEstoque != tmpQtdeEstoque2 select r;
	    										break;

	
	    									case "<":
	    										System.Nullable<int> tmpQtdeEstoque3 = (System.Nullable<int>)value;
	    										query = from r in query where r.QtdeEstoque < tmpQtdeEstoque3 select r;
	    										break;
	    									case "<=":
	    										System.Nullable<int> tmpQtdeEstoque4 = (System.Nullable<int>)value;
	    										query = from r in query where r.QtdeEstoque <= tmpQtdeEstoque4 select r;
	    										break;
	    									case ">":
	    										System.Nullable<int> tmpQtdeEstoque5 = (System.Nullable<int>)value;
	    										query = from r in query where r.QtdeEstoque > tmpQtdeEstoque5 select r;
	    										break;
	    									case ">=":
	    										System.Nullable<int> tmpQtdeEstoque6 = (System.Nullable<int>)value;
	    										query = from r in query where r.QtdeEstoque >= tmpQtdeEstoque6 select r;
	    										break;	
	    				...
	    				foreach (var exp in search.Expressions.Where(e => e.Name == "Field" && (e.Value.ToString() == "DtEntrada" || e.Value.ToString() == "null")))
	    				{
	    					idxElement = search.Expressions.IndexOf(exp);
	    					if ((idxElement + 2) < search.Expressions.Count)
	    					{
	    						if (search.Expressions[idxElement + 1].Name == "Operator" && search.Expressions[idxElement + 2].Name == "Value")
	    						{
	    								...
	    								{
	    									case "==":
	    										System.Nullable<DateTime> tmpDtEntrada1 = (System.Nullable<DateTime>)value;
	    										query = from r in query where r.DtEntrada == tmpDtEntrada1 select r;
	    										break;
	    									case "!=":
	    										System.Nullable<DateTime> tmpDtEntrada2 = (System.Nullable<DateTime>)value;
	    										query = from r in query where r.DtEntrada != tmpDtEntrada2 select r;
	    										break;
