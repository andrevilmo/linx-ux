    ...
    public class UpdateBulkTests
    {
        ...
        public void UpdateBulk_UpdatesAll()
        {
            ...
            using (var db = Context.Sql())
            {
                ...
                EFBatchOperation.For(db, db.BlogPosts).UpdateAll(posts, spec => spec.ColumnsToUpdate(p => p.Title), new List<ForeignKeyCfg>(), new string[] { }, null, null);
            }
        ...
        public void UpdateBulk_CanUpdateTPH()
        {
            ...
            using (var db = Context.Sql())
            {
                ...
                EFBatchOperation.For(db, db.People).UpdateAll(contacts, x => x.ColumnsToUpdate(p => p.FirstName), new List<ForeignKeyCfg>(), new string[] { }, null, null);
            }
        ...
        public void UpdateBulk_CanUpdateNumerics()
        {
            ...
            using (var db = Context.Sql())
            {
                ...
                EFBatchOperation.For(db, db.NumericTestsObjects).UpdateAll(items, spec => spec.ColumnsToUpdate(p => p.DecimalType, p => p.FloatType, p => p.NumericType), new List<ForeignKeyCfg>(), new string[] { }, null, null);
            }
        ...
        public void UpdateBulk_CanUpdateMultiPK()
        {
            ...
            using (var db = Context.Sql())
            {
                ...
                EFBatchOperation.For(db, db.MultiPKObjects).UpdateAll(items, spec => spec.ColumnsToUpdate(p => p.Text), new List<ForeignKeyCfg>(), new string[] { }, null, null);
            }
        ...
        public void UpdateBulk_CanUpdateNvarcharWithLength()
        {
            ...
            using (var db = Context.Sql())
            {
                ...
                EFBatchOperation.For(db, db.BlogPosts).UpdateAll(posts, spec => spec.ColumnsToUpdate(p => p.ShortTitle), new List<ForeignKeyCfg>(), new string[] { }, null, null);
            }
