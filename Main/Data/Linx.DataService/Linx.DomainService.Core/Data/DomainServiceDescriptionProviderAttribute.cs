...
namespace Linx.DS.Core.Data
{
    ...
    public class DomainServiceDescriptionProviderAttribute : Attribute
    {
        ...
        public virtual DomainServiceDescriptionProvider CreateProvider(Type domainServiceType, DomainServiceDescriptionProvider parent)
        {
            ...
            if (!typeof(DomainServiceDescriptionProvider).GetTypeInfo().IsAssignableFrom(this._domainServiceDescriptionProviderType))
            {
            ...
            if (this._domainServiceDescriptionProviderType.GetTypeInfo().GetConstructor(new Type[] { typeof(Type), typeof(DomainServiceDescriptionProvider) }) == null)
            {
