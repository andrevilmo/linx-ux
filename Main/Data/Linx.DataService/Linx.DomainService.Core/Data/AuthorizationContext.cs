...
using DataAnnotationsResources = Linx.DS.Core.Data.Resource;
...
namespace System.ComponentModel.DataAnnotations
{
    ...
    /// </para>
    /// <para>
    /// This class also provides an <see cref="DomainServiceContextServiceContainer"/> implementation to allow
    /// developers to add services to the context at runtime.   This container is available
    /// via <see cref="GetService"/> specifying <c>typeof(DomainServiceContextServiceContainer)</c> or via
    ...
    public sealed class AuthorizationContext : IServiceProvider, IDisposable
    {
        ...
        /// </para>
        /// <para>
        /// The <see cref="Linx.DomainService.Core.Data.DomainService.AuthorizationContext"/> 
        /// property allows such a template to be set into the
        /// <see cref="Linx.DomainService.Core.Data.DomainService"/> for all authorization requests.
        /// </para>
        /// </remarks>
