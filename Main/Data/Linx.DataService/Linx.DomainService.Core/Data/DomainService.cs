...
namespace Linx.DS.Core.Data
{
    ...
    public abstract class DomainService : IDisposable
    {
        ...
        private static MethodInfo countMethod = typeof(DomainService).GetTypeInfo().GetMethod("Count", BindingFlags.NonPublic | BindingFlags.Instance);
        private static MethodInfo enumerateMethod = typeof(DomainService).GetTypeInfo().GetMethod("Enumerate", BindingFlags.NonPublic | BindingFlags.Static);
        ...
        private class DefaultDomainServiceFactory : IDomainServiceFactory
        {
            ...
            {
                if (!typeof(DomainService).GetTypeInfo().IsAssignableFrom(domainServiceType))
                {
