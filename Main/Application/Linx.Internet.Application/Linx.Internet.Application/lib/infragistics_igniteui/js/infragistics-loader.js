/*!@license Infragistics.Web.Loader 15.1.20151.2300
*
...
/// igDataChart ///
	{
		widget: 'igDVCore',
		priority: true,
		scripts: ['$path$/modules/infragistics.dv.core.js', '$path$/modules/infragistics.dvcommonwidget.js'],
	...
	{
		widget: 'igDataChart',
		dependency: [{ name: 'igUtil' }, { name: 'igDataSource' }, { name: 'igDVCore' }, { name: 'igTemplating' }, { name: 'igChartLegend' }],
		scripts: ['$path$/modules/infragistics.ui.chart.js'],
		group: $.ig.loaderClass.locale.dvGroup,
		css: ['$path$/structure/modules/infragistics.ui.shared.css', '$path$/structure/modules/infragistics.ui.chart.css', '$path$/structure/modules/infragistics.ui.html5.css']
	},
	{
		widget: 'igSimpleDataChart',
		dependency: [{ name: 'igUtil' }, { name: 'igDataSource' }, { name: 'igDVSimpleCore' }, { name: 'igTemplating' }],
		scripts: ['$path$/modules/infragistics.ui.basechart.js'],
		group: $.ig.loaderClass.locale.dvGroup,
		css: ['$path$/structure/modules/infragistics.ui.shared.css', '$path$/structure/modules/infragistics.ui.html5.css']
	},
	{
		widget: 'Category',
	...
	},
	{
		...
		dependency: [{ name: 'igUtil' }, { name: 'igDataSource' }, { name: 'igDVCore' }, { name: 'igTemplating' }, { name: 'igChartLegend' }],
		scripts: ['$path$/modules/infragistics.ui.basechart.js', '$path$/modules/infragistics.chart_piechart.js', '$path$/modules/infragistics.ui.doughnutchart.js'],
	...
	},
	{
		...
		scripts: ['$path$/modules/infragistics.chart_funnelchart.js', '$path$/modules/infragistics.ui.funnelchart.js'],
		group: $.ig.loaderClass.locale.dvGroup,
		css: ['$path$/structure/modules/infragistics.ui.chart.css']
	},
	{
		...
		scripts: ['$path$/modules/infragistics.ui.sparkline.js', '$path$/modules/infragistics.chart_sparkline.js'],
		group: $.ig.loaderClass.locale.dvGroup,
...
/// end igDataChart ///

	{
		...
		scripts: ['$path$/modules/infragistics.ui.radialgauge.js', '$path$/modules/infragistics.gauge_radialgauge.js'],
		group: $.ig.loaderClass.locale.dvGroup,
...

	{
		...
		dependency: [{ name: 'igUtil' }, { name: 'igTemplating' }, { name: 'igDVSimpleCore' }],
		scripts: ['$path$/modules/infragistics.ui.bulletgraph.js', '$path$/modules/infragistics.gauge_bulletgraph.js'],
		group: $.ig.loaderClass.locale.dvGroup,
...

	{
		...
		dependency: [{ name: 'igUtil' }, { name: 'igTemplating' }, { name: 'igDVSimpleCore' }],
		scripts: ['$path$/modules/infragistics.ui.lineargauge.js', '$path$/modules/infragistics.gauge_lineargauge.js'],
		group: $.ig.loaderClass.locale.dvGroup
...

	{
		widget: 'igRadialMenu',
		dependency: [{ name: 'igUtil' }, { name: 'igTemplating' }, { name: 'igDVSimpleCore' }],
		scripts: ['$path$/modules/infragistics.ui.radialmenu.js', '$path$/modules/infragistics.radialmenu_core.js'],
...

	{
		...
		dependency: [{ name: 'igUtil' }, { name: 'igDVSimpleCore'}],
		scripts: ['$path$/modules/infragistics.barcode_qrcodebarcode.js', '$path$/modules/infragistics.ui.barcode.js'],
	...
	},
	{
		...
		dependency: [{ name: 'igQRCodeBarcode' }],
		group: $.ig.loaderClass.locale.dvGroup,
		scripts: ['$path$/modules/encoding/infragistics.encoding.core.js', '$path$/modules/encoding/infragistics.encoding_big5.js']
	},
	{
		widget: 'CP437',
		parentWidget: 'igQRCodeBarcode',
		dependency: [{ name: 'igQRCodeBarcode' }],
		group: $.ig.loaderClass.locale.dvGroup,
		scripts: ['$path$/modules/encoding/infragistics.encoding.core.js', '$path$/modules/encoding/infragistics.encoding_cp437.js']
	},
	{
		widget: 'GB2312',
		parentWidget: 'igQRCodeBarcode',
		dependency: [{ name: 'igQRCodeBarcode' }],
		group: $.ig.loaderClass.locale.dvGroup,
		scripts: ['$path$/modules/encoding/infragistics.encoding.core.js', '$path$/modules/encoding/infragistics.encoding_gb2312.js']
	},
	{
		widget: 'ISO646-US',
		parentWidget: 'igQRCodeBarcode',
		dependency: [{ name: 'igQRCodeBarcode' }],
		group: $.ig.loaderClass.locale.dvGroup,
		scripts: ['$path$/modules/encoding/infragistics.encoding.core.js', '$path$/modules/encoding/infragistics.encoding_iso646-us.js']
	},
	{
		widget: 'ISO-8859-1',
		parentWidget: 'igQRCodeBarcode',
		dependency: [{ name: 'igQRCodeBarcode' }],
		group: $.ig.loaderClass.locale.dvGroup,
		scripts: ['$path$/modules/encoding/infragistics.encoding.core.js', '$path$/modules/encoding/infragistics.encoding_iso-8859-1.js']
	},
	{
		widget: 'ISO-8859-2',
		parentWidget: 'igQRCodeBarcode',
		dependency: [{ name: 'igQRCodeBarcode' }],
		group: $.ig.loaderClass.locale.dvGroup,
		scripts: ['$path$/modules/encoding/infragistics.encoding.core.js', '$path$/modules/encoding/infragistics.encoding_iso-8859-2.js']
	},
	{
		widget: 'ISO-8859-3',
		parentWidget: 'igQRCodeBarcode',
		dependency: [{ name: 'igQRCodeBarcode' }],
		group: $.ig.loaderClass.locale.dvGroup,
		scripts: ['$path$/modules/encoding/infragistics.encoding.core.js', '$path$/modules/encoding/infragistics.encoding_iso-8859-3.js']
	},
	{
		widget: 'ISO-8859-4',
		parentWidget: 'igQRCodeBarcode',
		dependency: [{ name: 'igQRCodeBarcode' }],
		group: $.ig.loaderClass.locale.dvGroup,
		scripts: ['$path$/modules/encoding/infragistics.encoding.core.js', '$path$/modules/encoding/infragistics.encoding_iso-8859-4.js']
	},
	{
		widget: 'ISO-8859-5',
		parentWidget: 'igQRCodeBarcode',
		dependency: [{ name: 'igQRCodeBarcode' }],
		group: $.ig.loaderClass.locale.dvGroup,
		scripts: ['$path$/modules/encoding/infragistics.encoding.core.js', '$path$/modules/encoding/infragistics.encoding_iso-8859-5.js']
	},
	{
		widget: 'ISO-8859-6',
		parentWidget: 'igQRCodeBarcode',
		dependency: [{ name: 'igQRCodeBarcode' }],
		group: $.ig.loaderClass.locale.dvGroup,
		scripts: ['$path$/modules/encoding/infragistics.encoding.core.js', '$path$/modules/encoding/infragistics.encoding_iso-8859-6.js']
	},
	{
		widget: 'ISO-8859-7',
		parentWidget: 'igQRCodeBarcode',
		dependency: [{ name: 'igQRCodeBarcode' }],
		group: $.ig.loaderClass.locale.dvGroup,
		scripts: ['$path$/modules/encoding/infragistics.encoding.core.js', '$path$/modules/encoding/infragistics.encoding_iso-8859-7.js']
	},
	{
		widget: 'ISO-8859-8',
		parentWidget: 'igQRCodeBarcode',
		dependency: [{ name: 'igQRCodeBarcode' }],
		group: $.ig.loaderClass.locale.dvGroup,
		scripts: ['$path$/modules/encoding/infragistics.encoding.core.js', '$path$/modules/encoding/infragistics.encoding_iso-8859-8.js']
	},
	{
		widget: 'ISO-8859-9',
		parentWidget: 'igQRCodeBarcode',
		dependency: [{ name: 'igQRCodeBarcode' }],
		group: $.ig.loaderClass.locale.dvGroup,
		scripts: ['$path$/modules/encoding/infragistics.encoding.core.js', '$path$/modules/encoding/infragistics.encoding_iso-8859-9.js']
	},
	{
		widget: 'ISO-8859-11',
		parentWidget: 'igQRCodeBarcode',
		dependency: [{ name: 'igQRCodeBarcode' }],
		group: $.ig.loaderClass.locale.dvGroup,
		scripts: ['$path$/modules/encoding/infragistics.encoding.core.js', '$path$/modules/encoding/infragistics.encoding_iso-8859-11.js']
	},
	{
		widget: 'ISO-8859-13',
		parentWidget: 'igQRCodeBarcode',
		dependency: [{ name: 'igQRCodeBarcode' }],
		group: $.ig.loaderClass.locale.dvGroup,
		scripts: ['$path$/modules/encoding/infragistics.encoding.core.js', '$path$/modules/encoding/infragistics.encoding_iso-8859-13.js']
	},
	{
		widget: 'ISO-8859-15',
		parentWidget: 'igQRCodeBarcode',
		dependency: [{ name: 'igQRCodeBarcode' }],
		group: $.ig.loaderClass.locale.dvGroup,
		scripts: ['$path$/modules/encoding/infragistics.encoding.core.js', '$path$/modules/encoding/infragistics.encoding_iso-8859-15.js']
	},
	{
		widget: 'KSC5601',
		parentWidget: 'igQRCodeBarcode',
		dependency: [{ name: 'igQRCodeBarcode' }],
		group: $.ig.loaderClass.locale.dvGroup,
		scripts: ['$path$/modules/encoding/infragistics.encoding.core.js', '$path$/modules/encoding/infragistics.encoding_ksc5601.js']
	},
	{
		widget: 'Shift_JIS',
		parentWidget: 'igQRCodeBarcode',
		dependency: [{ name: 'igQRCodeBarcode' }],
		group: $.ig.loaderClass.locale.dvGroup,
		scripts: ['$path$/modules/encoding/infragistics.encoding.core.js', '$path$/modules/encoding/infragistics.encoding_shift_jis.js']
	},
	{
		widget: 'Windows-1250',
		parentWidget: 'igQRCodeBarcode',
		dependency: [{ name: 'igQRCodeBarcode' }],
		group: $.ig.loaderClass.locale.dvGroup,
		scripts: ['$path$/modules/encoding/infragistics.encoding.core.js', '$path$/modules/encoding/infragistics.encoding_windows-1250.js']
	},
	{
		widget: 'Windows-1251',
		parentWidget: 'igQRCodeBarcode',
		dependency: [{ name: 'igQRCodeBarcode' }],
		group: $.ig.loaderClass.locale.dvGroup,
		scripts: ['$path$/modules/encoding/infragistics.encoding.core.js', '$path$/modules/encoding/infragistics.encoding_windows-1251.js']
	},
	{
		widget: 'Windows-1252',
		parentWidget: 'igQRCodeBarcode',
		dependency: [{ name: 'igQRCodeBarcode' }],
		group: $.ig.loaderClass.locale.dvGroup,
		scripts: ['$path$/modules/encoding/infragistics.encoding.core.js', '$path$/modules/encoding/infragistics.encoding_windows-1252.js']
	},
	{
		widget: 'Windows-1256',
		parentWidget: 'igQRCodeBarcode',
		dependency: [{ name: 'igQRCodeBarcode' }],
		group: $.ig.loaderClass.locale.dvGroup,
		scripts: ['$path$/modules/encoding/infragistics.encoding.core.js', '$path$/modules/encoding/infragistics.encoding_windows-1256.js']
	},

	{
		widget: 'igCombo',
		dependency: [{ name: 'igUtil' }, { name: 'igDataSource' }, { name: 'igTemplating' }, { name: 'igScroll' }, { name: 'igValidator' }],
	...
	{
		widget: 'igEditors',
		dependency: [{ name: 'igUtil' }, { name: 'regional' }, { name: 'igScroll' }, { name: 'igValidator' }],
	...
	},
	{
		...
		css: ['$path$/structure/modules/infragistics.ui.shared.css', '$path$/structure/modules/infragistics.ui.zoombar.css']
	},

/// igGrid ///
	{
		widget: 'igGrid',
		dependency: [{ name: 'igUtil' }, { name: 'regional' }, { name: 'igDataSource' }, { name: 'igTemplating' }, { name: 'igShared' }, { name: 'igScroll' }],
	...
	},
	{
		...
		parentWidget: 'igGrid,igHierarchicalGrid',
		dependency: [{ name: 'igGrid' }, { name: 'igPopover' }],
...
/// end igHierarchicalGrid ///
	...
	{
		widget: 'igHtmlEditor',
		dependency: [{ name: 'igUtil' }, { name: 'igPopover' }, { name: 'igSplitButton' }, { name: 'igColorPicker' }, { name: 'igColorPickerSplitButton' }, { name: 'igCombo' }, { name: "igEditors" }, { name: 'igToolbarButton' }, { name: 'igToolbar' }],
...
/// igMap ///
	{
		widget: 'igMap',
		dependency: [{ name: 'igUtil' }, { name: 'igTemplating' }, { name: 'igDataSource' }, { name: 'igDVCore' }, { name: 'igDVMapCore' }],
...
/// end igMap ///
	...
	{
		widget: 'igPivotGrid',
		dependency: [{ name: 'igPivotShared' }, { name: 'MultiColumnHeaders' }],
...

	{
		...
		dependency: [{ name: 'igPivotShared' }, { name: 'igCombo' }, { name: 'igTree' }],
	...
	{
		widget: 'igPivotView',
		dependency: [{ name: 'igSplitter' }, { name: 'igPivotGrid' }, { name: 'igPivotDataSelector' }],
	...
	},
	{
		...
		dependency: [{ name: 'igPopover' }, { name: 'igColorPicker' }, { name: 'igSplitButton' }],
	...
	},
	{
		...
		dependency: [{ name: 'igDataSource' }, { name: 'igTemplating' }, { name: 'igLayoutManager' }, { name: 'igSplitter' }],
	...
	},
	{
		...
		group: $.ig.loaderClass.locale.interactionsGroup,
		css: ['$path$/structure/modules/infragistics.ui.videoplayer.css', '$path$/structure/modules/infragistics.ui.html5.css']
	},
	{
		widget: 'igSplitter',
		dependency: [{ name: 'igUtil' }],
	...
	{
		widget: 'igToolbar',
		dependency: [{ name: 'igUtil' }, { name: 'igToolbarButton' }],
...
/// igTreeGrid Features ///
	...
	widget: 'Filtering',
	parentWidget: 'igTreeGrid',
	dependency: [{ name: 'igTreeGrid' }, { name: 'Filtering', parentWidget: "igGrid,igHierarchicalGrid" }],
	scripts: ['$path$/modules/infragistics.ui.treegrid.filtering.js']
	},
	{
		widget: 'Hiding',
		parentWidget: 'igTreeGrid',
		dependency: [{ name: 'igTreeGrid' }, { name: 'Hiding', parentWidget: "igGrid,igHierarchicalGrid" }],
		scripts: ['$path$/modules/infragistics.ui.treegrid.hiding.js']
	},
	{
		widget: 'Updating',
		parentWidget: 'igTreeGrid',
		dependency: [{ name: 'igTreeGrid' }, { name: 'Updating', parentWidget: "igGrid,igHierarchicalGrid" }],
		scripts: ['$path$/modules/infragistics.ui.treegrid.updating.js']
	},
	{
		widget: 'Paging',
		parentWidget: 'igTreeGrid',
		dependency: [{ name: 'igTreeGrid' }, { name: 'Paging', parentWidget: "igGrid,igHierarchicalGrid" }],
		scripts: ['$path$/modules/infragistics.ui.treegrid.paging.js']
	},
	{
		widget: 'Selection',
		parentWidget: 'igTreeGrid',
		dependency: [{ name: 'igTreeGrid' }, { name: 'Selection', parentWidget: "igGrid,igHierarchicalGrid" }],
		scripts: ['$path$/modules/infragistics.ui.treegrid.selection.js']
	},
	{
		widget: 'Sorting',
		parentWidget: 'igTreeGrid',
		dependency: [{ name: 'igTreeGrid' }, { name: 'Sorting', parentWidget: "igGrid,igHierarchicalGrid" }],
		scripts: ['$path$/modules/infragistics.ui.treegrid.sorting.js']
	},
	{
		widget: 'MultiColumnHeaders',
		parentWidget: 'igTreeGrid',
		dependency: [{ name: 'igTreeGrid' }, { name: 'MultiColumnHeaders', parentWidget: "igGrid,igHierarchicalGrid" }],
		scripts: ['$path$/modules/infragistics.ui.treegrid.multicolumnheaders.js']
	},
	{
		widget: 'Tooltips',
		parentWidget: 'igTreeGrid',
		dependency: [{ name: 'igTreeGrid' }, { name: 'Tooltips', parentWidget: "igGrid,igHierarchicalGrid" }],
		scripts: ['$path$/modules/infragistics.ui.treegrid.tooltips.js']
	},
	{
		widget: 'ColumnFixing',
		parentWidget: 'igTreeGrid',
		dependency: [{ name: 'igTreeGrid' }, { name: 'ColumnFixing', parentWidget: "igGrid" }],
	...
	*/
	...
	_findWidgetScriptData: function (widgetName, parentWidget) {
		...
		for (i = 0; i < len; i++) {
			...
			if (scriptData.widget === widgetName && ((scriptData.parentWidget !== undefined && parentWidget !== undefined &&
				scriptData.parentWidget.indexOf(parentWidget) > -1) || (parentWidget === undefined || parentWidget === widgetName))) {
				return scriptData;
			}
		}
		return null;
	...
	_loadScript: function (fileName, loadingEntity) {
		...
		if (!this.isLoadedScript(fileName)) {
			...
			s.onreadystatechange = s.onload = function () {
				if (s.readyState === undefined || s.readyState === "complete" || (!isIE10Plus && s.readyState === "loaded")) {
