/*
* TelerikReporting v9.0.15.422 (http://www.telerik.com/products/reporting.aspx)
...
(function (trv, $, window, document, undefined) {
    ...
    function PagesArea(placeholder, options) {
        ...
        function setPageDimensions(page, scaleMode, scale) {
            ...
            $page.css("height", scale * pageHeight).css("width", "100%");
        }
        ...
        function setPageContent(page) {
            ...
            var $target = $pageWrapper.empty().data("pageNumber", pageNumber).append($page);
    ...
    function ReportViewer(dom, options) {
        ...
        function start() {
            ...
            if (options.printMode) {
                controller.printMode(options.printMode);
            }
...
/* DO NOT MODIFY OR DELETE THIS LINE! UPGRADE WIZARD CHECKSUM ACD10A2879BD494C1124E2AB9DBF9612 */