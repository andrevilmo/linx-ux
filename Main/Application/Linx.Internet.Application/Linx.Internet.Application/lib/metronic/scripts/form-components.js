var FormComponents = function () {
    ...
    return {
        ...
        init: function () {
            console.log("FormComponents.init()")
        ...
        initSelect2: function () {
            console.log("FormComponents.initSelect2()")
            handleSelect2();
        },

        initSelect2Modal: function () {
            console.log("FormComponents.initSelect2Modal()")
            handleSelect2Modal();
        },

        initMultiSelect: function () {
            console.log("FormComponents.initMultiSelect()")
            handleMultiSelect();
        }
    };
