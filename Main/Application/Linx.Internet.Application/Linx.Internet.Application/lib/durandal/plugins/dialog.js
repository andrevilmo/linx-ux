    ...
    MessageBox.defaultViewMarkup = [
        '<div data-view="plugins/messageBox" class="messageBox">',
            ...
            '<div class="modal-body">',
                '<p class="message" data-bind="html: toHTML(message)"></p>',
            '</div>',
            '<div class="modal-footer" data-bind="foreach: options">',
                '<button class="btn" data-bind="click: function () { $parent.selectOption($data); }, text: translateData($data), css: { \'btn-ok\': $index() == 0, \'btn-close\': $index() > 0, autofocus: $index() == 0 }"></button>',
            '</div>',
        '</div>'
    ].join('\n');
