...
var result = function () {
    ...
    var getDataFeedUrl = function() {
       return getServiceAddress('LinxDemoUIExternaOData');
    };
    ...
    var controllerName = 'LinxDemoUIExterna';
    ...
    dataExportInfo['Cliente'] = [ 
        { name: 'Cliente', canExportMedia: true , canExportReport: true, actionExport: 'LinxDemoUIExterna/GetClienteToExcel', actionReport: 'LinxDemoUIExterna/GetClienteToReportXml', actionFeed: 'LinxDemoUIExternaOData/Cliente', actionName: 'LinxDemoUIExterna/GetClienteByEntitySearchNoAssociations', display: 'Cliente',  metaData: function() { return metadataInfo['Cliente']; } }
    ];
    ...
    var ClienteInitializer = function (ownerReference, isPOCO) {
       ...
       ownerReference.namespace = 'Linx.Demo.BV.UIExterna';
    ...
    // Define that the event name is 'UIExternaContext_DataUpdate'.
    var contextUpdtEvt = 'UIExternaContext_DataUpdate_' + getNewGuid();
    ...
    var saveChanges = function(saveSucceeded, saveFailed, fin, saveNoTRack) {
        if (saveNoTRack === true) {
            ...
            return $.ajax({
               type: 'POST',
               crossDomain: true,
               url: getServiceAddress('LinxDemoUIExterna/Save' + vm.rootDataTypeName),
               globalError: false,
    ...
    var exportReportDataSource = function(complete) {
        $.ajax({
           ...
           crossDomain: true,
           headers: managerAuth.getHeaders(),
           url: getServiceAddress("LinxDemoUIExterna/GetReportDataSource"),
           success: function (response) {
    ...
    var exportTemplateReport = function(reportPath, complete) {
        $.ajax({
           ...
           crossDomain: true,
           headers: managerAuth.getHeaders(),
           url: getServiceAddress("LinxDemoUIExterna/GetTemplateReport"),
