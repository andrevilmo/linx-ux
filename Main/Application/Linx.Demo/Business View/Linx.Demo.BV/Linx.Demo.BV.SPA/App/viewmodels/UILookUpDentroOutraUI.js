...
var vmConstructor = function () {
    ...
    var objectLayout = function () {
       return {Name: 'UILookUpDentroOutraUI', Items: [
{Name: 'UILookUpDentroOutraUI_gbLoja', DisplayName: 'Loja', ColumnSpan: 12, Visible: true, Items: [{Name: 'UILookUpDentroOutraUI_ntxBigIntLoja', DisplayName: 'Big Int Loja', ColumnSpan: 8, Visible: true},{Name: 'UILookUpDentroOutraUI_ckBitLoja', DisplayName: 'Bit Loja', ColumnSpan: 3, Visible: true},{Name: 'UILookUpDentroOutraUI_cmbComboboxLoja', DisplayName: 'Combobox Loja', ColumnSpan: 6, Visible: true},{Name: 'UILookUpDentroOutraUI_dtDatetimeLoja', DisplayName: 'Datetime Loja', ColumnSpan: 3, Visible: true},{Name: 'UILookUpDentroOutraUI_ntxDecimalLoja', DisplayName: 'Decimal Loja', ColumnSpan: 5, Visible: true},{Name: 'UILookUpDentroOutraUI_ntxIdLoja', DisplayName: 'Id Loja', ColumnSpan: 5, Visible: true},{Name: 'UILookUpDentroOutraUI_ntxIntLoja', DisplayName: 'Int Loja', ColumnSpan: 5, Visible: true},{Name: 'UILookUpDentroOutraUI_ntxSmallIntLoja', DisplayName: 'Small Int Loja', ColumnSpan: 2, Visible: true},{Name: 'UILookUpDentroOutraUI_tbStringLoja', DisplayName: 'String Loja', ColumnSpan: 9, Visible: true},]},       ]};
    };
    ...
    var activate = function (settings, querystring) {
      ...
      vm.UILookUpDentroOutraUI = getVM;
      ...
      if ((typeof settings === 'object') && (settings != null) && settings.objectQuery) {
          ...
          if ((typeof settings === 'object') && (settings != null) && settings.uiSettings) {
              ...
              if (uiSettings.executeQuery === true) {
                  ...
                  filteredEntities = [];
                  if (settings.parentVM) { settings.parentVM.internalUIs = [ 'UILookUpDentroOutraUI' ]; settings.parentVM.UILookUpDentroOutraUI = getVM; }
                  clear();
                  ...
                  if ((typeof settings.parentVM === 'object') && settings.parentVM != null) {
                      ...
                      parentVM.UILookUpDentroOutraUI = getVM;
                      if (isLookup()) { 
                      ...
                      if ($.inArray('UILookUpDentroOutraUI', parentVM.internalUIs) === -1) parentVM.internalUIs.push('UILookUpDentroOutraUI');
                  }
              }
          }
          else {
    ...
    var adjustModuleSecurity = function () {
        ...
        managerAuth.getFormAccess('linx-demo-bv-spa-UILookUpDentroOutraUI', function (data) {
    ...
    var canActivate = function() {
        ...
        if (data.lxShellCompiledVersion != managerAuth.shellVersion) {
            app.showMessage('Versão de formulário incompatível com a versão de ambiente [' + managerAuth.shellVersion + '].', 'Formulário: UILookUpDentroOutraUI', ['Ok']);
            return false;
        }
        return true;
    };
    ...
    var compositionComplete = function() {
                   $('#UILookUpDentroOutraUI_gbLoja').one('shown.bs.collapse', function (e) { vm.notifyInnerElements($(e.currentTarget), true); });

                   complement.renderscyUILookUpDentroOutraUI_dGrid(vm);
    ...
    var visibleColumns = 'BigIntLoja,BitLoja,ComboboxLoja,DatetimeLoja,DecimalLoja,IdLoja,IntLoja,SmallIntLoja,StringLoja';
    ...
    var query = function (lookupInitializing, parentEntity, quickSearchJExpression, externalQueryCallBack, noMessages, noDetails) {
        ...
        return dataContext.getLojaByEntitySearchNoAssociations(lastJEntitySearch, 0, pageSize(), (pageSize() > 0), preserveDataCurrentState(), true, sortInfo).then(querySucceeded).fin(complete);
        ...
        function querySucceeded(data) {
            for (var idx = 0; idx < data.results.length; idx++) { dataContext.initializePOCO(data.results[idx], 'Loja'); }
            hasError = false;
    ...
    var removeFormViewControl = function () {
        var front = $('#UILookUpDentroOutraUI_formViewer_front')[0];
        if (front) front.removeClassName('front');
        var back = $('#UILookUpDentroOutraUI_formViewer_back')[0];
    ...
    var changeFormView = function () {
        ...
        var panel = $('#UILookUpDentroOutraUI_formViewer')[0];
           ...
           if (vm.status() !== 'C') {
               ...
               colunas.forEach(function (entry, index) {
                   if (entry.hidden && entry.key !== 'RowDataId') {
                       var control = $('#UILookUpDentroOutraUI_div' + (!dataView ? '' : '' + dataView + '_') + entry.key + 'Template');
    ...
    var vm = {
            ...
            dataView: dataView,
            viewName: 'UILookUpDentroOutraUI',
            ...
            __moduleId__: 'pkg_linx-demo-bv-spa/viewmodels/UILookUpDentroOutraUI'
        };
