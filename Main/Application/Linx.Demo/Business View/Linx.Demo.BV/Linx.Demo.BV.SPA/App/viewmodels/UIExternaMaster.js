define(['durandal/app', 'pkg_linx-demo-bv-spa/services/ModalExternaContext', 'plugins/router', 'plugins/widget', 'managers/__auth', 'viewmodels/shared/modal', 'viewmodels/shared/modal2', 'managers/brand', 'managers/predefinedFilters', 'services/logger', 'viewmodels/shared/modalMultimidia', 'common', 'pkg_linx-demo-bv-spa/viewmodels/UIExternaMasterComplement', 'viewmodels/shared/modalCustomSearch', 'managers/user'],
...
var vmConstructor = function () {
    ...
    var objectLayout = function () {
       return {Name: 'UIExternaMaster', Items: [
{Name: 'UIExternaMaster_gbExpander_5283c47111bf401897d59eeec35afdb8', DisplayName: 'Cliente', ColumnSpan: 12, Visible: true, Items: [{Name: 'UIExternaMaster_cntCliente', DisplayName: 'Cliente', ColumnSpan: 12, Visible: true, Items: [{Name: 'UIExternaMaster_cmbComboboxCliente', DisplayName: 'Combobox Cliente', ColumnSpan: 6, Visible: true},{Name: 'UIExternaMaster_lUpIdPais', DisplayName: 'Id Pais', ColumnSpan: 5, Visible: true},{Name: 'UIExternaMaster_ntxIdCliente', DisplayName: 'Id Cliente', ColumnSpan: 5, Visible: true},{Name: 'UIExternaMaster_dtDatetimeCliente', DisplayName: 'Datetime Cliente', ColumnSpan: 3, Visible: true},{Name: 'UIExternaMaster_ntxDecimalCliente', DisplayName: 'Decimal Cliente', ColumnSpan: 6, Visible: true},{Name: 'UIExternaMaster_ntxIntCliente', DisplayName: 'Int Cliente', ColumnSpan: 5, Visible: true},{Name: 'UIExternaMaster_tbStringCliente', DisplayName: 'String Cliente', ColumnSpan: 9, Visible: true},{Name: 'UIExternaMaster_ntxBigIntCliente', DisplayName: 'Big Int Cliente', ColumnSpan: 8, Visible: true},{Name: 'UIExternaMaster_ckBitCliente', DisplayName: 'Bit Cliente', ColumnSpan: 5, Visible: true},{Name: 'UIExternaMaster_ntxSmallIntCliente', DisplayName: 'Small Int Cliente', ColumnSpan: 2, Visible: true},{Name: 'UIExternaMaster_lUpStringEstado', DisplayName: 'String Estado', ColumnSpan: 9, Visible: true},{Name: 'UIExternaMaster_lUpStringPais', DisplayName: 'String Pais', ColumnSpan: 9, Visible: true},]},{Name: 'UIExternaMaster_tcTabControl_37c985ebeb6b49489dd094efe09c6809', DisplayName: '', ColumnSpan: 12, Visible: true, Items: [{Name: 'UIExternaMaster_tiTabItem_c804b851b71743b9b51ffb99eb617c56', DisplayName: 'UIExternaPaiFilhaTab', ColumnSpan: 12, Visible: true, Items: [{Name: 'UIExternaMaster_euiExternalUI_f4f3a92367b04a5ca17aaebd7e6e9fd6', DisplayName: 'New Group', ColumnSpan: 12, Visible: true, },]},{Name: 'UIExternaMaster_tiTabItem_5e4d08f59b9b4f8fbc2d05fc29af9a33', DisplayName: 'UIExternaPaiFilhaBotão', ColumnSpan: 12, Visible: true, Items: [{Name: 'UIExternaMaster_btnCustomControl7886006', DisplayName: 'Botão Externa', ColumnSpan: 5, Visible: true},]},{Name: 'UIExternaMaster_tiTabItem_ae415a5a00f94c1db50db74965f6efcc', DisplayName: 'UIExternaLookUp', ColumnSpan: 12, Visible: true, Items: [{Name: 'UIExternaMaster_lUpIdEstado', DisplayName: 'Id Estado', ColumnSpan: 5, Visible: true},]},]},]},       ]};
    };
      ...
      if ((typeof settings === 'object') && (settings != null) && settings.objectQuery) {
          ...
          if ((typeof settings === 'object') && (settings != null) && settings.uiSettings) {
              ...
              if (uiSettings.executeQuery === true) {
                  ...
                  filteredEntities = [];
                  if (settings.parentVM) { settings.parentVM.internalUIs = [ 'UIExternaMaster' ]; settings.parentVM.UIExternaMaster = getVM; }
                  clear();
                  ...
                  if ((typeof settings.parentVM === 'object') && settings.parentVM != null) {
                      ...
                      parentVM.UIExternaMaster = getVM;
                      if (isLookup()) { 
                      ...
                      if ($.inArray('UIExternaMaster', parentVM.internalUIs) === -1) parentVM.internalUIs.push('UIExternaMaster');
                  }
              }
          }
          else {
    ...
    var adjustModuleSecurity = function () {
        ...
        managerAuth.getFormAccess('linx-demo-bv-spa-UIExternaMaster', function (data) {
    ...
    var canActivate = function() {
        ...
        if (data.lxShellCompiledVersion != managerAuth.shellVersion) {
            app.showMessage('Versão de formulário incompatível com a versão de ambiente [' + managerAuth.shellVersion + '].', 'Formulário: UIExternaMaster', ['Ok']);
            return false;
        }
        return true;
    };
    ...
    var compositionComplete = function() {
                   $('#UIExternaMaster_gbExpander_5283c47111bf401897d59eeec35afdb8').one('shown.bs.collapse', function (e) { vm.notifyInnerElements($(e.currentTarget), true); });

                   $('#UIExternaMaster_tcTabControl_37c985ebeb6b49489dd094efe09c6809').on('shown.bs.tab', function (e) { vm.notifyInnerElements($(e.target.hash)); });
                   initializeTabControl('#UIExternaMaster_tcTabControl_37c985ebeb6b49489dd094efe09c6809');

                   complement.renderscyUIExternaMaster_dGrid(vm);
    ...
    var visibleColumns = 'ComboboxCliente,IdPais,IdCliente,DatetimeCliente,DecimalCliente,IntCliente,StringCliente,BigIntCliente,BitCliente,SmallIntCliente,StringEstado,StringPais,IdEstado';
    ...
    var CustomControl7886006_Click = function () {
    
      var str = 'Linx.Demo.BV.SPA/BotãoTipoPagExterna'; while (str.indexOf('.') !== -1) { str = str.replace('.', '-'); };
      var currentModal = (modal.inUse ? modal2 : modal);
      currentModal.showModal('pkg_' + strExtract('#' + str.toLowerCase(), '#', '/') + '/viewmodels/' + strExtract(str + '#', '/', '#'), {  executeQuery: true, parentUI: {vm: vm}, querySetters: {}, toolbarSettings: 
{removeDataToolbar:false,canAddNew:true,canClear:true,canCustomSearch:true,canDelete:true,
canEdit:true,canLayout:true,canNavigate:true,canPrint:true,canSearch:true,noBusyLoading:false} }, 'UI Externa Botão', ['Ok'], 'large')
    ...
    var removeFormViewControl = function () {
        var front = $('#UIExternaMaster_formViewer_front')[0];
        if (front) front.removeClassName('front');
        var back = $('#UIExternaMaster_formViewer_back')[0];
    ...
    var changeFormView = function () {
        ...
        var panel = $('#UIExternaMaster_formViewer')[0];
           ...
           if (vm.status() !== 'C') {
               ...
               colunas.forEach(function (entry, index) {
                   if (entry.hidden && entry.key !== 'RowDataId') {
                       var control = $('#UIExternaMaster_div' + (!dataView ? '' : '' + dataView + '_') + entry.key + 'Template');
    ...
    var vm = {
            ...
            rootNamespace: 'Linx.Demo.BV.ModalExterna',
            ...
            CustomControl7886006_Click: CustomControl7886006_Click,
            ...
            __moduleId__: 'pkg_linx-demo-bv-spa/viewmodels/UIExternaMaster'
        };
