define(['durandal/app', 'pkg_linx-demo-bv-spa/services/PaiFilhaContext', 'plugins/router', 'plugins/widget', 'managers/__auth', 'viewmodels/shared/modal', 'viewmodels/shared/modal2', 'managers/brand', 'managers/predefinedFilters', 'services/logger', 'viewmodels/shared/modalMultimidia', 'common', 'pkg_linx-demo-bv-spa/viewmodels/UIPaiFilhaNetaComplement', 'viewmodels/shared/modalCustomSearch', 'managers/user'],
...
var vmConstructor = function () {
    ...
    var getLayoutColumnSpan = function(name) {
        var colSpan = 12;
        try{ colSpan = flattenLayout()[name].ColumnSpan; }
        catch (e) { colSpan = 12; }
        return 'col-lg-' + colSpan + ' col-md-' + colSpan ;
    };
    
    var getLayoutDisplayName = function(name) {
        try { return flattenLayout()[name].DisplayName; }
        catch (e) { return ''; }
    };
    
    var getLayoutVisible = function(name) {
        try { return flattenLayout()[name].Visible; }
        catch (e) { return false; }
    };
    
    var objectLayout = function () {
       return {Name: 'UIPaiFilhaNeta', Items: [
{Name: 'UIPaiFilhaNeta_gbCliente', DisplayName: 'Cliente', ColumnSpan: 12, Visible: true, Items: [{Name: 'UIPaiFilhaNeta_ntxBigIntCliente', DisplayName: 'Big Int Cliente', ColumnSpan: 8, Visible: true},{Name: 'UIPaiFilhaNeta_ckBitCliente', DisplayName: 'Bit Cliente', ColumnSpan: 5, Visible: true},{Name: 'UIPaiFilhaNeta_cmbComboboxCliente', DisplayName: 'Combobox Cliente', ColumnSpan: 6, Visible: true},{Name: 'UIPaiFilhaNeta_dtDatetimeCliente', DisplayName: 'Datetime Cliente', ColumnSpan: 3, Visible: true},{Name: 'UIPaiFilhaNeta_ntxDecimalCliente', DisplayName: 'Decimal Cliente', ColumnSpan: 5, Visible: true},{Name: 'UIPaiFilhaNeta_ntxIdCliente', DisplayName: 'Id Cliente', ColumnSpan: 5, Visible: true},{Name: 'UIPaiFilhaNeta_lUpIdEstado', DisplayName: 'Id Estado', ColumnSpan: 5, Visible: true},{Name: 'UIPaiFilhaNeta_ntxIntCliente', DisplayName: 'Int Cliente', ColumnSpan: 5, Visible: true},{Name: 'UIPaiFilhaNeta_ntxSmallIntCliente', DisplayName: 'Small Int Cliente', ColumnSpan: 2, Visible: true},{Name: 'UIPaiFilhaNeta_tbStringCliente', DisplayName: 'String Cliente', ColumnSpan: 9, Visible: true},{Name: 'UIPaiFilhaNeta_tbStringEstado', DisplayName: 'String Estado', ColumnSpan: 9, Visible: true},]},{Name: 'UIPaiFilhaNeta_tcClienteTabControl', DisplayName: 'Cliente', ColumnSpan: 12, Visible: true, Items: [{Name: 'UIPaiFilhaNeta_tiVendaTabItem', DisplayName: 'Venda', ColumnSpan: 12, Visible: true, Items: [{Name: 'UIPaiFilhaNeta_dGridVenda', DisplayName: 'DataGrid', ColumnSpan: 12, Visible: true, Items: [{Name: 'UIPaiFilhaNeta_ntxVenda_BigIntVenda', DisplayName: 'Big Int Venda', ColumnSpan: 8, Visible: true},{Name: 'UIPaiFilhaNeta_ckVenda_BitVenda', DisplayName: 'Bit Venda', ColumnSpan: 5, Visible: true},{Name: 'UIPaiFilhaNeta_cmbVenda_ComboboxVenda', DisplayName: 'Combobox Venda', ColumnSpan: 6, Visible: true},{Name: 'UIPaiFilhaNeta_dtVenda_DatetimeVenda', DisplayName: 'Datetime Venda', ColumnSpan: 3, Visible: true},{Name: 'UIPaiFilhaNeta_ntxVenda_DecimalVenda', DisplayName: 'Decimal Venda', ColumnSpan: 5, Visible: true},{Name: 'UIPaiFilhaNeta_ntxVenda_IdCliente', DisplayName: 'Id Cliente', ColumnSpan: 5, Visible: true},{Name: 'UIPaiFilhaNeta_lUpVenda_IdLoja', DisplayName: 'Id Loja', ColumnSpan: 5, Visible: true},{Name: 'UIPaiFilhaNeta_ntxVenda_IdVenda', DisplayName: 'Id Venda', ColumnSpan: 5, Visible: true},{Name: 'UIPaiFilhaNeta_ntxVenda_IntVenda', DisplayName: 'Int Venda', ColumnSpan: 5, Visible: true},{Name: 'UIPaiFilhaNeta_ntxVenda_SmallIntVenda', DisplayName: 'Small Int Venda', ColumnSpan: 2, Visible: true},{Name: 'UIPaiFilhaNeta_tbVenda_StringVenda', DisplayName: 'String Venda', ColumnSpan: 9, Visible: true},]},]},{Name: 'UIPaiFilhaNeta_tiVendaItemTabItem', DisplayName: 'VendaItem', ColumnSpan: 12, Visible: true, Items: [{Name: 'UIPaiFilhaNeta_dGridVendaItem', DisplayName: 'DataGrid', ColumnSpan: 12, Visible: true, Items: [{Name: 'UIPaiFilhaNeta_ntxVendaItem_BigIntVendaItem', DisplayName: 'Big Int Venda Item', ColumnSpan: 8, Visible: true},{Name: 'UIPaiFilhaNeta_ckVendaItem_BitVendaItem', DisplayName: 'Bit Venda Item', ColumnSpan: 5, Visible: true},{Name: 'UIPaiFilhaNeta_cmbVendaItem_ComboboxVendaItem', DisplayName: 'Combobox Venda Item', ColumnSpan: 6, Visible: true},{Name: 'UIPaiFilhaNeta_dtVendaItem_DatetimeVendaItem', DisplayName: 'Datetime Venda Item', ColumnSpan: 3, Visible: true},{Name: 'UIPaiFilhaNeta_ntxVendaItem_DecimalVendaItem', DisplayName: 'Decimal Venda Item', ColumnSpan: 5, Visible: true},{Name: 'UIPaiFilhaNeta_lUpVendaItem_IdVenda', DisplayName: 'Id Venda', ColumnSpan: 5, Visible: true},{Name: 'UIPaiFilhaNeta_ntxVendaItem_IdVendaItem', DisplayName: 'Id Venda Item', ColumnSpan: 5, Visible: true},{Name: 'UIPaiFilhaNeta_ntxVendaItem_IntVendaItem', DisplayName: 'Int Venda Item', ColumnSpan: 5, Visible: true},{Name: 'UIPaiFilhaNeta_ntxVendaItem_SmallIntVendaItem', DisplayName: 'Small Int Venda Item', ColumnSpan: 2, Visible: true},{Name: 'UIPaiFilhaNeta_tbVendaItem_StringVendaItem', DisplayName: 'String Venda Item', ColumnSpan: 9, Visible: true},]},]},{Name: 'UIPaiFilhaNeta_tiVendaAtacadoTabItem', DisplayName: 'VendaAtacado', ColumnSpan: 12, Visible: true, Items: [{Name: 'UIPaiFilhaNeta_dGridVendaAtacado', DisplayName: 'DataGrid', ColumnSpan: 12, Visible: true, Items: [{Name: 'UIPaiFilhaNeta_lUpVendaAtacado_IdCliente', DisplayName: 'Id Cliente', ColumnSpan: 5, Visible: true},{Name: 'UIPaiFilhaNeta_ntxVendaAtacado_IdVendaAtacado', DisplayName: 'Id Venda Atacado', ColumnSpan: 5, Visible: true},{Name: 'UIPaiFilhaNeta_ntxVendaAtacado_BigIntVendaAtacado', DisplayName: 'Big Int Venda Atacado', ColumnSpan: 8, Visible: true},{Name: 'UIPaiFilhaNeta_ckVendaAtacado_BitVendaAtacado', DisplayName: 'Bit Venda Atacado', ColumnSpan: 6, Visible: true},{Name: 'UIPaiFilhaNeta_cmbVendaAtacado_ComboboxVendaAtacado', DisplayName: 'Combobox Venda Atacado', ColumnSpan: 6, Visible: true},{Name: 'UIPaiFilhaNeta_dtVendaAtacado_DatetimeVendaAtacado', DisplayName: 'Datetime Venda Atacado', ColumnSpan: 3, Visible: true},{Name: 'UIPaiFilhaNeta_ntxVendaAtacado_DecimalVendaAtacado', DisplayName: 'Decimal Venda Atacado', ColumnSpan: 5, Visible: true},{Name: 'UIPaiFilhaNeta_ntxVendaAtacado_IntVendaAtacado', DisplayName: 'Int Venda Atacado', ColumnSpan: 5, Visible: true},{Name: 'UIPaiFilhaNeta_ntxVendaAtacado_SmallIntVendaAtacado', DisplayName: 'Small Int Venda Atacado', ColumnSpan: 2, Visible: true},{Name: 'UIPaiFilhaNeta_tbVendaAtacado_StringVendaAtacado', DisplayName: 'String Venda Atacado', ColumnSpan: 9, Visible: true},]},]},]},       ]};
    };
      ...
      if ((typeof settings === 'object') && (settings != null) && settings.objectQuery) {
          ...
          if ((typeof settings === 'object') && (settings != null) && settings.uiSettings) {
              ...
              if (uiSettings.executeQuery === true) {
                  ...
                  filteredEntities = [];
                  if (settings.parentVM) { settings.parentVM.internalUIs = [ 'UIPaiFilhaNeta' ]; settings.parentVM.UIPaiFilhaNeta = getVM; }
                  clear();
                  ...
                  if ((typeof settings.parentVM === 'object') && settings.parentVM != null) {
                      ...
                      if ($.inArray('UIPaiFilhaNeta', parentVM.internalUIs) === -1) parentVM.internalUIs.push('UIPaiFilhaNeta');
                  }
              }
          }
          else {
    ...
    var adjustModuleSecurity = function () {
        ...
        managerAuth.getFormAccess('linx-demo-bv-spa-UIPaiFilhaNeta', function (data) {
    ...
    var canActivate = function() {
        ...
        if (data.lxShellCompiledVersion != managerAuth.shellVersion) {
            app.showMessage('Versão de formulário incompatível com a versão de ambiente [' + managerAuth.shellVersion + '].', 'Formulário: UIPaiFilhaNeta', ['Ok']);
            return false;
        }
        return true;
    };
    ...
    var compositionComplete = function() {
                   $('#UIPaiFilhaNeta_gbCliente').one('shown.bs.collapse', function (e) { vm.notifyInnerElements($(e.currentTarget), true); });

               $('#UIPaiFilhaNeta_tcClienteTabControl').on('shown.bs.tab', function (e) { vm.notifyInnerElements($(e.target.hash)); });
               initializeTabControl('#UIPaiFilhaNeta_tcClienteTabControl');

                           complement.renderUIPaiFilhaNeta_dGridVenda(vm);

                           complement.renderUIPaiFilhaNeta_dGridVendaItem(vm);

                           complement.renderUIPaiFilhaNeta_dGridVendaAtacado(vm);

                   complement.renderscyUIPaiFilhaNeta_dGrid(vm);
        ...
        vm.currentBrands.subscribe(function(newValue) {
            ...
            var reset = (!newValue || searchedBrands.cod === ''), decimals = searchedBrands.decimals;
                           complement.ChangedBrandUIPaiFilhaNeta_dGridVenda(vm, decimals, reset);
                       complement.ChangedBrandUIPaiFilhaNeta_dGridVendaItem(vm, decimals, reset);

                       complement.ChangedBrandUIPaiFilhaNeta_dGridVendaAtacado(vm, decimals, reset);
    ...
    var getMaxLength = function(entityName, propertyName){
        if (isNullOrEmpty(entityName)) entityName = 'Cliente';
    ...
    var visibleColumns = 'BigIntCliente,BitCliente,ComboboxCliente,DatetimeCliente,DecimalCliente,IdCliente,IdEstado,IntCliente,SmallIntCliente,StringCliente,StringEstado';
    ...
    var exportData = function (forceAdd, isExcelDataSource) {
        if (forceAdd)
            require(['viewmodels/shared/addCustomExport'],
                function(addCustomExport){ addCustomExport.showModal(vm, null, 'Cliente', getVisiblePropertiesForExcel('dataView'), null, true, isExcelDataSource); } );
        else
            require(['viewmodels/shared/customExport'],
                function(modalExport){ modalExport.showModal(vm, 'Cliente', getVisiblePropertiesForExcel('dataView'), null, { canAdd: true, canEdit: true, canDel: true }, isExcelDataSource); } );
    };
    ...
    var query = function (lookupInitializing, parentEntity, quickSearchJExpression, externalQueryCallBack, noMessages, noDetails) {
        ...
        if (freeEntityForQuerying == null && isChildVM()) freeEntityForQuerying = dataContext.createFreeEntity('Cliente');
        ...
        return dataContext.getClienteByEntitySearchNoAssociations(lastJEntitySearch, 0, pageSize(), (pageSize() > 0), preserveDataCurrentState(), true, sortInfo).then(querySucceeded).fin(complete);
        ...
        function querySucceeded(data) {
            for (var idx = 0; idx < data.results.length; idx++) { dataContext.initializePOCO(data.results[idx], 'Cliente'); }
            hasError = false;
    ...
    var refresh = function (curPage, goLast) {
        ...
        return dataContext.getClienteByEntitySearchNoAssociations(lastJEntitySearch, curPage * pageSize(), pageSize(), false, false, status() !== 'E', sortInfo).then(querySucceeded).fin(complete);
        ...
        function querySucceeded(data) {
            if (vm.status() !== 'E') { for (var idx = 0; idx < data.results.length; idx++) { dataContext.initializePOCO(data.results[idx], 'Cliente'); } }
            dataView(data.results);
            currentPage(curPage);
        ...
        function saveSucceeded(saveResult) {
            ...
            for (var idxElem = toList.length - 1; idxElem >= 0; idxElem--) {
                    if (toList[idxElem].ChangeState !== 'N') {
                               var fromObj = _.where(fromList, { IdCliente: toList[idxElem]['IdCliente'] });
    ...
    var createVenda = function(parent, noCurrent) {
        ...
        var entity = dataContext.createVenda(parent, noCurrent);
        if(!entity) return null;
        entity.setBandeiraRede(getBandeiraRede());
        entity.setGpecon(getGpecon());
       if ((noCurrent !== true) && !isNullOrEmpty(parent)) { parent.currentVenda(entity); entity.fillDetails(); } 
        return entity;
    };
    ...
    var createVendaItem = function(parent, noCurrent) {
        ...
        var entity = dataContext.createVendaItem(parent, noCurrent);
        if(!entity) return null;
        entity.setBandeiraRede(getBandeiraRede());
        entity.setGpecon(getGpecon());
       if ((noCurrent !== true) && !isNullOrEmpty(parent)) { parent.currentVendaItem(entity); entity.fillDetails(); } 
        return entity;
    };
    ...
    var createVendaAtacado = function(parent, noCurrent) {
        ...
        var entity = dataContext.createVendaAtacado(parent, noCurrent);
        if(!entity) return null;
        entity.setBandeiraRede(getBandeiraRede());
        entity.setGpecon(getGpecon());
       if ((noCurrent !== true) && !isNullOrEmpty(parent)) { parent.currentVendaAtacado(entity); entity.fillDetails(); } 
        return entity;
    };
    ...
    var removeFormViewControl = function () {
        var front = $('#UIPaiFilhaNeta_formViewer_front')[0];
        if (front) front.removeClassName('front');
        var back = $('#UIPaiFilhaNeta_formViewer_back')[0];
    ...
    var changeFormView = function () {
        ...
        var panel = $('#UIPaiFilhaNeta_formViewer')[0];
    ...
    var entitySearchRange = {
        predefinedFilters: ko.observableArray(managerPredefined.predefinedFilters),
            ClienteDatetimeCliente_typeRange: ko.observable('R'), ClienteDatetimeCliente_begin: ko.observable(null), ClienteDatetimeCliente_end: ko.observable(null), ClienteDatetimeCliente_predefFilter: ko.observableArray([]), ClienteDatetimeCliente_predefValue: ko.observable(null),
        ...
        VendaItemDatetimeVendaItem_typeRange: ko.observable('R'), VendaItemDatetimeVendaItem_begin: ko.observable(null), VendaItemDatetimeVendaItem_end: ko.observable(null), VendaItemDatetimeVendaItem_predefFilter: ko.observableArray([]), VendaItemDatetimeVendaItem_predefValue: ko.observable(null),
        VendaAtacadoDatetimeVendaAtacado_typeRange: ko.observable('R'), VendaAtacadoDatetimeVendaAtacado_begin: ko.observable(null), VendaAtacadoDatetimeVendaAtacado_end: ko.observable(null), VendaAtacadoDatetimeVendaAtacado_predefFilter: ko.observableArray([]), VendaAtacadoDatetimeVendaAtacado_predefValue: ko.observable(null),
        ClienteBigIntCliente_begin: ko.observable(null), ClienteBigIntCliente_end: ko.observable(null),
        ClienteDecimalCliente_begin: ko.observable(null), ClienteDecimalCliente_end: ko.observable(null),
        ClienteIdCliente_begin: ko.observable(null), ClienteIdCliente_end: ko.observable(null),
        ClienteIntCliente_begin: ko.observable(null), ClienteIntCliente_end: ko.observable(null),
        ClienteSmallIntCliente_begin: ko.observable(null), ClienteSmallIntCliente_end: ko.observable(null),
        ...
        VendaIdCliente_begin: ko.observable(null), VendaIdCliente_end: ko.observable(null),
        ...
        VendaItemBigIntVendaItem_begin: ko.observable(null), VendaItemBigIntVendaItem_end: ko.observable(null),
        VendaItemDecimalVendaItem_begin: ko.observable(null), VendaItemDecimalVendaItem_end: ko.observable(null),
        VendaItemIdVendaItem_begin: ko.observable(null), VendaItemIdVendaItem_end: ko.observable(null),
        VendaItemIntVendaItem_begin: ko.observable(null), VendaItemIntVendaItem_end: ko.observable(null),
        VendaItemSmallIntVendaItem_begin: ko.observable(null), VendaItemSmallIntVendaItem_end: ko.observable(null),
        VendaAtacadoBigIntVendaAtacado_begin: ko.observable(null), VendaAtacadoBigIntVendaAtacado_end: ko.observable(null),
        VendaAtacadoDecimalVendaAtacado_begin: ko.observable(null), VendaAtacadoDecimalVendaAtacado_end: ko.observable(null),
        VendaAtacadoIdVendaAtacado_begin: ko.observable(null), VendaAtacadoIdVendaAtacado_end: ko.observable(null),
        VendaAtacadoIntVendaAtacado_begin: ko.observable(null), VendaAtacadoIntVendaAtacado_end: ko.observable(null),
        VendaAtacadoSmallIntVendaAtacado_begin: ko.observable(null), VendaAtacadoSmallIntVendaAtacado_end: ko.observable(null),
        ClienteIdEstado: ko.observable(null),
        VendaIdLoja: ko.observable(null),
        VendaItemIdVenda: ko.observable(null),
        VendaAtacadoIdCliente: ko.observable(null)
    };
    entitySearchRange.clear = function(){
            entitySearchRange.ClienteDatetimeCliente_typeRange('R'); entitySearchRange.ClienteDatetimeCliente_begin(null); entitySearchRange.ClienteDatetimeCliente_end(null); entitySearchRange.ClienteDatetimeCliente_predefFilter([]); entitySearchRange.ClienteDatetimeCliente_predefValue(null);
        ...
        entitySearchRange.VendaItemDatetimeVendaItem_typeRange('R'); entitySearchRange.VendaItemDatetimeVendaItem_begin(null); entitySearchRange.VendaItemDatetimeVendaItem_end(null); entitySearchRange.VendaItemDatetimeVendaItem_predefFilter([]); entitySearchRange.VendaItemDatetimeVendaItem_predefValue(null);
        entitySearchRange.VendaAtacadoDatetimeVendaAtacado_typeRange('R'); entitySearchRange.VendaAtacadoDatetimeVendaAtacado_begin(null); entitySearchRange.VendaAtacadoDatetimeVendaAtacado_end(null); entitySearchRange.VendaAtacadoDatetimeVendaAtacado_predefFilter([]); entitySearchRange.VendaAtacadoDatetimeVendaAtacado_predefValue(null);
        ...
        entitySearchRange.VendaItemIdVenda(null);
        entitySearchRange.VendaAtacadoIdCliente(null);
    };
    entitySearchRange.has_ClienteBigIntCliente = ko.computed(function(){ return (entitySearchRange.ClienteBigIntCliente_begin() != null || entitySearchRange.ClienteBigIntCliente_end() != null); });
    entitySearchRange.has_ClienteDecimalCliente = ko.computed(function(){ return (entitySearchRange.ClienteDecimalCliente_begin() != null || entitySearchRange.ClienteDecimalCliente_end() != null); });
    entitySearchRange.has_ClienteIdCliente = ko.computed(function(){ return (entitySearchRange.ClienteIdCliente_begin() != null || entitySearchRange.ClienteIdCliente_end() != null); });
    entitySearchRange.has_ClienteIntCliente = ko.computed(function(){ return (entitySearchRange.ClienteIntCliente_begin() != null || entitySearchRange.ClienteIntCliente_end() != null); });
    entitySearchRange.has_ClienteSmallIntCliente = ko.computed(function(){ return (entitySearchRange.ClienteSmallIntCliente_begin() != null || entitySearchRange.ClienteSmallIntCliente_end() != null); });
    ...
    entitySearchRange.has_VendaIdCliente = ko.computed(function(){ return (entitySearchRange.VendaIdCliente_begin() != null || entitySearchRange.VendaIdCliente_end() != null); });
    ...
    entitySearchRange.has_VendaItemBigIntVendaItem = ko.computed(function(){ return (entitySearchRange.VendaItemBigIntVendaItem_begin() != null || entitySearchRange.VendaItemBigIntVendaItem_end() != null); });
    entitySearchRange.has_VendaItemDecimalVendaItem = ko.computed(function(){ return (entitySearchRange.VendaItemDecimalVendaItem_begin() != null || entitySearchRange.VendaItemDecimalVendaItem_end() != null); });
    entitySearchRange.has_VendaItemIdVendaItem = ko.computed(function(){ return (entitySearchRange.VendaItemIdVendaItem_begin() != null || entitySearchRange.VendaItemIdVendaItem_end() != null); });
    entitySearchRange.has_VendaItemIntVendaItem = ko.computed(function(){ return (entitySearchRange.VendaItemIntVendaItem_begin() != null || entitySearchRange.VendaItemIntVendaItem_end() != null); });
    entitySearchRange.has_VendaItemSmallIntVendaItem = ko.computed(function(){ return (entitySearchRange.VendaItemSmallIntVendaItem_begin() != null || entitySearchRange.VendaItemSmallIntVendaItem_end() != null); });
    entitySearchRange.has_VendaAtacadoBigIntVendaAtacado = ko.computed(function(){ return (entitySearchRange.VendaAtacadoBigIntVendaAtacado_begin() != null || entitySearchRange.VendaAtacadoBigIntVendaAtacado_end() != null); });
    entitySearchRange.has_VendaAtacadoDecimalVendaAtacado = ko.computed(function(){ return (entitySearchRange.VendaAtacadoDecimalVendaAtacado_begin() != null || entitySearchRange.VendaAtacadoDecimalVendaAtacado_end() != null); });
    entitySearchRange.has_VendaAtacadoIdVendaAtacado = ko.computed(function(){ return (entitySearchRange.VendaAtacadoIdVendaAtacado_begin() != null || entitySearchRange.VendaAtacadoIdVendaAtacado_end() != null); });
    entitySearchRange.has_VendaAtacadoIntVendaAtacado = ko.computed(function(){ return (entitySearchRange.VendaAtacadoIntVendaAtacado_begin() != null || entitySearchRange.VendaAtacadoIntVendaAtacado_end() != null); });
    entitySearchRange.has_VendaAtacadoSmallIntVendaAtacado = ko.computed(function(){ return (entitySearchRange.VendaAtacadoSmallIntVendaAtacado_begin() != null || entitySearchRange.VendaAtacadoSmallIntVendaAtacado_end() != null); });
    entitySearchRange.has_ClienteDatetimeCliente = ko.computed(function(){ return (entitySearchRange.ClienteDatetimeCliente_typeRange() == 'R' && (entitySearchRange.ClienteDatetimeCliente_begin() != null || entitySearchRange.ClienteDatetimeCliente_end() != null) || (entitySearchRange.ClienteDatetimeCliente_typeRange() == 'P' && entitySearchRange.ClienteDatetimeCliente_predefFilter().length > 0)); });
    ...
    entitySearchRange.has_VendaItemDatetimeVendaItem = ko.computed(function(){ return (entitySearchRange.VendaItemDatetimeVendaItem_typeRange() == 'R' && (entitySearchRange.VendaItemDatetimeVendaItem_begin() != null || entitySearchRange.VendaItemDatetimeVendaItem_end() != null) || (entitySearchRange.VendaItemDatetimeVendaItem_typeRange() == 'P' && entitySearchRange.VendaItemDatetimeVendaItem_predefFilter().length > 0)); });
    entitySearchRange.has_VendaAtacadoDatetimeVendaAtacado = ko.computed(function(){ return (entitySearchRange.VendaAtacadoDatetimeVendaAtacado_typeRange() == 'R' && (entitySearchRange.VendaAtacadoDatetimeVendaAtacado_begin() != null || entitySearchRange.VendaAtacadoDatetimeVendaAtacado_end() != null) || (entitySearchRange.VendaAtacadoDatetimeVendaAtacado_typeRange() == 'P' && entitySearchRange.VendaAtacadoDatetimeVendaAtacado_predefFilter().length > 0)); });
           ...
           if (vm.status() !== 'C') {
               ...
               colunas.forEach(function (entry, index) {
                   if (entry.hidden && entry.key !== 'RowDataId') {
                       var control = $('#UIPaiFilhaNeta_div' + (!dataView ? '' : '' + dataView + '_') + entry.key + 'Template');
    ...
    var vm = {
            ...
            __moduleId__: 'pkg_linx-demo-bv-spa/viewmodels/UIPaiFilhaNeta'
        };
