...
var vmConstructor = function () {
    ...
    var objectLayout = function () {
       return {Name: 'UIExternaTab', Items: [
{Name: 'UIExternaTab_gbVenda', DisplayName: 'Venda', ColumnSpan: 12, Visible: true, Items: [{Name: 'UIExternaTab_ntxBigIntVenda', DisplayName: 'Big Int Venda', ColumnSpan: 8, Visible: true},{Name: 'UIExternaTab_cmbComboboxVenda', DisplayName: 'Combobox Venda', ColumnSpan: 6, Visible: true},{Name: 'UIExternaTab_ckBitVenda', DisplayName: 'Bit Venda', ColumnSpan: 5, Visible: true},{Name: 'UIExternaTab_ntxIdVenda', DisplayName: 'Id Venda', ColumnSpan: 5, Visible: true},{Name: 'UIExternaTab_lUpIdCliente', DisplayName: 'Id Cliente', ColumnSpan: 5, Visible: true},{Name: 'UIExternaTab_dtDatetimeVenda', DisplayName: 'Datetime Venda', ColumnSpan: 3, Visible: true},{Name: 'UIExternaTab_ntxDecimalVenda', DisplayName: 'Decimal Venda', ColumnSpan: 6, Visible: true},{Name: 'UIExternaTab_lUpIdLoja', DisplayName: 'Id Loja', ColumnSpan: 5, Visible: true},{Name: 'UIExternaTab_ntxIntVenda', DisplayName: 'Int Venda', ColumnSpan: 5, Visible: true},{Name: 'UIExternaTab_ntxSmallIntVenda', DisplayName: 'Small Int Venda', ColumnSpan: 2, Visible: true},{Name: 'UIExternaTab_tbStringLoja', DisplayName: 'String Loja', ColumnSpan: 9, Visible: true},{Name: 'UIExternaTab_tbStringVenda', DisplayName: 'String Venda', ColumnSpan: 9, Visible: true},]},{Name: 'UIExternaTab_tcVendaTabControl', DisplayName: 'Venda', ColumnSpan: 12, Visible: true, Items: [{Name: 'UIExternaTab_tiVendaItemTabItem', DisplayName: 'VendaItem', ColumnSpan: 12, Visible: true, Items: [{Name: 'UIExternaTab_dGridVendaItem', DisplayName: 'DataGrid', ColumnSpan: 12, Visible: true, Items: [{Name: 'UIExternaTab_ntxVendaItem_BigIntVendaItem', DisplayName: 'Big Int Venda Item', ColumnSpan: 8, Visible: true},{Name: 'UIExternaTab_cmbVendaItem_ComboboxVendaItem', DisplayName: 'Combobox Venda Item', ColumnSpan: 6, Visible: true},{Name: 'UIExternaTab_ckVendaItem_BitVendaItem', DisplayName: 'Bit Venda Item', ColumnSpan: 5, Visible: true},{Name: 'UIExternaTab_ntxVendaItem_IdVenda', DisplayName: 'Id Venda', ColumnSpan: 5, Visible: true},{Name: 'UIExternaTab_ntxVendaItem_IdVendaItem', DisplayName: 'Id Venda Item', ColumnSpan: 5, Visible: true},{Name: 'UIExternaTab_dtVendaItem_DatetimeVendaItem', DisplayName: 'Datetime Venda Item', ColumnSpan: 3, Visible: true},{Name: 'UIExternaTab_ntxVendaItem_DecimalVendaItem', DisplayName: 'Decimal Venda Item', ColumnSpan: 5, Visible: true},{Name: 'UIExternaTab_lUpVendaItem_IdCliente', DisplayName: 'Id Cliente', ColumnSpan: 5, Visible: true},{Name: 'UIExternaTab_ntxVendaItem_IntVendaItem', DisplayName: 'Int Venda Item', ColumnSpan: 5, Visible: true},{Name: 'UIExternaTab_ntxVendaItem_IntVenda', DisplayName: 'Int Venda', ColumnSpan: 5, Visible: true},{Name: 'UIExternaTab_ntxVendaItem_SmallIntVendaItem', DisplayName: 'Small Int Venda Item', ColumnSpan: 2, Visible: true},{Name: 'UIExternaTab_tbVendaItem_StringVendaItem', DisplayName: 'String Venda Item', ColumnSpan: 9, Visible: true},]},]},]},       ]};
    };
    ...
    var adjustModuleSecurity = function () {
        ...
        managerAuth.getFormAccess('linx-demo-bv-spa-UIExternaTab', function (data) {
    ...
    var compositionComplete = function() {
               ...
               $('#UIExternaTab_tcVendaTabControl').on('shown.bs.tab', function (e) { vm.notifyInnerElements($(e.target.hash)); });
               initializeTabControl('#UIExternaTab_tcVendaTabControl');

                           complement.renderUIExternaTab_dGridVendaItem(vm);
        ...
        vm.currentBrands.subscribe(function(newValue) {
            ...
            var reset = (!newValue || searchedBrands.cod === ''), decimals = searchedBrands.decimals;
                           complement.ChangedBrandUIExternaTab_dGridVendaItem(vm, decimals, reset);
    ...
    var visibleColumns = 'BigIntVenda,ComboboxVenda,BitVenda,IdVenda,IdCliente,DatetimeVenda,DecimalVenda,IdLoja,IntVenda,SmallIntVenda,StringLoja,StringVenda';
    ...
    var query = function (lookupInitializing, parentEntity, quickSearchJExpression, externalQueryCallBack, noMessages, noDetails) {
        ...
        return dataContext.getVendaByEntitySearchNoAssociations(lastJEntitySearch, 0, pageSize(), (pageSize() > 0), preserveDataCurrentState(), true, sortInfo).then(querySucceeded).fin(complete);
        ...
        function querySucceeded(data) {
            for (var idx = 0; idx < data.results.length; idx++) { dataContext.initializePOCO(data.results[idx], 'Venda'); }
            hasError = false;
    ...
    var entitySearchRange = {
        ...
        VendaItemIntVenda_begin: ko.observable(null), VendaItemIntVenda_end: ko.observable(null),
        ...
        VendaItemIdCliente: ko.observable(null)
    };
    entitySearchRange.clear = function(){
        ...
        entitySearchRange.VendaItemIntVenda_begin(null); entitySearchRange.VendaItemIntVenda_end(null);
        ...
        entitySearchRange.VendaItemIdCliente(null);
    };
    ...
    entitySearchRange.has_VendaItemIntVenda = ko.computed(function(){ return (entitySearchRange.VendaItemIntVenda_begin() != null || entitySearchRange.VendaItemIntVenda_end() != null); });
    ...
    var vm = {
            ...
            __moduleId__: 'pkg_linx-demo-bv-spa/viewmodels/UIExternaTab'
        };
