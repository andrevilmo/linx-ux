...
var complementCtor = function() {
    var complement = {
    isAutomatic: true
                           , ChangedBrandUIPaiFilhaNeta_dGridVenda: function(vm, decimals, reset) {
                           var i, format = '0.'.concat('0'.repeat(decimals)), grd =$('#UIPaiFilhaNeta_dGridVenda').data('igGrid'),
                               grdUpd = $('#UIPaiFilhaNeta_dGridVenda').data('igGridUpdating');
                               ...
                               grid.igGrid({ height: (getGridHeightSuggested() * 0.75), width: '100%',
                                   ...
                                   features: [
                                               ...
                                               filterDialogOpening: function (evt, ui) {
                                                   ...
                                                   var dataView = $('#UIPaiFilhaNeta_dGridVenda').data('igGrid').dataSource;
                                                   ...
                                                   scriptHtml += '    var newGrid = $("#UIPaiFilhaNeta_dGridVenda");';
                                                   ...
                                                   scriptHtml += '            $("#UIPaiFilhaNeta_dGridVenda_container_dialog_list").html(newList)';
                                                   scriptHtml += '         }});';
                                   ...
                                   selectionrowselectionchanged = function (evt, ui) {
                                       if ((ui.owner.grid.selectedRow() && typeof ui.owner.grid.selectedRow().id !== 'undefined') || (ui.owner.grid.selectedRows() && ui.owner.grid.selectedRows().length > 0)) { 
                                           if (isNullOrEmpty(ui.owner.selectedRows())|| ui.selectedRows.length <= 1) {
                                               $(document).undelegate('#UIPaiFilhaNeta_dGridVenda', 'iggridselectionrowselectionchanged', selectionrowselectionchanged);
                                   ...
                                   $(document).delegate('#UIPaiFilhaNeta_dGridVenda', 'iggridselectionrowselectionchanged', selectionrowselectionchanged);
                                   $('#UIPaiFilhaNeta_dGridVenda > tbody tr').live('focus', function(evt) {
                                       var grid = $('#UIPaiFilhaNeta_dGridVenda'), row = $(this).closest('tr'), id = parseInt(row.attr('data-id'), 10);
                       ...
                       , ChangedBrandUIPaiFilhaNeta_dGridVendaItem: function(vm, decimals, reset) {
                           var i, format = '0.'.concat('0'.repeat(decimals)), grd =$('#UIPaiFilhaNeta_dGridVendaItem').data('igGrid'),
                               grdUpd = $('#UIPaiFilhaNeta_dGridVendaItem').data('igGridUpdating');
                           if(isNull(grd) || isNull(grdUpd)) return;
                           for (i = 0; i < grd.options.columns.length; i++) {
                           }
                           for (i = 0; i < grdUpd.options.columnSettings.length; i++) {
                           ...
                           function createDataGrid(grid) {
                               ...
                               grid.igGrid({ height: (getGridHeightSuggested() * 0.75), width: '100%',
                                   ...
                                   columns: [
                                       ...
                                       { key: 'IdVenda', headerText: 'Id Venda', width: '151px', dataType: 'string', columnCssClass: 'ellipsis', format: '', hidden: false, unbound: false, group: null   },
                                   ...
                                   features: [
                                               ...
                                               filterDialogOpening: function (evt, ui) {
                                                   ...
                                                   var dataView = $('#UIPaiFilhaNeta_dGridVendaItem').data('igGrid').dataSource;
                                                   if (dataView.settings.filtering.expressions.length <= 0)
                                                       dataView._filteredData = [];
                                                   ...
                                                   scriptHtml += '  <script>';
                                                   scriptHtml += '    var newCol = "' + col + '";';
                                                   scriptHtml += '    var newGrid = $("#UIPaiFilhaNeta_dGridVendaItem");';
                                                   scriptHtml += '    var listFilter = [];'
                                                   scriptHtml += '    var reloadList = ' + reloadList + ';';
                                                   scriptHtml += '    function hideColumn(){';
                                                   scriptHtml += '     if ($("#showHideColumn")["0"].innerHTML.indexOf("Ocultar") >= 0) {';
                                                   ...
                                                   scriptHtml += '            newCol = ui.items["0"].data.key;';
                                                   scriptHtml += '            var newList = reloadList(newCol);';
                                                   scriptHtml += '            $("#UIPaiFilhaNeta_dGridVendaItem_container_dialog_list").html(newList)';
                                                   scriptHtml += '         }});';
                                                   scriptHtml += '         $("#comboFields").igCombo("value", newCol);';
                                                   scriptHtml += '      </script>';
                                                   scriptHtml += '  </div>';
                       ...
                       , ChangedBrandUIPaiFilhaNeta_dGridVendaAtacado: function(vm, decimals, reset) {
                           var i, format = '0.'.concat('0'.repeat(decimals)), grd =$('#UIPaiFilhaNeta_dGridVendaAtacado').data('igGrid'),
                               grdUpd = $('#UIPaiFilhaNeta_dGridVendaAtacado').data('igGridUpdating');
                           if(isNull(grd) || isNull(grdUpd)) return;
                           for (i = 0; i < grd.options.columns.length; i++) {
                           }
                           for (i = 0; i < grdUpd.options.columnSettings.length; i++) {
                               ...
                               grid.igGrid({ height: (getGridHeightSuggested() * 0.75), width: '100%',
                                   ...
                                   features: [
                                               ...
                                               filterDialogOpening: function (evt, ui) {
                                                   ...
                                                   var dataView = $('#UIPaiFilhaNeta_dGridVendaAtacado').data('igGrid').dataSource;
                                                   if (dataView.settings.filtering.expressions.length <= 0)
                                                       dataView._filteredData = [];
                                                   ...
                                                   scriptHtml += '  <script>';
                                                   scriptHtml += '    var newCol = "' + col + '";';
                                                   scriptHtml += '    var newGrid = $("#UIPaiFilhaNeta_dGridVendaAtacado");';
                                                   scriptHtml += '    var listFilter = [];'
                                                   scriptHtml += '    var reloadList = ' + reloadList + ';';
                                                   scriptHtml += '    function hideColumn(){';
                                                   scriptHtml += '     if ($("#showHideColumn")["0"].innerHTML.indexOf("Ocultar") >= 0) {';
                                                   ...
                                                   scriptHtml += '            newCol = ui.items["0"].data.key;';
                                                   scriptHtml += '            var newList = reloadList(newCol);';
                                                   scriptHtml += '            $("#UIPaiFilhaNeta_dGridVendaAtacado_container_dialog_list").html(newList)';
                                                   scriptHtml += '         }});';
                                                   scriptHtml += '         $("#comboFields").igCombo("value", newCol);';
                                                   scriptHtml += '      </script>';
                                                   scriptHtml += '  </div>';
                                               ...
                                               { name: 'Selection', mode: 'row'},
                                               { name: 'Tooltips', columnSettings:[{ columnKey: "IdCliente", allowTooltips: false },{ columnKey: "IdVendaAtacado", allowTooltips: true },{ columnKey: "BigIntVendaAtacado", allowTooltips: true },{ columnKey: "BitVendaAtacado", allowTooltips: true },{ columnKey: "ComboboxVendaAtacado", allowTooltips: true },{ columnKey: "DatetimeVendaAtacado", allowTooltips: true },{ columnKey: "DecimalVendaAtacado", allowTooltips: true },{ columnKey: "IntVendaAtacado", allowTooltips: true },{ columnKey: "SmallIntVendaAtacado", allowTooltips: true },{ columnKey: "StringVendaAtacado", allowTooltips: true }] },
                                               { name: 'Resizing' }, 
                                               { name: 'Hiding', 
                                               },
                                               { name: 'MultiColumnHeaders' }
