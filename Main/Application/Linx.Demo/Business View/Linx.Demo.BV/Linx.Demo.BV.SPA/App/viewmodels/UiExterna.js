define(['durandal/app', 'pkg_linx-demo-bv-spa/services/UIExternaContext', 'plugins/router', 'plugins/widget', 'managers/__auth', 'viewmodels/shared/modal', 'viewmodels/shared/modal2', 'managers/brand', 'managers/predefinedFilters', 'services/logger', 'viewmodels/shared/modalMultimidia', 'common', 'pkg_linx-demo-bv-spa/viewmodels/UiExternaComplement', 'viewmodels/shared/modalCustomSearch', 'managers/user'],
...
var vmConstructor = function () {
    ...
    var objectLayout = function () {
       return {Name: 'UiExterna', Items: [
{Name: 'UiExterna_gbCliente', DisplayName: 'Cliente', ColumnSpan: 12, Visible: true, Items: [{Name: 'UiExterna_ntxBigIntCliente', DisplayName: 'Big Int Cliente', ColumnSpan: 8, Visible: true},{Name: 'UiExterna_ckBitCliente', DisplayName: 'Bit Cliente', ColumnSpan: 5, Visible: true},{Name: 'UiExterna_cmbComboboxCliente', DisplayName: 'Combobox Cliente', ColumnSpan: 1, Visible: true},{Name: 'UiExterna_dtDatetimeCliente', DisplayName: 'Datetime Cliente', ColumnSpan: 3, Visible: true},{Name: 'UiExterna_ntxDecimalCliente', DisplayName: 'Decimal Cliente', ColumnSpan: 5, Visible: true},{Name: 'UiExterna_ntxIdCliente', DisplayName: 'Id Cliente', ColumnSpan: 5, Visible: true},{Name: 'UiExterna_lUpIdEstado', DisplayName: 'Id Estado', ColumnSpan: 5, Visible: true},{Name: 'UiExterna_ntxIntCliente', DisplayName: 'Int Cliente', ColumnSpan: 5, Visible: true},{Name: 'UiExterna_ntxSmallIntCliente', DisplayName: 'Small Int Cliente', ColumnSpan: 2, Visible: true},{Name: 'UiExterna_tbStringCliente', DisplayName: 'String Cliente', ColumnSpan: 9, Visible: true},]},       ]};
    };
      ...
      if ((typeof settings === 'object') && (settings != null) && settings.objectQuery) {
          ...
          if ((typeof settings === 'object') && (settings != null) && settings.uiSettings) {
              ...
              if (uiSettings.executeQuery === true) {
                  ...
                  filteredEntities = [];
                  if (settings.parentVM) { settings.parentVM.internalUIs = [ 'UiExterna' ]; settings.parentVM.UiExterna = getVM; }
                  clear();
                  ...
                  if ((typeof settings.parentVM === 'object') && settings.parentVM != null) {
                      ...
                      if ($.inArray('UiExterna', parentVM.internalUIs) === -1) parentVM.internalUIs.push('UiExterna');
                  }
              }
          }
          else {
    ...
    var adjustModuleSecurity = function () {
        ...
        managerAuth.getFormAccess('linx-demo-bv-spa-UiExterna', function (data) {
    ...
    var canActivate = function() {
        ...
        if (data.lxShellCompiledVersion != managerAuth.shellVersion) {
            app.showMessage('Versão de formulário incompatível com a versão de ambiente [' + managerAuth.shellVersion + '].', 'Formulário: UiExterna', ['Ok']);
            return false;
        }
        return true;
    };
    ...
    var compositionComplete = function() {
                       complement.renderscyUiExterna_dGrid(vm);
    ...
    var removeFormViewControl = function () {
        var front = $('#UiExterna_formViewer_front')[0];
        if (front) front.removeClassName('front');
        var back = $('#UiExterna_formViewer_back')[0];
    ...
    var changeFormView = function () {
        ...
        var panel = $('#UiExterna_formViewer')[0];
           ...
           if (vm.status() !== 'C') {
               ...
               colunas.forEach(function (entry, index) {
                   if (entry.hidden && entry.key !== 'RowDataId') {
                       var control = $('#UiExterna_div' + (!dataView ? '' : '' + dataView + '_') + entry.key + 'Template');
    ...
    var vm = {
            ...
            rootNamespace: 'Linx.Demo.BV.UIExterna',
            ...
            __moduleId__: 'pkg_linx-demo-bv-spa/viewmodels/UiExterna'
        };
