define(['durandal/app', 'pkg_linx-demo-bv-spa/services/RecurosContext', 'plugins/router', 'plugins/widget', 'managers/__auth', 'viewmodels/shared/modal', 'viewmodels/shared/modal2', 'managers/brand', 'managers/predefinedFilters', 'services/logger', 'viewmodels/shared/modalMultimidia', 'common', 'pkg_linx-demo-bv-spa/viewmodels/RecursosComplement', 'viewmodels/shared/modalCustomSearch', 'managers/user'],
...
var vmConstructor = function () {
    ...
    var objectLayout = function () {
       return {Name: 'Recursos', Items: [
{Name: 'Recursos_gbCliente', DisplayName: 'Cliente', ColumnSpan: 12, Visible: true, Items: [{Name: 'Recursos_btnDownload', DisplayName: 'Download', ColumnSpan: 3, Visible: true},{Name: 'Recursos_ntxBigIntCliente', DisplayName: '1', ColumnSpan: 3, Visible: true},{Name: 'Recursos_cmbComboboxCliente', DisplayName: '3', ColumnSpan: 3, Visible: true},{Name: 'Recursos_ckBitCliente', DisplayName: '2', ColumnSpan: 5, Visible: true},{Name: 'Recursos_dtDatetimeCliente', DisplayName: '4', ColumnSpan: 3, Visible: true},{Name: 'Recursos_ntxDecimalCliente', DisplayName: '5', ColumnSpan: 3, Visible: true},{Name: 'Recursos_ntxIdCliente', DisplayName: '6', ColumnSpan: 3, Visible: true},{Name: 'Recursos_lUpIdEstado', DisplayName: '7', ColumnSpan: 3, Visible: true},{Name: 'Recursos_ntxIntCliente', DisplayName: '8', ColumnSpan: 3, Visible: true},{Name: 'Recursos_ntxSmallIntCliente', DisplayName: '9', ColumnSpan: 3, Visible: true},{Name: 'Recursos_tbStringCliente', DisplayName: '10', ColumnSpan: 3, Visible: true},{Name: 'Recursos_tbStringEstado', DisplayName: '11', ColumnSpan: 3, Visible: true},]},{Name: 'Recursos_tcClienteTabControl', DisplayName: 'Cliente', ColumnSpan: 12, Visible: true, Items: [{Name: 'Recursos_tiVendaTabItem', DisplayName: 'Venda', ColumnSpan: 12, Visible: true, Items: [{Name: 'Recursos_dGridVenda', DisplayName: '', ColumnSpan: 12, Visible: true, Items: [{Name: 'Recursos_ntxVenda_BigIntVenda', DisplayName: '12', ColumnSpan: 8, Visible: true},{Name: 'Recursos_ckVenda_BitVenda', DisplayName: '13', ColumnSpan: 5, Visible: true},{Name: 'Recursos_cmbVenda_ComboboxVenda', DisplayName: '14', ColumnSpan: 1, Visible: true},{Name: 'Recursos_dtVenda_DatetimeVenda', DisplayName: '15', ColumnSpan: 3, Visible: true},{Name: 'Recursos_ntxVenda_DecimalVenda', DisplayName: '16', ColumnSpan: 5, Visible: true},{Name: 'Recursos_lUpVenda_IdCliente', DisplayName: '17', ColumnSpan: 5, Visible: true},{Name: 'Recursos_lUpVenda_IdLoja', DisplayName: '18', ColumnSpan: 5, Visible: true},{Name: 'Recursos_ntxVenda_IdVenda', DisplayName: '19', ColumnSpan: 5, Visible: true},{Name: 'Recursos_ntxVenda_IntVenda', DisplayName: '20', ColumnSpan: 5, Visible: true},{Name: 'Recursos_ntxVenda_SmallIntVenda', DisplayName: '21', ColumnSpan: 2, Visible: true},{Name: 'Recursos_tbVenda_StringVenda', DisplayName: '22', ColumnSpan: 9, Visible: true},]},]},]},       ]};
    };
      ...
      if ((typeof settings === 'object') && (settings != null) && settings.objectQuery) {
          ...
          if ((typeof settings === 'object') && (settings != null) && settings.uiSettings) {
              ...
              if (uiSettings.executeQuery === true) {
                  ...
                  filteredEntities = [];
                  if (settings.parentVM) { settings.parentVM.internalUIs = [ 'Recursos' ]; settings.parentVM.Recursos = getVM; }
                  clear();
                  ...
                  if ((typeof settings.parentVM === 'object') && settings.parentVM != null) {
                      ...
                      if ($.inArray('Recursos', parentVM.internalUIs) === -1) parentVM.internalUIs.push('Recursos');
                  }
              }
          }
          else {
    ...
    var adjustModuleSecurity = function () {
        ...
        managerAuth.getFormAccess('linx-demo-bv-spa-Recursos', function (data) {
    ...
    var canActivate = function() {
        ...
        if (data.lxShellCompiledVersion != managerAuth.shellVersion) {
            app.showMessage('Versão de formulário incompatível com a versão de ambiente [' + managerAuth.shellVersion + '].', 'Formulário: Recursos', ['Ok']);
            return false;
        }
        return true;
    };
    ...
    var compositionComplete = function() {
                   $('#Recursos_tcClienteTabControl').on('shown.bs.tab', function (e) { vm.notifyInnerElements($(e.target.hash)); });
               initializeTabControl('#Recursos_tcClienteTabControl');

                           complement.renderRecursos_dGridVenda(vm);

                   complement.renderscyRecursos_dGrid(vm);
        ...
        vm.currentBrands.subscribe(function(newValue) {
            ...
            var reset = (!newValue || searchedBrands.cod === ''), decimals = searchedBrands.decimals;
                           complement.ChangedBrandRecursos_dGridVenda(vm, decimals, reset);
    ...
    var visibleColumns = 'BigIntCliente,ComboboxCliente,BitCliente,DatetimeCliente,DecimalCliente,IdCliente,IdEstado,IntCliente,SmallIntCliente,StringCliente,StringEstado';
    ...
    var getAddedEntities = function () {
        return dataContext.getEntities('Cliente', [dataContext.breeze.EntityState.Added]);
    }
    var getRelatedElementsInCache = function () {
        if (parentEntityRelated != null && preserveDataCurrentState()) {
           var cacheElements = dataContext.getEntities('Cliente');
           var result = [];
           var relationExpr = '';
...
var stringEstado = getAbsoluteValue(currentDataItem().StringEstado);	
debugger; 
      ...
      urlDef += "ChamaMetodoBV?StringEstado="+stringEstado;
      ...
      vm.dataToolbar.isBusy(false);
		...
		if (result != 'undefined') 
		{	
				app.showMessage(('Evento executado com sucesso!!').toString(), 'Alerta', ['Ok'])
		}
    ...
    var removeFormViewControl = function () {
        var front = $('#Recursos_formViewer_front')[0];
        if (front) front.removeClassName('front');
        var back = $('#Recursos_formViewer_back')[0];
    ...
    var changeFormView = function () {
        ...
        var panel = $('#Recursos_formViewer')[0];
           ...
           if (vm.status() !== 'C') {
               ...
               colunas.forEach(function (entry, index) {
                   if (entry.hidden && entry.key !== 'RowDataId') {
                       var control = $('#Recursos_div' + (!dataView ? '' : '' + dataView + '_') + entry.key + 'Template');
    ...
    var vm = {
            ...
            rootNamespace: 'Linx.Demo.BV.Recuros',
            ...
            __moduleId__: 'pkg_linx-demo-bv-spa/viewmodels/Recursos'
        };
