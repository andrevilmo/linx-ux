...
{  
	...
	[FunctionalPoint("ClassDescription[ ];DisplayName[];SizeGridConfigurations[];ReplicationKey[];CompositionHierarchy[Cliente,Cliente.Venda];IsOlap[false];OlapCatalogName[];CubeName[];IsAggregationView[false];ForceAggregationPaging[false];HasLocalResultEntityAdapters[false];TemporaryKeyName[IdCliente];ReadOnly[false];Entities[CLIENTE:IdCliente|ESTADO:IdEstado];SubQueryInfo[];EdmEntityName[CLIENTE];EntityRelations[ESTADO(ESTADO)#PAIS(PAIS)];EdmParentEntityName[];IsIQueryable[true]")]
		
	[DataContract(IsReference = false, Name = "Cliente")]
	[Serializable()]
	[Export(typeof(object))]
	[ExportMetadata("ImplementationName", "Linx.Demo.BV.Recuros.Cliente")]
	public partial class Cliente : Linx.Data.Entity
	{
	    ...
	    public virtual void FillDetails(RecurosDomainService context, string serializedEntitySearch = null, string jEntitySearch = null, string[] viewNames = null, int take = 0)
	    {
	    ...
	    [XmlAttribute()]
	    [Editable(true)]
	    [Display(Name = "1", Description="", Order = 1, AutoGenerateField = true, GroupName="", ResourceType= null)]
	    ...
	    [XmlAttribute()]
	    [Editable(true)]
	    [Display(Name = "2", Description="", Order = 2, AutoGenerateField = true, GroupName="", ResourceType= null)]
	    ...
	    [XmlAttribute()]
	    [Editable(true)]
	    [Display(Name = "3", Description="", Order = 3, AutoGenerateField = true, GroupName="", ResourceType= null)]
	    ...
	    [XmlAttribute()]
	    [Editable(true)]
	    [Display(Name = "4", Description="", Order = 4, AutoGenerateField = true, GroupName="", ResourceType= null)]
	    ...
	    [XmlAttribute()]
	    [Editable(true)]
	    [Display(Name = "5", Description="", Order = 5, AutoGenerateField = true, GroupName="", ResourceType= null)]
	    ...
	    [XmlAttribute()]
	    [Editable(true)]
	    [Display(Name = "6", Description="", Order = 7, AutoGenerateField = true, GroupName="", ResourceType= null)]
	    [Key()]
	    ...
	    [XmlAttribute()]
	    [Editable(true)]
	    [Display(Name = "7", Description="", Order = 7, AutoGenerateField = true, GroupName="", ResourceType= null)]
	    [FunctionalPoint("Precision[12:0];IsEditable[true];CustomMediaTable[];IsAutomaticSequency[false];IsNull[true];DomainName[];KpiName[];KpiRelatedAttribute[];DefaultValue[];DataFormatString[];OrderByOrientation[Ascending];OrderBySequence[-1];AggregationFunction[None];ObjectClass[LookUpTextBox];ConnectedField[];Mask[];MaskType[];ExcludedAsFilter[false];LookUpName[LookUpEstado];LookUpTitle[Seleção de (7)];LookUpQuery[executeLookUpEstado];LookUpFinalize[finalizeLookUpEstado];LookUpDisplayColumns[{\"IdEstado\" : \"Id Estado\", \"StringEstado\" : \"String Estado\"}];LookUpColumns[{\"IdEstado\" : true, \"StringEstado\" : true}];FilterDataKey[CLIENTE.ESTADO.ID_ESTADO];IsMeasure[false]")]
	    [LinxPublicationField(IsSuggestion=false, LookUpInfo="System.Nullable<Int32>#IdEstado#true##12:0##Id Estado#0#true##::LookUpEstado##false#false#ESTADO#ESTADO#Linx.Demo.BV.Recuros#IQueryable###true#false", EdmKey="CLIENTE.ESTADO.ID_ESTADO")]
	    ...
	    [XmlAttribute()]
	    [Editable(true)]
	    [Display(Name = "8", Description="", Order = 8, AutoGenerateField = true, GroupName="", ResourceType= null)]
	    ...
	    [XmlAttribute()]
	    [Editable(true)]
	    [Display(Name = "9", Description="", Order = 9, AutoGenerateField = true, GroupName="", ResourceType= null)]
	    ...
	    [XmlAttribute()]
	    [Editable(true)]
	    [Display(Name = "10", Description="", Order = 10, AutoGenerateField = true, GroupName="", ResourceType= null)]
	    [LinxStringLength(50)]
	    ...
	    [XmlAttribute()]
	    [Editable(true)]
	    [Display(Name = "11", Description="", Order = 10, AutoGenerateField = true, GroupName="", ResourceType= null)]
	    [LinxStringLength(50)]
	    [FunctionalPoint("Precision[50:0];IsEditable[false];CustomMediaTable[];IsAutomaticSequency[false];IsNull[true];DomainName[];KpiName[];KpiRelatedAttribute[];DefaultValue[];DataFormatString[];OrderByOrientation[Ascending];OrderBySequence[-1];AggregationFunction[None];ObjectClass[TextBox];ConnectedField[];Mask[];MaskType[];ExcludedAsFilter[false];LookUpName[LookUpEstado];LookUpTitle[Seleção de (11)];LookUpQuery[executeLookUpEstado];LookUpFinalize[finalizeLookUpEstado];LookUpDisplayColumns[{\"IdEstado\" : \"Id Estado\", \"StringEstado\" : \"String Estado\"}];LookUpColumns[{\"IdEstado\" : true, \"StringEstado\" : true}];FilterDataKey[CLIENTE.ESTADO.STRING_ESTADO];IsMeasure[false]")]
	    [LinxPublicationField(IsSuggestion=false, LookUpInfo="System.String#StringEstado#false##50:0##String Estado#1#true##::LookUpEstado##false#false#ESTADO#ESTADO#Linx.Demo.BV.Recuros#IQueryable###true#false", EdmKey="CLIENTE.ESTADO.STRING_ESTADO")]
	    ...
	    [XmlAttribute()]
	    [Editable(true)]
	    [Display(Name = "6 (Tmp)", Description="Temporary Key", Order = 7, AutoGenerateField = false, GroupName="", ResourceType= null)]
	    ...
	    [XmlAttribute()]
	    [Editable(false)]
	    [Display(Name = "3", Description="", Order = 0, AutoGenerateField = true, GroupName="", ResourceType= null)]
	...
	public partial class Venda : Linx.Data.Entity
	{
	    ...
	    public void LoadParent(RecurosDomainService context)
	    {
	    ...
	    [XmlAttribute()]
	    [Editable(true)]
	    [Display(Name = "12", Description="", Order = 1, AutoGenerateField = true, GroupName="", ResourceType= null)]
	    ...
	    [XmlAttribute()]
	    [Editable(true)]
	    [Display(Name = "13", Description="", Order = 2, AutoGenerateField = true, GroupName="", ResourceType= null)]
	    ...
	    [XmlAttribute()]
	    [Editable(true)]
	    [Display(Name = "14", Description="", Order = 3, AutoGenerateField = true, GroupName="", ResourceType= null)]
	    ...
	    [XmlAttribute()]
	    [Editable(true)]
	    [Display(Name = "15", Description="", Order = 4, AutoGenerateField = true, GroupName="", ResourceType= null)]
	    ...
	    [XmlAttribute()]
	    [Editable(true)]
	    [Display(Name = "16", Description="", Order = 5, AutoGenerateField = true, GroupName="", ResourceType= null)]
	    ...
	    [XmlAttribute()]
	    [Editable(true)]
	    [Display(Name = "18", Description="", Order = 7, AutoGenerateField = true, GroupName="", ResourceType= null)]
	    ...
	    [XmlAttribute()]
	    [Editable(true)]
	    [Display(Name = "19", Description="", Order = 7, AutoGenerateField = true, GroupName="", ResourceType= null)]
	    [Key()]
	    ...
	    [XmlAttribute()]
	    [Editable(true)]
	    [Display(Name = "20", Description="", Order = 8, AutoGenerateField = true, GroupName="", ResourceType= null)]
	    ...
	    [XmlAttribute()]
	    [Editable(true)]
	    [Display(Name = "21", Description="", Order = 9, AutoGenerateField = true, GroupName="", ResourceType= null)]
	    ...
	    [XmlAttribute()]
	    [Editable(true)]
	    [Display(Name = "22", Description="", Order = 10, AutoGenerateField = true, GroupName="", ResourceType= null)]
	    [LinxStringLength(50)]
	    ...
	    [XmlAttribute()]
	    [Editable(true)]
	    [Display(Name = "19 (Tmp)", Description="Temporary Key", Order = 7, AutoGenerateField = false, GroupName="", ResourceType= null)]
	    ...
	    [XmlAttribute()]
	    [Editable(false)]
	    [Display(Name = "14", Description="", Order = 0, AutoGenerateField = true, GroupName="", ResourceType= null)]
	    [FunctionalPoint("Precision[0];IsEditable[true];CustomMediaTable[];IsAutomaticSequency[false];IsNull[false];DomainName[];KpiName[];KpiRelatedAttribute[];DefaultValue[];DataFormatString[];OrderByOrientation[Ascending];OrderBySequence[-1];AggregationFunction[None];ObjectClass[ComboBox];ConnectedField[];Mask[];MaskType[];ExcludedAsFilter[true];FilterDataKey[1]")]
	    [LinxPublicationField(IsSuggestion=false, LookUpInfo="", EdmKey="")]
	...
	///////////////////////////////////////////////////////////////////////
	[EnableClientAccess()]	
	[DomainIdentifier("ProcessorOverviewRecurosDomainService", CodeProcessor = typeof(MethodPatchingCodeProcessor))]
	public partial class RecurosDomainService : DomainService, IDataServiceContext 
	{
	    ...
	    public RecurosDomainService() : this("", null, null) { }
	    public RecurosDomainService(string connectionString) : this(connectionString, null, null) { }
	    public RecurosDomainService(Dictionary<string, string> headers) : this("", null, headers) { }
	    public RecurosDomainService(LINXDEMO.BM.BaseTeste dataContext, Dictionary<string, string> headers) : this("", dataContext, headers) { }
	    public RecurosDomainService(string connectionString, LINXDEMO.BM.BaseTeste dataContext, Dictionary<string, string> headers) : base() 
	    { 
	    ...
	    public List<LinxEntityReferenceInfo> GetMetaDataObject(string entityName, bool forceAll = false, bool removeParentComposition = false)
        {
	        ...
	        if (entityName.InList("Linx.Demo.BV.Recuros.Cliente"))
	        {
	        		result.Add(new LinxEntityReferenceInfo()
	        		{
	        			...
	        			EdmEntityName = ObjectExtension.GetFunctionalPointOfType(Type.GetType("Linx.Demo.BV.Recuros.Cliente"), "EdmEntityName"),
	        			Properties = ObjectExtension.GetFunctionalPoints(Type.GetType("Linx.Demo.BV.Recuros.Cliente"), forceAll: forceAll)
	        		});
	        }
		

	        if (entityName.InList("Linx.Demo.BV.Recuros.Cliente", "Linx.Demo.BV.Recuros.Venda"))
	        {
	        		result.Add(new LinxEntityReferenceInfo()
	        		{
	        			...
	        			EdmEntityName = ObjectExtension.GetFunctionalPointOfType(Type.GetType("Linx.Demo.BV.Recuros.Venda"), "EdmEntityName"),
	        			Properties = ObjectExtension.GetFunctionalPoints(Type.GetType("Linx.Demo.BV.Recuros.Venda" + (removeParentComposition ? "" : "ParentComposition")), forceAll: forceAll)
	        		});
	        }
        ...
        {	
	    		...
	    		if (erp)
	    		{
         		    ...
         		    return new string[] { "Demo_RecurosClientErpService", Linx.Tools.AssemblyHelper.ReadResourceContent("Linx.Demo.BV.ClientResources.RecurosClientErpService.res", System.Reflection.Assembly.GetExecutingAssembly()) };		
	    		}
	    		else 
	    		{

         		    return new string[] { "Demo_recurosService", Linx.Tools.AssemblyHelper.ReadResourceContent("Linx.Demo.BV.ClientResources.recurosService.res", System.Reflection.Assembly.GetExecutingAssembly()) };	
	    		}
	    ...
	    public IQueryable<VendaParentComposition> GetVendaParentCompositionByEntitySearchNoAssociations(string serializedEntitySearch, string jEntitySearch = "")
	    {
	        ...
	        List<ObjectParameter> parameters = new List<ObjectParameter>();
	        EntitySearch.AdjustExcludedFilters(entitySearchList, GetExcludedFilters());
	        List<EntitySearch> replacedEntitySearchList = EntitySearch.ReplaceParentCompositionDataKey(entitySearchList, "CLIENTE", "VENDA", "CLIENTE", typeof(VendaParentComposition));
	        replacedEntitySearchList.GetEntityQueryExpression(ref dynQuery, parameters);
	        if (!jEntitySearch.IsNullOrEmpty()) 
	        { 
	            string bmSearch = this.GetEDM().JExpressionToEntitySql(jEntitySearch, parameters);
