...
namespace Linx.Demo.BV.ModalExterna
{
	...
	public partial class VendaItemUpdateCustomAuthorizationAutoAttribute : AuthorizationAttribute
	{
		...
		protected override AuthorizationResult IsAuthorized(System.Security.Principal.IPrincipal principal, AuthorizationContext authorizationContext)
		{
				...
				return (_domainService != null && _domainService.IsSecure) ? AuthorizationResult.Allowed : Linx.Business.Tools.LinxAutorization.ValidateAuthorization(AuthorizationType.Update, "Linx.Demo.BV#Linx.Demo.BV.ModalExterna#Linx.Demo.BV.ModalExterna.Venda", (_domainService == null ? ServiceHelper.GetHttpHeaders() : _domainService.Headers));
		}
	...
	public partial class VendaItemInsertCustomAuthorizationAutoAttribute : AuthorizationAttribute
	{
		...
		{
				if (_domainService == null) _domainService = authorizationContext == null ? null : authorizationContext.GetService(typeof(ModalExternaDomainService)) as ModalExternaDomainService;
				return (_domainService != null && _domainService.IsSecure) ? AuthorizationResult.Allowed : Linx.Business.Tools.LinxAutorization.ValidateAuthorization(AuthorizationType.Insert, "Linx.Demo.BV#Linx.Demo.BV.ModalExterna#Linx.Demo.BV.ModalExterna.Venda", (_domainService == null ? ServiceHelper.GetHttpHeaders() : _domainService.Headers));
		}
	...
	public partial class VendaItemDeleteCustomAuthorizationAutoAttribute : AuthorizationAttribute
	{
		...
		{
				if (_domainService == null) _domainService = authorizationContext == null ? null : authorizationContext.GetService(typeof(ModalExternaDomainService)) as ModalExternaDomainService;
				return (_domainService != null && _domainService.IsSecure) ? AuthorizationResult.Allowed : Linx.Business.Tools.LinxAutorization.ValidateAuthorization(AuthorizationType.Delete, "Linx.Demo.BV#Linx.Demo.BV.ModalExterna#Linx.Demo.BV.ModalExterna.Venda", (_domainService == null ? ServiceHelper.GetHttpHeaders() : _domainService.Headers));
		}
