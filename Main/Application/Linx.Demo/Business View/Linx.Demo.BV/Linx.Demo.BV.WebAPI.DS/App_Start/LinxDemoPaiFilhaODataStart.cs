...
[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(Linx.Demo.BV.WebAPI.DS.App_Start.LinxDemoPaiFilhaODataStart), "Start")]

namespace Linx.Demo.BV.WebAPI.DS.App_Start
{

    public static class LinxDemoPaiFilhaODataStart
    {
        public static void Start()
        {
           var conventions = ODataRoutingConventions.CreateDefault();
           conventions.Insert(0, new Linx.DataService.ODataContainmentRoutingConvention("LinxDemoPaiFilhaFeed"));
           GlobalConfiguration.Configuration.Routes.MapODataServiceRoute(
               routeName: "LinxDemoPaiFilhaODataRoute",
               routePrefix: "LinxDemoPaiFilhaOData",
        ...
        private static IEdmModel GetEdmModel()
        {
            ...
            modelBuilder.EntitySet<BusinessNS.Vendedor>("Vendedor");
            modelBuilder.EntitySet<BusinessNS.VendedorParentComposition>("VendedorParentComposition");
