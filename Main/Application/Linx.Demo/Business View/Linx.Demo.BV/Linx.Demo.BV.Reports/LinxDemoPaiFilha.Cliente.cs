namespace Linx.Demo.BV.Reports {
    ...
    [Description("UIPaiFilhaNetaTesteReport1")]
    public partial class LinxDemoPaiFilhaCliente : Telerik.Reporting.Report {
        
        public LinxDemoPaiFilhaCliente() {
            InitializeComponent();
            this.ReportDS.DataMember = "GetCliente";
            this.ReportDS.DataSource = new PaiFilhaDataSource();
            this.DataSource = this.ReportDS;
            this.ItemDataBinding += new System.EventHandler(this.LinxDemoPaiFilhaCliente_ItemDataBinding);
        }
        
        private void LinxDemoPaiFilhaCliente_ItemDataBinding(object sender, EventArgs e) {
