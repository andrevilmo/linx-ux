...
[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(VAREJO.BV.WebAPI.DS.App_Start.VarejoDiversosODataStart), "Start")]

namespace VAREJO.BV.WebAPI.DS.App_Start
{

    public static class VarejoDiversosODataStart
    {
        public static void Start()
        {
           var conventions = ODataRoutingConventions.CreateDefault();
           conventions.Insert(0, new Linx.DataService.ODataContainmentRoutingConvention("VarejoDiversosFeed"));
           GlobalConfiguration.Configuration.Routes.MapODataServiceRoute(
               routeName: "VarejoDiversosODataRoute",
               routePrefix: "VarejoDiversosOData",
