...
var result = function () {
    ...
    var getDataFeedUrl = function() {
       return getServiceAddress('VarejoOlapGraficosGaugeOData');
    };
    ...
    var controllerName = 'VarejoOlapGraficosGauge';
    ...
    metadataInfo['Venda'] = [
        ...
        { key: 'BigIntVendaKpiInfo', isQbeZero: false, isDomain: false, domainName: '', lookupPropertyName: '', lookupVisibleColumns: '', isRequired: true, maxLength: 0, isPartOfKey: false, headerText: 'Big Int Venda (KPI)', width: '283px', dataType: 'string', format: '', hidden: false, unbound: false, group: null },
    ...
    dataExportInfo['Venda'] = [ 
        { name: 'Venda', canExportMedia: true , canExportReport: true, actionExport: 'VarejoOlapGraficosGauge/GetVendaToExcel', actionReport: 'VarejoOlapGraficosGauge/GetVendaToReportXml', actionFeed: 'VarejoOlapGraficosGaugeOData/Venda', actionName: 'VarejoOlapGraficosGauge/GetVendaByEntitySearchNoAssociations', display: 'Venda',  metaData: function() { return metadataInfo['Venda']; } }
        , { name: 'VendaItem', canExportMedia: true , canExportReport: true, actionExport: 'VarejoOlapGraficosGauge/GetVendaItemParentCompositionToExcel', actionReport: 'VarejoOlapGraficosGauge/GetVendaItemParentCompositionToReportXml', actionFeed: 'VarejoOlapGraficosGaugeOData/VendaItemParentComposition', actionName: 'VarejoOlapGraficosGauge/GetVendaItemParentCompositionByEntitySearchNoAssociations', display: 'VendaItem',  metaData: function() { return metadataInfo['VendaItemParentComposition']; } }
    ];
    ...
    metadataInfo['VendaItem'] = [
        ...
        { key: 'BigIntVendaItemKpiInfo', isQbeZero: false, isDomain: false, domainName: '', lookupPropertyName: '', lookupVisibleColumns: '', isRequired: true, maxLength: 0, isPartOfKey: false, headerText: 'Big Int Venda Item (KPI)', width: '348px', dataType: 'string', format: '', hidden: false, unbound: false, group: null },
        { key: 'ChangeState', isDomain: false, domainName: '', lookupPropertyName: '', lookupVisibleColumns: '', maxLength: 0, isPartOfKey: false, headerText: '', width: '0px', dataType: 'string', format: '', hidden: true, unbound: false, group: null }
    ];
    ...
    dataExportInfo['VendaItem'] = [ 
        { name: 'VendaItem', canExportMedia: true , canExportReport: true, actionExport: 'VarejoOlapGraficosGauge/GetVendaItemToExcel', actionReport: 'VarejoOlapGraficosGauge/GetVendaItemToReportXml', actionFeed: 'VarejoOlapGraficosGaugeOData/VendaItem', actionName: 'VarejoOlapGraficosGauge/GetVendaItemByEntitySearchNoAssociations', display: 'VendaItem',  metaData: function() { return metadataInfo['VendaItem']; } }
    ];
    ...
    ,BigIntVendaKpiInfo: { dataType: DataType.String, isNullable: false, isPartOfKey: false, validators: [ Validator.hasValueValidator]  }
    ...
    VendaItemList: { entityTypeName: "VendaItem:#VAREJO.BV.OlapGraficosGauge", isScalar: false, invForeignKeyNames: ["IdVenda"], associationName: "FK_Venda_VendaItem" }
                          }
    });
    ...
    var VendaInitializer = function (ownerReference, isPOCO) {
       ownerReference.RowDataId = (isPOCO === true ? getNextSequence('Venda') : ko.observable(getNextSequence('Venda')));
        ...
        var _bigIntVendaKpiInfo = ownerReference.BigIntVendaKpiInfo;
        Object.defineProperty(ownerReference, 'BigIntVendaKpiInfo', {
          get: function() { return _bigIntVendaKpiInfo; },
          set: function(newValue) { var oldValue = _bigIntVendaKpiInfo; _bigIntVendaKpiInfo = newValue; if (!entityPropChanged(ownerReference, 'BigIntVendaKpiInfo', oldValue, newValue)) { _bigIntVendaKpiInfo = oldValue; } }
        });
       ...
       ownerReference.serverDataType['BigIntVendaKpiInfo'] = 'S';
       ...
       ownerReference.namespace = 'VAREJO.BV.OlapGraficosGauge';
       ownerReference.myProperties = [ 'BigIntVenda','IdVenda','BigIntVendaKpiInfo' ];
    ...
    ,BigIntVendaItemKpiInfo: { dataType: DataType.String, isNullable: false, isPartOfKey: false, validators: [ Validator.hasValueValidator]  }
    ,ChangeState: { dataType: DataType.String, isNullable: true, isPartOfKey: false, validators: [] }
                    },
    navigationProperties: {
    // Returns a single parent and associates with Details
    Venda: { entityTypeName: "Venda:#VAREJO.BV.OlapGraficosGauge", isScalar: true, foreignKeyNames: ["IdVenda"], associationName: "FK_Venda_VendaItem" }
    // Returns collections of details and associates with Parent
                          }
    });
    ...
    var VendaItemInitializer = function (ownerReference, isPOCO) {
       ownerReference.RowDataId = (isPOCO === true ? getNextSequence('VendaItem') : ko.observable(getNextSequence('VendaItem')));
        ...
        var _bigIntVendaItemKpiInfo = ownerReference.BigIntVendaItemKpiInfo;
        Object.defineProperty(ownerReference, 'BigIntVendaItemKpiInfo', {
          get: function() { return _bigIntVendaItemKpiInfo; },
          set: function(newValue) { var oldValue = _bigIntVendaItemKpiInfo; _bigIntVendaItemKpiInfo = newValue; if (!entityPropChanged(ownerReference, 'BigIntVendaItemKpiInfo', oldValue, newValue)) { _bigIntVendaItemKpiInfo = oldValue; } }
        });
        //End Property Definitions
       ownerReference.setRemovedLookupFields = function(removedFields) {
           for (var idxLUp in entitylookUps[ownerReference.typeName]) {
       ...
       ownerReference.serverDataType['BigIntVendaItemKpiInfo'] = 'S';
       ...
       ownerReference.namespace = 'VAREJO.BV.OlapGraficosGauge';
       ownerReference.myProperties = [ 'BigIntVendaItem','BitVendaItem','ComboboxVendaItem','DatetimeVendaItem','DecimalVendaItem','GuidVendaItem','IdVenda','IdVendaItem','IntVendaItem','SmallIntVendaItem','StringVendaItem','BigIntVendaItemKpiInfo' ];
       ownerReference.queryRequiredProperties = {  };
       ownerReference.excludedFilters = [];
       ownerReference.getCurrentElements = function() {
           var result = [ ownerReference ];
    ...
    var getGaugesFormularioRanges = function () {
        var query = EntityQuery.from('GetGaugesFormularioRanges').noTracking(true)
    ...
    var getKPIGridRanges = function () {
        var query = EntityQuery.from('GetKPIGridRanges').noTracking(true)
        return manager.executeQuery(query)
        .fail(queryFailed);
    };
    ...
    // Define that the event name is 'OlapGraficosGaugeContext_DataUpdate'.
    var contextUpdtEvt = 'OlapGraficosGaugeContext_DataUpdate_' + getNewGuid();
    ...
    var saveChangesFake = function (transactionID, saveSucceeded) {
        ...
        return $.ajax({
            type: 'POST',
            crossDomain: true,
            url: getServiceAddress('VarejoOlapGraficosGauge/Save' + vm.rootDataTypeName + 'InCache'),
            globalError: false,
    ...
    var submitAllChanges = function (transactionId, saveSucceeded, failed, completed) {
        return $.ajax({
            type: 'GET',
            crossDomain: true,
            url: getServiceAddress('VarejoOlapGraficosGauge/submitAllChanges?transactionID=' + transactionId),
            globalError: false,
            contentType: 'application/json',
            async: true,
            cache: false,
    ...
    var cancelAllChanges = function (transactionId, saveSucceeded, failed) {
        return $.ajax({
            type: 'GET',
            crossDomain: true,
            url: getServiceAddress('VarejoOlapGraficosGauge/CancelAllChanges?transactionID=' + transactionId),
            globalError: false,
            contentType: 'application/json',
            async: true,
            cache: false,
    ...
    var saveChanges = function(saveSucceeded, saveFailed, fin, saveNoTRack) {
        if (saveNoTRack === true) {
            ...
            return $.ajax({
               type: 'POST',
               crossDomain: true,
               url: getServiceAddress('VarejoOlapGraficosGauge/Save' + vm.rootDataTypeName),
               globalError: false,
               contentType: 'application/json',
               async: true,
               cache: false,
    ...
    var createVenda = function() {
        ...
        enableChangeTrack = false;
        var defaultVals = { IdVenda: (-1 * getSequence('Venda')) };
    ...
    var exportReportDataSource = function(complete) {
        $.ajax({
           ...
           crossDomain: true,
           headers: managerAuth.getHeaders(),
           url: getServiceAddress("VarejoOlapGraficosGauge/GetReportDataSource"),
           success: function (response) {
    ...
    var exportTemplateReport = function(reportPath, complete) {
        $.ajax({
           ...
           crossDomain: true,
           headers: managerAuth.getHeaders(),
           url: getServiceAddress("VarejoOlapGraficosGauge/GetTemplateReport"),
