...
var vmConstructor = function () {
      ...
      if ((typeof settings === 'object') && (settings != null) && settings.objectQuery) {
          ...
          if ((typeof settings === 'object') && (settings != null) && settings.uiSettings) {
              ...
              if (uiSettings.executeQuery === true) {
                  ...
                  filteredEntities = [];
                  if (settings.parentVM) { settings.parentVM.internalUIs = [ 'CadastroVendaAtacado' ]; settings.parentVM.CadastroVendaAtacado = getVM; }
                  clear();
                  ...
                  if ((typeof settings.parentVM === 'object') && settings.parentVM != null) {
                      ...
                      parentVM.CadastroVendaAtacado = getVM;
                      if (isLookup()) { 
                      ...
                      if ($.inArray('CadastroVendaAtacado', parentVM.internalUIs) === -1) parentVM.internalUIs.push('CadastroVendaAtacado');
                  }
              }
          }
          else {
    ...
    var adjustModuleSecurity = function () {
        ...
        managerAuth.getFormAccess('varejo-bv-spa-CadastroVendaAtacado', function (data) {
    ...
    var canActivate = function() {
        ...
        if (data.lxShellCompiledVersion != managerAuth.shellVersion) {
            app.showMessage('Versão de formulário incompatível com a versão de ambiente [' + managerAuth.shellVersion + '].', 'Formulário: CadastroVendaAtacado', ['Ok']);
            return false;
        }
        return true;
    };
    ...
    var compositionComplete = function() {
        $('#CadastroVendaAtacado_gbVendaAtacadoWizard').one('shown.bs.collapse', function (e) { vm.notifyInnerElements($(e.currentTarget), true); });

    complement.renderscyCadastroVendaAtacado_dGrid(vm);
    ...
    var getMaxLength = function(entityName, propertyName){
        if (isNullOrEmpty(entityName)) entityName = 'VendaAtacadoWizard';
    ...
    var visibleColumns = 'BigIntVendaAtacado,BitVendaAtacado,ComboboxVendaAtacado,DatetimeVendaAtacado,DecimalVendaAtacado,IdCliente,IdVendaAtacado,IntVendaAtacado,SmallIntVendaAtacado,StringVendaAtacado';
    ...
    var exportData = function (forceAdd, isExcelDataSource) {
        if (forceAdd)
            require(['viewmodels/shared/addCustomExport'],
                function(addCustomExport){ addCustomExport.showModal(vm, null, 'VendaAtacadoWizard', getVisiblePropertiesForExcel('dataView'), null, true, isExcelDataSource); } );
        else
            require(['viewmodels/shared/customExport'],
                function(modalExport){ modalExport.showModal(vm, 'VendaAtacadoWizard', getVisiblePropertiesForExcel('dataView'), null, { canAdd: true, canEdit: true, canDel: true }, isExcelDataSource); } );
    };
    ...
    var query = function (lookupInitializing, parentEntity, quickSearchJExpression, externalQueryCallBack, noMessages, noDetails) {
        ...
        if (freeEntityForQuerying == null && isChildVM()) freeEntityForQuerying = dataContext.createFreeEntity('VendaAtacadoWizard');
        ...
        return dataContext.getVendaAtacadoWizardByEntitySearchNoAssociations(lastJEntitySearch, 0, pageSize(), (pageSize() > 0), preserveDataCurrentState(), status() !== 'E', sortInfo).then(querySucceeded).fin(complete);
        ...
        function querySucceeded(data) {
            if (vm.status() !== 'E') { for (var idx = 0; idx < data.results.length; idx++) { dataContext.initializePOCO(data.results[idx], 'VendaAtacadoWizard'); } }
            hasError = false;
    ...
    var refresh = function (curPage, goLast) {
        ...
        return dataContext.getVendaAtacadoWizardByEntitySearchNoAssociations(lastJEntitySearch, curPage * pageSize(), pageSize(), false, false, status() !== 'E', sortInfo).then(querySucceeded).fin(complete);
    ...
    var clear = function (noBindingReport) {
        ...
        else return dataContext.clearVendaAtacadoWizard(getBandeiraRede(), clearComplete);
    ...
    var createVendaAtacadoWizard = function() {
        dataBind('dataView', true);
        var entity = dataContext.createVendaAtacadoWizard();
    ...
    var createAndNotifyVendaAtacadoWizard = function() {
        var entity = createVendaAtacadoWizard();
        notifyPresentation('');
        return entity;
    };
    ...
    var addNew = function (parentEntity) {
        ...
        goToItem(createVendaAtacadoWizard());
        editInnerUIs();
        showButtonsEditorTemplate();
        dataBind();
    };
    ...
    var removeFormViewControl = function () {
        var front = $('#CadastroVendaAtacado_formViewer_front')[0];
        if (front) front.removeClassName('front');
        var back = $('#CadastroVendaAtacado_formViewer_back')[0];
    ...
    var changeFormView = function () {
        ...
        var panel = $('#CadastroVendaAtacado_formViewer')[0];
    ...
    var entitySearchRange = {
        predefinedFilters: ko.observableArray(managerPredefined.predefinedFilters),
            VendaAtacadoWizardDatetimeVendaAtacado_typeRange: ko.observable('R'), VendaAtacadoWizardDatetimeVendaAtacado_begin: ko.observable(null), VendaAtacadoWizardDatetimeVendaAtacado_end: ko.observable(null), VendaAtacadoWizardDatetimeVendaAtacado_predefFilter: ko.observableArray([]), VendaAtacadoWizardDatetimeVendaAtacado_predefValue: ko.observable(null),
        VendaAtacadoWizardBigIntVendaAtacado_begin: ko.observable(null), VendaAtacadoWizardBigIntVendaAtacado_end: ko.observable(null),
        VendaAtacadoWizardDecimalVendaAtacado_begin: ko.observable(null), VendaAtacadoWizardDecimalVendaAtacado_end: ko.observable(null),
        VendaAtacadoWizardIdVendaAtacado_begin: ko.observable(null), VendaAtacadoWizardIdVendaAtacado_end: ko.observable(null),
        VendaAtacadoWizardIntVendaAtacado_begin: ko.observable(null), VendaAtacadoWizardIntVendaAtacado_end: ko.observable(null),
        VendaAtacadoWizardSmallIntVendaAtacado_begin: ko.observable(null), VendaAtacadoWizardSmallIntVendaAtacado_end: ko.observable(null),
        VendaAtacadoWizardIdCliente: ko.observable(null)
    };
    entitySearchRange.clear = function(){
            entitySearchRange.VendaAtacadoWizardDatetimeVendaAtacado_typeRange('R'); entitySearchRange.VendaAtacadoWizardDatetimeVendaAtacado_begin(null); entitySearchRange.VendaAtacadoWizardDatetimeVendaAtacado_end(null); entitySearchRange.VendaAtacadoWizardDatetimeVendaAtacado_predefFilter([]); entitySearchRange.VendaAtacadoWizardDatetimeVendaAtacado_predefValue(null);
        entitySearchRange.VendaAtacadoWizardBigIntVendaAtacado_begin(null); entitySearchRange.VendaAtacadoWizardBigIntVendaAtacado_end(null);
        entitySearchRange.VendaAtacadoWizardDecimalVendaAtacado_begin(null); entitySearchRange.VendaAtacadoWizardDecimalVendaAtacado_end(null);
        entitySearchRange.VendaAtacadoWizardIdVendaAtacado_begin(null); entitySearchRange.VendaAtacadoWizardIdVendaAtacado_end(null);
        entitySearchRange.VendaAtacadoWizardIntVendaAtacado_begin(null); entitySearchRange.VendaAtacadoWizardIntVendaAtacado_end(null);
        entitySearchRange.VendaAtacadoWizardSmallIntVendaAtacado_begin(null); entitySearchRange.VendaAtacadoWizardSmallIntVendaAtacado_end(null);
        entitySearchRange.VendaAtacadoWizardIdCliente(null);
    };
    entitySearchRange.has_VendaAtacadoWizardBigIntVendaAtacado = ko.computed(function(){ return (entitySearchRange.VendaAtacadoWizardBigIntVendaAtacado_begin() != null || entitySearchRange.VendaAtacadoWizardBigIntVendaAtacado_end() != null); });
    entitySearchRange.has_VendaAtacadoWizardDecimalVendaAtacado = ko.computed(function(){ return (entitySearchRange.VendaAtacadoWizardDecimalVendaAtacado_begin() != null || entitySearchRange.VendaAtacadoWizardDecimalVendaAtacado_end() != null); });
    entitySearchRange.has_VendaAtacadoWizardIdVendaAtacado = ko.computed(function(){ return (entitySearchRange.VendaAtacadoWizardIdVendaAtacado_begin() != null || entitySearchRange.VendaAtacadoWizardIdVendaAtacado_end() != null); });
    entitySearchRange.has_VendaAtacadoWizardIntVendaAtacado = ko.computed(function(){ return (entitySearchRange.VendaAtacadoWizardIntVendaAtacado_begin() != null || entitySearchRange.VendaAtacadoWizardIntVendaAtacado_end() != null); });
    entitySearchRange.has_VendaAtacadoWizardSmallIntVendaAtacado = ko.computed(function(){ return (entitySearchRange.VendaAtacadoWizardSmallIntVendaAtacado_begin() != null || entitySearchRange.VendaAtacadoWizardSmallIntVendaAtacado_end() != null); });
    entitySearchRange.has_VendaAtacadoWizardDatetimeVendaAtacado = ko.computed(function(){ return (entitySearchRange.VendaAtacadoWizardDatetimeVendaAtacado_typeRange() == 'R' && (entitySearchRange.VendaAtacadoWizardDatetimeVendaAtacado_begin() != null || entitySearchRange.VendaAtacadoWizardDatetimeVendaAtacado_end() != null) || (entitySearchRange.VendaAtacadoWizardDatetimeVendaAtacado_typeRange() == 'P' && entitySearchRange.VendaAtacadoWizardDatetimeVendaAtacado_predefFilter().length > 0)); });
           ...
           if (vm.status() !== 'C') {
               ...
               colunas.forEach(function (entry, index) {
                   if (entry.hidden && entry.key !== 'RowDataId') {
                       var control = $('#CadastroVendaAtacado_div' + (!dataView ? '' : '' + dataView + '_') + entry.key + 'Template');
    ...
    var vm = {
            ...
            rootBmTypeName: 'VENDA_ATACADO',
            rootDataTypeName: 'VendaAtacadoWizard',
            ...
            createAndNotifyVendaAtacadoWizard: createAndNotifyVendaAtacadoWizard,
            ...
            __moduleId__: 'pkg_varejo-bv-spa/viewmodels/CadastroVendaAtacado'
        };
