...
var vmConstructor = function () {
      ...
      if ((typeof settings === 'object') && (settings != null) && settings.objectQuery) {
          ...
          if ((typeof settings === 'object') && (settings != null) && settings.uiSettings) {
              ...
              if (uiSettings.executeQuery === true) {
                  ...
                  filteredEntities = [];
                  if (settings.parentVM) { settings.parentVM.internalUIs = [ 'CadastroVendaItem' ]; settings.parentVM.CadastroVendaItem = getVM; }
                  clear();
                  ...
                  if ((typeof settings.parentVM === 'object') && settings.parentVM != null) {
                      ...
                      parentVM.CadastroVendaItem = getVM;
                      if (isLookup()) { 
                      ...
                      if ($.inArray('CadastroVendaItem', parentVM.internalUIs) === -1) parentVM.internalUIs.push('CadastroVendaItem');
                  }
              }
          }
          else {
    ...
    var adjustModuleSecurity = function () {
        ...
        managerAuth.getFormAccess('varejo-bv-spa-CadastroVendaItem', function (data) {
    ...
    var canActivate = function() {
        ...
        if (data.lxShellCompiledVersion != managerAuth.shellVersion) {
            app.showMessage('Versão de formulário incompatível com a versão de ambiente [' + managerAuth.shellVersion + '].', 'Formulário: CadastroVendaItem', ['Ok']);
            return false;
        }
        return true;
    };
    ...
    var compositionComplete = function() {
        $('#CadastroVendaItem_gbVendaItemWizard').one('shown.bs.collapse', function (e) { vm.notifyInnerElements($(e.currentTarget), true); });

    complement.renderscyCadastroVendaItem_dGrid(vm);
    ...
    var getMaxLength = function(entityName, propertyName){
        if (isNullOrEmpty(entityName)) entityName = 'VendaItemWizard';
    ...
    var visibleColumns = 'BigIntVendaItem,BitVendaItem,ComboboxVendaItem,DatetimeVendaItem,DecimalVendaItem,IdVenda,IdVendaItem,IntVendaItem,SmallIntVendaItem,StringVendaItem';
    ...
    var exportData = function (forceAdd, isExcelDataSource) {
        if (forceAdd)
            require(['viewmodels/shared/addCustomExport'],
                function(addCustomExport){ addCustomExport.showModal(vm, null, 'VendaItemWizard', getVisiblePropertiesForExcel('dataView'), null, true, isExcelDataSource); } );
        else
            require(['viewmodels/shared/customExport'],
                function(modalExport){ modalExport.showModal(vm, 'VendaItemWizard', getVisiblePropertiesForExcel('dataView'), null, { canAdd: true, canEdit: true, canDel: true }, isExcelDataSource); } );
    };
    ...
    var query = function (lookupInitializing, parentEntity, quickSearchJExpression, externalQueryCallBack, noMessages, noDetails) {
        ...
        if (freeEntityForQuerying == null && isChildVM()) freeEntityForQuerying = dataContext.createFreeEntity('VendaItemWizard');
        ...
        return dataContext.getVendaItemWizardByEntitySearchNoAssociations(lastJEntitySearch, 0, pageSize(), (pageSize() > 0), preserveDataCurrentState(), status() !== 'E', sortInfo).then(querySucceeded).fin(complete);
        ...
        function querySucceeded(data) {
            if (vm.status() !== 'E') { for (var idx = 0; idx < data.results.length; idx++) { dataContext.initializePOCO(data.results[idx], 'VendaItemWizard'); } }
            hasError = false;
    ...
    var refresh = function (curPage, goLast) {
        ...
        return dataContext.getVendaItemWizardByEntitySearchNoAssociations(lastJEntitySearch, curPage * pageSize(), pageSize(), false, false, status() !== 'E', sortInfo).then(querySucceeded).fin(complete);
    ...
    var clear = function (noBindingReport) {
        ...
        else return dataContext.clearVendaItemWizard(getBandeiraRede(), clearComplete);
    ...
    var createVendaItemWizard = function() {
        dataBind('dataView', true);
        var entity = dataContext.createVendaItemWizard();
    ...
    var createAndNotifyVendaItemWizard = function() {
        var entity = createVendaItemWizard();
        notifyPresentation('');
        return entity;
    };
    ...
    var addNew = function (parentEntity) {
        ...
        goToItem(createVendaItemWizard());
        editInnerUIs();
        showButtonsEditorTemplate();
        dataBind();
    };
    ...
    var removeFormViewControl = function () {
        var front = $('#CadastroVendaItem_formViewer_front')[0];
        if (front) front.removeClassName('front');
        var back = $('#CadastroVendaItem_formViewer_back')[0];
    ...
    var changeFormView = function () {
        ...
        var panel = $('#CadastroVendaItem_formViewer')[0];
    ...
    var entitySearchRange = {
        predefinedFilters: ko.observableArray(managerPredefined.predefinedFilters),
            VendaItemWizardDatetimeVendaItem_typeRange: ko.observable('R'), VendaItemWizardDatetimeVendaItem_begin: ko.observable(null), VendaItemWizardDatetimeVendaItem_end: ko.observable(null), VendaItemWizardDatetimeVendaItem_predefFilter: ko.observableArray([]), VendaItemWizardDatetimeVendaItem_predefValue: ko.observable(null),
        VendaItemWizardBigIntVendaItem_begin: ko.observable(null), VendaItemWizardBigIntVendaItem_end: ko.observable(null),
        VendaItemWizardDecimalVendaItem_begin: ko.observable(null), VendaItemWizardDecimalVendaItem_end: ko.observable(null),
        VendaItemWizardIdVendaItem_begin: ko.observable(null), VendaItemWizardIdVendaItem_end: ko.observable(null),
        VendaItemWizardIntVendaItem_begin: ko.observable(null), VendaItemWizardIntVendaItem_end: ko.observable(null),
        VendaItemWizardSmallIntVendaItem_begin: ko.observable(null), VendaItemWizardSmallIntVendaItem_end: ko.observable(null),
        VendaItemWizardIdVenda: ko.observable(null)
    };
    entitySearchRange.clear = function(){
            entitySearchRange.VendaItemWizardDatetimeVendaItem_typeRange('R'); entitySearchRange.VendaItemWizardDatetimeVendaItem_begin(null); entitySearchRange.VendaItemWizardDatetimeVendaItem_end(null); entitySearchRange.VendaItemWizardDatetimeVendaItem_predefFilter([]); entitySearchRange.VendaItemWizardDatetimeVendaItem_predefValue(null);
        entitySearchRange.VendaItemWizardBigIntVendaItem_begin(null); entitySearchRange.VendaItemWizardBigIntVendaItem_end(null);
        entitySearchRange.VendaItemWizardDecimalVendaItem_begin(null); entitySearchRange.VendaItemWizardDecimalVendaItem_end(null);
        entitySearchRange.VendaItemWizardIdVendaItem_begin(null); entitySearchRange.VendaItemWizardIdVendaItem_end(null);
        entitySearchRange.VendaItemWizardIntVendaItem_begin(null); entitySearchRange.VendaItemWizardIntVendaItem_end(null);
        entitySearchRange.VendaItemWizardSmallIntVendaItem_begin(null); entitySearchRange.VendaItemWizardSmallIntVendaItem_end(null);
        entitySearchRange.VendaItemWizardIdVenda(null);
    };
    entitySearchRange.has_VendaItemWizardBigIntVendaItem = ko.computed(function(){ return (entitySearchRange.VendaItemWizardBigIntVendaItem_begin() != null || entitySearchRange.VendaItemWizardBigIntVendaItem_end() != null); });
    entitySearchRange.has_VendaItemWizardDecimalVendaItem = ko.computed(function(){ return (entitySearchRange.VendaItemWizardDecimalVendaItem_begin() != null || entitySearchRange.VendaItemWizardDecimalVendaItem_end() != null); });
    entitySearchRange.has_VendaItemWizardIdVendaItem = ko.computed(function(){ return (entitySearchRange.VendaItemWizardIdVendaItem_begin() != null || entitySearchRange.VendaItemWizardIdVendaItem_end() != null); });
    entitySearchRange.has_VendaItemWizardIntVendaItem = ko.computed(function(){ return (entitySearchRange.VendaItemWizardIntVendaItem_begin() != null || entitySearchRange.VendaItemWizardIntVendaItem_end() != null); });
    entitySearchRange.has_VendaItemWizardSmallIntVendaItem = ko.computed(function(){ return (entitySearchRange.VendaItemWizardSmallIntVendaItem_begin() != null || entitySearchRange.VendaItemWizardSmallIntVendaItem_end() != null); });
    entitySearchRange.has_VendaItemWizardDatetimeVendaItem = ko.computed(function(){ return (entitySearchRange.VendaItemWizardDatetimeVendaItem_typeRange() == 'R' && (entitySearchRange.VendaItemWizardDatetimeVendaItem_begin() != null || entitySearchRange.VendaItemWizardDatetimeVendaItem_end() != null) || (entitySearchRange.VendaItemWizardDatetimeVendaItem_typeRange() == 'P' && entitySearchRange.VendaItemWizardDatetimeVendaItem_predefFilter().length > 0)); });
           ...
           if (vm.status() !== 'C') {
               ...
               colunas.forEach(function (entry, index) {
                   if (entry.hidden && entry.key !== 'RowDataId') {
                       var control = $('#CadastroVendaItem_div' + (!dataView ? '' : '' + dataView + '_') + entry.key + 'Template');
    ...
    var vm = {
            ...
            rootDataTypeName: 'VendaItemWizard',
            ...
            createAndNotifyVendaItemWizard: createAndNotifyVendaItemWizard,
            ...
            __moduleId__: 'pkg_varejo-bv-spa/viewmodels/CadastroVendaItem'
        };
