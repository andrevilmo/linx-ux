...
var vmConstructor = function () {
      ...
      if ((typeof settings === 'object') && (settings != null) && settings.objectQuery) {
          ...
          if ((typeof settings === 'object') && (settings != null) && settings.uiSettings) {
              ...
              if (uiSettings.executeQuery === true) {
                  ...
                  filteredEntities = [];
                  if (settings.parentVM) { settings.parentVM.internalUIs = [ 'TelaPrincipal' ]; settings.parentVM.TelaPrincipal = getVM; }
                  clear();
                  ...
                  if ((typeof settings.parentVM === 'object') && settings.parentVM != null) {
                      ...
                      if ($.inArray('TelaPrincipal', parentVM.internalUIs) === -1) parentVM.internalUIs.push('TelaPrincipal');
                  }
              }
          }
          else {
    ...
    var adjustModuleSecurity = function () {
        ...
        managerAuth.getFormAccess('varejo-bv-spa-TelaPrincipal', function (data) {
    ...
    var canActivate = function() {
        ...
        if (data.lxShellCompiledVersion != managerAuth.shellVersion) {
            app.showMessage('Versão de formulário incompatível com a versão de ambiente [' + managerAuth.shellVersion + '].', 'Formulário: TelaPrincipal', ['Ok']);
            return false;
        }
        return true;
    };
    ...
    var compositionComplete = function() {
        $('#TelaPrincipal_gbVenda').one('shown.bs.collapse', function (e) { vm.notifyInnerElements($(e.currentTarget), true); });

    complement.renderscyTelaPrincipal_dGrid(vm);
    ...
    var getMaxLength = function(entityName, propertyName){
        if (isNullOrEmpty(entityName)) entityName = 'VendaPrincipal';
    ...
    var visibleColumns = 'BigIntVenda,BitVenda,ComboboxVenda,DatetimeVenda,DecimalVenda,IdVenda,IntVenda,SmallIntVenda,StringVenda';
    ...
    var exportData = function (forceAdd, isExcelDataSource) {
        if (forceAdd)
            require(['viewmodels/shared/addCustomExport'],
                function(addCustomExport){ addCustomExport.showModal(vm, null, 'VendaPrincipal', getVisiblePropertiesForExcel('dataView'), null, true, isExcelDataSource); } );
        else
            require(['viewmodels/shared/customExport'],
                function(modalExport){ modalExport.showModal(vm, 'VendaPrincipal', getVisiblePropertiesForExcel('dataView'), null, { canAdd: true, canEdit: true, canDel: true }, isExcelDataSource); } );
    };
    ...
    var query = function (lookupInitializing, parentEntity, quickSearchJExpression, externalQueryCallBack, noMessages, noDetails) {
        ...
        if (freeEntityForQuerying == null && isChildVM()) freeEntityForQuerying = dataContext.createFreeEntity('VendaPrincipal');
        ...
        return dataContext.getVendaPrincipalByEntitySearchNoAssociations(lastJEntitySearch, 0, pageSize(), (pageSize() > 0), preserveDataCurrentState(), status() !== 'E', sortInfo).then(querySucceeded).fin(complete);
        ...
        function querySucceeded(data) {
            if (vm.status() !== 'E') { for (var idx = 0; idx < data.results.length; idx++) { dataContext.initializePOCO(data.results[idx], 'VendaPrincipal'); } }
            hasError = false;
    ...
    var refresh = function (curPage, goLast) {
        ...
        return dataContext.getVendaPrincipalByEntitySearchNoAssociations(lastJEntitySearch, curPage * pageSize(), pageSize(), false, false, status() !== 'E', sortInfo).then(querySucceeded).fin(complete);
    ...
    var clear = function (noBindingReport) {
        ...
        else return dataContext.clearVendaPrincipal(getBandeiraRede(), clearComplete);
    ...
    var createVendaPrincipal = function() {
        dataBind('dataView', true);
        var entity = dataContext.createVendaPrincipal();
    ...
    var createAndNotifyVendaPrincipal = function() {
        var entity = createVendaPrincipal();
        notifyPresentation('');
        return entity;
    };
    ...
    var removeFormViewControl = function () {
        var front = $('#TelaPrincipal_formViewer_front')[0];
        if (front) front.removeClassName('front');
        var back = $('#TelaPrincipal_formViewer_back')[0];
    ...
    var changeFormView = function () {
        ...
        var panel = $('#TelaPrincipal_formViewer')[0];
    ...
    var entitySearchRange = {
        predefinedFilters: ko.observableArray(managerPredefined.predefinedFilters),
            VendaPrincipalDatetimeVenda_typeRange: ko.observable('R'), VendaPrincipalDatetimeVenda_begin: ko.observable(null), VendaPrincipalDatetimeVenda_end: ko.observable(null), VendaPrincipalDatetimeVenda_predefFilter: ko.observableArray([]), VendaPrincipalDatetimeVenda_predefValue: ko.observable(null),
        VendaPrincipalBigIntVenda_begin: ko.observable(null), VendaPrincipalBigIntVenda_end: ko.observable(null),
        VendaPrincipalDecimalVenda_begin: ko.observable(null), VendaPrincipalDecimalVenda_end: ko.observable(null),
        VendaPrincipalIdVenda_begin: ko.observable(null), VendaPrincipalIdVenda_end: ko.observable(null),
        VendaPrincipalIntVenda_begin: ko.observable(null), VendaPrincipalIntVenda_end: ko.observable(null),
        VendaPrincipalSmallIntVenda_begin: ko.observable(null), VendaPrincipalSmallIntVenda_end: ko.observable(null)
    };
    entitySearchRange.clear = function(){
            entitySearchRange.VendaPrincipalDatetimeVenda_typeRange('R'); entitySearchRange.VendaPrincipalDatetimeVenda_begin(null); entitySearchRange.VendaPrincipalDatetimeVenda_end(null); entitySearchRange.VendaPrincipalDatetimeVenda_predefFilter([]); entitySearchRange.VendaPrincipalDatetimeVenda_predefValue(null);
        entitySearchRange.VendaPrincipalBigIntVenda_begin(null); entitySearchRange.VendaPrincipalBigIntVenda_end(null);
        entitySearchRange.VendaPrincipalDecimalVenda_begin(null); entitySearchRange.VendaPrincipalDecimalVenda_end(null);
        entitySearchRange.VendaPrincipalIdVenda_begin(null); entitySearchRange.VendaPrincipalIdVenda_end(null);
        entitySearchRange.VendaPrincipalIntVenda_begin(null); entitySearchRange.VendaPrincipalIntVenda_end(null);
        entitySearchRange.VendaPrincipalSmallIntVenda_begin(null); entitySearchRange.VendaPrincipalSmallIntVenda_end(null);
    };
    entitySearchRange.has_VendaPrincipalBigIntVenda = ko.computed(function(){ return (entitySearchRange.VendaPrincipalBigIntVenda_begin() != null || entitySearchRange.VendaPrincipalBigIntVenda_end() != null); });
    entitySearchRange.has_VendaPrincipalDecimalVenda = ko.computed(function(){ return (entitySearchRange.VendaPrincipalDecimalVenda_begin() != null || entitySearchRange.VendaPrincipalDecimalVenda_end() != null); });
    entitySearchRange.has_VendaPrincipalIdVenda = ko.computed(function(){ return (entitySearchRange.VendaPrincipalIdVenda_begin() != null || entitySearchRange.VendaPrincipalIdVenda_end() != null); });
    entitySearchRange.has_VendaPrincipalIntVenda = ko.computed(function(){ return (entitySearchRange.VendaPrincipalIntVenda_begin() != null || entitySearchRange.VendaPrincipalIntVenda_end() != null); });
    entitySearchRange.has_VendaPrincipalSmallIntVenda = ko.computed(function(){ return (entitySearchRange.VendaPrincipalSmallIntVenda_begin() != null || entitySearchRange.VendaPrincipalSmallIntVenda_end() != null); });
    entitySearchRange.has_VendaPrincipalDatetimeVenda = ko.computed(function(){ return (entitySearchRange.VendaPrincipalDatetimeVenda_typeRange() == 'R' && (entitySearchRange.VendaPrincipalDatetimeVenda_begin() != null || entitySearchRange.VendaPrincipalDatetimeVenda_end() != null) || (entitySearchRange.VendaPrincipalDatetimeVenda_typeRange() == 'P' && entitySearchRange.VendaPrincipalDatetimeVenda_predefFilter().length > 0)); });
           ...
           if (vm.status() !== 'C') {
               ...
               colunas.forEach(function (entry, index) {
                   if (entry.hidden && entry.key !== 'RowDataId') {
                       var control = $('#TelaPrincipal_div' + (!dataView ? '' : '' + dataView + '_') + entry.key + 'Template');
    ...
    var vm = {
            ...
            rootDataTypeName: 'VendaPrincipal',
            ...
            createAndNotifyVendaPrincipal: createAndNotifyVendaPrincipal,
            ...
            __moduleId__: 'pkg_varejo-bv-spa/viewmodels/TelaPrincipal'
        };
