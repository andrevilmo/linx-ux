...
namespace VAREJO.BV.Domains
{
	...
	public partial class DomainHelper
    {
		...
		public static Dictionary<string, Dictionary<string, string>> GetAllDomainsInfo()
        {
            ...
            values = GetDomainValues("LX_LOJA");
            if (values.Count > 0)
            {
            	result.Add("LX_LOJA", values);                    
            }
            values = GetDomainValues("LX_ESTADO");
            if (values.Count > 0)
            {
            	result.Add("LX_ESTADO", values);                    
            }
            values = GetDomainValues("LX_PAIS");
            if (values.Count > 0)
            {
            	result.Add("LX_PAIS", values);                    
            }
            ...
            values = GetDomainValues("LX_CLIENTE");
            if (values.Count > 0)
            {
            	result.Add("LX_CLIENTE", values);                    
            }
            ...
            values = GetDomainValues("LX_VENDA_PAI");
            if (values.Count > 0)
            {
            	result.Add("LX_VENDA_PAI", values);                    
            }
            values = GetDomainValues("LX_VENDA_FILHA");
            if (values.Count > 0)
            {
            	result.Add("LX_VENDA_FILHA", values);                    
            }
            values = GetDomainValues("LX_VENDA_ATACADO");
            if (values.Count > 0)
            {
            	result.Add("LX_VENDA_ATACADO", values);                    
            }
            return result;
        }
        ...
        public static Dictionary<string, string> GetDomainValues(string domainName)
        {
            ...
            switch (domainName)
            {
                ...
                case "LX_LOJA":
                    result = LX_LOJA.GetValues();
                    break;

                case "LX_ESTADO":
                    result = LX_ESTADO.GetValues();
                    break;

                case "LX_PAIS":
                    result = LX_PAIS.GetValues();
                    break;
                ...
                case "LX_VENDA_PAI":
                    result = LX_VENDA_PAI.GetValues();
                    break;

                case "LX_VENDA_FILHA":
                    result = LX_VENDA_FILHA.GetValues();
                    break;

                case "LX_VENDA_ATACADO":
                    result = LX_VENDA_ATACADO.GetValues();
                    break;
	...
	//<LX_LOJA>((#LxExpr#) == [-1-] ? "LOJA 1" : ((#LxExpr#) == [-2-] ? "LOJA 2" : ((#LxExpr#) == [-3-] ? "LOJA 3" : "")))</LX_LOJA>	
    public partial class LX_LOJA
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("1", "LOJA 1"); 
						
						domainValues.Add("2", "LOJA 2"); 
						
						domainValues.Add("3", "LOJA 3"); 
	...
	//<LX_ESTADO>((#LxExpr#) == [-1-] ? "ESTADO 1" : ((#LxExpr#) == [-2-] ? "ESTADO 2" : ((#LxExpr#) == [-3-] ? "ESTADO 3" : ((#LxExpr#) == [-4-] ? "ESTADO 4" : ""))))</LX_ESTADO>	
    public partial class LX_ESTADO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("1", "ESTADO 1"); 
						
						domainValues.Add("2", "ESTADO 2"); 
						
						domainValues.Add("3", "ESTADO 3"); 
						
						domainValues.Add("4", "ESTADO 4"); 
	...
	//<LX_PAIS>((#LxExpr#) == [-1-] ? "PAIS 1" : ((#LxExpr#) == [-2-] ? "PAIS 2" : ((#LxExpr#) == [-3-] ? "PAIS 3" : "")))</LX_PAIS>	
    public partial class LX_PAIS
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("1", "PAIS 1"); 
						
						domainValues.Add("2", "PAIS 2"); 
						
						domainValues.Add("3", "PAIS 3"); 
	...
	//<LX_VENDA>((#LxExpr#) == [-1-] ? "VENDA 1" : ((#LxExpr#) == [-2-] ? "VENDA 2" : ((#LxExpr#) == [-3-] ? "VENDA 3" : "")))</LX_VENDA>	
    public partial class LX_VENDA
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("1", "VENDA 1"); 
						
						domainValues.Add("2", "VENDA 2"); 
						
						domainValues.Add("3", "VENDA 3"); 
	...
	//<LX_VENDEDOR>((#LxExpr#) == [-1-] ? "VENDEDOR 1" : ((#LxExpr#) == [-2-] ? "VENDEDOR 2" : ((#LxExpr#) == [-3-] ? "VENDEDOR 3" : "")))</LX_VENDEDOR>	
    public partial class LX_VENDEDOR
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("1", "VENDEDOR 1"); 
						
						domainValues.Add("2", "VENDEDOR 2"); 
						
						domainValues.Add("3", "VENDEDOR 3"); 
	...
	//<LX_FORMA_PAGAMENTO>((#LxExpr#) == [-1-] ? "FORMA PAGAMENTO 1" : ((#LxExpr#) == [-2-] ? "FORMA PAGAMENTO 2" : ((#LxExpr#) == [-3-] ? "FORMA PAGAMENTO 3" : "")))</LX_FORMA_PAGAMENTO>	
    public partial class LX_FORMA_PAGAMENTO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("1", "FORMA PAGAMENTO 1"); 
						
						domainValues.Add("2", "FORMA PAGAMENTO 2"); 
						
						domainValues.Add("3", "FORMA PAGAMENTO 3"); 
	...
	//<LX_CLIENTE>((#LxExpr#) == [-1-] ? "CLIENTE 1" : ((#LxExpr#) == [-2-] ? "CLIENTE 2" : ((#LxExpr#) == [-3-] ? "CLIENTE 3" : "")))</LX_CLIENTE>	
    public partial class LX_CLIENTE
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("1", "CLIENTE 1"); 
						
						domainValues.Add("2", "CLIENTE 2"); 
						
						domainValues.Add("3", "CLIENTE 3"); 
	...
	//<LX_VENDA_ITEM>((#LxExpr#) == [-1-] ? "VENDA ITEM 1" : ((#LxExpr#) == [-2-] ? "VENDA ITEM 2" : ((#LxExpr#) == [-3-] ? "VENDA ITEM 3" : "")))</LX_VENDA_ITEM>	
    public partial class LX_VENDA_ITEM
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("1", "VENDA ITEM 1"); 
						
						domainValues.Add("2", "VENDA ITEM 2"); 
						
						domainValues.Add("3", "VENDA ITEM 3"); 
	...
	//<LX_VENDA_PAI>((#LxExpr#) == [-A-] ? "VENDA 1" : ((#LxExpr#) == [-B-] ? "VENDA 2" : ((#LxExpr#) == [-C-] ? "VENDA 3" : "")))</LX_VENDA_PAI>	
    public partial class LX_VENDA_PAI
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("A", "VENDA 1"); 
						
						domainValues.Add("B", "VENDA 2"); 
						
						domainValues.Add("C", "VENDA 3"); 
	...
	//<LX_VENDA_FILHA>((#LxExpr#) == [-A-] ? "VENDA ITEM 1" : ((#LxExpr#) == [-B-] ? "VENDA ITEM 2" : ((#LxExpr#) == [-C-] ? "VENDA ITEM 3" : "")))</LX_VENDA_FILHA>	
    public partial class LX_VENDA_FILHA
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("A", "VENDA ITEM 1"); 
						
						domainValues.Add("B", "VENDA ITEM 2"); 
						
						domainValues.Add("C", "VENDA ITEM 3"); 
	...
	//<LX_VENDA_ATACADO>((#LxExpr#) == [-1-] ? "VENDA 1" : ((#LxExpr#) == [-2-] ? "VENDA 2" : ((#LxExpr#) == [-3-] ? "VENDA 3" : "")))</LX_VENDA_ATACADO>	
