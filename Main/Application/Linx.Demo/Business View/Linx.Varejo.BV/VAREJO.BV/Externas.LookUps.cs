...
namespace VAREJO.BV.Externas
{
	...
	[Serializable()]
	[FunctionalPoint("ClassDescription[Look Up ESTADO];DisplayName[Look Up ESTADO];Height[0];Width[0];Entities[ESTADO:IdEstado];EdmEntityName[ESTADO]")]	
	...
	[DataContract(IsReference = false)]
	[Serializable()]
	[FunctionalPoint("ClassDescription[Look Up CLIENTE];DisplayName[Look Up CLIENTE];Height[0];Width[0];Entities[CLIENTE:IdCliente];EdmEntityName[CLIENTE]")]	
	...
	[DataContract(IsReference = false)]
	[Serializable()]
	[FunctionalPoint("ClassDescription[Look Up LOJA];DisplayName[Look Up LOJA];Height[0];Width[0];Entities[LOJA:IdLoja];EdmEntityName[LOJA]")]	
	...
	[DataContract(IsReference = false)]
	[Serializable()]
	[FunctionalPoint("ClassDescription[Look Up PAIS];DisplayName[Look Up PAIS];Height[0];Width[0];Entities[PAIS:IdPais];EdmEntityName[PAIS]")]	
