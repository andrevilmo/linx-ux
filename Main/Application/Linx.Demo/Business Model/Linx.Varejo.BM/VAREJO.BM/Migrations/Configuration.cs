...
namespace VAREJO.BM.Migrations
{
    using System;
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ConnBV>
    {
	...
	internal sealed class SqlMigrator : SqlServerMigrationSqlGenerator
    {
            ...
            : base()
        {
            ...
            //Add Foreign Keys
            _tableMigrator.Fks.Add("dbo.ESTADO.ID_ESTADO.dbo.CLIENTE.ID_ESTADO", "FK_CLIENTE_ESTADO,true");
            _tableMigrator.Fks.Add("dbo.PAIS.ID_PAIS.dbo.ESTADO.ID_PAIS", "FK_ESTADO_PAIS1,true");
            _tableMigrator.Fks.Add("dbo.VENDA.ID_VENDA.dbo.FORMA_PAGAMENTO.ID_VENDA", "FK_FORMA_PAGAMENTO_VENDA,true");
            ...
            _tableMigrator.Fks.Add("dbo.CLIENTE.ID_CLIENTE.dbo.VENDA_ATACADO.ID_CLIENTE", "FK_VENDA_ATACADO_CLIENTE,true");
