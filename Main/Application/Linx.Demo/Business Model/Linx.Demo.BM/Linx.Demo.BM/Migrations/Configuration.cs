...
namespace Linx.Demo.BM.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<DCLinxDemoBM>
    {
	...
	internal sealed class SqlMigrator : SqlServerMigrationSqlGenerator
    {
            ...
            : base()
        {
            ...
            //Add Indexes
            createIndexOperation = new CreateIndexOperation() { Table = "dbo.CLIENTE", IsUnique = false, Name = "IX_ID_ESTADO" };
            createIndexOperation.Columns.Add("ID_ESTADO");
            _tableMigrator.Indexes.Add(createIndexOperation);
            createIndexOperation = new CreateIndexOperation() { Table = "dbo.ESTADO", IsUnique = false, Name = "IX_ID_PAIS" };
            createIndexOperation.Columns.Add("ID_PAIS");
            _tableMigrator.Indexes.Add(createIndexOperation);
            createIndexOperation = new CreateIndexOperation() { Table = "dbo.FORMA_PAGAMENTO", IsUnique = false, Name = "IX_ID_VENDA" };
            createIndexOperation.Columns.Add("ID_VENDA");
            _tableMigrator.Indexes.Add(createIndexOperation);
            createIndexOperation = new CreateIndexOperation() { Table = "dbo.VENDA", IsUnique = false, Name = "IX_ID_LOJA" };
            ...
            _tableMigrator.Indexes.Add(createIndexOperation);
            //Add Primary Keys
            _tableMigrator.PrimaryKeys["dbo.CLIENTE"] = "PK_CLIENTE";
            _tableMigrator.PrimaryKeys["dbo.ESTADO"] = "PK_ESTADO_1";
            _tableMigrator.PrimaryKeys["dbo.FORMA_PAGAMENTO"] = "PK_FORMA_PAGAMENTO_1";
            _tableMigrator.PrimaryKeys["dbo.LOJA"] = "PK_LOJA_1";
            _tableMigrator.PrimaryKeys["dbo.PAIS"] = "PK_PAIS_1";
            _tableMigrator.PrimaryKeys["dbo.VENDA"] = "PK_VENDA_1";
            _tableMigrator.PrimaryKeys["dbo.VENDA_ITEM"] = "PK_VENDA_ITEM_1";
            _tableMigrator.PrimaryKeys["dbo.VENDEDOR"] = "PK_VENDEDOR_1";
            _tableMigrator.PrimaryKeys["dbo.VENDA_ATACADO"] = "PK_VENDA_ATACADO";
            //Add Nullables
            _tableMigrator.Nullables.Add("dbo.CLIENTE.ID_ESTADO");
            _tableMigrator.Nullables.Add("dbo.ESTADO.ID_PAIS");
            _tableMigrator.Nullables.Add("dbo.FORMA_PAGAMENTO.ID_VENDA");
            _tableMigrator.Nullables.Add("dbo.VENDA.ID_LOJA");
            _tableMigrator.Nullables.Add("dbo.VENDA.ID_CLIENTE");
            _tableMigrator.Nullables.Add("dbo.VENDA_ITEM.ID_VENDA");
            _tableMigrator.Nullables.Add("dbo.VENDEDOR.ID_LOJA");
            _tableMigrator.Nullables.Add("dbo.VENDA_ATACADO.ID_CLIENTE");
            //Add Foreign Keys
            _tableMigrator.Fks.Add("dbo.ESTADO.ID_ESTADO.dbo.CLIENTE.ID_ESTADO", "FK_CLIENTE_ESTADO,false");
            _tableMigrator.Fks.Add("dbo.PAIS.ID_PAIS.dbo.ESTADO.ID_PAIS", "FK_ESTADO_PAIS1,false");
            _tableMigrator.Fks.Add("dbo.VENDA.ID_VENDA.dbo.FORMA_PAGAMENTO.ID_VENDA", "FK_FORMA_PAGAMENTO_VENDA,false");
            _tableMigrator.Fks.Add("dbo.CLIENTE.ID_CLIENTE.dbo.VENDA.ID_CLIENTE", "FK_VENDA_CLIENTE,true");
            _tableMigrator.Fks.Add("dbo.LOJA.ID_LOJA.dbo.VENDA.ID_LOJA", "FK_VENDA_LOJA1,true");
            _tableMigrator.Fks.Add("dbo.VENDA.ID_VENDA.dbo.VENDA_ITEM.ID_VENDA", "FK_VENDA_ITEM_VENDA1,true");
            _tableMigrator.Fks.Add("dbo.LOJA.ID_LOJA.dbo.VENDEDOR.ID_LOJA", "FK_VENDEDOR_LOJA,true");
            _tableMigrator.Fks.Add("dbo.CLIENTE.ID_CLIENTE.dbo.VENDA_ATACADO.ID_CLIENTE", "FK_VENDA_ATACADO_CLIENTE,false");
