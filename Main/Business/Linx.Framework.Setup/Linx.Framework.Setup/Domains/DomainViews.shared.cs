...
namespace Linx.Framework.Setup.Domains
{
	...
	public partial class DomainHelper
    {
		...
		public static Dictionary<string, Dictionary<string, string>> GetAllDomainsInfo()
        {
            ...
            values = GetDomainValues("LX_STATUS_PONTEIRO");
            if (values.Count > 0)
            {
            	result.Add("LX_STATUS_PONTEIRO", values);                    
            }
            values = GetDomainValues("LX_TIPO_PONTEIRO");
            if (values.Count > 0)
            {
            	result.Add("LX_TIPO_PONTEIRO", values);                    
            }
            ...
            values = GetDomainValues("LX_STATUS_DOCUMENTO_ROMANEIO");
            if (values.Count > 0)
            {
            	result.Add("LX_STATUS_DOCUMENTO_ROMANEIO", values);                    
            }
            ...
            values = GetDomainValues("DmvLxTipoEnderecoEletronico");
            if (values.Count > 0)
            {
            	result.Add("DmvLxTipoEnderecoEletronico", values);                    
            }
            values = GetDomainValues("DmvLxTipoTelefone");
            if (values.Count > 0)
            {
            	result.Add("DmvLxTipoTelefone", values);                    
            }
            return result;
        }
        ...
        public static Dictionary<string, string> GetDomainValues(string domainName)
        {
            ...
            switch (domainName)
            {
                ...
                case "LX_STATUS_PONTEIRO":
                    result = LX_STATUS_PONTEIRO.GetValues();
                    break;

                case "LX_TIPO_PONTEIRO":
                    result = LX_TIPO_PONTEIRO.GetValues();
                    break;
                ...
                case "LX_STATUS_DOCUMENTO_ROMANEIO":
                    result = LX_STATUS_DOCUMENTO_ROMANEIO.GetValues();
                    break;
                ...
                case "DmvLxTipoEnderecoEletronico":
                    result = DmvLxTipoEnderecoEletronico.GetValues();
                    break;

                case "DmvLxTipoTelefone":
                    result = DmvLxTipoTelefone.GetValues();
                    break;
	...
	//<TIPO_OPERACAO>((#LxExpr#) == [-E-] ? "Alteração" : ((#LxExpr#) == [-D-] ? "Exclusão" : ((#LxExpr#) == [-I-] ? "Inserção" : "")))</TIPO_OPERACAO>	
	...
	//<LX_STATUS_PONTEIRO>((#LxExpr#) == [-1-] ? "Aguardando Processamento" : ((#LxExpr#) == [-2-] ? "Em Processamento" : ((#LxExpr#) == [-9-] ? "Erro" : ((#LxExpr#) == [-3-] ? "Processado" : ""))))</LX_STATUS_PONTEIRO>	
    public partial class LX_STATUS_PONTEIRO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("1", "Aguardando Processamento"); 
						
						domainValues.Add("2", "Em Processamento"); 
						
						domainValues.Add("9", "Erro"); 
						
						domainValues.Add("3", "Processado"); 
			...
			public static Dictionary<string, string> GetNames()
			{
					...
					result.Add("1", "AguardandoProcessamento"); 
				    
					result.Add("2", "EmProcessamento"); 
			...
			#region properties
					...
					private static DomainKeyPair _AguardandoProcessamento = new DomainKeyPair() { Value = "1", DisplayName = "Aguardando Processamento" };
					[FunctionalPoint("Value[1];DisplayName[Aguardando Processamento]")]
					public static DomainKeyPair AguardandoProcessamento { get { return _AguardandoProcessamento; } }
				    
					private static DomainKeyPair _EmProcessamento = new DomainKeyPair() { Value = "2", DisplayName = "Em Processamento" };
					[FunctionalPoint("Value[2];DisplayName[Em Processamento]")]
	...
	//<LX_TIPO_PONTEIRO>((#LxExpr#) == [-3-] ? "Conferência de Entrada de Mercadorias" : ((#LxExpr#) == [-1-] ? "Nota Fiscal de Entrada" : ((#LxExpr#) == [-2-] ? "Nota Fiscal de Saída" : "")))</LX_TIPO_PONTEIRO>	
    public partial class LX_TIPO_PONTEIRO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("3", "Conferência de Entrada de Mercadorias"); 
						
						domainValues.Add("1", "Nota Fiscal de Entrada"); 
						
						domainValues.Add("2", "Nota Fiscal de Saída"); 
			...
			public static Dictionary<string, string> GetNames()
			{
					...
					result.Add("3", "CONFERENCIA_ROMANEIO"); 
				    
					result.Add("1", "NF_ENTRADA"); 
				    
					result.Add("2", "NF_SAIDA"); 
			...
			#region properties
					...
					private static DomainKeyPair _CONFERENCIA_ROMANEIO = new DomainKeyPair() { Value = "3", DisplayName = "Conferência de Entrada de Mercadorias" };
					[FunctionalPoint("Value[3];DisplayName[Conferência de Entrada de Mercadorias]")]
					public static DomainKeyPair CONFERENCIA_ROMANEIO { get { return _CONFERENCIA_ROMANEIO; } }
				    
					private static DomainKeyPair _NF_ENTRADA = new DomainKeyPair() { Value = "1", DisplayName = "Nota Fiscal de Entrada" };
					[FunctionalPoint("Value[1];DisplayName[Nota Fiscal de Entrada]")]
					public static DomainKeyPair NF_ENTRADA { get { return _NF_ENTRADA; } }
				    
					private static DomainKeyPair _NF_SAIDA = new DomainKeyPair() { Value = "2", DisplayName = "Nota Fiscal de Saída" };
					[FunctionalPoint("Value[2];DisplayName[Nota Fiscal de Saída]")]
					public static DomainKeyPair NF_SAIDA { get { return _NF_SAIDA; } }
    ...
    public partial class LX_MODALIDADE_FRETE
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("1", "Por Conta do Destinatário/Remetente"); 
						
						domainValues.Add("100", "Por Conta do Emitente"); 
						
						domainValues.Add("2", "Por Conta de Terceiros"); 
						
						domainValues.Add("9", "Sem Frete"); 
    ...
    public partial class LX_TIPO_LOGRADOURO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("2", "Avenida"); 
						
						domainValues.Add("1", "Rua"); 
    ...
    public partial class LX_VIA_TRANSPORTE
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("4", "Aérea"); 
						
						domainValues.Add("8", "Conduto rede transmissão"); 
						
						domainValues.Add("11", "Courier"); 
						
						domainValues.Add("10", "Entrada e Saida ficta"); 
						
						domainValues.Add("6", "Ferroviária"); 
						
						domainValues.Add("2", "Fluvial"); 
						
						domainValues.Add("12", "Hand Carry"); 
						
						domainValues.Add("3", "Lacustre"); 
						
						domainValues.Add("1", "Marítima"); 
						
						domainValues.Add("9", "Meios Próprios"); 
						
						domainValues.Add("5", "Postal"); 
						
						domainValues.Add("7", "Rodoviária"); 
    ...
    public partial class LX_TIPO_TELEFONE
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("3", "Celular"); 
						
						domainValues.Add("2", "Comercial"); 
						
						domainValues.Add("1", "Residencial"); 
    ...
    public partial class LX_TIPO_END_ELETRONICO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("1", "E-mail"); 
						
						domainValues.Add("3", "FaceBook"); 
						
						domainValues.Add("4", "LinkedIn"); 
						
						domainValues.Add("2", "Site"); 
						
						domainValues.Add("5", "Skype"); 
    ...
    public partial class LX_TIPO_ENDERECO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("3", "Coleta"); 
						
						domainValues.Add("2", "Comercial"); 
						
						domainValues.Add("4", "Entrega"); 
    ...
    public partial class LX_GRUPO_RELACAO_TIPO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("45", "Comercial Compra"); 
						
						domainValues.Add("40", "Comercial Venda"); 
						
						domainValues.Add("20", "Relação Empresarial"); 
						
						domainValues.Add("25", "Relação Financeira"); 
						
						domainValues.Add("15", "Relação Funcional"); 
						
						domainValues.Add("30", "Relação Logística "); 
						
						domainValues.Add("10", "Relação Pessoal"); 
						
						domainValues.Add("35", "Relação Transporte"); 
    ...
    public partial class LX_TIPO_CARTAO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("1", "Cartão de Crédito"); 
						
						domainValues.Add("2", "Cartão de Débito"); 
    ...
    public partial class LX_STATUS_ARTIGO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("3", "Aguardando Liberação"); 
						
						domainValues.Add("2", "Em Desenvolvimento"); 
						
						domainValues.Add("1", "Inativo"); 
						
						domainValues.Add("4", "Liberado"); 
    ...
    public partial class LX_CODIGO_ITEM_FISCAL
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("1", "Por Artigo"); 
						
						domainValues.Add("3", "Por GTIN"); 
						
						domainValues.Add("2", "Por Sku"); 
    ...
    public partial class LX_STATUS_LOJA
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("1", "Em fase de Abertura"); 
						
						domainValues.Add("3", "Fechamento Temporário"); 
						
						domainValues.Add("2", "Loja Aberta"); 
						
						domainValues.Add("4", "Loja Fechada"); 
    ...
    public partial class LX_STATUS_ACAO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("2", "Aguardando Data de Execução"); 
						
						domainValues.Add("5", "Cancelada"); 
						
						domainValues.Add("3", "Em Execução"); 
						
						domainValues.Add("1", "Em Planejamento"); 
						
						domainValues.Add("4", "Encerrada"); 
    ...
    public partial class LX_STATUS_COLETA
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("4", "Coleta Eleita"); 
						
						domainValues.Add("2", "Coleta Finalizada"); 
						
						domainValues.Add("1", "Coleta em Andamento"); 
    ...
    public partial class LX_STATUS_COLETA_ITEM
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("9", "Coleta Processada"); 
						
						domainValues.Add("3", "Coleta Rejeitada"); 
    ...
    public partial class dmvDias
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("1", "Domingo"); 
						
						domainValues.Add("8", "Quarta"); 
						
						domainValues.Add("16", "Quinta"); 
						
						domainValues.Add("64", "Sábado"); 
						
						domainValues.Add("2", "Segunda"); 
						
						domainValues.Add("32", "Sexta"); 
						
						domainValues.Add("4", "Terça"); 
    ...
    public partial class GiftTipoRequisicao
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("2", "Carga"); 
						
						domainValues.Add("4", "Confirmacao"); 
						
						domainValues.Add("5", "Desfazimento"); 
						
						domainValues.Add("6", "Estorno"); 
						
						domainValues.Add("3", "Resgate"); 
						
						domainValues.Add("1", "Saldo"); 
    ...
    public partial class ProvedorGiftCard
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("1", "Peela"); 
						
						domainValues.Add("2", "Unik"); 
    ...
    public partial class DmvPjpf
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("0", "Pessoa Física"); 
						
						domainValues.Add("1", "Pesoa Jurídica"); 
    ...
    public partial class LX_TABELA_ATRIBUTO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("1", "Artigo"); 
						
						domainValues.Add("2", "Cliente"); 
						
						domainValues.Add("4", "LOJA"); 
						
						domainValues.Add("3", "Variante Sku"); 
    ...
    public partial class LX_SEXO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("2", "Feminino"); 
						
						domainValues.Add("1", "Masculino"); 
						
						domainValues.Add("3", "Não Informado"); 
    ...
    public partial class LX_TIPO_PRECO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("5", "Concorrência"); 
						
						domainValues.Add("2", "Custo Médio"); 
						
						domainValues.Add("1", "Custo Reposição"); 
						
						domainValues.Add("4", "Preço de Venda Atacado"); 
						
						domainValues.Add("3", "Preço de Venda Varejo"); 
    ...
    public partial class LX_TIPO_ATENDIMENTO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("2", "Devolução"); 
						
						domainValues.Add("1", "Venda"); 
    ...
    public partial class LX_STATUS_REGISTRO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("3", "Enviado"); 
						
						domainValues.Add("2", "Enviando"); 
						
						domainValues.Add("1", "Pendente"); 
    ...
    public partial class LX_STATUS_OPERACAO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("1", "Loja Aberta"); 
						
						domainValues.Add("3", "Loja Fechada"); 
						
						domainValues.Add("4", "Movimento Integrado"); 
						
						domainValues.Add("2", "Venda Encerrada"); 
    ...
    public partial class LX_TIPO_ITEM
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("6", "Correspondente Bancário"); 
						
						domainValues.Add("1", "Mercadoria"); 
						
						domainValues.Add("7", "Outros Recebimentos Financeiros"); 
						
						domainValues.Add("3", "Pedido"); 
						
						domainValues.Add("5", "Recarga Celular"); 
						
						domainValues.Add("2", "Serviço"); 
						
						domainValues.Add("4", "Vale Presente"); 
    ...
    public partial class LX_TIPO_RESGATE
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("1", "Desconto"); 
						
						domainValues.Add("2", "Pagamento"); 
    ...
    public partial class LX_FILTRO_TIPO_LOJA
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("2", "Lojas não participantes"); 
						
						domainValues.Add("1", "Lojas participantes"); 
						
						domainValues.Add("3", "Todas as lojas"); 
    ...
    public partial class LX_FILTRO_TIPO_OPERACAO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("2", "Operações não participantes"); 
						
						domainValues.Add("1", "Operações participantes"); 
						
						domainValues.Add("3", "Todas as operações"); 
    ...
    public partial class LX_FILTRO_TIPO_PGTO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("2", "Tipos não participantes"); 
						
						domainValues.Add("1", "Tipos participantes"); 
						
						domainValues.Add("3", "Todos os tipos"); 
    ...
    public partial class LX_STATUS_PEDIDO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("5", "Faturamento iniciado"); 
						
						domainValues.Add("3", "Pedido cancelado"); 
						
						domainValues.Add("1", "Pedido em confecção"); 
						
						domainValues.Add("4", "Pedido encerrado"); 
						
						domainValues.Add("2", "Pedido publicado"); 
    ...
    public partial class LX_TIPO_PEDIDO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("3", "Lista de presente"); 
						
						domainValues.Add("2", "Pedido ecommerce"); 
						
						domainValues.Add("1", "Pré venda"); 
    ...
    public partial class LX_TIPO_LISTA
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("2", "Casamento"); 
						
						domainValues.Add("1", "Presente"); 
    ...
    public partial class LX_ESTADO_CIVIL
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("2", "Casado(a)"); 
						
						domainValues.Add("4", "Divorciado(a)"); 
						
						domainValues.Add("6", "Outros"); 
						
						domainValues.Add("3", "Separado(a)"); 
						
						domainValues.Add("1", "Solteiro(a)"); 
						
						domainValues.Add("5", "Viúvo(a)"); 
    ...
    public partial class LX_TIPO_VALIDACAO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("1", "Atributos"); 
						
						domainValues.Add("2", "Faixa de Valores"); 
						
						domainValues.Add("4", "Livre"); 
						
						domainValues.Add("3", "Tabelas de Sistemas"); 
    ...
    public partial class LX_PRIORIDADE_PROMOCAO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("4", "Alta"); 
						
						domainValues.Add("2", "Baixa"); 
						
						domainValues.Add("3", "Média"); 
						
						domainValues.Add("5", "Muito Alta"); 
						
						domainValues.Add("1", "Muito Baixa"); 
    ...
    public partial class LX_TIPO_OFERTA
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("7", "Brinde Próprio"); 
						
						domainValues.Add("8", "Brinde Terceiro"); 
						
						domainValues.Add("11", "Campanha Estacionamento"); 
						
						domainValues.Add("10", "Campanha Frete"); 
						
						domainValues.Add("14", "Comissão Extra"); 
						
						domainValues.Add("17", "Cupom Promocional"); 
						
						domainValues.Add("2", "Desconto Item"); 
						
						domainValues.Add("1", "Desconto Subtotal"); 
						
						domainValues.Add("3", "Desconto Subtotal Cupom"); 
						
						domainValues.Add("4", "Desconto Subtotal Gift"); 
						
						domainValues.Add("9", "Gift Terceiro"); 
						
						domainValues.Add("15", "Outras Ofertas"); 
						
						domainValues.Add("12", "Pontuação Fidelidade"); 
						
						domainValues.Add("13", "Pontuação Vendedor"); 
						
						domainValues.Add("16", "Sem Benefício"); 
						
						domainValues.Add("6", "Vale Produto Outra Venda"); 
						
						domainValues.Add("5", "Vale Produto Venda Atual"); 
    ...
    public partial class LX_STATUS_LGE_PEDIDO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("4", "Aguardando Recebimento"); 
						
						domainValues.Add("3", "Aprovação Externa"); 
						
						domainValues.Add("2", "Aprovação Interna"); 
						
						domainValues.Add("9", "Cancelado"); 
						
						domainValues.Add("1", "Em Elaboração"); 
						
						domainValues.Add("5", "Já Faturado e em trânsito"); 
						
						domainValues.Add("6", "Encerrado"); 
						
						domainValues.Add("7", "Não Aprovado Internamente"); 
    ...
    public partial class LX_STATUS_ATENDIMENTO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("3", "Atendimento Concluído"); 
						
						domainValues.Add("1", "Atendimento em Andamento"); 
						
						domainValues.Add("2", "Atendimento Suspenso"); 
						
						domainValues.Add("0", "Indefinido"); 
    ...
    public partial class LX_FATOR_STK_MOV
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("1", "Entrada"); 
						
						domainValues.Add("-1", "Saída"); 
    ...
    public partial class LX_TIPO_OPERACAO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("5", "Ajuste de Estoque"); 
						
						domainValues.Add("7", "Loja Devolução"); 
						
						domainValues.Add("3", "Entrada no Estoque"); 
						
						domainValues.Add("1", "Entrada de Nota Fiscal"); 
						
						domainValues.Add("50", "Financeiro a Pagar"); 
						
						domainValues.Add("60", "Financeiro a Receber"); 
						
						domainValues.Add("4", "Saída do Estoque"); 
						
						domainValues.Add("2", "Saida de Nota Fiscal"); 
						
						domainValues.Add("6", "Loja Venda"); 
    ...
    public partial class LX_COND_PAGTO_STATUS
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("4", "Aprovada"); 
						
						domainValues.Add("3", "Em Aprovação Externa"); 
						
						domainValues.Add("2", "Em Aprovação Interna"); 
						
						domainValues.Add("1", "Em Elaboração"); 
						
						domainValues.Add("5", "Reprovada"); 
    ...
    public partial class LX_TIPO_COND_PAGTO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("1", "À Vista"); 
						
						domainValues.Add("2", "Parcela Fixa"); 
						
						domainValues.Add("3", "Parcela Variável"); 
    ...
    public partial class LX_STATUS_NFE
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("14", "Aguardando Informações"); 
						
						domainValues.Add("8", "Autorizado"); 
						
						domainValues.Add("5", "Autorizando"); 
						
						domainValues.Add("11", "Cancelado"); 
						
						domainValues.Add("7", "Consultando"); 
						
						domainValues.Add("13", "Denegado"); 
						
						domainValues.Add("9", "Erro na Comunicação com o MID-e"); 
						
						domainValues.Add("10", "Erro da SEFAZ"); 
						
						domainValues.Add("2", "Erro na Solicitação do XML"); 
						
						domainValues.Add("12", "Inutilizado"); 
						
						domainValues.Add("16", "NF não Eletrônica"); 
						
						domainValues.Add("4", "Pendente de Autorização"); 
						
						domainValues.Add("6", "Pendente de Consulta"); 
						
						domainValues.Add("15", "Recebimento de NF-e de Entrada"); 
						
						domainValues.Add("3", "Solicitando XML"); 
						
						domainValues.Add("1", "Solicitar XML"); 
    ...
    public partial class LX_TIPO_PARCEIRO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("1", "Envio de e-mails"); 
						
						domainValues.Add("3", "Envio de mala direta"); 
						
						domainValues.Add("2", "Envio de SMS"); 
						
						domainValues.Add("6", "Fornecedor de Brinde"); 
						
						domainValues.Add("4", "Fornecedor de  Gift Card de conteúdo"); 
						
						domainValues.Add("5", "Limpeza de dados"); 
    ...
    public partial class LX_STATUS_INTEGRACAO_FISCAL
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("2", "Integrado"); 
						
						domainValues.Add("1", "Não Integrado"); 
						
						domainValues.Add("3", "Reintegrar"); 
						
						domainValues.Add("9", "Trânsito Integração"); 
    ...
    public partial class LX_ORIGEM_DESCONTO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("6", "Fidelidade"); 
						
						domainValues.Add("4", "Manual"); 
						
						domainValues.Add("5", "Operação"); 
						
						domainValues.Add("1", "Pagamento"); 
						
						domainValues.Add("2", "Promoção"); 
						
						domainValues.Add("3", "Promoção Brinde"); 
						
						domainValues.Add("7", "Tabela de Preço"); 
    ...
    public partial class LX_OPERADOR
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("1", "E"); 
						
						domainValues.Add("4", "E ("); 
						
						domainValues.Add("6", ")"); 
						
						domainValues.Add("7", ") E"); 
						
						domainValues.Add("8", ") OU"); 
						
						domainValues.Add("2", "OU"); 
						
						domainValues.Add("5", "OU ("); 
    ...
    public partial class LX_TIPO_CODIGO_BARRA
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("2", "GTIN-12"); 
						
						domainValues.Add("3", "GTIN-13"); 
						
						domainValues.Add("4", "GTIN-14"); 
						
						domainValues.Add("1", "GTIN-8"); 
						
						domainValues.Add("9", "Próprio"); 
    ...
    public partial class LX_TIPO_FISCAL
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("104", "Desenvolvimento"); 
						
						domainValues.Add("100", "ECF"); 
						
						domainValues.Add("99", "Não se Aplica"); 
						
						domainValues.Add("101", "NFCe"); 
						
						domainValues.Add("102", "NFe"); 
						
						domainValues.Add("103", "Pré Venda"); 
						
						domainValues.Add("105", "SAT"); 
    ...
    public partial class LX_PEDIDO_ORIGEM
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("1", "Caixa"); 
						
						domainValues.Add("0", "Indefinido"); 
						
						domainValues.Add("2", "Microterminal"); 
						
						domainValues.Add("3", "Mobile"); 
    ...
    public partial class TipoFiltro
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("1", "Filtro BO"); 
						
						domainValues.Add("2", "Filtro EDM (Entity SQL)"); 
    ...
    public partial class LX_INDICADOR_MERCADORIA
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("A", "Armamento"); 
						
						domainValues.Add("C", "Combustível e Lubrificante"); 
						
						domainValues.Add("K", "Kit / Embalagem / Lista"); 
						
						domainValues.Add("L", "Look"); 
						
						domainValues.Add("M", "Medicamento"); 
						
						domainValues.Add("P", "Produto"); 
						
						domainValues.Add("S", "Serviço"); 
						
						domainValues.Add("V", "Veículo"); 
    ...
    public partial class LX_EMBALAGEM
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("2", "Embalagem"); 
						
						domainValues.Add("3", "Kit"); 
						
						domainValues.Add("4", "Lista de Produtos"); 
						
						domainValues.Add("1", "Único"); 
    ...
    public partial class LX_TIPO_MENSAGEM
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("3", "Cliente não Fidelidade"); 
						
						domainValues.Add("4", "Cliente não identificado na venda"); 
						
						domainValues.Add("1", "Cliente Fidelidade que pontuou na venda"); 
						
						domainValues.Add("2", "Cliente Fidelidade que resgatou pontos na venda"); 
    ...
    public partial class LX_STATUS_CONFERENCIA_CTRL
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("2", "Conferido"); 
						
						domainValues.Add("3", "Com Divergência"); 
						
						domainValues.Add("4", "Financeiro Gerado"); 
						
						domainValues.Add("1", "Não Conferido"); 
    ...
    public partial class LX_TIPO_CONFERENCIA
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("3", "Período"); 
						
						domainValues.Add("2", "Terminal"); 
						
						domainValues.Add("1", "Tipo de Pagamento"); 
    ...
    public partial class LX_TIPO_OCORRENCIA
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("3", "Exclusão"); 
						
						domainValues.Add("1", "Inclusão"); 
						
						domainValues.Add("2", "Manutenção"); 
    ...
    public partial class LX_LOJA_TIPO_AGRUPAMENTO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("2", "Agrupamento Comercial"); 
						
						domainValues.Add("1", "Agrupamento Sortimento"); 
    ...
    public partial class LX_STATUS_CENARIO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("2", "Ativo"); 
						
						domainValues.Add("1", "Em Elaboração"); 
						
						domainValues.Add("3", "Inativo"); 
    ...
    public partial class LX_STATUS_PROCESSO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("4", "Em Processamento"); 
						
						domainValues.Add("3", "Erro"); 
						
						domainValues.Add("1", "Não Processado"); 
						
						domainValues.Add("2", "Processado"); 
    ...
    public partial class LX_ORIGEM_MOVIMENTO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("4", "Capturada do Resumo da NFCe"); 
						
						domainValues.Add("5", "Capturada do Resumo do SAT"); 
						
						domainValues.Add("1", "Capturada pelo Sistema"); 
						
						domainValues.Add("2", "Digitada na Loja"); 
						
						domainValues.Add("3", "Digitada na Retaguarda"); 
    ...
    public partial class LX_STATUS_REDUCAO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("3", "Ausência de Redução Anterior"); 
						
						domainValues.Add("9", "Erro"); 
						
						domainValues.Add("1", "Não Processado"); 
						
						domainValues.Add("2", "Validado"); 
    ...
    public partial class LX_STATUS_REQUISICAO_ITEM
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("1", "Aguardando Pedido"); 
						
						domainValues.Add("3", "Cancelado"); 
						
						domainValues.Add("2", "Pedido Gerado"); 
    ...
    public partial class LX_TIPO_AJUSTE
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("1", "Completo"); 
						
						domainValues.Add("2", "Parcial"); 
    ...
    public partial class LX_METODO_RECONTAGEM
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("2", "Somente com Divergência"); 
						
						domainValues.Add("1", "Todos os Itens do Setor"); 
    ...
    public partial class LX_STATUS_INVENTARIO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("3", "Aguardando Ajuste"); 
						
						domainValues.Add("2", "Aguardando Coleta"); 
						
						domainValues.Add("1", "Em Definição"); 
						
						domainValues.Add("4", "Finalizado"); 
    ...
    public partial class LX_STATUS_INVENTARIO_SETOR
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("1", "Aguardando Coleta"); 
    ...
    public partial class LX_STATUS_CONFERENCIA
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("2", "Aguardando Confronto"); 
						
						domainValues.Add("3", "Conferência em Análise"); 
						
						domainValues.Add("1", "Em Contagem"); 
						
						domainValues.Add("4", "Conferência Finalizada"); 
    ...
    public partial class LX_STATUS_CONFRONTO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("1", "Aguarda Confronto"); 
						
						domainValues.Add("2", "Conferência = NF"); 
						
						domainValues.Add("3", "Conferência > NF "); 
						
						domainValues.Add("5", "Conferência > NF - Op1-Devolução"); 
						
						domainValues.Add("6", "Conferência > NF - Op2-Complementar"); 
						
						domainValues.Add("4", "Conferência < NF "); 
						
						domainValues.Add("7", "Conferência < NF - Op1-Dev.Simbolica"); 
	...
	//<LX_STATUS_ROMANEIO>((#LxExpr#) == [-3-] ? "Finalizado" : ((#LxExpr#) == [-2-] ? "Pendente" : ((#LxExpr#) == [-1-] ? "Não Considera" : "")))</LX_STATUS_ROMANEIO>	
    public partial class LX_STATUS_ROMANEIO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("3", "Finalizado"); 
						
						domainValues.Add("2", "Pendente"); 
						
						domainValues.Add("1", "Não Considera"); 
    ...
    public partial class LX_TIPO_EMISSAO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("1", "Própria"); 
						
						domainValues.Add("2", "Terceiro"); 
    ...
    public partial class LX_OCORRENCIA_CUSTO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("1", "Processado"); 
						
						domainValues.Add("2", "Saldo Negativo"); 
						
						domainValues.Add("3", "Saldo sem composição "); 
    ...
    public partial class LX_INDICADOR_PRESENCA
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("100", "Nao se aplica"); 
						
						domainValues.Add("4", "NFC-e com Entrega em Domicílio"); 
						
						domainValues.Add("2", "Operação pela Internet"); 
						
						domainValues.Add("9", "Operação não presencial / Outros"); 
						
						domainValues.Add("1", "Operação Presencial"); 
						
						domainValues.Add("3", "Operação por Teleatendimento"); 
	...
	//<LX_STATUS_DOCUMENTO_ROMANEIO>((#LxExpr#) == [-4-] ? "Aguardando Autorização da NF" : ((#LxExpr#) == [-3-] ? "Aguardando Mercadoria" : ((#LxExpr#) == [-2-] ? "Aguardando Nota Fiscal" : ((#LxExpr#) == [-9-] ? "Cancelado" : ((#LxExpr#) == [-1-] ? "Em Elaboração" : ((#LxExpr#) == [-5-] ? "Finalizado" : ""))))))</LX_STATUS_DOCUMENTO_ROMANEIO>	
    public partial class LX_STATUS_DOCUMENTO_ROMANEIO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("4", "Aguardando Autorização da NF"); 
						
						domainValues.Add("3", "Aguardando Mercadoria"); 
						
						domainValues.Add("2", "Aguardando Nota Fiscal"); 
						
						domainValues.Add("9", "Cancelado"); 
						
						domainValues.Add("1", "Em Elaboração"); 
						
						domainValues.Add("5", "Finalizado"); 
    ...
    public partial class LX_PROPRIEDADE_STK
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("3", "Estoque com Terceiro"); 
						
						domainValues.Add("2", "Estoque de Terceiro"); 
						
						domainValues.Add("4", "Estoque de Terceiro com Terceiro"); 
						
						domainValues.Add("1", "Estoque Próprio"); 
    ...
    public partial class LX_LOJA_SORTIMENTO_METODO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("9", "Digitação Mínimo, Máximo e Ideal"); 
						
						domainValues.Add("3", "Estoque Ideal"); 
						
						domainValues.Add("4", "Calcular Estoque Ideal"); 
						
						domainValues.Add("2", "Estoque Mínimo"); 
						
						domainValues.Add("8", "Importação"); 
						
						domainValues.Add("1", "Venda Período"); 
    ...
    public partial class LX_STATUS_GERACAO_COMPRA
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("3", "Compra Gerada"); 
						
						domainValues.Add("1", "Gerar Compra"); 
						
						domainValues.Add("2", "Não Gerar Compra"); 
    ...
    public partial class LX_STATUS_NF_DOC_FISCAL
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("2", "Autorizado"); 
						
						domainValues.Add("3", "Cancelado"); 
						
						domainValues.Add("6", "Contingência Offline"); 
						
						domainValues.Add("5", "Denegado"); 
						
						domainValues.Add("4", "Inutilizado"); 
    ...
    public partial class LX_TIPO_VALOR_ATENDIMENTO_ATRIBUTO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("1", "Saldo de Pontos"); 
    ...
    public partial class LX_ORIGEM_ATENDIMENTO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("3", "Ecommerce"); 
						
						domainValues.Add("4", "Televenda"); 
						
						domainValues.Add("2", "Venda Direta"); 
						
						domainValues.Add("1", "Venda Loja Física"); 
    ...
    public partial class LX_STATUS_COMISSAO_PERIODO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("2", "Aguardando Processamento"); 
						
						domainValues.Add("1", "Em preparação"); 
						
						domainValues.Add("9", "Finalizado"); 
    ...
    public partial class LX_COMISSAO_PROCESSO_TIPO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("36", "Funcionário - Adicional - Governo"); 
						
						domainValues.Add("34", "Grupo Econômico - Adicional - Governo"); 
						
						domainValues.Add("35", "Loja - Adicional - Governo"); 
						
						domainValues.Add("53", "UF - Adicional - Governo"); 
						
						domainValues.Add("3", "Funcionário - Comissão Base"); 
						
						domainValues.Add("1", "Grupo Econômico - Comissão Base"); 
						
						domainValues.Add("2", "Loja - Comissão Base"); 
						
						domainValues.Add("4", "Grupo Econômico - Comissão Base - Operação"); 
						
						domainValues.Add("5", "Loja - Comissão Base - Operação"); 
						
						domainValues.Add("42", "UF - Comissão Base - Operação"); 
						
						domainValues.Add("6", "Grupo Econômico - Comissão Base - Promoção"); 
						
						domainValues.Add("7", "Loja - Comissão Base - Promoção"); 
						
						domainValues.Add("43", "UF - Comissão Base - Promoção"); 
						
						domainValues.Add("41", "UF - Comissão Base"); 
						
						domainValues.Add("98", "Fonte Externa de Valores"); 
						
						domainValues.Add("99", "Não Elegível"); 
						
						domainValues.Add("10", "Funcionário - Prêmio - Meta Loja"); 
						
						domainValues.Add("8", "Grupo Econômico - Prêmio - Meta Loja"); 
						
						domainValues.Add("9", "Loja - Prêmio - Meta Loja"); 
						
						domainValues.Add("44", "UF - Prêmio - Meta Loja"); 
						
						domainValues.Add("13", "Funcionário - Prêmio - Meta Vendedor"); 
						
						domainValues.Add("11", "Grupo Econômico - Prêmio - Meta Vendedor"); 
						
						domainValues.Add("12", "Loja - Prêmio - Meta Vendedor"); 
						
						domainValues.Add("40", "Funcionário - Prêmio - Adicional de Superação de Meta"); 
						
						domainValues.Add("38", "Grupo Econômico - Prêmio - Adicional de Superação de Meta"); 
						
						domainValues.Add("39", "Loja - Prêmio - Adicional de Superação de Meta"); 
						
						domainValues.Add("54", "UF - Prêmio - Adicional de Superação de Meta"); 
						
						domainValues.Add("33", "Funcionário - Prêmio - Superação de Meta"); 
						
						domainValues.Add("31", "Grupo Econômico - Prêmio - Superação de Meta"); 
						
						domainValues.Add("32", "Loja - Prêmio - Superação de Meta"); 
						
						domainValues.Add("52", "UF - Prêmio - Superação de Meta"); 
						
						domainValues.Add("45", "UF - Prêmio - Meta Vendedor"); 
						
						domainValues.Add("25", "Funcionário - Prêmio - Quantidade de Cupons"); 
						
						domainValues.Add("23", "Grupo Econômico - Prêmio - Quantidade de Cupons"); 
						
						domainValues.Add("24", "Loja - Prêmio - Quantidade de Cupons"); 
						
						domainValues.Add("49", "UF - Prêmio - Quantidade de Cupons"); 
						
						domainValues.Add("28", "Funcionário - Prêmio - Valor de Cupom"); 
						
						domainValues.Add("26", "Grupo Econômico - Prêmio - Valor de Cupom"); 
						
						domainValues.Add("27", "Loja - Prêmio - Valor de Cupom"); 
						
						domainValues.Add("50", "UF - Prêmio - Valor de Cupom"); 
						
						domainValues.Add("16", "Funcionário - Prêmio - Ticket Médio"); 
						
						domainValues.Add("14", "Grupo Econômico - Prêmio - Ticket Médio"); 
						
						domainValues.Add("15", "Loja - Prêmio - Ticket Médio"); 
						
						domainValues.Add("46", "UF - Prêmio - Ticket Médio"); 
						
						domainValues.Add("29", "Grupo Econômico - Prêmio - Tipo Pagamento"); 
						
						domainValues.Add("30", "Loja - Prêmio - Tipo Pagamento"); 
						
						domainValues.Add("51", "UF - Prêmio - Tipo Pagamento"); 
						
						domainValues.Add("19", "Funcionário - Prêmio - Venda Cartão Presente"); 
						
						domainValues.Add("17", "Grupo Econômico - Prêmio - Venda Cartão Presente"); 
						
						domainValues.Add("18", "Loja - Prêmio - Venda Cartão Presente"); 
						
						domainValues.Add("47", "UF - Prêmio - Venda Cartão Presente"); 
						
						domainValues.Add("20", "Grupo Econômico - Prêmio - Venda Produto"); 
						
						domainValues.Add("21", "Loja - Prêmio - Venda Produto"); 
						
						domainValues.Add("48", "UF - Prêmio - Venda Produto"); 
						
						domainValues.Add("37", "Vendedor - Prêmio - Venda Produto"); 
    ...
    public partial class LX_FUNCAO_VENDEDOR
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("3", "Caixa"); 
						
						domainValues.Add("2", "Gerente"); 
						
						domainValues.Add("1", "Vendedor"); 
    ...
    public partial class LX_TIPO_COMISSAO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("1", "Oficial"); 
						
						domainValues.Add("2", "Simulação"); 
    ...
    public partial class LX_TIPO_NF_RELACAO
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("60", "À Ordem"); 
						
						domainValues.Add("91", "À Retornar"); 
						
						domainValues.Add("99", "Complementar"); 
						
						domainValues.Add("70", "CTRC de NF"); 
						
						domainValues.Add("20", "Devolução"); 
						
						domainValues.Add("51", "Devolução de Transferência"); 
						
						domainValues.Add("81", "Entrega Futura"); 
						
						domainValues.Add("71", "Fatura Frete"); 
						
						domainValues.Add("10", "Não Relacionada"); 
						
						domainValues.Add("90", "NF de Cupom Fiscal"); 
						
						domainValues.Add("82", "Recebimento Futuro"); 
						
						domainValues.Add("30", "Retorno Físico"); 
						
						domainValues.Add("31", "Retorno Simbólico"); 
						
						domainValues.Add("80", "Simples Faturamento"); 
						
						domainValues.Add("50", "Transferência"); 
	...
	//<DmvLxTipoEnderecoEletronico>((#LxExpr#) == [-3-] ? "E-mail Geral" : ((#LxExpr#) == [-4-] ? "E-mail NF-e" : ((#LxExpr#) == [-2-] ? "E-mail Pessoal" : ((#LxExpr#) == [-1-] ? "E-mail Profissional" : ((#LxExpr#) == [-99-] ? "Outros" : ((#LxExpr#) == [-20-] ? "Rede Social" : ((#LxExpr#) == [-10-] ? "Site" : "")))))))</DmvLxTipoEnderecoEletronico>	
    public partial class DmvLxTipoEnderecoEletronico
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("3", "E-mail Geral"); 
						
						domainValues.Add("4", "E-mail NF-e"); 
						
						domainValues.Add("2", "E-mail Pessoal"); 
						
						domainValues.Add("1", "E-mail Profissional"); 
						
						domainValues.Add("99", "Outros"); 
						
						domainValues.Add("20", "Rede Social"); 
						
						domainValues.Add("10", "Site"); 
			...
			public static Dictionary<string, string> GetNames()
			{
					...
					result.Add("3", "EMAIL_GERAL"); 
				    
					result.Add("4", "EMAIL_NFE"); 
				    
					result.Add("2", "EMAIL_PESSOAL"); 
				    
					result.Add("1", "EMAIL_PROFISSIONAL"); 
				    
					result.Add("99", "OUTROS"); 
				    
					result.Add("20", "REDE_SOCIAL"); 
			...
			#region properties
					...
					private static DomainKeyPair _EMAIL_GERAL = new DomainKeyPair() { Value = "3", DisplayName = "E-mail Geral" };
					[FunctionalPoint("Value[3];DisplayName[E-mail Geral]")]
					public static DomainKeyPair EMAIL_GERAL { get { return _EMAIL_GERAL; } }
				    
					private static DomainKeyPair _EMAIL_NFE = new DomainKeyPair() { Value = "4", DisplayName = "E-mail NF-e" };
					[FunctionalPoint("Value[4];DisplayName[E-mail NF-e]")]
					public static DomainKeyPair EMAIL_NFE { get { return _EMAIL_NFE; } }
				    
					private static DomainKeyPair _EMAIL_PESSOAL = new DomainKeyPair() { Value = "2", DisplayName = "E-mail Pessoal" };
					[FunctionalPoint("Value[2];DisplayName[E-mail Pessoal]")]
					public static DomainKeyPair EMAIL_PESSOAL { get { return _EMAIL_PESSOAL; } }
				    
					private static DomainKeyPair _EMAIL_PROFISSIONAL = new DomainKeyPair() { Value = "1", DisplayName = "E-mail Profissional" };
					[FunctionalPoint("Value[1];DisplayName[E-mail Profissional]")]
					public static DomainKeyPair EMAIL_PROFISSIONAL { get { return _EMAIL_PROFISSIONAL; } }
				    
					private static DomainKeyPair _OUTROS = new DomainKeyPair() { Value = "99", DisplayName = "Outros" };
					[FunctionalPoint("Value[99];DisplayName[Outros]")]
					public static DomainKeyPair OUTROS { get { return _OUTROS; } }
				    
					private static DomainKeyPair _REDE_SOCIAL = new DomainKeyPair() { Value = "20", DisplayName = "Rede Social" };
					[FunctionalPoint("Value[20];DisplayName[Rede Social]")]
					public static DomainKeyPair REDE_SOCIAL { get { return _REDE_SOCIAL; } }
				    
					private static DomainKeyPair _SITE = new DomainKeyPair() { Value = "10", DisplayName = "Site" };
					[FunctionalPoint("Value[10];DisplayName[Site]")]
					public static DomainKeyPair SITE { get { return _SITE; } }
	...
	//<DmvLxTipoTelefone>((#LxExpr#) == [-2-] ? "Celular Comercial" : ((#LxExpr#) == [-3-] ? "Celular Corporativo" : ((#LxExpr#) == [-1-] ? "Celular Pessoal" : ((#LxExpr#) == [-20-] ? "FAX" : ((#LxExpr#) == [-11-] ? "Fixo Comercial" : ((#LxExpr#) == [-12-] ? "Fixo Corporativo" : ((#LxExpr#) == [-10-] ? "Fixo Residencial" : ((#LxExpr#) == [-99-] ? "Outros" : ((#LxExpr#) == [-30-] ? "Pager" : ((#LxExpr#) == [-40-] ? "Rádio" : ((#LxExpr#) == [-50-] ? "VOIP - Skype" : "")))))))))))</DmvLxTipoTelefone>	
    public partial class DmvLxTipoTelefone
    {
			...
			public static Dictionary<string, string> GetValues()
			{
					if (domainValues == null)
					{
						...
						domainValues.Add("2", "Celular Comercial"); 
						
						domainValues.Add("3", "Celular Corporativo"); 
						
						domainValues.Add("1", "Celular Pessoal"); 
						
						domainValues.Add("20", "FAX"); 
						
						domainValues.Add("11", "Fixo Comercial"); 
						
						domainValues.Add("12", "Fixo Corporativo"); 
						
						domainValues.Add("10", "Fixo Residencial"); 
						
						domainValues.Add("99", "Outros"); 
						
						domainValues.Add("30", "Pager"); 
						
						domainValues.Add("40", "Rádio"); 
						
						domainValues.Add("50", "VOIP - Skype"); 
			...
			public static Dictionary<string, string> GetNames()
			{
					...
					result.Add("2", "CELULAR_COMERCIAL"); 
				    
					result.Add("3", "CELULAR_CORPORATIVO"); 
				    
					result.Add("1", "CELULAR_PESSOAL"); 
				    
					result.Add("20", "FAX"); 
				    
					result.Add("11", "FIXO_COMERCIAL"); 
				    
					result.Add("12", "FIXO_CORPORATIVO"); 
				    
					result.Add("10", "FIXO_RESIDENCIAL"); 
			...
			#region properties
					...
					private static DomainKeyPair _CELULAR_COMERCIAL = new DomainKeyPair() { Value = "2", DisplayName = "Celular Comercial" };
					[FunctionalPoint("Value[2];DisplayName[Celular Comercial]")]
					public static DomainKeyPair CELULAR_COMERCIAL { get { return _CELULAR_COMERCIAL; } }
				    
					private static DomainKeyPair _CELULAR_CORPORATIVO = new DomainKeyPair() { Value = "3", DisplayName = "Celular Corporativo" };
					[FunctionalPoint("Value[3];DisplayName[Celular Corporativo]")]
					public static DomainKeyPair CELULAR_CORPORATIVO { get { return _CELULAR_CORPORATIVO; } }
				    
					private static DomainKeyPair _CELULAR_PESSOAL = new DomainKeyPair() { Value = "1", DisplayName = "Celular Pessoal" };
					[FunctionalPoint("Value[1];DisplayName[Celular Pessoal]")]
					public static DomainKeyPair CELULAR_PESSOAL { get { return _CELULAR_PESSOAL; } }
				    
					private static DomainKeyPair _FAX = new DomainKeyPair() { Value = "20", DisplayName = "FAX" };
					[FunctionalPoint("Value[20];DisplayName[FAX]")]
					public static DomainKeyPair FAX { get { return _FAX; } }
				    
					private static DomainKeyPair _FIXO_COMERCIAL = new DomainKeyPair() { Value = "11", DisplayName = "Fixo Comercial" };
					[FunctionalPoint("Value[11];DisplayName[Fixo Comercial]")]
					public static DomainKeyPair FIXO_COMERCIAL { get { return _FIXO_COMERCIAL; } }
				    
					private static DomainKeyPair _FIXO_CORPORATIVO = new DomainKeyPair() { Value = "12", DisplayName = "Fixo Corporativo" };
					[FunctionalPoint("Value[12];DisplayName[Fixo Corporativo]")]
					public static DomainKeyPair FIXO_CORPORATIVO { get { return _FIXO_CORPORATIVO; } }
				    
					private static DomainKeyPair _FIXO_RESIDENCIAL = new DomainKeyPair() { Value = "10", DisplayName = "Fixo Residencial" };
					[FunctionalPoint("Value[10];DisplayName[Fixo Residencial]")]
					public static DomainKeyPair FIXO_RESIDENCIAL { get { return _FIXO_RESIDENCIAL; } }
				    
					private static DomainKeyPair _OUTROS = new DomainKeyPair() { Value = "99", DisplayName = "Outros" };
					[FunctionalPoint("Value[99];DisplayName[Outros]")]
					public static DomainKeyPair OUTROS { get { return _OUTROS; } }
				    
					private static DomainKeyPair _PAGER = new DomainKeyPair() { Value = "30", DisplayName = "Pager" };
					[FunctionalPoint("Value[30];DisplayName[Pager]")]
					public static DomainKeyPair PAGER { get { return _PAGER; } }
				    
					private static DomainKeyPair _RADIO = new DomainKeyPair() { Value = "40", DisplayName = "Rádio" };
					[FunctionalPoint("Value[40];DisplayName[Rádio]")]
					public static DomainKeyPair RADIO { get { return _RADIO; } }
				    
					private static DomainKeyPair _VOIP_SKYPE = new DomainKeyPair() { Value = "50", DisplayName = "VOIP - Skype" };
					[FunctionalPoint("Value[50];DisplayName[VOIP - Skype]")]
					public static DomainKeyPair VOIP_SKYPE { get { return _VOIP_SKYPE; } }
