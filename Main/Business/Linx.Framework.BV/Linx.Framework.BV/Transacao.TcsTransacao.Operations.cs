...
namespace Linx.Framework.BV.Transacao
{
    ...
    public partial class TcsTransacao
    {
        ...
        {
            if (!this._DescObjeto.IsNullOrEmpty() || this.IdObjeto.IsNullOrEmpty())
        ...
        {
            if (!this._ClasseNomeObjeto.IsNullOrEmpty() || this.IdObjeto.IsNullOrEmpty())
        ...
        private string Values(int valueOption)
        {
            ...
            if (this._DescObjeto.IsNullOrEmpty() && !this.IdObjeto.IsNullOrEmpty())
            {
                string descriptions = Utils.GetDescObjeto(this.IdObjeto);
