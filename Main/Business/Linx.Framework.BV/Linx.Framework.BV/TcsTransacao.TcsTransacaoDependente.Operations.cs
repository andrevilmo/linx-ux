...
namespace Linx.TCS0101.BO.TcsTransacao
{
	...
	public partial class TcsTransacaoDependente
	{
        ...
        {
            if (!this._ClasseNome.IsNullOrEmpty() || this.UidTransacaoRelacionada.IsNullOrEmpty())
        ...
        {
            if (!this._DescTransacao.IsNullOrEmpty() || this.UidTransacaoRelacionada.IsNullOrEmpty())
        ...
        private string Values(int valueOption)
        {
            ...
            if (this._DescTransacao.IsNullOrEmpty() && !this.UidTransacaoRelacionada.IsNullOrEmpty())
            {
                string descriptions = Utils.GetDescTransacao(this.UidTransacaoRelacionada);
