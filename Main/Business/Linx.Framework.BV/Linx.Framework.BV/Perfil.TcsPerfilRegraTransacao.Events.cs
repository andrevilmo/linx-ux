...
namespace Linx.Framework.BV.Perfil
{
    ...
    public partial class TcsPerfilRegraTransacao
    {
        ...
        public static void OnLookUpingLookUpTcsPerfilRegraTransacao(ref IQueryable<LookUpTcsPerfilRegraTransacao> searchDefinition, string propertyName, EntitySearch entitySearch)
        {
            searchDefinition =
