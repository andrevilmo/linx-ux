    ...
    public partial class TcsAutorizacaoDomainService
    {
        ...
        public bool RecoverUserPassword(string userName)
        {
            ...
            using (TransactionScope transaction = new TransactionScope())
            {
                ...
                Linx.Tools.LinxMail.Send(usuario.Email, "Recuperação de senha de usuário.".Translate(), true, TcsAutorizacaoDomainService.EmailBody(usuario.NomeUsuario, usuario.NomeAutenticacao, password));
