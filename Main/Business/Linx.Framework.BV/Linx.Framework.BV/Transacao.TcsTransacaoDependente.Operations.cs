...
namespace Linx.Framework.BV.Transacao
{
	...
	public partial class TcsTransacaoDependente
	{
        ...
        {
            if (!this._ClasseNome.IsNullOrEmpty() || this.IdTransacaoRelacionada.IsNullOrEmpty())
        ...
        {
            if (!this._DescTransacao.IsNullOrEmpty() || this.IdTransacaoRelacionada.IsNullOrEmpty())
        ...
        private string Values(int valueOption)
        {
            ...
            if (this._DescTransacao.IsNullOrEmpty() && !this.IdTransacaoRelacionada.IsNullOrEmpty())
            {
                string descriptions = Utils.GetDescTransacao(this.IdTransacaoRelacionada);
