...
var result = function () {
    ...
    var getDataFeedUrl = function() {
       return getServiceAddress('LinxFrameworkUsuarioExternoOData');
    };
    ...
    var controllerName = 'LinxFrameworkUsuarioExterno';
    ...
    var lookUpNames = [];
    var entitylookUps = [];
    entityNames.push('TcsUsuarioExterno');
    metadataInfo['TcsUsuarioExterno'] = [
        ...
        { key: 'FoneCelular', isQbeZero: false, isDomain: false, domainName: '', lookupPropertyName: '', lookupVisibleColumns: '', maxLength: 20, validateMaxLength: true, isPartOfKey: false, headerText: 'Celular', width: '200px', dataType: 'string', format: '', hidden: false, unbound: false, group: null },
        { key: 'IdDispositivo', isQbeZero: false, isDomain: false, domainName: '', lookupPropertyName: '', lookupVisibleColumns: '', isRequired: true, maxLength: 256, validateMaxLength: true, isPartOfKey: false, headerText: 'ID Dispositivo', width: '400px', dataType: 'string', format: '', hidden: false, unbound: false, group: null },
        { key: 'IdentidadeExterna', isQbeZero: false, isDomain: false, domainName: '', lookupPropertyName: '', lookupVisibleColumns: '', maxLength: 250, validateMaxLength: true, isPartOfKey: false, headerText: 'ID Externo', width: '400px', dataType: 'string', format: '', hidden: false, unbound: false, group: null },
        { key: 'IdTcsUsuarioExterno', isQbeZero: false, isDomain: false, domainName: '', lookupPropertyName: '', lookupVisibleColumns: '', isRequired: true, maxLength: 24, isPartOfKey: true, headerText: 'Id Tcs Usuario Externo', width: '322px', dataType: 'number', format: 'int', hidden: false, unbound: false, group: null },
        ...
        { key: 'LxTipoAutenticador', isQbeZero: false, isDomain: true, domainName: 'TipoAutenticador', lookupPropertyName: '', lookupVisibleColumns: '', isRequired: true, maxLength: 3, isPartOfKey: false, headerText: 'Autenticador', width: '200px', dataType: 'number', format: 'int', hidden: false, unbound: false, group: null },
        { key: 'LxTipoAutenticadorName', isDomain: true, domainName: 'TipoAutenticador', lookupPropertyName: '', lookupVisibleColumns: '', maxLength: 0, isPartOfKey: false, headerText: 'Autenticador (Name)', width: '0px', dataType: 'string', format: '', hidden: true, unbound: false, group: null },
    ...
    dataExportInfo['TcsUsuarioExterno'] = [ 
        { name: 'TcsUsuarioExterno', canExportMedia: true , canExportReport: true, actionExport: 'LinxFrameworkUsuarioExterno/GetTcsUsuarioExternoToExcel', actionReport: 'LinxFrameworkUsuarioExterno/GetTcsUsuarioExternoToReportXml', actionFeed: 'LinxFrameworkUsuarioExternoOData/TcsUsuarioExterno', actionName: 'LinxFrameworkUsuarioExterno/GetTcsUsuarioExternoByEntitySearchNoAssociations', display: 'TcsUsuarioExterno',  metaData: function() { return metadataInfo['TcsUsuarioExterno']; } }
    ];
    entitylookUps.push('TcsUsuarioExterno');
    entitylookUps['TcsUsuarioExterno'] = [];
    ...
    // Configure TcsUsuarioExterno data type
    metadataStore.addEntityType({
    shortName: "TcsUsuarioExterno",
    ...
    ,IdDispositivo: { dataType: DataType.String, maxLength: 256, isNullable: false, isPartOfKey: false, validators: [ Validator.hasValueValidator, Validator.maxLength( {maxLength: 256})]  }
    ,IdentidadeExterna: { dataType: DataType.String, maxLength: 250, isNullable: true, isPartOfKey: false, validators: [ Validator.maxLength( {maxLength: 250})]  }
    ,IdTcsUsuarioExterno: { dataType: DataType.Int64, isNullable: false, isPartOfKey: true, validators: [ Validator.hasValueValidator]  }
    ,Inativo: { dataType: DataType.Boolean, isNullable: true, isPartOfKey: false, validators: [ ]  }
    ,LxTipoAutenticador: { dataType: DataType.Byte, isNullable: true, isPartOfKey: false, validators: [ Validator.hasValueValidator]  }
    ,LxTipoAutenticadorName: { dataType: DataType.String, isNullable: false, isPartOfKey: false, validators: [] }
    ...
    lookUpProperties['TcsUsuarioExterno'] = {};
    var TcsUsuarioExternoInitializer = function (ownerReference, isPOCO) {
       ownerReference.RowDataId = (isPOCO === true ? getNextSequence('TcsUsuarioExterno') : ko.observable(getNextSequence('TcsUsuarioExterno')));
       ...
       enableChangeTrack = true;
          ...
          ownerReference.refreshData = function(noWait, succeeded) {
             var filterByKey = 'TcsUsuarioExterno{' + 'IdTcsUsuarioExterno#==#L' + getAbsoluteValue(ownerReference.IdTcsUsuarioExterno).toString() + '}';
             ...
             return dataContext.getTcsUsuarioExternoByEntitySearchNoAssociations(filterByKey, 0, 0, false, true, ownerReference.isPOCO === true, '', querySucceeded);
       ...
       ownerReference.serverDataType['IdDispositivo'] = 'S';
       ownerReference.serverDataType['IdentidadeExterna'] = 'S';
       ownerReference.serverDataType['IdTcsUsuarioExterno'] = 'L';
       ownerReference.serverDataType['Inativo'] = 'B';
       ownerReference.serverDataType['LxTipoAutenticador'] = 'Y';
       ownerReference.serverDataType['NomeUsuario'] = 'S';
       ownerReference.typeName = 'TcsUsuarioExterno';
       ownerReference.isPrimaryKey = function(propertyName) {
           var keys = [ 'IdTcsUsuarioExterno' ];
       ...
       ownerReference.UpdateIndependentRelation = function(detailName) {
           ...
           for (var idxR = 0; idxR < cacheElements.length; idxR++) {
               if (typeof cacheElements[idxR].TcsUsuarioExterno !== 'function') { return; }
               else  if (cacheElements[idxR].TcsUsuarioExterno() != ownerReference) { cacheElements[idxR].TcsUsuarioExterno(ownerReference); }
           }
       }
       ...
       ownerReference.namespace = 'Linx.Framework.BV.UsuarioExterno';
       ownerReference.myProperties = [ 'CnpjCpf','DataCadastro','Email','FoneCelular','IdDispositivo','IdentidadeExterna','IdTcsUsuarioExterno','Inativo','LxTipoAutenticador','NomeUsuario' ];
    ...
    //#region Extended Domain Names
       if (isPOCO !== true) {
           ownerReference.LxTipoAutenticadorName.subscribe(
               function (newValue) {
                   if (newValue == null) { ownerReference.LxTipoAutenticadorName(''); return; }
                   var value = (dataDomains.getId('TipoAutenticador', newValue));
                   if (value != ownerReference.LxTipoAutenticador()) {
                       ownerReference.LxTipoAutenticador(value);
                   }
            });
    
           ownerReference.LxTipoAutenticador.subscribe(
           function (newValue) {
                   var value = (newValue == null) ? '' : dataDomains.getName('TipoAutenticador', newValue);
                   if (value != ownerReference.LxTipoAutenticadorName()) {
                       ownerReference.LxTipoAutenticadorName(value);
               }
           });
       }
    //#endregion Extended Domain Names
    };
    metadataStore.registerEntityTypeCtor("TcsUsuarioExterno", null, TcsUsuarioExternoInitializer);
    ...
    var clearTcsUsuarioExterno = function (idBandeiraRede, complete) {
        clearAll();
        resetSequence('TcsUsuarioExterno');
        var refTcsUsuarioExterno = manager.createEntity('TcsUsuarioExterno', {}, breeze.EntityState.Unchanged);
        if (complete) complete({ results: [ refTcsUsuarioExterno ] });
        return true;
    };
    
    var getTcsUsuarioExterno = function (predicate, preserveCurrentState, noTracking) {
        if (!preserveCurrentState) clearAll();
        var query = EntityQuery.from('GetTcsUsuarioExterno').noTracking(noTracking)
        .orderBy('IdTcsUsuarioExterno asc')
        ;
    ...
    var getTcsUsuarioExternoByEntitySearchNoAssociations = function (jEntitySearch, skip, take, returnInlineCount, preserveCurrentState, noTracking, orderByDef, succeeded, complete) {
        if (!preserveCurrentState) clearAll();
        ...
        if (hasEntitySearch && jEntitySearch.length > 1000) {
           $.ajax({
               type: 'POST',
               crossDomain: true,
               url: getServiceAddress('LinxFrameworkUsuarioExterno/AddTcsUsuarioExternoEntitySearchId'),
               globalError: true,
               headers: managerAuth.getHeaders(),
               ...
               success: function (response) {
                   var query = EntityQuery.from('GetTcsUsuarioExternoByEntitySearchIdNoAssociations').noTracking(noTracking)
                           .orderBy((isNullOrEmpty(orderByDef) ? 'IdTcsUsuarioExterno asc' : orderByDef))
                               ;
           ...
           var query = EntityQuery.from('GetTcsUsuarioExternoByEntitySearchNoAssociations').noTracking(noTracking)
           .orderBy((isNullOrEmpty(orderByDef) ? 'IdTcsUsuarioExterno asc' : orderByDef))
           ;
    ...
    // Define that the event name is 'UsuarioExternoContext_DataUpdate'.
    var contextUpdtEvt = 'UsuarioExternoContext_DataUpdate_' + getNewGuid();
    ...
    var saveChanges = function(saveSucceeded, saveFailed, fin, saveNoTRack) {
        if (saveNoTRack === true) {
            ...
            return $.ajax({
               type: 'POST',
               crossDomain: true,
               url: getServiceAddress('LinxFrameworkUsuarioExterno/Save' + vm.rootDataTypeName),
               globalError: false,
               contentType: 'application/json',
               async: true,
               cache: false,
    ...
    var createTcsUsuarioExterno = function() {
        ...
        enableChangeTrack = false;
        var entity = createEntity('TcsUsuarioExterno', { Inativo: false });
        entity.setDefaults();
    ...
    var exportReportDataSource = function(complete) {
        $.ajax({
           ...
           crossDomain: true,
           headers: managerAuth.getHeaders(),
           url: getServiceAddress("LinxFrameworkUsuarioExterno/GetReportDataSource"),
           success: function (response) {
    ...
    var exportTemplateReport = function(reportPath, complete) {
        $.ajax({
           ...
           crossDomain: true,
           headers: managerAuth.getHeaders(),
           url: getServiceAddress("LinxFrameworkUsuarioExterno/GetTemplateReport"),
    ...
    //#endregion getWithBinding
        ...
        var dataContext = {
            ...
            clearTcsUsuarioExterno: clearTcsUsuarioExterno,
            getTcsUsuarioExterno: getTcsUsuarioExterno,
            getTcsUsuarioExternoByEntitySearchNoAssociations: getTcsUsuarioExternoByEntitySearchNoAssociations
        };
    loadParameters();
    return dataContext;
