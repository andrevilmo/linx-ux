define(['managers/__auth', 'managers/user'], function (managerAuth, managerUser) {
    var complementCtor = function() {
        var complement = {
            isAutomatic: true
            , ChangedBrandCadastroUsuarioLocalPerfil_dGridExpander_e4f439559d84476db94e9b74fdcf41bd: function(vm, decimals, reset) {
                var i, format = '0.'.concat('0'.repeat(decimals)), grd =$('#CadastroUsuarioLocalPerfil_dGridExpander_e4f439559d84476db94e9b74fdcf41bd').data('igGrid'),
                    grdUpd = $('#CadastroUsuarioLocalPerfil_dGridExpander_e4f439559d84476db94e9b74fdcf41bd').data('igGridUpdating');
            ...
            , renderCadastroUsuarioLocalPerfil_dGridExpander_e4f439559d84476db94e9b74fdcf41bd: function(vm) {
                ...
                $('#CadastroUsuarioLocalPerfil_dGridExpander_e4f439559d84476db94e9b74fdcf41bd_headers').live('focus  keydown', function (evt) {
                    var keyCode = window.event ? evt.which : evt.keyCode;
                    if (keyCode === 9) {
                        var cols = $('#CadastroUsuarioLocalPerfil_dGridExpander_e4f439559d84476db94e9b74fdcf41bd').igGrid('option', 'columns');
                        var dataView = $('#CadastroUsuarioLocalPerfil_dGridExpander_e4f439559d84476db94e9b74fdcf41bd').data('igGrid').dataSource._dataView
                        if (dataView.length === 0) return;
                        var firstRow = dataView[0].RowDataId;
                        clear = vm.status() === 'C';
                        if (vm.status() === 'C')
                            $('#CadastroUsuarioLocalPerfil_dGridExpander_e4f439559d84476db94e9b74fdcf41bd').igGridUpdating('startEdit', firstRow, 0, true);
                        else {
                            ...
                            cols.some(function (entry) {
                                if (entry.key !== 'RowDataId' && !entry.hidden) {
                                    if (verifyCanEditCol(entry.key, clear, entity)) {
                                        $('#CadastroUsuarioLocalPerfil_dGridExpander_e4f439559d84476db94e9b74fdcf41bd').igGridUpdating('startEdit', firstRow, indexColumn, true);
                                        return true;
                                    }
                                    indexColumn++;
                                }
                ...
                var getVisibleColumns = function(metaDataControl) {
                   ...
                   var visibleColumns = '';
                   if($('#CadastroUsuarioLocalPerfil_dGridExpander_e4f439559d84476db94e9b74fdcf41bd').data('igGrid') === undefined) return '';
                   var cols = $('#CadastroUsuarioLocalPerfil_dGridExpander_e4f439559d84476db94e9b74fdcf41bd').igGrid('option', 'columns');
                   if (cols) {
                ...
                var isElementHided = function (grid, forceCreating) {
                  if (!grid) grid = $('#CadastroUsuarioLocalPerfil_dGridExpander_e4f439559d84476db94e9b74fdcf41bd');
                  return ((!grid[0] || (!forceCreating && grid.parent().width() <= 0)) && !$('#dialogExpander_e4f439559d84476db94e9b74fdcf41bd').is(':visible'));
                }
                var refreshData = true;
                var itemsSource = { isElementHided: isElementHided, getVisibleColumns: getVisibleColumns, containerId: 'CadastroUsuarioLocalPerfil_dGridExpander_e4f439559d84476db94e9b74fdcf41bd_container', dataBind: function (commitData, forceCreating) {
                   var grid = $('#CadastroUsuarioLocalPerfil_dGridExpander_e4f439559d84476db94e9b74fdcf41bd');
                   ...
                   if (!started) {
                       ...
                       started = true;
                       commitData = false;
                       $('#CadastroUsuarioLocalPerfil_dGridExpander_e4f439559d84476db94e9b74fdcf41bd_groupbyarea').addClass('hide');
                   }
                   if (grid.igGridUpdating('isEditing')) {
                   ...
                   if (rows.length > 0) {
                     ...
                     if ($('#dialogExpander_e4f439559d84476db94e9b74fdcf41bd').is(':visible')) {
                        ...
                        if (hasPaging.length > 0) {
                           ...
                           $('label#currentNumberExpander_e4f439559d84476db94e9b74fdcf41bd').html(current + ' - ' + totalCurrentPage);
                        }
                        else
                           $('label#currentNumberExpander_e4f439559d84476db94e9b74fdcf41bd').html(1);
                        $('label#totalNumberExpander_e4f439559d84476db94e9b74fdcf41bd').html(totalGrid);
                    }
                   } else {
                       $('label#currentNumberExpander_e4f439559d84476db94e9b74fdcf41bd').html(0);
                       $('label#totalNumberExpander_e4f439559d84476db94e9b74fdcf41bd').html(0);
                   }
                }};
                var valueGrouBy = -1;
                var deletedIndex = -1;
                ...
                function createDataGrid(grid) {
                    ...
                    vm.gridSaveStates[gridId] = {
                        ...
                        closePopover: function () {
                            $('#CadastroUsuarioLocalPerfil_dGridExpander_e4f439559d84476db94e9b74fdcf41bd_LayoutBtn').igPopover('hide');
                        },
                    ...
                    grid.igGrid({ height: '280px', width: '100%',
                        dataSource: [],
                        ...
                        cellClick: function(evt, ui) {
                             if (ui.cellElement && ui.cellElement.childNodes[0] && ui.cellElement.childNodes[0].childNodes[1]) {
                                 ...
                                 if (e && e.tagName === 'IMG' && vm.status() !== 'C')
                                 {
                                      ...
                                      showMultimidia(entity, e, table, key, vm.CadastroUsuarioLocalPerfil());
                                 }
                             }
                             if (typeof vm.OnGridClientClick === 'function') {
                                 entity = findElementByKey(getDataSource(), 'RowDataId', ui.rowKey);
                                 vm.OnGridClientClick('CadastroUsuarioLocalPerfil_dGridExpander_e4f439559d84476db94e9b74fdcf41bd', ui.colKey, entity);
                             }
                             if (vm.status() != 'Q') {
                                 var grid = $('#CadastroUsuarioLocalPerfil_dGridExpander_e4f439559d84476db94e9b74fdcf41bd');
                        ...
                        columns: [
                            ...
                            { key: 'DescPerfil', headerText: vm.getLayoutHeaderGrid('CadastroUsuarioLocalPerfil_lUpDescPerfil'), width: '421px', dataType: 'string', columnCssClass: 'ellipsis', format: '', hidden: false, unbound: false, group: null   }
                        ],
                        features: [
                                    ...
                                    filterDialogOpening: function (evt, ui) {
                                        ...
                                        var dataView = $('#CadastroUsuarioLocalPerfil_dGridExpander_e4f439559d84476db94e9b74fdcf41bd').data('igGrid').dataSource;
                                        ...
                                        scriptHtml += '    var newGrid = $("#CadastroUsuarioLocalPerfil_dGridExpander_e4f439559d84476db94e9b74fdcf41bd");';
                                        scriptHtml += '    var listFilter = [];';
                                        scriptHtml += '    function hideColumn(){';
                                        scriptHtml += '     if ($("#showHideColumn_CadastroUsuarioLocalPerfil_dGridExpander_e4f439559d84476db94e9b74fdcf41bd")["0"].innerHTML.indexOf("Ocultar") >= 0) {';
                                        scriptHtml += '        $("#showHideColumn_CadastroUsuarioLocalPerfil_dGridExpander_e4f439559d84476db94e9b74fdcf41bd")["0"].innerHTML = "Mostrar Coluna";';
                                        scriptHtml += '        newGrid.igGridHiding("hideColumn", newCol);';
                                        scriptHtml += '     }';
                                        scriptHtml += '     else{';
                                        scriptHtml += '        $("#showHideColumn_CadastroUsuarioLocalPerfil_dGridExpander_e4f439559d84476db94e9b74fdcf41bd")["0"].innerHTML = "Ocultar Coluna";';
                                        ...
                                        scriptHtml += '             $("#showHideColumn_CadastroUsuarioLocalPerfil_dGridExpander_e4f439559d84476db94e9b74fdcf41bd")["0"].innerHTML = column[0].hidden ? "Mostrar Coluna" : "Ocultar Coluna"';
                                        scriptHtml += '         }';
                                        scriptHtml += '    }';
                                        ...
                                        scriptHtml += '              <div id="comboFields_CadastroUsuarioLocalPerfil_dGridExpander_e4f439559d84476db94e9b74fdcf41bd"></div>';
                                        scriptHtml += '              <script>';
                                        scriptHtml += '                  var columns = newGrid.igGrid("option", "columns");';
                                        scriptHtml += '                  $("#comboFields_CadastroUsuarioLocalPerfil_dGridExpander_e4f439559d84476db94e9b74fdcf41bd").igCombo({ dataSource: columns, mode : "dropdown", valueKey: "key", textKey: "headerText", selectionChanging: function (evt, ui) {';
                                        scriptHtml += '                      newCol = ui.items["0"].data.key;';
                                        scriptHtml += '                      updateHideButton()';
                                        scriptHtml += '                  }});';
                                        scriptHtml += '                  $("#comboFields_CadastroUsuarioLocalPerfil_dGridExpander_e4f439559d84476db94e9b74fdcf41bd").igCombo("value", newCol);';
                                        scriptHtml += '              </script>';
                                        scriptHtml += '          </div>';
                                        scriptHtml += '      </div>';
                                        scriptHtml += '     <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">';
                                        ...
                                        scriptHtml += '          </div>';
                                        scriptHtml += '          <div style="margin-left: 5px; margin-top: 5px">';
                                        scriptHtml += '              <i class="fa fa-eye-slash" aria-hidden="true" style="margin-right: 5px;"></i><a onclick="hideColumn()" style="cursor: pointer" id="showHideColumn_CadastroUsuarioLocalPerfil_dGridExpander_e4f439559d84476db94e9b74fdcf41bd">Ocultar Coluna</a>';
                                        scriptHtml += '          </div>';
                                        scriptHtml += '          <br>';
                                        scriptHtml += '      </div>';
                                        scriptHtml += '  </div>';
                                   ...
                                   ,{ name: 'Updating', horizontalMoveOnEnter: true,
                                      ...
                                      editCellStarted: function(evt, ui){
                                          ...
                                          var columns = $('#CadastroUsuarioLocalPerfil_dGridExpander_e4f439559d84476db94e9b74fdcf41bd').igGridUpdating('option', 'columnSettings');
                                          var currentCol = null;
                                          currentRow = ui.rowID;
                        ...
                        if ((typeof vm.OnDataGridCreated === 'function')){
                            vm.OnDataGridCreated('CadastroUsuarioLocalPerfil_dGridExpander_e4f439559d84476db94e9b74fdcf41bd');
                        }
                        ...
                        selectionrowselectionchanged = function (evt, ui) {
                            if ((ui.owner.grid.selectedRow() && typeof ui.owner.grid.selectedRow().id !== 'undefined') || (ui.owner.grid.selectedRows() && ui.owner.grid.selectedRows().length > 0)) { 
                                if (isNullOrEmpty(ui.owner.selectedRows())|| ui.selectedRows.length <= 1) {
                                    $(document).undelegate('#CadastroUsuarioLocalPerfil_dGridExpander_e4f439559d84476db94e9b74fdcf41bd', 'iggridselectionrowselectionchanged', selectionrowselectionchanged);
                                    ...
                                    $(document).delegate ('#CadastroUsuarioLocalPerfil_dGridExpander_e4f439559d84476db94e9b74fdcf41bd', 'iggridselectionrowselectionchanged', selectionrowselectionchanged);
                                }
                                selectGridCurrentItem(vm.goToKey, 'RowDataId', ui); 
                             } 
                        };
                        $(document).delegate('#CadastroUsuarioLocalPerfil_dGridExpander_e4f439559d84476db94e9b74fdcf41bd', 'iggridselectionrowselectionchanged', selectionrowselectionchanged);
                        $('#CadastroUsuarioLocalPerfil_dGridExpander_e4f439559d84476db94e9b74fdcf41bd > tbody tr').live('focus', function(evt) {
                            var grid = $('#CadastroUsuarioLocalPerfil_dGridExpander_e4f439559d84476db94e9b74fdcf41bd'), row = $(this).closest('tr'), id = parseInt(row.attr('data-id'), 10);
                    ...
                    vm.addDataSource({ key: 'CadastroUsuarioLocalPerfil_dGridExpander_e4f439559d84476db94e9b74fdcf41bd', name: 'dataView', itemsSource: itemsSource });
                }
