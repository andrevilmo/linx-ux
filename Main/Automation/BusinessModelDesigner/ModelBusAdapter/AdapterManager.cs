...
{
    /// <summary>
    /// Adapter manager base class (double derived pattern) for the BusinessModelDesigner Designer
    /// </summary>
    public partial class BusinessModelDesignerAdapterManagerBase : DslIntegrationShell::VsModelingAdapterManager
    {
        #region Fields
        /// <summary>
        ...
        public BusinessModelDesignerAdapterManagerBase()
        {
        }
        #endregion
        ...
        public override global::System.Collections.Generic.IEnumerable<string> GetSupportedLogicalAdapterIds()
        {
            if (supportedAdapterIds == null)
            {
                ...
                supportedAdapterIds = new string[] { BusinessModelDesignerAdapter.AdapterId };
            }
            return supportedAdapterIds;
        }

        /// <summary>
        /// Instantiates a ModelBusAdapter for the BusinessModelDesigner model of given ModelBusReference and Root Model element
        /// </summary>
        ...
        {
            if (rootModelElement as global::Linx.BusinessModelDesigner.BusinessModelDesignerRoot == null) throw new global::System.ArgumentException("Invalid model root passed");
            return new BusinessModelDesignerAdapter(reference, this, rootModelElement as global::Linx.BusinessModelDesigner.BusinessModelDesignerRoot);
        }
        ...
        public override global::System.Collections.Generic.IEnumerable<DslIntegration::SupportedType> GetExposedElementTypes(string adapterId)
        {
            ...
            if (exposedElementTypes == null)
            {
                ...
                types.Add(
                    new DslIntegration::SupportedType(typeof(BusinessModelDesignerRoot), "BusinessModelDesignerRoot"));
                types.Add(
        ...
        public override DslIntegration::ModelBusReference CreateReference(params object[] modelLocatorInfo)
        {
            ...
            DslIntegration::ModelBusReference mbr = new DslIntegration::ModelBusReference(
                this.ModelBus, BusinessModelDesignerAdapter.AdapterId,
    ...
    /// <summary>
    /// ModelBus modeling adapter manager for a BusinessModelDesignerAdapter model adapter
    /// </summary>
    [Mef::Export(typeof(DslIntegration::ModelBusAdapterManager))]
    [Mef::ExportMetadata(DslIntegration::CompositionAttributes.AdapterIdKey,BusinessModelDesignerAdapter.AdapterId)]
    [DslIntegration::HostSpecific(DslIntegrationShell::VsModelingAdapterManager.HostName)]
    public partial class BusinessModelDesignerAdapterManager : BusinessModelDesignerAdapterManagerBase
    {
    }
}
