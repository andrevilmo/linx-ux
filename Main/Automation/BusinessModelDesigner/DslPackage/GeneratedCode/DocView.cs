...
namespace Linx.BusinessModelDesigner
{
	...
	/// </summary>
	internal partial class BusinessModelDesignerDocView : BusinessModelDesignerDocViewBase
	{
		/// <summary>
		/// Constructs a new BusinessModelDesignerDocView.
		/// </summary>
		public BusinessModelDesignerDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class BusinessModelDesignerDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new BusinessModelDesignerDocView.
		/// </summary>
		protected BusinessModelDesignerDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			BusinessModelDesignerDocDataBase docData = this.DocData as BusinessModelDesignerDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for BusinessModelDesignerDocViewBase should be an BusinessModelDesignerDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Linx.BusinessModelDesigner.BusinessModelDesignerDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Linx.BusinessModelDesigner.BusinessModelDesignerDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Linx.BusinessModelDesigner.BusinessModelDesignerToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Linx.BusinessModelDesigner.BusinessModelDesignerToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.BusinessModelDesignerDiagramMenu;
			}
		}
			...
			if(global::Linx.BusinessModelDesigner.BusinessModelDesignerHelpKeywordHelper.Instance != null)
			{
				...
				if(selectedElement != null)
				{
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Linx.BusinessModelDesigner.BusinessModelDesignerHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
