...
namespace Linx.BusinessModelDesigner
{
	...
	/// </summary>
	internal partial class BusinessModelDesignerDocData : BusinessModelDesignerDocDataBase
	{
		/// <summary>
		/// Constructs a new BusinessModelDesignerDocData.
		/// </summary>
		public BusinessModelDesignerDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a BusinessModelDesigner document in memory.
	/// </summary>
	internal abstract partial class BusinessModelDesignerDocDataBase : DslShell::ModelingDocData
	{
		...
		/// <summary>
		/// Constructs a new BusinessModelDesignerDocDataBase.
		/// </summary>
		protected BusinessModelDesignerDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::Linx.BusinessModelDesigner.BusinessModelDesignerDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::Linx.BusinessModelDesigner.BusinessModelDesignerDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		{
			return new DslShell::VsValidationController(this.ServiceProvider, typeof(BusinessModelDesignerExplorerToolWindow));
		}
		/// <summary>
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::Linx.BusinessModelDesigner.BusinessModelDesignerDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::Linx.BusinessModelDesigner.BusinessModelDesignerDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::Linx.BusinessModelDesigner.BusinessModelDesignerRoot modelRoot = null;
			...
			global::Linx.BusinessModelDesigner.BusinessModelDesignerDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::Linx.BusinessModelDesigner.BusinessModelDesignerSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::Linx.BusinessModelDesigner.BusinessModelDesignerDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::Linx.BusinessModelDesigner.BusinessModelDesignerDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		protected virtual void OnDocumentLoaded()
		{
			...
			global::Linx.BusinessModelDesigner.BusinessModelDesignerRoot modelRoot = this.RootElement as global::Linx.BusinessModelDesigner.BusinessModelDesignerRoot;
			if (modelRoot != null)
			{
				...
				if (diagrams.Count > 0)
				{
					global::Linx.BusinessModelDesigner.BusinessModelDesignerDiagram diagram = diagrams[0] as global::Linx.BusinessModelDesigner.BusinessModelDesignerDiagram;
					if (diagram != null)
					{
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::Linx.BusinessModelDesigner.BusinessModelDesignerRoot modelRoot = (global::Linx.BusinessModelDesigner.BusinessModelDesignerRoot)this.RootElement;
			...
			if (diagrams.Count > 0 && (!saveAs || this.diagramDocumentLockHolder == null))
			{
				...
				if (diagram != null)
				{
					...
					try
					{
						...
						global::Linx.BusinessModelDesigner.BusinessModelDesignerSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::Linx.BusinessModelDesigner.BusinessModelDesignerSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::Linx.BusinessModelDesigner.BusinessModelDesignerDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::Linx.BusinessModelDesigner.BusinessModelDesignerSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				...
				if (modelRoot != null)
				{
					modelFile = global::Linx.BusinessModelDesigner.BusinessModelDesignerSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
