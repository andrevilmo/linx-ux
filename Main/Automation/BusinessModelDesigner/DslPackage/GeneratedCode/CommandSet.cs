...
namespace Linx.BusinessModelDesigner
{
	...
	/// </summary>
	internal partial class BusinessModelDesignerCommandSet : BusinessModelDesignerCommandSetBase
	{
		/// <summary>
		/// Constructs a new BusinessModelDesignerCommandSet.
		/// </summary>
		public BusinessModelDesignerCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class BusinessModelDesignerCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new BusinessModelDesignerCommandSetBase.
		/// </summary>
		protected BusinessModelDesignerCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewBusinessModelDesignerExplorerCommand,
				typeof(BusinessModelDesignerEditorFactory).GUID);
		...
		{
			BusinessModelDesignerExplorerToolWindow explorer = this.BusinessModelDesignerExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		{
			if (this.CurrentBusinessModelDesignerDocData != null && this.CurrentBusinessModelDesignerDocData.Store != null)
			{
				this.CurrentBusinessModelDesignerDocData.ValidationController.Validate(this.CurrentBusinessModelDesignerDocData.GetAllElementsForValidation(), DslValidation::ValidationCategories.Menu);
			}
		}
		...
		internal virtual void OnMenuValidate(object sender, global::System.EventArgs e)
		{
			if (this.CurrentBusinessModelDesignerDocData != null && this.CurrentBusinessModelDesignerDocData.Store != null)
			{
				...
				this.CurrentBusinessModelDesignerDocData.ValidationController.Validate(elementList, DslValidation::ValidationCategories.Menu);
			}
		}
		...
		protected BusinessModelDesignerDocData CurrentBusinessModelDesignerDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as BusinessModelDesignerDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected BusinessModelDesignerDocView CurrentBusinessModelDesignerDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as BusinessModelDesignerDocView;
			}
		}
		...
		/// </summary>
		protected BusinessModelDesignerExplorerToolWindow BusinessModelDesignerExplorerToolWindow
		{
			get
			{
				BusinessModelDesignerExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(BusinessModelDesignerExplorerToolWindow), true) as BusinessModelDesignerExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				BusinessModelDesignerExplorerToolWindow explorerWindow = this.BusinessModelDesignerExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class BusinessModelDesignerClipboardCommandSet : BusinessModelDesignerClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new BusinessModelDesignerClipboardCommandSet.
		/// </summary>
		public BusinessModelDesignerClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class BusinessModelDesignerClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new BusinessModelDesignerClipboardCommandSetBase.
		/// </summary>
		protected BusinessModelDesignerClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
