...
namespace Linx.BusinessModelDesigner.CustomizedCode.Forms
{
    public partial class frmQueryPreview : Form
    {
        ...
        public void ExecuteQuery()
        {
            ...
            var result = Linx.LinqExtensions.BM.BmQueryBuilder.ExecuteQuery(AssemblyName, AssemblyName + ".config", this.ContextName, this.EntityClass.Name, (int)this.numTotalRows.Value, this.txFilter.Text);
