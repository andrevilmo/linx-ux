...
namespace Linx.BusinessModelDesigner.CustomizedCode.ReverseEngineeringModel
{
    ...
    public class SQLiteDatabaseLoader : IProviderDatabaseLoader
    {
        ...
        public SQLiteDatabaseLoader(string connString)
        {
        ...
        public List<Column> GetScriptColumns(string sqlScript)
        {
            ...
            string command = string.Format(@"SELECT * FROM (" + sqlScript + ") AS A WHERE 1=0");
        ...
        {
            System.Windows.Forms.MessageBox.Show("Só são permitidas as Stored Procedures do SQL Server.");
        }
