...
namespace Linx.BusinessModelDesigner
{
    public partial class MultipleAssociationOrigin
    {
        ...
        public void SelectProperties()
        {
            ...
            {
                this.MultipleAssociation.TargetType.BusinessModelDesignerRoot.SelectedProperties.Clear();
                foreach (var attr in this.GetTargetAttributeElements())
                {
                    this.MultipleAssociation.TargetType.BusinessModelDesignerRoot.SelectedProperties.Add(attr.ModelClass.Name + "." + attr.Name);
                }
            }
        }
        ...
        {
            if (this.OriginType == null || this.OriginType.BusinessModelDesignerRoot == null || this.OriginType.BusinessModelDesignerRoot.IsLocked)
                return;
