...
namespace Linx.BusinessModelDesigner
{
    partial class ReferenceModelClass
    {
        ...
        {
            return (this.ModelClassReference == null ? String.Empty : "<<" + this.ModelClassReference.ModelDisplayName + ".bmd" + ">>");                
        }
        ...
        {
            this.BusinessModelDesignerRoot.ConvertToModelCLass(this);
        }
        ...
        private bool UpdateLinkToSuperclass(ModelClass modelClassInstance)
        {
            ...
            if (link != null)
            {
                var superClass = this.BusinessModelDesignerRoot.Types.Where(e => e is ReferenceModelClass && e.Name == link.Superclass.Name).FirstOrDefault() as ReferenceModelClass;
                if (superClass != null)
                {
        ...
        private bool UpdateLinkToSuperclassSh(ModelClass modelClassInstance)
        {
            ...
            if (link != null)
            {
                var superClass = this.BusinessModelDesignerRoot.Types.Where(e => e is ReferenceModelClass && e.Name == link.SuperclassSh.Name).FirstOrDefault() as ReferenceModelClass;
                if (superClass != null)
                {
        ...
        private bool UpdatLinksToTargetModelClasses(ModelClass modelClassInstance)
        {
            ...
            foreach (var link in links)
            {
                ...
                var targetClass = this.BusinessModelDesignerRoot.Types.Where(e => e is ReferenceModelClass && e.Name == link.TargetModelClass.Name).FirstOrDefault() as ReferenceModelClass;
                if (targetClass != null)
                {
        ...
        private bool UpdatLinkToMultipleAssociation(ModelClass modelClassInstance)
        {
            ...
            if (link != null)
            {
                var multAssociation = this.BusinessModelDesignerRoot.Types.Where(e => e is MultipleAssociation && ((MultipleAssociation)e).IdReference == link.MultipleAssociation.Id).FirstOrDefault() as MultipleAssociation;
                if (multAssociation == null)
                {
                    hasChanges = true;
                    multAssociation = new MultipleAssociation(this.Partition);
                    this.BusinessModelDesignerRoot.Types.Add(multAssociation);
        ...
        {
            if (this.BusinessModelDesignerRoot == null || this.BusinessModelDesignerRoot.IsLocked || modelClassInstance == null)
                return false;
            ...
            if (!String.IsNullOrWhiteSpace(this.Table) && this.Table == this.Name)
                this.Table = "";
            ...
            for (int idx = 0; idx < modelClassInstance.Attributes.Count; idx++)
            {
                ...
                if (!String.IsNullOrWhiteSpace(element.ColumnName) && element.ColumnName == element.Name)
                    element.ColumnName = "";
