...
namespace Linx.BusinessModelDesigner
{
    ...
    public partial class Association
    {
        ...
        public void Remove()
        {
            ...
            {
                var root = this.TargetModelClass.BusinessModelDesignerRoot;
        ...
        {
            this.TargetModelClass.BusinessModelDesignerRoot.SelectedProperties.Clear();
            foreach (var attr in this.GetTargetAttributeElements())
            {
                this.TargetModelClass.BusinessModelDesignerRoot.SelectedProperties.Add(attr.ModelClass.Name + "." + attr.Name);
            }
        }
        ...
        {
            if (this.SourceModelClass == null || this.SourceModelClass.BusinessModelDesignerRoot == null || this.SourceModelClass.BusinessModelDesignerRoot.IsLocked)
                return;
