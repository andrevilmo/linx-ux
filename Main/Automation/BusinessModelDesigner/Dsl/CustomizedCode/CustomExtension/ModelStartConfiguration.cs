...
namespace Linx.BusinessModelDesigner
{
    ...
    internal sealed class DbProviderStartConfiguration : AddRule
    {
        public override void ElementAdded(ElementAddedEventArgs e)
        {
            ...
            if (catalog != null && catalog.Server.IsNullOrEmpty())
            {
                ...
                catalog.SetDefaults();
                catalog.BusinessModelDesignerRoot.CheckDefaultProvider();
            }
    ...
    internal sealed class DbProviderChangeConfiguration : ChangeRule
    {
        ...
        {
            DbProvider catalog = e.ModelElement as DbProvider;
            if (catalog != null && catalog.BusinessModelDesignerRoot != null && catalog.BusinessModelDesignerRoot.DTEReference != null)
            {
                if (e.DomainProperty.Name == "IsDefault" && e.OldValue != e.NewValue)
                {
                    if (catalog != null)
                    {
                        catalog.BusinessModelDesignerRoot.CheckDefaultProvider(catalog);
                    }
                }
    ...
    internal sealed class DbProviderdeleteConfiguration : DeletingRule
    {
        public override void ElementDeleting(ElementDeletingEventArgs e)
        {
            ...
            {
                catalog.BusinessModelDesignerRoot.CheckDefaultProvider(catalog, true);
            }
                ...
                if (e.OldValue != e.NewValue)
                {
                    switch (e.DomainProperty.Name)
                    {
                        ...
                        case "IsValidatable":
                            ...
                            break;
                        case "ModelViewCustomQueryEnabled":
                            refModelClass.AdjustCustomQueryMethod();
                            break;
                        default:
                            break;
                    }
    ...
    internal sealed class ModelClassChangeConfiguration : ChangeRule
    {
        public override void ElementPropertyChanged(ElementPropertyChangedEventArgs e)
        {
            ...
            if (mClass != null)
            {
                ...
                {
                    if (ClassKindHelper.IsModelViewBehavior(((ClassKind)e.NewValue)))
    ...
    /// /// </summary>  
    public partial class BusinessModelDesignerDomainModel
    {
