...
namespace Linx.BusinessModelDesigner
{
    public partial class ModelAttribute
    {
        ...
        {
            return (!this.ModelViewFormula.IsNullOrEmpty() & this.ModelViewFormula.StartsWith("KEY("));
        }
        ...
        public string GetFullColumnType()
        {
            ...
            if (columnType.ToLower().Contains("char"))
                columnType = columnType + "(" + this.MaxLength + ")";
            else if (columnType.ToLower().Contains("decimal"))
                columnType = columnType + "(" + this.Precision + ", " + this.Scale + ")";
        ...
        public bool IsSelectedByAssociation()
        {
            ...
            if (this.ModelClass != null && this.ModelClass.BusinessModelDesignerRoot != null && this.ModelClass.BusinessModelDesignerRoot.SelectedProperties.Count > 0)
                isSelected = this.ModelClass.BusinessModelDesignerRoot.SelectedProperties.Contains(this.ModelClass.Name + "." + this.Name);
            return isSelected;
        }
        ...
        //public string GetSqlLiteColumnTypeValue()
        //{
        //    string result = String.Empty;
        ...
        //public string GetOracleColumnTypeValue()
        //{
        //    string result = String.Empty;
        ...
        //        case ModelDataType.Double:
        //        case ModelDataType.Float:
        //            result = "number(" + this.Precision.ToString() + "," + this.Scale.ToString() + ")";
        //            break;
        //        case ModelDataType.UnsignedShort:
        //        case ModelDataType.Short:
        //            result = "number(5)";
        ...
        public string GetForeignKeyNavigation(List<BusinessModelDesignerRoot> models)
        {
        ...
        {
            if (this.ModelClass == null || this.ModelClass.BusinessModelDesignerRoot == null || (!force && this.ModelClass.BusinessModelDesignerRoot.IsLocked))
                return;
