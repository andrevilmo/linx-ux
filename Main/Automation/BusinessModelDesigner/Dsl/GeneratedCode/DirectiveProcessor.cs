...
namespace Linx.BusinessModelDesigner
{
	...
	/// <summary>
	/// Double-derived template directive processor that provides BusinessModelDesigner files
	/// The implementation is done in BusinessModelDesignerDirectiveProcessorBase. This class
	/// exist so users can customize behavior easily.
	/// </summary>
	public sealed partial class BusinessModelDesignerDirectiveProcessor : BusinessModelDesignerDirectiveProcessorBase
	{
		/// <summary>
		/// Constructor
		/// </summary>
		public BusinessModelDesignerDirectiveProcessor()
			: base()
		{
		}
	}
	...
	/// <summary>
	/// Base implementation for template directive processor that provides BusinessModelDesigner files
	/// </summary>
	public class BusinessModelDesignerDirectiveProcessorBase : VSTextTemplating::RequiresProvidesDirectiveProcessor
	{
		/// <summary>
		/// The friendly name of this processor.
		/// </summary>
		public const string BusinessModelDesignerDirectiveProcessorName = "BusinessModelDesignerDirectiveProcessor";
		...
		/// </summary>
		private const string providesModelParameter = "BusinessModelDesignerRoot";
		...
		/// </summary>
		private const string supportedDirectiveName = "BusinessModelDesigner";
		...
		/// Constructor
		/// </summary>
		public BusinessModelDesignerDirectiveProcessorBase()
			: base()
		{
		}
		...
		protected override string FriendlyName
		{
			get
			{
				return BusinessModelDesignerDirectiveProcessorName;
			}
		}
		...
		protected override void GenerateTransformCode(string directiveName, global::System.Text.StringBuilder codeBuffer, global::System.CodeDom.Compiler.CodeDomProvider languageProvider, global::System.Collections.Generic.IDictionary<string, string> requiresArguments, global::System.Collections.Generic.IDictionary<string, string> providesArguments)
		{
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				if (languageProvider != null)
				{
					...
					rootElement.Type = new global::System.CodeDom.CodeTypeReference(typeof(global::Linx.BusinessModelDesigner.BusinessModelDesignerRoot));
					...
					rootElementProperty.Type = new global::System.CodeDom.CodeTypeReference(typeof(global::Linx.BusinessModelDesigner.BusinessModelDesignerRoot));
					...
					if (!this.oneTimeCodeGenerated && global::System.IO.File.Exists(this.Host.TemplateFile))
					{
						...
						resolver.Name = "Convert" + "BusinessModelDesignerRoot" + "RelativePathToTemplateRelativePath";
		...
		protected override void GeneratePreInitializationCode(string directiveName, global::System.Text.StringBuilder codeBuffer, global::System.CodeDom.Compiler.CodeDomProvider languageProvider, global::System.Collections.Generic.IDictionary<string, string> requiresArguments, global::System.Collections.Generic.IDictionary<string, string> providesArguments)
		{
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				...
				{
					string[] domainModels = {
						"Linx.BusinessModelDesigner.BusinessModelDesignerDomainModel",
					};
				...
				if (languageProvider != null)
				{
					...
					if(LoadDiagramData)
					{
						...
						invokeEnableDiagramRules = new global::System.CodeDom.CodeMethodInvokeExpression(
							new global::System.CodeDom.CodeMethodReferenceExpression(new global::System.CodeDom.CodeTypeReferenceExpression("BusinessModelDesignerDomainModel"), "EnableDiagramRules"), new global::System.CodeDom.CodePropertyReferenceExpression(new global::System.CodeDom.CodeThisReferenceExpression(), "Store"));
		...
		public override string[] GetImportsForProcessingRun()
		{
			...
			imports.Add("Linx.BusinessModelDesigner");
