...
namespace Linx.BusinessModelDesigner
{
	...
	/// </remarks>
	public partial class BusinessModelDesignerHelpKeywordHelper : BusinessModelDesignerHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new BusinessModelDesignerHelpKeywordHelper.
		/// </summary>
		protected BusinessModelDesignerHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the BusinessModelDesignerHelpKeywordHelper.
		/// </summary>
		public static BusinessModelDesignerHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class BusinessModelDesignerHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new BusinessModelDesignerHelpKeywordHelperBase.
		/// </summary>
		protected BusinessModelDesignerHelpKeywordHelperBase()
			: base() { }
