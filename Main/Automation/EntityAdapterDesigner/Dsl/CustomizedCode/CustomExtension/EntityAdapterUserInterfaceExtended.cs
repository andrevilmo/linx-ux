...
namespace Linx.EntityAdapterDesigner
{
    public partial class EntityAdapterUserInterface
    {
        ...
        public PublicationEntity GetEntityAdapter()
        {
            ...
            {
                var entity = this.GetDirectEntityAdapter();
                if (entity != null)
                    return entity.ToPublicationEntity();
            }
        ...
        public EntityAdapter GetDirectEntityAdapter()
        {
            ...
            else if (this.ClientLocalService != null && this.ClientLocalService.EntityAdapter != null)
                return this.ClientLocalService.EntityAdapter;
            else
            {
                if (this.BaseUserInterface != null)
                    return this.BaseUserInterface.GetDirectEntityAdapter();
            }
        ...
        public void AddClientEvent(string eventName, bool exposeVM)
        {
            ...
            switch (eventName)
            {
                case "OnGridClientClick":
                    customEvent.Parameters = "string gridName#string columnName#object entity";
                    break;
                ...
                case "OnDataGridCreated":
                    ...
                    customEvent.ExposedByViewModel = true;
                    break;
                case "OnOpeningExternalUIFromGrid":
                    customEvent.ReturnType = "string";
                    customEvent.Parameters = "string externalUIName#string qbeSearch";
                    customEvent.ExposedByViewModel = true;
                    break;
                case "OnDataGridRowChecked":
                    ...
                    customEvent.ExposedByViewModel = true;
                    break;
                case "OnPropertyChangeDataGrid":
                    customEvent.Parameters = "string dataGridName#string propertyName#string oldValue#string newValue";
                    customEvent.ExposedByViewModel = true;
                    break;
                ...
                case "OnClosing":
                    customEvent.ReturnType = "bool";
                    break;
                case "OnClickPivotCell":
                    customEvent.Parameters = "object cell#string jEntitySearch#string viewName";
                    customEvent.ExposedByViewModel = true;
                    break;
                case "OnSaving":
                    customEvent.ReturnType = "bool";
                ...
                case "OnNavigated":
                    ...
                    break;
                case "OnchangePivotLayoutOnLoad":
                    customEvent.Parameters = "object pivot";
                    customEvent.ExposedByViewModel = true;
                    break;

                case "OnPivotLoadLayoutCompleted":
                    customEvent.Parameters = "string pivotName#string layoutName";
                    customEvent.ExposedByViewModel = true;
                    break;

                default:  
                    if (eventName.Contains("CustomAggregation"))
                    {
                        customEvent.ReturnType = "string";
                    }
                    break;
        ...
        public CustomizedLayoutV2 LayoutDefinition
        {
            get
            {
                if (!this.LayoutContent.IsNullOrEmpty())
                {
                    ...
                    return (this.VisualType == InterfaceType.Mobile ? new CustomizedLayoutV2() : null);
            }
        }
        ...
        public void RenameMobileSourceFiles(string oldName)
        {
            if (!oldName.IsNullOrEmpty() && oldName != this.Name)
            {
                ProjectItem item = this.EntityAdapterDesignerRoot.MobileCodeGen.GetMobileAppControllerFolder();
                if (!item.IsNull())
                {
                ...
                item = this.EntityAdapterDesignerRoot.MobileCodeGen.GetMobileAppViewFolder();
                if (!item.IsNull())
                {
