...
namespace Linx.EntityAdapterDesigner
{
    ...
    public partial class EntityAdapterProperty : IEntityProperty
    {
        ...
        public void RestoreUserDefinition(EntityAdapterProperty definitions, bool updateTargetKeyName)
        {
            base.RestoreUserDefinition(definitions);
            if (!definitions.DefaultValue.IsNullOrEmpty())
                this.DefaultValue = definitions.DefaultValue;
            if (updateTargetKeyName)
                this.TargetKeyName = definitions.TargetKeyName;
            this.OrderBySequence = definitions.OrderBySequence;
            this.OrderByOrientation = definitions.OrderByOrientation;
            this.Filter = definitions.Filter;
            this.PublicationRelatedKey = definitions.PublicationRelatedKey;
            this.PublicationSuffix = definitions.PublicationSuffix;
            this.IsAutomaticSequency = definitions.IsAutomaticSequency;
            this.DenormalizedDataInfo = definitions.DenormalizedDataInfo;
            this.LinqMethod = definitions.LinqMethod;
            this.IsRequiredBeforeSearching = definitions.IsRequiredBeforeSearching;
            this.QuickSearchIndex = definitions.QuickSearchIndex;
