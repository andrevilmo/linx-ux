...
namespace Linx.EntityAdapterDesigner
{
	...
	/// </remarks>
	public partial class EntityAdapterDesignerHelpKeywordHelper : EntityAdapterDesignerHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new EntityAdapterDesignerHelpKeywordHelper.
		/// </summary>
		protected EntityAdapterDesignerHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the EntityAdapterDesignerHelpKeywordHelper.
		/// </summary>
		public static EntityAdapterDesignerHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class EntityAdapterDesignerHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new EntityAdapterDesignerHelpKeywordHelperBase.
		/// </summary>
		protected EntityAdapterDesignerHelpKeywordHelperBase()
			: base() { }
