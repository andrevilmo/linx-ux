...
namespace Linx.EntityAdapterDesigner
{
	...
	/// </summary>
	internal partial class EntityAdapterDesignerCommandSet : EntityAdapterDesignerCommandSetBase
	{
		/// <summary>
		/// Constructs a new EntityAdapterDesignerCommandSet.
		/// </summary>
		public EntityAdapterDesignerCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class EntityAdapterDesignerCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new EntityAdapterDesignerCommandSetBase.
		/// </summary>
		protected EntityAdapterDesignerCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewEntityAdapterDesignerExplorerCommand,
				typeof(EntityAdapterDesignerEditorFactory).GUID);
		...
		{
			EntityAdapterDesignerExplorerToolWindow explorer = this.EntityAdapterDesignerExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		{
			if (this.CurrentEntityAdapterDesignerDocData != null && this.CurrentEntityAdapterDesignerDocData.Store != null)
			{
				this.CurrentEntityAdapterDesignerDocData.ValidationController.Validate(this.CurrentEntityAdapterDesignerDocData.GetAllElementsForValidation(), DslValidation::ValidationCategories.Menu);
			}
		}
		...
		internal virtual void OnMenuValidate(object sender, global::System.EventArgs e)
		{
			if (this.CurrentEntityAdapterDesignerDocData != null && this.CurrentEntityAdapterDesignerDocData.Store != null)
			{
				...
				this.CurrentEntityAdapterDesignerDocData.ValidationController.Validate(elementList, DslValidation::ValidationCategories.Menu);
			}
		}
		...
		protected EntityAdapterDesignerDocData CurrentEntityAdapterDesignerDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as EntityAdapterDesignerDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected EntityAdapterDesignerDocView CurrentEntityAdapterDesignerDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as EntityAdapterDesignerDocView;
			}
		}
		...
		/// </summary>
		protected EntityAdapterDesignerExplorerToolWindow EntityAdapterDesignerExplorerToolWindow
		{
			get
			{
				EntityAdapterDesignerExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(EntityAdapterDesignerExplorerToolWindow), true) as EntityAdapterDesignerExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				EntityAdapterDesignerExplorerToolWindow explorerWindow = this.EntityAdapterDesignerExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class EntityAdapterDesignerClipboardCommandSet : EntityAdapterDesignerClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new EntityAdapterDesignerClipboardCommandSet.
		/// </summary>
		public EntityAdapterDesignerClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class EntityAdapterDesignerClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new EntityAdapterDesignerClipboardCommandSetBase.
		/// </summary>
		protected EntityAdapterDesignerClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
