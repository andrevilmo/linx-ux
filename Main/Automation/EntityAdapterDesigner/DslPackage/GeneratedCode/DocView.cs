...
namespace Linx.EntityAdapterDesigner
{
	...
	/// </summary>
	internal partial class EntityAdapterDesignerDocView : EntityAdapterDesignerDocViewBase
	{
		/// <summary>
		/// Constructs a new EntityAdapterDesignerDocView.
		/// </summary>
		public EntityAdapterDesignerDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class EntityAdapterDesignerDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new EntityAdapterDesignerDocView.
		/// </summary>
		protected EntityAdapterDesignerDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			EntityAdapterDesignerDocDataBase docData = this.DocData as EntityAdapterDesignerDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for EntityAdapterDesignerDocViewBase should be an EntityAdapterDesignerDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Linx.EntityAdapterDesigner.EntityAdapterDesignerDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Linx.EntityAdapterDesigner.EntityAdapterDesignerDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Linx.EntityAdapterDesigner.EntityAdapterDesignerToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Linx.EntityAdapterDesigner.EntityAdapterDesignerToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.EntityAdapterDesignerDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Linx.EntityAdapterDesigner.EntityAdapterDesignerHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Linx.EntityAdapterDesigner.EntityAdapterDesignerHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Linx.EntityAdapterDesigner.EntityAdapterDesignerHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
