        ...
        public ListViewGroupCollection Groups
        {
            ...
            set
            {
                ...
                if (groups != null)
                {
                    ...
                    {
                        if (maxCode < int.Parse(((string)gr.Tag).Left(":").Right(4)))
                            maxCode = int.Parse(((string)gr.Tag).Left(":").Right(4));
                    }
                    GroupCode = "G" + (maxCode+1).ToString().PadLeft(4, '0');
                    GroupName = "";                     
                }
            }
        }
        ...
        public ListViewGroup Group 
        {
            ...
            set
            {
                ...
                if (group != null)
                {
                    ...
                    GroupName = ((string)group.Tag).Right(":");
                }
            }
        }
