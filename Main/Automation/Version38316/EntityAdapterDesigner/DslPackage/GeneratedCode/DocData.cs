...
namespace Linx.EntityAdapterDesigner
{
	...
	/// </summary>
	internal partial class EntityAdapterDesignerDocData : EntityAdapterDesignerDocDataBase
	{
		/// <summary>
		/// Constructs a new EntityAdapterDesignerDocData.
		/// </summary>
		public EntityAdapterDesignerDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a EntityAdapterDesigner document in memory.
	/// </summary>
	internal abstract partial class EntityAdapterDesignerDocDataBase : DslShell::ModelingDocData
	{
		...
		/// <summary>
		/// Constructs a new EntityAdapterDesignerDocDataBase.
		/// </summary>
		protected EntityAdapterDesignerDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::Linx.EntityAdapterDesigner.EntityAdapterDesignerDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::Linx.EntityAdapterDesigner.EntityAdapterDesignerDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		{
			return new DslShell::VsValidationController(this.ServiceProvider, typeof(EntityAdapterDesignerExplorerToolWindow));
		}
		/// <summary>
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::Linx.EntityAdapterDesigner.EntityAdapterDesignerDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::Linx.EntityAdapterDesigner.EntityAdapterDesignerDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::Linx.EntityAdapterDesigner.EntityAdapterDesignerRoot modelRoot = null;
			...
			global::Linx.EntityAdapterDesigner.EntityAdapterDesignerDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::Linx.EntityAdapterDesigner.EntityAdapterDesignerSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::Linx.EntityAdapterDesigner.EntityAdapterDesignerDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::Linx.EntityAdapterDesigner.EntityAdapterDesignerDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		protected virtual void OnDocumentLoaded()
		{
			...
			global::Linx.EntityAdapterDesigner.EntityAdapterDesignerRoot modelRoot = this.RootElement as global::Linx.EntityAdapterDesigner.EntityAdapterDesignerRoot;
			if (modelRoot != null)
			{
				...
				if (diagrams.Count > 0)
				{
					global::Linx.EntityAdapterDesigner.EntityAdapterDesignerDiagram diagram = diagrams[0] as global::Linx.EntityAdapterDesigner.EntityAdapterDesignerDiagram;
					if (diagram != null)
					{
		...
		protected override bool CanSave(bool allowUserInterface)
		{
			...
			if (allowUserInterface)
			{
				...
				if (vc.ErrorMessages.Count != 0)
				{
					...
					global::System.Windows.Forms.DialogResult result = DslShell::PackageUtility.ShowMessageBox(this.ServiceProvider, global::Linx.EntityAdapterDesigner.EntityAdapterDesignerDomainModel.SingletonResourceManager.GetString(errorMsg), VSShellInterop::OLEMSGBUTTON.OLEMSGBUTTON_YESNO, VSShellInterop::OLEMSGDEFBUTTON.OLEMSGDEFBUTTON_SECOND, VSShellInterop::OLEMSGICON.OLEMSGICON_WARNING);
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::Linx.EntityAdapterDesigner.EntityAdapterDesignerRoot modelRoot = (global::Linx.EntityAdapterDesigner.EntityAdapterDesignerRoot)this.RootElement;
			...
			if (diagrams.Count > 0 && (!saveAs || this.diagramDocumentLockHolder == null))
			{
				...
				if (diagram != null)
				{
					...
					try
					{
						...
						global::Linx.EntityAdapterDesigner.EntityAdapterDesignerSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::Linx.EntityAdapterDesigner.EntityAdapterDesignerSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::Linx.EntityAdapterDesigner.EntityAdapterDesignerDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::Linx.EntityAdapterDesigner.EntityAdapterDesignerSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				...
				if (modelRoot != null)
				{
					modelFile = global::Linx.EntityAdapterDesigner.EntityAdapterDesignerSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
