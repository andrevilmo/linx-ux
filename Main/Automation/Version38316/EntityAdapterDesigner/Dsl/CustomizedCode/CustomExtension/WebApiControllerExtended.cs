...
namespace Linx.EntityAdapterDesigner
{
    public partial class WebApiController
    {
        ...
        //public void DeleteMobileServiceCode()
        //{
        //    if (this.SynchronizedWithDomainService)
        //    {
        //        var item = this.EntityAdapterDesignerRoot.MobileCodeGen.GetMobileAppFolder("services");
        //        if (!item.IsNull())
        //        {
        //            var fileItem = this.EntityAdapterDesignerRoot.GetProjectItemByName(item.ProjectItems, this.EntityAdapterDesignerRoot.MobileCodeGen.GetMobileContextName() + ".js");
        //            if (fileItem != null)
        //                fileItem.Delete();
        //        }
        //    }
