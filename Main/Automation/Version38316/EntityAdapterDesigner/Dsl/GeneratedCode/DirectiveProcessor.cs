...
namespace Linx.EntityAdapterDesigner
{
	...
	/// <summary>
	/// Double-derived template directive processor that provides EntityAdapterDesigner files
	/// The implementation is done in EntityAdapterDesignerDirectiveProcessorBase. This class
	/// exist so users can customize behavior easily.
	/// </summary>
	public sealed partial class EntityAdapterDesignerDirectiveProcessor : EntityAdapterDesignerDirectiveProcessorBase
	{
		/// <summary>
		/// Constructor
		/// </summary>
		public EntityAdapterDesignerDirectiveProcessor()
			: base()
		{
		}
	}
	...
	/// <summary>
	/// Base implementation for template directive processor that provides EntityAdapterDesigner files
	/// </summary>
	public class EntityAdapterDesignerDirectiveProcessorBase : VSTextTemplating::RequiresProvidesDirectiveProcessor
	{
		/// <summary>
		/// The friendly name of this processor.
		/// </summary>
		public const string EntityAdapterDesignerDirectiveProcessorName = "EntityAdapterDesignerDirectiveProcessor";
		...
		/// </summary>
		private const string providesModelParameter = "EntityAdapterDesignerRoot";
		...
		/// </summary>
		private const string supportedDirectiveName = "EntityAdapterDesigner";
		...
		/// Constructor
		/// </summary>
		public EntityAdapterDesignerDirectiveProcessorBase()
			: base()
		{
		}
		...
		protected override string FriendlyName
		{
			get
			{
				return EntityAdapterDesignerDirectiveProcessorName;
			}
		}
		...
		protected override void GenerateTransformCode(string directiveName, global::System.Text.StringBuilder codeBuffer, global::System.CodeDom.Compiler.CodeDomProvider languageProvider, global::System.Collections.Generic.IDictionary<string, string> requiresArguments, global::System.Collections.Generic.IDictionary<string, string> providesArguments)
		{
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				if (languageProvider != null)
				{
					...
					rootElement.Type = new global::System.CodeDom.CodeTypeReference(typeof(global::Linx.EntityAdapterDesigner.EntityAdapterDesignerRoot));
					...
					rootElementProperty.Type = new global::System.CodeDom.CodeTypeReference(typeof(global::Linx.EntityAdapterDesigner.EntityAdapterDesignerRoot));
					...
					if (!this.oneTimeCodeGenerated && global::System.IO.File.Exists(this.Host.TemplateFile))
					{
						...
						resolver.Name = "Convert" + "EntityAdapterDesignerRoot" + "RelativePathToTemplateRelativePath";
		...
		protected override void GeneratePreInitializationCode(string directiveName, global::System.Text.StringBuilder codeBuffer, global::System.CodeDom.Compiler.CodeDomProvider languageProvider, global::System.Collections.Generic.IDictionary<string, string> requiresArguments, global::System.Collections.Generic.IDictionary<string, string> providesArguments)
		{
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				...
				{
					string[] domainModels = {
						"Linx.EntityAdapterDesigner.EntityAdapterDesignerDomainModel",
					};
				...
				if (languageProvider != null)
				{
					...
					if(LoadDiagramData)
					{
						...
						invokeEnableDiagramRules = new global::System.CodeDom.CodeMethodInvokeExpression(
							new global::System.CodeDom.CodeMethodReferenceExpression(new global::System.CodeDom.CodeTypeReferenceExpression("EntityAdapterDesignerDomainModel"), "EnableDiagramRules"), new global::System.CodeDom.CodePropertyReferenceExpression(new global::System.CodeDom.CodeThisReferenceExpression(), "Store"));
		...
		public override string[] GetImportsForProcessingRun()
		{
			...
			imports.Add("Linx.EntityAdapterDesigner");
