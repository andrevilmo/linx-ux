...
namespace LinxSistemas.JsEditor
{
    ...
    //     - An empty js file in the same directory as NewFileItems.vsdir. In
    //       our case we chose JScriptFile.js. Note this file name appears in Editor.vsdir
    ...
    //          - "JScriptFile" - This is the base file name. New files will initially
    //             be named as JScriptFile1.js, JScriptFile2.js... etc.
    ///////////////////////////////////////////////////////////////////////////////
    // Editor.vsdir contents:-
    //    JScriptFile.js|{3085E1D6-A938-478e-BE49-3546C09A1AB1}|#106|80|#109|0|401|0|#107
    //
    // The fields in order are as follows:-
    //    - JScriptFile.js - our empty js file
                                ...
                                IVsToolboxUser      //Sends notification about Toolbox items to the owner of these items
    {
        ...
        #region Fields
        private JsEditorPackage myPackage;
        ...
        public EditorPane(JsEditorPackage package)
            : base(null)
        {
            PrivateInit(package);
        }
        ...
        /// <summary>
        /// Initialization routine for the Editor. Loads the list of properties for the js document 
        /// which will show up in the properties window 
        /// </summary>
        /// <param name="package"></param>
        private void PrivateInit(JsEditorPackage package)
        {
            myPackage = package;
            loading = false;
        ...
        private void DisplayContextMenuAt(Point point)
        {
            ...
            CommandID contextMenuID = new CommandID(GuidList.guidJsEditorCmdSet, PkgCmdIDList.IDMX_RTF);
        ...
        {
            pClassID = GuidList.guidJsEditorEditorFactory;
            return VSConstants.S_OK;
        }
        ...
        int IVsTextImage.GetLineSize(out int pcLines)
        {
            ...
            int len = editorControl.RichTextBoxControl.Lines.Count;
            pcLines = len;
            ...
            )
        {
            ...
            //replace the text
            editorControl.RichTextBoxControl.SetSelection(NewPosition, length);
            ...
            )
        {
            ...
            int lineCount = editorControl.RichTextBoxControl.Lines.Count;
            ...
            string lineText = editorControl.RichTextBoxControl.Lines[iLine].Text;
        ...
        public int GetLastLineIndex(out int piLine, out int piIndex)
        {
            ...
            int totalLines = editorControl.RichTextBoxControl.Lines.Count;
            if (totalLines > 0)
                piLine = totalLines - 1;
        ...
        {
            piLineCount = editorControl.RichTextBoxControl.Lines.Count;
            return VSConstants.E_NOTIMPL;
        }
