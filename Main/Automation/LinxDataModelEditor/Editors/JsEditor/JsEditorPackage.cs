...
namespace LinxSistemas.JsEditor
{
    ...
    [ProvideEditorExtension(typeof(EditorFactory), ".js", 50, 
              ...
              NameResourceID = 105,
              DefaultName = "JsEditor")]
    [ProvideKeyBindingTable(GuidList.guidJsEditorEditorFactoryString, 102)]
    ...
    [Guid(GuidList.guidJsEditorPkgString)]
    public sealed class JsEditorPackage : Package
    {
        /// <summary>
