...
namespace LinxSistemas.JsEditor
{
    ...
    /// </summary>
    [Guid(GuidList.guidJsEditorEditorFactoryString)]
    public sealed class EditorFactory : IVsEditorFactory, IDisposable
    {
        private JsEditorPackage editorPackage;
        private ServiceProvider vsServiceProvider;


        public EditorFactory(JsEditorPackage package)
        {
                        ...
                        out int pgrfCDW)
        {
            ...
            pguidCmdUI = GuidList.guidJsEditorEditorFactory;
            pgrfCDW = 0;
