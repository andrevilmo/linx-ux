...
namespace Linx.BusinessDataModelDesigner
{
	...
	/// </summary>
	internal partial class BusinessDataModelDesignerDocData : BusinessDataModelDesignerDocDataBase
	{
		/// <summary>
		/// Constructs a new BusinessDataModelDesignerDocData.
		/// </summary>
		public BusinessDataModelDesignerDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a BusinessDataModelDesigner document in memory.
	/// </summary>
	internal abstract partial class BusinessDataModelDesignerDocDataBase : DslShell::ModelingDocData
	{
		...
		/// <summary>
		/// Constructs a new BusinessDataModelDesignerDocDataBase.
		/// </summary>
		protected BusinessDataModelDesignerDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::Linx.BusinessDataModelDesigner.BusinessDataModelDesignerDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::Linx.BusinessDataModelDesigner.BusinessDataModelDesignerDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		{
			return new DslShell::VsValidationController(this.ServiceProvider, typeof(BusinessDataModelDesignerExplorerToolWindow));
		}
		/// <summary>
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::Linx.BusinessDataModelDesigner.BusinessDataModelDesignerDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::Linx.BusinessDataModelDesigner.BusinessDataModelDesignerDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::Linx.BusinessDataModelDesigner.BusinessDataModelDesignerRoot modelRoot = null;
			...
			global::Linx.BusinessDataModelDesigner.BusinessDataModelDesignerDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::Linx.BusinessDataModelDesigner.BusinessDataModelDesignerSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::Linx.BusinessDataModelDesigner.BusinessDataModelDesignerDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::Linx.BusinessDataModelDesigner.BusinessDataModelDesignerDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		protected virtual void OnDocumentLoaded()
		{
			...
			global::Linx.BusinessDataModelDesigner.BusinessDataModelDesignerRoot modelRoot = this.RootElement as global::Linx.BusinessDataModelDesigner.BusinessDataModelDesignerRoot;
			if (modelRoot != null)
			{
				...
				if (diagrams.Count > 0)
				{
					global::Linx.BusinessDataModelDesigner.BusinessDataModelDesignerDiagram diagram = diagrams[0] as global::Linx.BusinessDataModelDesigner.BusinessDataModelDesignerDiagram;
					if (diagram != null)
					{
		...
		protected override bool CanSave(bool allowUserInterface)
		{
			...
			if (allowUserInterface)
			{
				...
				if (vc.ErrorMessages.Count != 0)
				{
					...
					global::System.Windows.Forms.DialogResult result = DslShell::PackageUtility.ShowMessageBox(this.ServiceProvider, global::Linx.BusinessDataModelDesigner.BusinessDataModelDesignerDomainModel.SingletonResourceManager.GetString(errorMsg), VSShellInterop::OLEMSGBUTTON.OLEMSGBUTTON_YESNO, VSShellInterop::OLEMSGDEFBUTTON.OLEMSGDEFBUTTON_SECOND, VSShellInterop::OLEMSGICON.OLEMSGICON_WARNING);
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::Linx.BusinessDataModelDesigner.BusinessDataModelDesignerRoot modelRoot = (global::Linx.BusinessDataModelDesigner.BusinessDataModelDesignerRoot)this.RootElement;
			...
			if (diagrams.Count > 0 && (!saveAs || this.diagramDocumentLockHolder == null))
			{
				...
				if (diagram != null)
				{
					...
					try
					{
						...
						global::Linx.BusinessDataModelDesigner.BusinessDataModelDesignerSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::Linx.BusinessDataModelDesigner.BusinessDataModelDesignerSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::Linx.BusinessDataModelDesigner.BusinessDataModelDesignerDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::Linx.BusinessDataModelDesigner.BusinessDataModelDesignerSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				...
				if (modelRoot != null)
				{
					modelFile = global::Linx.BusinessDataModelDesigner.BusinessDataModelDesignerSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
