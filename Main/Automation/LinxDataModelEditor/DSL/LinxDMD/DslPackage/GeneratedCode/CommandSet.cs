...
namespace Linx.BusinessDataModelDesigner
{
	...
	/// </summary>
	internal partial class BusinessDataModelDesignerCommandSet : BusinessDataModelDesignerCommandSetBase
	{
		/// <summary>
		/// Constructs a new BusinessDataModelDesignerCommandSet.
		/// </summary>
		public BusinessDataModelDesignerCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class BusinessDataModelDesignerCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new BusinessDataModelDesignerCommandSetBase.
		/// </summary>
		protected BusinessDataModelDesignerCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewBusinessDataModelDesignerExplorerCommand,
				typeof(BusinessDataModelDesignerEditorFactory).GUID);
		...
		{
			BusinessDataModelDesignerExplorerToolWindow explorer = this.BusinessDataModelDesignerExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		{
			if (this.CurrentBusinessDataModelDesignerDocData != null && this.CurrentBusinessDataModelDesignerDocData.Store != null)
			{
				this.CurrentBusinessDataModelDesignerDocData.ValidationController.Validate(this.CurrentBusinessDataModelDesignerDocData.GetAllElementsForValidation(), DslValidation::ValidationCategories.Menu);
			}
		}
		...
		internal virtual void OnMenuValidate(object sender, global::System.EventArgs e)
		{
			if (this.CurrentBusinessDataModelDesignerDocData != null && this.CurrentBusinessDataModelDesignerDocData.Store != null)
			{
				...
				this.CurrentBusinessDataModelDesignerDocData.ValidationController.Validate(elementList, DslValidation::ValidationCategories.Menu);
			}
		}
		...
		protected BusinessDataModelDesignerDocData CurrentBusinessDataModelDesignerDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as BusinessDataModelDesignerDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected BusinessDataModelDesignerDocView CurrentBusinessDataModelDesignerDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as BusinessDataModelDesignerDocView;
			}
		}
		...
		/// </summary>
		protected BusinessDataModelDesignerExplorerToolWindow BusinessDataModelDesignerExplorerToolWindow
		{
			get
			{
				BusinessDataModelDesignerExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(BusinessDataModelDesignerExplorerToolWindow), true) as BusinessDataModelDesignerExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				BusinessDataModelDesignerExplorerToolWindow explorerWindow = this.BusinessDataModelDesignerExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class BusinessDataModelDesignerClipboardCommandSet : BusinessDataModelDesignerClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new BusinessDataModelDesignerClipboardCommandSet.
		/// </summary>
		public BusinessDataModelDesignerClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class BusinessDataModelDesignerClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new BusinessDataModelDesignerClipboardCommandSetBase.
		/// </summary>
		protected BusinessDataModelDesignerClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
