...
namespace Linx.BusinessDataModelDesigner
{
	...
	/// </summary>
	internal partial class BusinessDataModelDesignerDocView : BusinessDataModelDesignerDocViewBase
	{
		/// <summary>
		/// Constructs a new BusinessDataModelDesignerDocView.
		/// </summary>
		public BusinessDataModelDesignerDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class BusinessDataModelDesignerDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new BusinessDataModelDesignerDocView.
		/// </summary>
		protected BusinessDataModelDesignerDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			BusinessDataModelDesignerDocDataBase docData = this.DocData as BusinessDataModelDesignerDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for BusinessDataModelDesignerDocViewBase should be an BusinessDataModelDesignerDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Linx.BusinessDataModelDesigner.BusinessDataModelDesignerDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Linx.BusinessDataModelDesigner.BusinessDataModelDesignerDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Linx.BusinessDataModelDesigner.BusinessDataModelDesignerToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Linx.BusinessDataModelDesigner.BusinessDataModelDesignerToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.BusinessDataModelDesignerDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Linx.BusinessDataModelDesigner.BusinessDataModelDesignerHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Linx.BusinessDataModelDesigner.BusinessDataModelDesignerHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Linx.BusinessDataModelDesigner.BusinessDataModelDesignerHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
