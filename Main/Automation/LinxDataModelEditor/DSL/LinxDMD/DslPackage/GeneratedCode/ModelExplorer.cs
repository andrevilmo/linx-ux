...
namespace Linx.BusinessDataModelDesigner
{
	...
	/// </summary>
	internal partial class BusinessDataModelDesignerExplorer : BusinessDataModelDesignerExplorerBase
	{
		/// <summary>
		/// Constructs a new BusinessDataModelDesignerExplorer.
		/// </summary>
		public BusinessDataModelDesignerExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the BusinessDataModelDesignerExplorerToolWindow.
	/// </summary>
	internal abstract class BusinessDataModelDesignerExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new BusinessDataModelDesignerExplorerBase.
		/// </summary>
		protected BusinessDataModelDesignerExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.BusinessDataModelDesignerExplorerMenu;
			}
		}
		...
		{
			get { return global::Linx.BusinessDataModelDesigner.BusinessDataModelDesignerRoot.DomainClassId; }
		}
