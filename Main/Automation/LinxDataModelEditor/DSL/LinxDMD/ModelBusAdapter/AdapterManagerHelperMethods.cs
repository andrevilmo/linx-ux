...
{
    /// <summary>
    /// ModelBus modeling adapter manager for a BusinessDataModelDesigner  model helper methods
    /// </summary>
    public partial class BusinessDataModelDesignerAdapterManager
    {
        #region Helper methods

        /// <summary>
        /// Create a new BusinessDataModelDesigner model and return a modelbus reference to it
        /// </summary>
        ...
        public static DslIntegration::ModelBusReference CreateBusinessDataModelDesignerRoot(string modelName, DslIntegration::ModelBusReference relativeTo, string relativePath = null)
        {
            ...
            if (adapter != null)
            {
                ...
                return CreateBusinessDataModelDesignerRoot(modelName, filename, relativePath);
            }
            else
                return null;
        }
        ...
        /// <param name="relativePath">Path relative to the <paramref name="relativeTo"/> model. If <c>null</c>, the new
        /// model is created at the same location as the <paramref name="relativeTo"/> model</param>
        public static DslIntegration::ModelBusReference CreateBusinessDataModelDesignerRoot(string modelName, string relativeToPathName, string relativePath = null)
        {
            ...
            string template = (dte.Solution as global::EnvDTE80.Solution2).GetProjectItemTemplate("BusinessDataModelDesigner.zip", "CSharp");
        
            string modelNameWithExtension = global::System.IO.Path.ChangeExtension(modelName, ".lxdm");
            ...
            DslIntegration::ModelBusReference mbr = new DslIntegration::ModelBusReference(modelBus,
                                                          BusinessDataModelDesignerAdapter.AdapterId,
