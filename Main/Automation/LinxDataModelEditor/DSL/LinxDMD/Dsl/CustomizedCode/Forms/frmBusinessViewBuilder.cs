    ...
    public partial class frmBusinessViewBuilder : Form
    {
        ...
        public ModelClass Entity
        {
            ...
            set
            {
                ...
                {
                    _entity = value;
                    _model = _entity.BusinessDataModelDesignerRoot;
                }
            }
        }
        ...
        public void PopulateTypes()
        {
            ...
            foreach (var item in models)
            {
                ...
                {   
                    ...
                    ModelBusAdapter modelAdapter = manager.CreateAdapter(modelReference);
                ...
                catch (Exception e) { errorMessage += (errorMessage.IsNullOrEmpty() ? e.GetCompleteMessage() : "\r\n") + "Fail loading elements from [" + item.Key + "]"; }
            }
        ...
        private void SyncSourceProperties(EntityQueryNode entity)
        {
            ...
            {
                entity.TableName = entitySource.GetTableName(true);
                entity.Schema = entitySource.Schema;
