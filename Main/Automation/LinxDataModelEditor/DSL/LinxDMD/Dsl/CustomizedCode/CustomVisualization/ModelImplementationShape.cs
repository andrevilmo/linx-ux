    ...
    public partial class ModelImplementationShape
    {
        ...
        public override void OnDoubleClick(Microsoft.VisualStudio.Modeling.Diagrams.DiagramPointEventArgs e)
        {
            foreach (var element in e.DiagramHitTestInfo.HitDiagramItem.RepresentedElements)
            {
                if (element is ModelImplementationShape)
                {
                    ((ModelImplementation)((ModelImplementationShape)element).ModelElement).BusinessDataModelDesignerRoot.OpenCodeElement(((ModelImplementation)((ModelImplementationShape)element).ModelElement));
                }
                break;
            }
