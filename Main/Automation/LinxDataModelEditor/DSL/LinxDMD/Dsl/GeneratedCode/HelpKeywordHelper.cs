...
namespace Linx.BusinessDataModelDesigner
{
	...
	/// </remarks>
	public partial class BusinessDataModelDesignerHelpKeywordHelper : BusinessDataModelDesignerHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new BusinessDataModelDesignerHelpKeywordHelper.
		/// </summary>
		protected BusinessDataModelDesignerHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the BusinessDataModelDesignerHelpKeywordHelper.
		/// </summary>
		public static BusinessDataModelDesignerHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class BusinessDataModelDesignerHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new BusinessDataModelDesignerHelpKeywordHelperBase.
		/// </summary>
		protected BusinessDataModelDesignerHelpKeywordHelperBase()
			: base() { }
