...
namespace Microsoft.VisualStudio.Project
{
        ...
        IVsSetTargetFrameworkWorkerCallback
    {
        ...
        protected virtual void InitializeProjectProperties()
        {
            ...
            if (String.IsNullOrEmpty(GetProjectProperty(ProjectFileConstants.ProjectGuid)))
            {
                SetProjectProperty(ProjectFileConstants.ProjectGuid, this.ProjectIDGuid.ToString());
            }
        }
