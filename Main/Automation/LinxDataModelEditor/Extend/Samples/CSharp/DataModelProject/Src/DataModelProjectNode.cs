...
namespace Microsoft.VisualStudio.Project.Samples.CustomProject
{
    ...
    public class DataModelProjectNode : ProjectNode
    {
        #region Enum for image list
        internal enum DataModelProjectImageName
        {
            Project = 0,
        }
        #endregion
        ...
        #region Constants
        internal const string ProjectTypeName = "DataModelProject";
        #endregion
        ...
        #region Constructors
        /// <summary>
        /// Initializes the <see cref="DataModelProjectNode"/> class.
        /// </summary>
        static DataModelProjectNode()
        {
            imageList = Utilities.GetImageList(typeof(DataModelProjectNode).Assembly.GetManifestResourceStream("Microsoft.VisualStudio.Project.Samples.CustomProject.Resources.DataModelProjectImageList.bmp"));
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="DataModelProjectNode"/> class.
        /// </summary>
        /// <param name="package">Value of the project package for initialize internal package field.</param>
        public DataModelProjectNode(CustomProjectPackage package)
        {
        ...
        {
            get { return typeof(DataModelProjectFactory).GUID; }
        }
        ...
        public override int ImageIndex
        {
            get
            {
                return imageOffset + (int)DataModelProjectImageName.Project;
            }
        }
        ...
        {
            return new OADataModelProject(this);
        }
        ...
        {
            DataModelProjectFileNode node = new DataModelProjectFileNode(this, item);
