...
{
    [ComVisible(true)]
    public class OADataModelProject : OAProject
    {
        #region Constructors
        /// <summary>
        /// Public constructor.
        ...
        public OADataModelProject(DataModelProjectNode project)
            : base(project)
        {
        }
        #endregion
    ...
    public class OADataModelProjectFileItem : OAFileItem
    {
        #region Constructors
        /// <summary>
        /// Public constructor.
        ...
        public OADataModelProjectFileItem(OAProject project, FileNode node)
            : base(project, node)
        {
        }
        #endregion
