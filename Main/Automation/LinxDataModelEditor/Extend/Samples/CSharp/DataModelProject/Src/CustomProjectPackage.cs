...
namespace Microsoft.VisualStudio.Project.Samples.CustomProject
{
    ...
    [ProvideProjectFactory(typeof(DataModelProjectFactory), "Business Data Model Projects", "DMD Project Files (*.lxdmproj);*.lxdmproj", "lxdmproj", "lxdmproj", @"..\..\Templates\Projects\DataModelDesignProject", LanguageVsTemplate = "DataModelDesignProject", NewProjectRequireNewFolderVsTemplate = false)]
    [ProvideProjectItem(typeof(DataModelProjectFactory), "Business Data Model Items", @"..\..\Templates\ProjectItems\DataModelDesignProject", 500)]
    [Guid(GuidStrings.guidCustomProjectPkgString)]    
    public sealed class CustomProjectPackage : ProjectPackage
    {
        internal static CustomProjectPackage Instance;
        ...
        protected override void Initialize()
        {
            base.Initialize();
            Instance = this;
            this.RegisterProjectFactory(new DataModelProjectFactory(this));
        }
        ...
        public static IComponentModel ComponentModel
        {
            get
            {
                return (IComponentModel)Instance.GetService(typeof(SComponentModel));
            }
        }
        ...
        //public static T GetProvider<T>(string assemblyName, IReplEvaluatorProvider provider = null)
        //{   
        //    var catalog = new System.ComponentModel.Composition.Hosting.AggregateCatalog(new System.ComponentModel.Composition.Hosting.DirectoryCatalog(AssemblyHelper.GetCurrentAssemblyDirectory<CustomProjectPackage>(), assemblyName));
        ...
        //    if (provider!= null)
        //        container.ComposeExportedValue<IReplEvaluatorProvider>(provider);
        ...
        public IContentType ReplContentType
        {
            get
            {
