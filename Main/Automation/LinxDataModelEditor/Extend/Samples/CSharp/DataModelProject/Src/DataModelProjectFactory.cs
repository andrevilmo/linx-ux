...
namespace Microsoft.VisualStudio.Project.Samples.CustomProject
{
    ...
    public class DataModelProjectFactory : ProjectFactory
    {
        #region Fields
        ...
        public DataModelProjectFactory(CustomProjectPackage package)
            : base(package)
        {
        ...
        {
            DataModelProjectNode project = new DataModelProjectNode(this.package);
