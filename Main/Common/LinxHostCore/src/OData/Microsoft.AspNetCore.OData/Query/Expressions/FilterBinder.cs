...
namespace Microsoft.AspNetCore.OData.Query.Expressions
{
    ...
    {
        private static ODataQuerySettings odataQuerySettings = new ODataQuerySettings() { HandleNullPropagation = HandleNullPropagationOption.True };
        ...
        public FilterBinder(IEdmModel model, IAssemblyProvider assemblyProvider, ODataQuerySettings querySettings)
            : base(model, assemblyProvider, querySettings)
        {
        }

        internal static Expression Bind(FilterClause filterClause, Type filterType, IEdmModel model, IAssemblyProvider assemblyProvider)
        {
            ...
            FilterBinder binder = new FilterBinder(model, assemblyProvider, odataQuerySettings);
            binder._filterType = filterType;

            return BindFilterClause(binder, filterClause, filterType);
        }

        internal static LambdaExpression Bind(OrderByClause orderBy, Type elementType, IEdmModel model, IAssemblyProvider assemblyProvider)
        {
