    ...
    public static class DynamicQueryable
    {
        ...
        public static string ToDynamicLinqExpression(this string predicate, Type entityType, System.Data.Entity.Core.Objects.ObjectParameter[] parameters, List<object> paramValues)
        {
            ...
            else
            {
                ...
                predicate = predicate.Replace("it.", "").Replace("'", "\"");
                predicate = predicate.TrimEnd();
            }
...
#pragma warning restore 0219
        ...
        int FindMethod(Type type, string methodName, bool staticAccess, Expression[] args, out MethodBase method)
        {
            ...
            method = GetExtensionMethods(typeof(GeneralUtils), type, methodName).FirstOrDefault();
            return (method == null ? 0 : 1);
        }

        IEnumerable<MethodInfo> GetExtensionMethods(Type stType, Type extendedType, string methodName)
        {
            var query = from type in (new Type[] { stType })
                        where type.IsSealed && !type.IsGenericType && !type.IsNested
                        from method in type.GetMethods(BindingFlags.Static
                            | BindingFlags.Public | BindingFlags.NonPublic)
                        where method.Name == methodName && method.IsDefined(typeof(System.Runtime.CompilerServices.ExtensionAttribute), false)
