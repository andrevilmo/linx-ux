...
namespace Linx.LinqExtensions.Expressions
{
	/// <summary>
	...
	public static class ExpressionExtensions
	{
        ...
        /// <summary>
        /// Takes expr and replaces all calls to Expand (extension) method by it's implementation, making a logical AND. 
        /// (modifies expression tree)
        /// </summary>
        public static Expression<Func<A0, bool>> And<A0, T>(this Expression<Func<A0, bool>> expr, Expression<Func<A0, bool>> addedExpr) 
        {
            System.Func<System.Linq.Expressions.Expression<System.Func<A0, bool>>, System.Linq.Expressions.Expression<System.Func<A0, bool>>, System.Linq.Expressions.Expression<System.Func<A0, bool>>> combineAnd =  (f, g) => (e) => f.Expand(e) && g.Expand(e);
            return combineAnd(expr, addedExpr);
        }

        /// <summary>
        /// Takes expr and replaces all calls to Expand (extension) method by it's implementation, making a logical OR. 
        /// (modifies expression tree)
        /// </summary>
        public static Expression<Func<A0, bool>> Or<A0, T>(this Expression<Func<A0, bool>> expr, Expression<Func<A0, bool>> addedExpr)
        {
            System.Func<System.Linq.Expressions.Expression<System.Func<A0, bool>>, System.Linq.Expressions.Expression<System.Func<A0, bool>>, System.Linq.Expressions.Expression<System.Func<A0, bool>>> combineOr = (f, g) => (e) => f.Expand(e) || g.Expand(e);
            return combineOr(expr, addedExpr);
        }
