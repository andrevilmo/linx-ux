define(['plugins/dialog', 'knockout', 'services/logger', 'managers/__auth', 'common'],
    function (dialog, ko, logger, managerAuth, common) {
        ...
        //var economicGroupId = (isNullOrEmpty(vm.managerAuth.economicGroupId) == true ? "null" : vm.managerAuth.economicGroupId);
        //var environmentId = (isNullOrEmpty(vm.managerAuth.environmentId) == true ? "null" : vm.managerAuth.environmentId);
        ...
        var vm = {
            ...
            urlNoImage: managerAuth.getServiceAddress("LinxFrameworkMultimidia/GetMediaThumbnail") + "?uidDocumento=00000000-0000-0000-0000-000000000000&uidGrupoAcesso=" + managerAuth.accessGroupId + '&uidEmpresa=' + managerAuth.companyId + "&uidGrupoEconomico=" + managerAuth.economicGroupId + "&idAmbiente=" + managerAuth.environmentId,
            ...
            UI_btnDeleteMidia_Click: function (o) {
                ...
                if (o.lxNew() == true) {
                    ...
                    $.ajax({
                        ...
                        globalError: true,
                        url: managerAuth.getServiceAddress('linxframeworkmultimidia/deletemedia?uidDocumento=' + o.UidDocumento()),
                        dataType: 'json',
                        async: true,
                        cache: false,
            ...
            getMultimedia: function () {
                ...
                $.ajax({
                    ...
                    globalError: true,
                    url: managerAuth.getServiceAddress('linxframeworkmultimidia/getmultimedia'),
                    data: {
