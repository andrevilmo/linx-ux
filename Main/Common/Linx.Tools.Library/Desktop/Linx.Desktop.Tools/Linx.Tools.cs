...
namespace Linx.Tools
{
    ...
    public delegate void PaneCloseHandler(System.Windows.FrameworkElement pane);
    ...
    {
        None, AllColumns, SelectedColumns, Entity
    }
    ...
    public class AuditAttribute : Attribute
    {
        ...
        public AuditAttribute(AuditType auditType) : this(auditType, null) { }
        public AuditAttribute(AuditType auditType, params string[] columns)
        {
    ...
    public partial interface IApplicationMainModule
    {
        ...
        System.Windows.FrameworkElement GetCurrentDataToolbar();
        object GetCurrentDomainContext();
        IEnumerable GetCurrentData();
        void ShowGridOrDataFormLink(Boolean IsVisible);
        System.Windows.FrameworkElement GetSelectedDocumentPane();
        ...
        System.Windows.FrameworkElement AddNewPane(System.Windows.FrameworkElement contentElement);
        ...
        event PaneCloseHandler PaneClose;
    ...
    public static class ObjectExtension
    {
        ...
        public static List<ControlCategoryInfo> GetControlCategories(string assembyName, string controlName)
        {
            ...
            try
            {
                ...
                {
                    var listCategory = item.GetCustomAttributes(typeof(System.ComponentModel.CategoryAttribute), false).ToList();
        ...
        public static string GetFunctionalPointOfType(Type type, string functionName)
        {
            ...
            foreach (var attr in type.GetCustomAttributes(typeof(FunctionalPoint), false))
            {
        ...
        {
            return (type.GetCustomAttributes(attributeType, true).Count() > 0);
        }
        ...
        public static void CopyInstanceFrom(this object objectRef, object sourceRef)
        {
            ...
            foreach (PropertyInfo propertyT in propertiesTo)
            {
                if (propertiesFrom.Contains(propertyT.Name) && propertyT.GetSetMethod() != null)
                {
                    ...
                    if ((propertyT.PropertyType.Name == "Nullable`1" ? propertyT.PropertyType.GetElement() : propertyT.PropertyType) == (propertyF.PropertyType.Name == "Nullable`1" ? propertyF.PropertyType.GetElement() : propertyF.PropertyType) && propertyT.PropertyType.FullName != "System.DBNull"
                        && (propertyF.PropertyType.IsEnum || propertyT.PropertyType.IsPrimitive || propertyF.PropertyType.IsPrimitive || propertyType.InList(new string[] { "string", "decimal", "guid", "datetime" })))
                    {
                        objectRef.SetPropertyValue(propertyT.Name, sourceRef.GetPropertyValue(propertyT.Name));
                    }
                }
        ...
        public static bool EqualsInstanceFrom(this object objectRef, object sourceRef, params string[] excluded)
        {
            ...
            foreach (PropertyInfo propertyT in propertiesTo)
            {
                if (!excluded.Contains(propertyT.Name) && propertiesFrom.Contains(propertyT.Name) && propertyT.GetSetMethod() != null)
                {
                    ...
                    if ((propertyT.PropertyType.Name == "Nullable`1" ? propertyT.PropertyType.GetElement() : propertyT.PropertyType) == (propertyF.PropertyType.Name == "Nullable`1" ? propertyF.PropertyType.GetElement() : propertyF.PropertyType) && propertyT.PropertyType.FullName != "System.DBNull"
                        && (propertyF.PropertyType.IsEnum || propertyF.PropertyType.IsPrimitive || propertyType.InList(new string[] { "string", "decimal", "guid", "datetime" })))
                    {
    ...
    {
        public static IApplicationMainModule GetMainModule(this System.Windows.Application app)
        {
            return (app.GetPropertyValue("MainModule") as IApplicationMainModule);
        }

        public static string GetCurrentUserName(this System.Windows.Application app)
        {
            return (app.GetPropertyValue("UserName") as string);
        }

        public static string GetCurrentUserAuthenticationName(this System.Windows.Application app)
        {
            return (app.GetPropertyValue("UserAuthenticationName") as string);
        }

        public static System.Nullable<Guid> GetCurrentUserId(this System.Windows.Application app)
        {
            return (app.GetPropertyValue("UserId") as System.Nullable<Guid>);
        }

        public static System.Nullable<Guid> GetCurrentCompanyId(this System.Windows.Application app)
        {
            return (app.GetPropertyValue("CurrentCompany") as System.Nullable<Guid>);
        }

        public static System.Nullable<Guid> GetAuthorizationToken(this System.Windows.Application app)
        {
            return (app.GetPropertyValue("AuthorizationToken") as System.Nullable<Guid>);
        }

        public static System.String GetLoginUrl(this System.Windows.Application app)
        {
            string loginUrl = app.GetPropertyValue("LoginUrl") as string;
            return loginUrl.IsNullOrEmpty() ? string.Empty : loginUrl;
        }

        public static System.String GetModalStartupUI(this System.Windows.Application app)
        {
            string modalStartupUI = app.GetPropertyValue("ModalStartupUI") as string;
            return modalStartupUI.IsNullOrEmpty() ? string.Empty : modalStartupUI;
        }

        public static ToolbarStatus GetCurrentControlStatus(this System.Windows.Application app)
        {
            var mainModule = app.GetMainModule();
            if (mainModule != null)
                return mainModule.GetCurrentControlStatus();
            else
                return ToolbarStatus.None;
        }

        public static void SetMainModule(this System.Windows.Application app, IApplicationMainModule mainModule)
        {
            app.SetPropertyValue("MainModule", mainModule);
        }

        public static void ShowException(this System.Windows.Application app, Exception exception)
        {
            var methofInfo = app.GetType().GetMethod("ShowException");
            if (!methofInfo.IsNull())
                methofInfo.Invoke(app, new object[] { exception });
        }

        public static void ShowMessage(this System.Windows.Application app, string message, string title,
            Linx.MessageBoxButton messageBoxButton = MessageBoxButton.OK, Linx.MessageBoxImage messageBoxImage = MessageBoxImage.Information,
            Exception error = null, SingleMsgMethodHandler afterValidated = null)
        {
            var methofInfo = app.GetType().GetMethod("ShowMessage");
            if (!methofInfo.IsNull())
                methofInfo.Invoke(app, new object[] { message, title, messageBoxButton, messageBoxImage, error, afterValidated });
        }

        public static void ShowMessages(this System.Windows.Application app, string title, string description, params string[] messages)
        {
            var methofInfo = app.GetType().GetMethod("ShowMessages");
            if (!methofInfo.IsNull())
                methofInfo.Invoke(app, new object[] { title, description, messages });
        }

        public static string GetResource(this System.Windows.Application app, string name)
        {
            string result = name;
            var methofInfo = app.GetType().GetMethod("GetResource");
            if (!methofInfo.IsNull())
                result = methofInfo.Invoke(app, new object[] { name }).ToString();

            return result;
        }

        public static System.Nullable<Guid> GetApplicationId(this System.Windows.Application app)
        {
            return (app.GetPropertyValue("ApplicationId") as System.Nullable<Guid>);
        }

        public static int GetInternalApplicationId(this System.Windows.Application app)
        {
            object appId = app.GetPropertyValue("InternalApplicationId");
            if (appId != null && (appId is int))
                return (int)appId;
            else
                return -1;
        ...
        public static System.Nullable<Guid> GetAccessGroupId(this System.Windows.Application app)
        {
            return (app.GetPropertyValue("AccessGroupId") as System.Nullable<Guid>);
        }

        /// <summary>
        /// Get the access point for the ServiceBus.
        /// </summary>
        /// <param name="app"></param>
        /// <returns></returns>
        public static string GetServiceBusAddress(this System.Windows.Application app, string key)
        {
            Dictionary<string, string> serviceBusAddresses = app.GetPropertyValue("ServiceBusAddresses") as Dictionary<string, string>;
            if (!serviceBusAddresses.IsNull())
            {
                if (serviceBusAddresses.ContainsKey(key))
                    return serviceBusAddresses[key];
                else if (serviceBusAddresses.ContainsKey("ServiceBusAddress"))
                    return serviceBusAddresses["ServiceBusAddress"];
        ...
        public static IBindingCollectionView GetThemesCatalog(this System.Windows.Application app)
        {
            return app.GetPropertyValue("ThemesCatalog") as IBindingCollectionView;
        }


        public static string GetApplicationPath(this System.Windows.Application app)
        {
            string appPath = app.GetPropertyValue("ApplicationPath") as String;

            return (appPath.IsNull() ? String.Empty : appPath);
        }
