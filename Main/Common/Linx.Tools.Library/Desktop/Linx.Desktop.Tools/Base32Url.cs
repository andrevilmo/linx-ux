...
namespace Linx.Tools
{
	...
	public class Base32Url
	{
        ...
        public static string LxToBase32String(string input, string input2 = "")
        {
            var b32 = new Base32Url(false);
            return b32.Encode(Encoding.ASCII.GetBytes(string.Concat(input, "||91JPRV3F41BPYWKCCG50||", input2)));
        }
