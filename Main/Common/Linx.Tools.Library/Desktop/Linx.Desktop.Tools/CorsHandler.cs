...
namespace Linx.Tools.WebApi
{
    ...
    public class CorsHandler : DelegatingHandler
    {
        ...
        {
            #region Self Host Headers 
            /*
            if (request.Properties.ContainsKey("MS_OwinContext"))
            {
                foreach (var header in request.Headers)
                {
                    //HttpContextShim.HttpContext.Current.Items.Add(header.Key, header.Value);
                }
            }
            */
            #endregion
                ...
                return base.SendAsync(request, cancellationToken).ContinueWith(t =>
                    {
                        ...
                        resp.Headers.Add(AccessControlExposeHeaders, "cacheHash");
                        resp.Headers.Add(AccessControlExposeHeaders, "X-MiniProfiler-Ids");
                        return resp;
                    });
            }
